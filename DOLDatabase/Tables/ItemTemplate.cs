...

{
    ...
    {
        get => m_durability == 0 ? m_maxdurability : m_durability;
        set
        {
            Dirty = true;
            m_durability = value;
    ...
    {
        get => m_condition == 0 ? m_maxcondition : m_condition;
        set
        {
            Dirty = true;
            m_condition = value;
    ...
    public bool IsStackable => m_maxCount > 1;
    ...
    {
        get => m_salvageYieldID;
        set
        {
            Dirty = true;
            m_salvageYieldID = value;
        }
    }
    ...
    public virtual byte BaseDurabilityPercent => (byte) (MaxDurability > 0 ? Durability * 100 / MaxDurability : 0);

    public virtual byte BaseConditionPercent =>
        (byte) Math.Round(MaxCondition > 0 ? (double) Condition / MaxCondition * 100 : 0);

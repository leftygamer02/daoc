...
public class DBStyle : DataObject
{
    ...
    {
        get => m_armorHitLocation;
        set
        {
            m_armorHitLocation = value;
            Dirty = true;
        }
    }

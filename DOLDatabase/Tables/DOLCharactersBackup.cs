...
{
    private string m_dolCharactersID = string.Empty;
        ...
        : base()
    {
        ...
        CustomParams = character.CustomParams != null
            ? character.CustomParams.Select(param =>
                    new DOLCharactersBackupXCustomParam(param.DOLCharactersObjectId, param.KeyName, param.Value))
                .ToArray()

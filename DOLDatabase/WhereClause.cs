...
public abstract class WhereClause
{
    ...
    {
        var prefix = "@";
        var radix = (uint) alphabet.Length;
        var result = "";
        do
        {
...
{
    internal override List<TextAtom> IntermediateRepresentation => new();
...
internal class FilterExpression : WhereClause
{
    ...
    internal override List<TextAtom> IntermediateRepresentation
    {
        get
        {
            ...
            {
                var result = new List<TextAtom>() {new(columnName), new(op), new("(")};
            ...
            return new List<TextAtom>() {new(columnName), new(op), new ValueAtom(val)};
        }
    }
...
internal class PlainTextExpression : WhereClause
{
    ...
    internal override List<TextAtom> IntermediateRepresentation => new() {new(columnName), new(op)};
...
internal class ChainingExpression : WhereClause
{
    ...
    internal override List<TextAtom> IntermediateRepresentation
    {
        get
        {
            ...
            var result = new List<TextAtom>() {new("(")};
...
public class DBColumn
{
    ...
    public WhereClause IsEqualTo(object val)
    {
        return new FilterExpression(Name, "=", val);
    }

    public WhereClause IsNotEqualTo(object val)
    {
        return new FilterExpression(Name, "!=", val);
    }

    public WhereClause IsGreatherThan(object val)
    {
        return new FilterExpression(Name, ">", val);
    }

    public WhereClause IsGreaterOrEqualTo(object val)
    {
        return new FilterExpression(Name, ">=", val);
    }

    public WhereClause IsLessThan(object val)
    {
        return new FilterExpression(Name, "<", val);
    }

    public WhereClause IsLessOrEqualTo(object val)
    {
        return new FilterExpression(Name, "<=", val);
    }

    public WhereClause IsLike(object val)
    {
        return new FilterExpression(Name, "LIKE", val);
    }
    ...
    {
        return new FilterExpression(Name, "IN", values.Cast<object>());
    }
}
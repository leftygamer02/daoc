...
ALTER TABLE newatlas.npctemplates ADD COLUMN OldId VARCHAR(255) NULL;
ALTER TABLE newatlas.npctemplates ADD COLUMN OldMobId VARCHAR(255) NULL;
ALTER TABLE newatlas.npctemplates ADD INDEX `OldMobId` (`OldMobId`);
ALTER TABLE newatlas.npctemplates ADD INDEX `OldId` (`OldId`);
ALTER TABLE newatlas.spawngroups ADD COLUMN OldMobId VARCHAR(255) NULL;

...
public class ConsolePacketLib : IPacketLib
{
    ...
    {
        if (log.IsDebugEnabled) log.Debug(string.Format("({0}, {1}): {2}", type, loc, msg));
    }
    ...
    public void SendInventoryItemsPartialUpdate(IDictionary<int, InventoryItem> items,
        eInventoryWindowType windowType)
    {
    }
    ...
    public void SendCheckLOS(GameObject source, GameObject target,
        CheckLOSMgrResponse callback)
    {
    }

...
public sealed class SprintEffect : StaticEffect, IGameEffect
{
    ...
    public int PulseCallback(ECSGameTimer callingTimer)
    {
        ...
        else
        {
            ...
            if (m_owner.IsMoving)
            {
                ...
                var ra = m_owner.GetAbility<AtlasOF_LongWindAbility>();
                if (ra != null)
    ...
    /// Name of the effect
    /// </summary>
    public override string Name => LanguageMgr.GetTranslation(((GamePlayer) Owner).Client, "Effects.SprintEffect.Name");

    /// <summary>
    /// Remaining Time of the effect in milliseconds
    /// </summary>
    public override int RemainingTime => 1000; // always 1 for blink effect

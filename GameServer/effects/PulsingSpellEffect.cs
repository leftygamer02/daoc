...
public sealed class PulsingSpellEffect : IConcentrationEffect
{
    ...
    /// Name of the effect
    /// </summary>
    public string Name => m_spellHandler.Spell.Name;

    /// <summary>
    /// The name of the owner
    /// </summary>
    public string OwnerName => "Pulse: " + m_spellHandler.Spell.Target;

    /// <summary>
    /// Effect icon ID
    /// </summary>
    public ushort Icon => m_spellHandler.Spell.Icon;

    /// <summary>
    /// Amount of concentration used by effect
    /// </summary>
    public byte Concentration => m_spellHandler.Spell.Concentration;

    /// <summary>
    /// The spell handler
    /// </summary>
    public ISpellHandler SpellHandler => m_spellHandler;

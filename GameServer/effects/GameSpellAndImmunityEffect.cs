...
public class GameSpellAndImmunityEffect : GameSpellEffect
{
    ...
    public GameSpellAndImmunityEffect(ISpellHandler handler, int duration, int pulseFreq) : this(handler, duration,
        pulseFreq, 1)
    {
    }
    ...
    /// </summary>
    public int StartedCount => m_startedCount;
}
...
public class XQuickCastEffect : TimedEffect, IGameEffect
{
        ...
        if (m_owner is GamePlayer)
            (m_owner as GamePlayer).Out.SendMessage(
                LanguageMgr.GetTranslation((m_owner as GamePlayer).Client,
                    "Effects.QuickCastEffect.YouActivatedQC"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
    ...
    /// </summary>
    public override int RemainingTime => 1000;
    ...
    public override IList<string> DelveInfo
    {
        get
        {
            ...
            delveInfoList.Add(
                LanguageMgr.GetTranslation(((GamePlayer) Owner).Client, "Effects.Quickcast.DelveInfo"));

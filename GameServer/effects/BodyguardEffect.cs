...
public class BodyguardEffect : StaticEffect, IGameEffect
{
    ...
    /// Gets guarder
    /// </summary>
    public GamePlayer GuardSource => m_guardSource;
    ...
    /// Gets guarded player
    /// </summary>
    public GamePlayer GuardTarget => m_guardTarget;
    ...
    public void Start(GamePlayer guardSource, GamePlayer guardTarget)
    {
        ...
        GameEventMgr.AddHandler(m_playerGroup, GroupEvent.MemberDisbanded,
            new DOLEventHandler(GroupDisbandCallback1));
        ...
        {
            guardSource.Out.SendMessage(
                LanguageMgr.GetTranslation(guardSource.Client, "Effects.BodyguardEffect.NowBGXButSC",
                    guardTarget.GetName(0, false)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
            guardTarget.Out.SendMessage(
                LanguageMgr.GetTranslation(guardTarget.Client, "Effects.BodyguardEffect.XNowBGYouButSC",
                    guardSource.GetName(0, true)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
        }
        else
        {
            guardSource.Out.SendMessage(
                LanguageMgr.GetTranslation(guardSource.Client, "Effects.BodyguardEffect.YouAreNowBGX",
                    guardTarget.GetName(0, false)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
            guardTarget.Out.SendMessage(
                LanguageMgr.GetTranslation(guardTarget.Client, "Effects.BodyguardEffect.XIsBGYou",
                    guardSource.GetName(0, true)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
        }
    }
    ...
    protected void GroupDisbandCallback1(DOLEvent e, object sender, EventArgs args)
    {
        ...
        if (eArgs.Member == GuardTarget || eArgs.Member == GuardSource) Cancel(false);
    }
    ...
    public override void Cancel(bool playerCancel)
    {
        ...
        m_guardSource.Out.SendMessage(
            LanguageMgr.GetTranslation(m_guardSource.Client, "Effects.BodyguardEffect.YouAreNoLongerBGX",
                m_guardTarget.GetName(0, false)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
        m_guardTarget.Out.SendMessage(
            LanguageMgr.GetTranslation(m_guardTarget.Client, "Effects.BodyguardEffect.XIsNoLongerBGYou",
                m_guardSource.GetName(0, true)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
        ...
        get
        {
            if (m_guardSource != null && m_guardTarget != null)
                return LanguageMgr.GetTranslation(((GamePlayer) Owner).Client,
                    "Effects.BodyguardEffect.BodyguardedByName", m_guardTarget.GetName(0, false),
                    m_guardSource.GetName(0, false));
    ...
    /// </summary>
    public override ushort Icon => 2648;
    ...
    public override IList<string> DelveInfo
    {
        get
        {
            ...
            delveInfoList.Add(LanguageMgr.GetTranslation(((GamePlayer) Owner).Client,
                "Effects.BodyguardEffect.InfoEffect"));
            delveInfoList.Add(" ");
            delveInfoList.Add(LanguageMgr.GetTranslation(((GamePlayer) Owner).Client,
                "Effects.BodyguardEffect.XIsBodyguardingY", GuardSource.GetName(0, true),
                GuardTarget.GetName(0, false)));

    ...
    public void OnCommand(GameClient client, string[] args)
    {
        try
        {
            if (args.Length == 4 && args[2] == "to" && args[3] == "jail")
            {
                ...
                if (character == null)
                {
                    client.Out.SendMessage("Character " + args[1] + " not found", eChatType.CT_Staff,
                ...
                client.Out.SendMessage("Character " + args[1].ToUpperInvariant() + " has been moved to Jail",
            ...
            else if (args.Length == 4 && args[2] == "to" && args[3] == "capital")
            {
                ...
                client.Out.SendMessage(
                    "Character " + args[1].ToUpperInvariant() + " has been moved to their Realm's Capital City",
                    eChatType.CT_Staff, eChatLoc.CL_SystemWindow);
            }
            else
            {

    ...
    public void OnCommand(GameClient client, string[] args)
    {
        ...
        switch (args[1].ToLower())
        {
                ...
                if (client.Account.PrivLevel != (uint) ePrivLevel.Player)
                {
                    if (args.Length < 5)
                    {
                        DisplayMessage(client,
                            "[Language-Manager] Usage: '/translate add [Language] [TranslationId] [Text]'");
                        return;
                    }

                    var translation = LanguageMgr.GetLanguageDataObject(args[2].ToUpper(), args[3],
                        LanguageDataObject.eTranslationIdentifier.eSystem);
                    if (translation != null)
                    {
                        DisplayMessage(client,
                            "[Language-Manager] This translation id is already in use by the given language! ( Language <" +
                            args[2].ToUpper() + "> - TranslationId <" + args[3] + "> )");
                        return;
                    }
                    ...
                    DisplayMessage(client,
                        "[Language-Manager] Translation successfully added! (Language <" + args[2].ToUpper() +
            ...
            case "memadd":
            {
                ...
                {
                    DisplayMessage(client,
                        "[Language-Manager] Usage: '/translate memadd [Language] [TranslationId]'");
                }
                else
                {
                    var lngObj =
                        (LanguageDataObject) client.Player.TempProperties.getProperty<object>(
                            LANGUAGEMGR_MEM_LNG_OBJ, null);

                    if (lngObj != null)
                    {
                        DisplayMessage(client,
                            "[Language-Manager] Can't add language object, there is already another one!");
                    }
                    else
                    {
                        lngObj = LanguageMgr.GetLanguageDataObject(args[2].ToUpper(), args[3],
                            LanguageDataObject.eTranslationIdentifier.eSystem);

                        if (lngObj != null)
                        {
                            DisplayMessage(client,
                                "[Language-Manager] The combination of the given TranslationId <" + args[3] +
                                "> and Language <" + args[2].ToUpper() + "> is already in use!");
                        }
                        else
                        {
                            ...
                            DisplayMessage(client,
                                "[Language-Manager] Language object successfully added to your temporary properties! ( Language <" +
                                args[2].ToUpper() + "> TranslationId <" + args[3] + "> )");
                        }
                    }
                }
            ...
            case "memclear":
            {
                ...
                var lngObj =
                    (LanguageDataObject) client.Player.TempProperties.getProperty<object>(LANGUAGEMGR_MEM_LNG_OBJ,
                        null);
            ...
            case "memsave":
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            DisplayMessage(client,
                                "[Language-Manager] Can't register language object in LanguageMgr, there is already another one!");
                        }
                        else
                        {
                            ...
                            client.Player.TempProperties.removeProperty(LANGUAGEMGR_MEM_LNG_OBJ);
                            DisplayMessage(client,
                                "[Language-Manager] Translation successfully added into the database and registered in LanguageMgr.");
                        }
                    }
                }
            ...
            case "memshow":
            {
                ...
                if (lngObj == null)
                    ...
                    DisplayMessage(client,
                        "[Language-Manager] Language object info: Language <" + lngObj.Language +
            ...
            case "refresh":
            {
                ...
                {
                    DisplayMessage(client,
                        "[Language-Manager] Usage: '/translate refresh [Language] [TranslationId] [Text]'");
                }
                else
                {
                    var lngObj = LanguageMgr.GetLanguageDataObject(args[2].ToUpper(), args[3],
                        LanguageDataObject.eTranslationIdentifier.eSystem);

                    if (lngObj == null)
                    {
                        DisplayMessage(client,
                            "[Language-Manager] Can't find TranslationId <" + args[3] + "> (Language <" +
                            args[2].ToUpper() + "> !");
                    }
                    else
                    {
                        ...
                        DisplayMessage(client,
                            "[Language-Manager] TranslationId <" + args[3] + "> (Language: " + args[2].ToUpper() +
            ...
            case "select":
            {
                ...
                {
                    DisplayMessage(client,
                        "[Language-Manager] Usage: '/translate select [Language] [TranslationId]'");
                }
                else
                {
                    var lngObj =
                        (LanguageDataObject) client.Player.TempProperties.getProperty<object>(
                            LANGUAGEMGR_SEL_LNG_OBJ, null);

                    if (lngObj != null)
                    {
                        DisplayMessage(client,
                            "[Language-Manager] You already have selected a language object! ( Language <" +
                            ((DBLanguageSystem) lngObj).Language +
                    ...
                    else
                    {
                        ...
                        {
                            DisplayMessage(client,
                                "[Language-Manager] Can't find language object. ( Language <" + args[2].ToUpper() +
                                "> - TranslationId <" + args[3] + "> )");
                        }
                        else
                        {
                            ...
                            DisplayMessage(client,
                                "[Language-Manager] Language object found and added to your temporary properties! ( Language <" +
                                args[2].ToUpper() +
                                "> - TranslationId <" + args[3] + "> )");
                        }
                    }
            ...
            case "selectclear":
            {
                ...
                var lngObj =
                    (LanguageDataObject) client.Player.TempProperties.getProperty<object>(LANGUAGEMGR_SEL_LNG_OBJ,
                        null);
                ...
                else
                {
                    ...
                    DisplayMessage(client,
                        "[Language-Manager] Language object successfully removed from your temporary properties." +
            ...
            case "selectsave":
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        client.Player.TempProperties.removeProperty(LANGUAGEMGR_SEL_LNG_OBJ);
                        DisplayMessage(client,
                            "[Language-Manager] Language object successfully changed and saved in database." +
                            "( Language <" + ((DBLanguageSystem) lngObj).Language +
                            "> - TranslationId <" + ((DBLanguageSystem) lngObj).TranslationId +
            ...
            case "selectshow":
            {
                ...
                if (lngObj == null)
                    ...
                    DisplayMessage(client, "[Language-Manager] Language object info: Language <" + lngObj.Language +
                                           "> - TranslationId <" + lngObj.TranslationId +
                                           "> - Text <" + ((DBLanguageSystem) lngObj).Text + ">");
                return;
            }
            ...
            case "show":
            {
                ...
                {
                    DisplayMessage(client,
                        "[Language-Manager] Usage: '/translate show [Language] [TranslationId]'");
                }
                else
                {
                    var lngObj = LanguageMgr.GetLanguageDataObject(args[2].ToUpper(), args[3],
                    ...
                    if (lngObj == null)
                        DisplayMessage(client, "[Language-Manager] Can't find language object. ( Language <" +
                                               args[2].ToUpper() +
                                               "> - TranslationId <" + args[3] + "> )");
                    else

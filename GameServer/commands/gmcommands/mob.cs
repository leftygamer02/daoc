...
public class MobCommandHandler : AbstractCommandHandler, ICommandHandler
{
    ...
    public void OnCommand(GameClient client, string[] args)
    {
        ...
        try
        {
                ...
                && targetMob == null)
            {
                ...
                {
                    client.Out.SendMessage("Cannot use " + client.Player.TargetObject + " for /mob command.",
            ...
            switch (args[1])
            {
                ...
                case "fastcreate":
                    ...
                    break;
                case "nfastcreate":
                    nfastcreate(client, args);
                    break;
                case "nrandcreate":
                    nrandcreate(client, args);
                    break;
                case "model":
                    model(client, targetMob, args);
                    break;
                case "modelinc":
                    modelinc(client, targetMob, args);
                    break;
                case "modeldec":
                    modeldec(client, targetMob, args);
                    break;
                case "size":
                ...
                case "name":
                    ...
                    break;
                case "suffix":
                    suffix(client, targetMob, args);
                    break;
                case "guild":
                    guild(client, targetMob, args);
                    break;
                case "examinearticle":
                    examinearticle(client, targetMob, args);
                    break;
                case "messagearticle":
                    messagearticle(client, targetMob, args);
                    break;
                case "peace":
                ...
                case "level":
                    ...
                    break;
                case "levela":
                    levela(client, targetMob, args);
                    break;
                case "autostats":
                    autostats(client, targetMob);
                    break;
                case "brain":
                ...
                case "questinfo":
                    ...
                    break;
                case "refreshquests":
                    refreshquests(client, targetMob, args);
                    break;
                case "equipinfo":
                ...
                case "equiptemplate":
                    ...
                    break;
                case "visibleslot":
                    visibleslot(client, targetMob, args);
                    break;
                case "dropcount":
                    dropcount<MobXLootTemplate>(client, targetMob, args);
                    break;
                case "dropcount2":
                    dropcount<MobDropTemplate>(client, targetMob, args);
                    break;
                case "addloot":
                    addloot<MobXLootTemplate, LootTemplate>(client, targetMob, args);
                    break;
                case "addloot2":
                    addloot<MobDropTemplate, DropTemplateXItemTemplate>(client, targetMob, args);
                    break;
                case "addotd":
                    addotd(client, targetMob, args);
                    break;
                case "viewloot":
                    viewloot(client, targetMob, args);
                    break;
                case "removeloot":
                    removeloot<LootTemplate>(client, targetMob, args);
                    break;
                case "removeloot2":
                    removeloot<DropTemplateXItemTemplate>(client, targetMob, args);
                    break;
                case "removeotd":
                    removeotd(client, targetMob, args);
                    break;
                case "refreshloot":
                ...
                case "gender":
                    ...
                    break;
                case "packageid":
                    packageid(client, targetMob, args);
                    break;
                case "ownerid":
                    ownerid(client, targetMob, args);
                    break;
                case "select":
                    select(AUTOSELECT_RADIUS, client);
                    break;
                ...
                case "findname":
                    ...
                    break;
                case "trigger":
                    trigger(client, targetMob, args);
                    break;
                case "scaling":
                    scaling(client, targetMob, args);
                    break;
                default:
                    DisplaySyntax(client);
                    return;
    ...
    private void scaling(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        try
        {
            ...
            client.Out.SendMessage("Mob Scaling changed to: " + targetMob.ScalingFactor, eChatType.CT_System,
    ...
    private void nfastcreate(GameClient client, string[] args)
    {
        ...
        for (var i = 0; i < number; ++i)
        {
            ...
            //Fill the object variables
            var x = client.Player.X + Util.Random(-radius, radius);
            var y = client.Player.Y + Util.Random(-radius, radius);
            ...
            mob.Size = 50;
            mob.AddToWorld();
            client.Out.SendMessage("Mob created: OID=" + mob.ObjectID, eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
        }
    }
    ...
    private List<ushort> invmodel = new()
    {
        3, 4, 604, 666, 1000, 1001, 1002, 1003, 1004, 1237, 1238, 1239, 1240, 1241, 1242, 1243, 1244, 1245, 1246,
        1247, 1248, 1249, 1250, 1251, 1252, 1253, 1254, 1275, 1391, 1392, 1393, 1441, 1442, 1443, 1444, 1445, 1446,
        1447, 1448, 1449,
        ...
        1552, 1553, 1554,
        1555, 1556, 1557, 1558, 1559, 1560, 1561, 1562, 1567, 1568, 1569, 1570, 1571, 1572, 1573, 1587, 1588, 1589,
        1590, 1591, 1592,
        1593, 1594, 1595, 1598, 1599, 1600, 1601, 1602, 1603, 1604, 1605, 1608, 1609, 1610, 1611, 1612, 1613, 1614,
        1615, 1616, 1617,
        1618, 1619, 1620, 1621, 1622, 1624, 1626, 1627, 1628, 1629, 1630, 1631, 1632, 1633, 1634, 1635, 1636, 1637,
        1638, 1639, 1640,
        1641, 1643, 1644, 1645, 1646, 1671, 1673, 1674, 1675, 1677, 1678, 1679, 1680, 1682, 1683, 1684, 1685, 1686,
        1737, 1738, 1739,
        1761, 1762, 1763, 1764, 1765, 1766, 1767, 1768, 1769, 1822, 1871, 1872, 1873, 1874, 1875, 1876, 1877, 1880,
        1881, 1882, 1886,
        1907, 1923, 1926, 1927, 1928, 1943, 2004, 2005, 2006, 2007, 2008, 2019, 2067, 2068, 2069, 2070, 2071, 2072,
        2073, 2280, 2281,
        2282, 2283, 2284, 2285, 2286, 2287, 2288, 2289, 2290, 2291, 2292, 2293, 2294, 2299, 2300, 2302, 2305, 2319,
        2333, 2334, 2335,
        2336, 2337, 2338, 2364
    };
    ...
    private void modelinc(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        try
        {
            ...
            client.Out.SendMessage("Mob model changed to: " + targetMob.Model, eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
        }
        catch (Exception)
        {
    ...
    private GameNPC FindOID(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        {
            var obj = client.Player.CurrentRegion.GetObject(mobOID);
            if (obj == null)
            {
                client.Out.SendMessage("No object with OID: " + args[1] + " in current Region.",
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
                return null;
            }
            else
            {
                ...
                {
                    client.Out.SendMessage(
                        "Object " + mobOID + " is a " + obj.GetType().ToString() + ", not a GameNPC.",
                        eChatType.CT_System, eChatLoc.CL_SystemWindow);
                    return null;
                }
            }
    ...
    private void size(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        try
        {
            ...
            if (mobSize > 255) mobSize = 255;

            targetMob.Size = (byte) mobSize;
            targetMob.SaveIntoDatabase();
            client.Out.SendMessage("Mob size changed to: " + targetMob.Size, eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
        }
        catch (Exception)
        {
    ...
    private void name(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        if (mobName != "")
        {
            ...
            targetMob.SaveIntoDatabase();
            client.Out.SendMessage("Mob name changed to: " + targetMob.Name, eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
        }
        else
        {
    ...
    private void suffix(GameClient client, GameNPC targetMob, string[] args)
    {
        if (targetMob.GetType().IsSubclassOf(typeof(GameMovingObject)))
        {
            client.Out.SendMessage("You cannot set a suffix for GameMovingObjects.", eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
            return;
        }
    ...
    private void guild(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        if (guildName != "")
        {
            ...
            targetMob.SaveIntoDatabase();
            client.Out.SendMessage("Mob guild changed to: " + targetMob.GuildName, eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
        }
        else
        {
    ...
    private void examinearticle(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        if (exa != "")
        {
            ...
            targetMob.SaveIntoDatabase();
            client.Out.SendMessage("Mob examine article changed to: " + exa, eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
        }
        else
        {
    ...
    private void messagearticle(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        if (msg != "")
        {
            ...
            targetMob.SaveIntoDatabase();
            client.Out.SendMessage("Mob message article changed to: " + msg, eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
        }
        else
        {
    ...
    private void peace(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        targetMob.SaveIntoDatabase();
        client.Out.SendMessage("Mob PEACE flag is set to " + ((targetMob.Flags & GameNPC.eFlags.PEACE) != 0),
            eChatType.CT_System, eChatLoc.CL_SystemWindow);
    }
    ...
    private void race(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        var reloadResists = args[2].ToLower().Equals("reload");
        ...
        {
            var raceName = string.Join(" ", args, 2, args.Length - 2);
    ...
    private void distance(GameClient client, GameNPC targetMob, string[] args)
    {
        try
        {
            var distance = Convert.ToInt32(args[2]);
    ...
    private void remove(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        if (args.Length > 2 && args[2] == "true")
        {
            ...
            if (mobs == null)
            {
                ...
                var deleteLootTempl =
                    DOLDB<LootTemplate>.SelectObjects(DB.Column("TemplateName").IsEqualTo(mobName));

                GameServer.Database.DeleteObject(deleteLootTempl);

                DisplayMessage(client,
                    "Removed MobXLootTemplate and LootTemplate entries for " + mobName + " from DB.");
            }
        }
    ...
    private void flags(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        targetMob.SaveIntoDatabase();
        client.Out.SendMessage("Mob flags are set to " + targetMob.Flags.ToString(), eChatType.CT_System,
            eChatLoc.CL_SystemWindow);
    }
    ...
    private void ghost(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        targetMob.SaveIntoDatabase();
        client.Out.SendMessage("Mob GHOST flag is set to " + ((targetMob.Flags & GameNPC.eFlags.GHOST) != 0),
            eChatType.CT_System, eChatLoc.CL_SystemWindow);
    }
    ...
    private void stealth(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        targetMob.SaveIntoDatabase();
        client.Out.SendMessage("Mob STEALTH flag is set to " + ((targetMob.Flags & GameNPC.eFlags.STEALTH) != 0),
            eChatType.CT_System, eChatLoc.CL_SystemWindow);
    }
    ...
    private void torch(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        targetMob.SaveIntoDatabase();
        client.Out.SendMessage("Mob TORCH flag is set to " + ((targetMob.Flags & GameNPC.eFlags.TORCH) != 0),
            eChatType.CT_System, eChatLoc.CL_SystemWindow);
    }
    ...
    private void statue(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        if ((targetMob.Flags & GameNPC.eFlags.STATUE) > 0)
            client.Out.SendMessage(
                "You have set the STATUE flag - you will need to use \"/debug on\" to target this NPC.",
                eChatType.CT_Important, eChatLoc.CL_SystemWindow);

        client.Out.SendMessage(
            targetMob.Name + "'s STATUE flag is set to " + ((targetMob.Flags & GameNPC.eFlags.STATUE) != 0),
            eChatType.CT_System, eChatLoc.CL_SystemWindow);
    }
    ...
    private void fly(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        if ((targetMob.Flags & GameNPC.eFlags.FLYING) != 0)
            targetMob.MoveTo(targetMob.CurrentRegionID, targetMob.X, targetMob.Y, targetMob.Z + height,
                targetMob.Heading);

        targetMob.SaveIntoDatabase();

        client.Out.SendMessage(
            targetMob.Name + "'s FLYING flag is set to " + ((targetMob.Flags & GameNPC.eFlags.FLYING) != 0),
            eChatType.CT_System, eChatLoc.CL_SystemWindow);
    }
    ...
    private void swimming(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        targetMob.SaveIntoDatabase();
        client.Out.SendMessage("Mob SWIMMING flag is set to " + ((targetMob.Flags & GameNPC.eFlags.SWIMMING) != 0),
            eChatType.CT_System, eChatLoc.CL_SystemWindow);
    }
    ...
    private void noname(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        targetMob.SaveIntoDatabase();
        client.Out.SendMessage(
            "Mob DONTSHOWNAME flag is set to " + ((targetMob.Flags & GameNPC.eFlags.DONTSHOWNAME) != 0),
            eChatType.CT_System, eChatLoc.CL_SystemWindow);
    }
    ...
    private void notarget(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        targetMob.SaveIntoDatabase();
        client.Out.SendMessage(
            "Mob CANTTARGET flag is set to " + ((targetMob.Flags & GameNPC.eFlags.CANTTARGET) != 0),
            eChatType.CT_System, eChatLoc.CL_SystemWindow);
    }
    ...
    private void kill(GameClient client, GameNPC targetMob, string[] args)
    {
        try
        {
            lock (targetMob.XPGainers.SyncRoot)
            {
                ...
                client.Out.SendMessage("Mob '" + targetMob.Name + "' killed", eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
            }
        }
        catch (Exception e)
    ...
    private void heal(GameClient client, GameNPC targetMob, string[] args)
    {
        try
        {
            ...
            client.Out.SendMessage(
                "Mob '" + targetMob.Name + "' healed (" + targetMob.Health + "/" + targetMob.MaxHealth + ")",
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
        }
        catch (Exception e)
        {
    ...
    private void info(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        if (targetMob.Brain != null && targetMob.Brain is IControlledBrain)
            try
            {
                info.Add(" + -- Owner: " + (targetMob.Brain as IControlledBrain).GetPlayerOwner() != null
                    ? (targetMob.Brain as IControlledBrain).GetPlayerOwner().Name
                    : (targetMob.Brain as IControlledBrain).GetNPCOwner().Name);
            }
            catch
            {
        ...
        if (targetMob.NPCTemplate != null)
            info.Add(
                " + NPCTemplate: " + "[" + targetMob.NPCTemplate.TemplateId + "] " + targetMob.NPCTemplate.Name);

        if (targetMob is Keeps.IKeepItem)
        {
            info.Add(" ");
            var keepItem = targetMob as Keeps.IKeepItem;
        ...
        else
        {
            ...
            info.Add(" + SpawnPoint:  " + targetMob.SpawnPoint.X + ", " + targetMob.SpawnPoint.Y + ", " +
                     targetMob.SpawnPoint.Z);
        }

        info.Add(" ");
        info.Add(" +     STR      /      CON      /      DEX      /      QUI");
        info.Add(" + " + targetMob.Strength + " (" + targetMob.GetModified(eProperty.Strength) + ")  /  " +
                 targetMob.Constitution + " (" + targetMob.GetModified(eProperty.Constitution) + ")  /  " +
                 targetMob.Dexterity + " (" + targetMob.GetModified(eProperty.Dexterity) + ")  /  " +
                 targetMob.Quickness + " (" + targetMob.GetModified(eProperty.Quickness) + ")");
        info.Add(" +     INT      /     EMP     /     PIE     /     CHR");
        info.Add(" + " + targetMob.Intelligence + " (" + targetMob.GetModified(eProperty.Intelligence) + ")  /  " +
                 targetMob.Empathy + " (" + targetMob.GetModified(eProperty.Empathy) + ")  /  " + targetMob.Piety +
                 " (" + targetMob.GetModified(eProperty.Piety) + ")  /  " + targetMob.Charisma + " (" +
                 targetMob.GetModified(eProperty.Charisma) + ")");
        info.Add(" + Block / Parry / Evade %:  " + targetMob.BlockChance + " / " + targetMob.ParryChance + " / " +
                 targetMob.EvadeChance);
        info.Add(" + Attack Speed (Melee Speed Increase %):  " + targetMob.AttackSpeed(targetMob.ActiveWeapon) +
                 " (" + (100 - targetMob.GetModified(eProperty.MeleeSpeed)) + ")");
        ...
        info.Add(" + Position (X, Y, Z, H):  " + targetMob.X + ", " + targetMob.Y + ", " + targetMob.Z + ", " +
                 targetMob.Heading);
    ...
    private void stats(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        info.Add("");
        for (var property = eProperty.Stat_First; property <= eProperty.Stat_Last; ++property)
        ...
        info.Add("");
        for (var property = eProperty.Resist_First + 1; property <= eProperty.Resist_Last; ++property)
            info.Add(string.Format("{0}: {1}",
                GlobalConstants.PropertyToName(property),
                targetMob.GetModified(property)));
        info.Add("");
    ...
    private void realm(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        try
        {
            ...
            targetMob.SaveIntoDatabase();
            client.Out.SendMessage("Mob realm changed to: " + GlobalConstants.RealmToName(targetMob.Realm),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
        }
        catch (Exception)
        {
    ...
    private void level(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        if (args.Length > 2 && byte.TryParse(args[2], out level))
        {
            ...
            targetMob.SaveIntoDatabase();
            client.Out.SendMessage("Mob level changed to: " + targetMob.Level, eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
        }
        else
        {
    ...
    private void levela(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        try
        {
            ...
            targetMob.SaveIntoDatabase();
            client.Out.SendMessage("Mob level changed to: " + targetMob.Level + " and stats adjusted",
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
        }
        catch (Exception)
        {
    ...
    private void autostats(GameClient client, GameNPC targetMob)
    {
        try
        {
            targetMob.AutoSetStats();
            targetMob.SaveIntoDatabase();
            client.Out.SendMessage("Mob stats adjusted to level " + targetMob.Level, eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
        }
        catch (Exception)
        {
    ...
    private void brain(GameClient client, GameNPC targetMob, string[] args)
    {
        try
        {
            ...
            {
                client.Out.SendMessage(
                    "Could not find brain " + brainType + ". Check spelling and script namespace (case sensitive)",
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
            }
            else
            {
                ...
                targetMob.SaveIntoDatabase();
                client.Out.SendMessage(targetMob.Name + "'s brain set to " + targetMob.Brain.ToString(),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
            }
        }
        catch (Exception)
    ...
    private void respawn(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        try
        {
            ...
            targetMob.SaveIntoDatabase();
            client.Out.SendMessage("Mob respawn interval changed to: " + interval, eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
        }
        catch (Exception)
        {
    ...
    private void questinfo(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        {
            client.Out.SendMessage("Scripted Quests: ------------------------", eChatType.CT_System,
                eChatLoc.CL_PopupWindow);

            foreach (AbstractQuest quest in targetMob.QuestListToGive)
                client.Out.SendMessage("Quest Name: [" + quest.Name + "]", eChatType.CT_System,
                    eChatLoc.CL_PopupWindow);

            client.Out.SendMessage("Data Quests: ----------------------------", eChatType.CT_System,
                eChatLoc.CL_PopupWindow);

            foreach (var dq in targetMob.DataQuestList)
                client.Out.SendMessage(
                    "Quest Name: [" + dq.Name + "] : " + (DataQuest.eStartType) dq.DBDataQuest.StartType,
    ...
    private void refreshquests(GameClient client, GameNPC targetMob, string[] args)
    {
        try
        {
            ...
            client.Out.SendMessage(targetMob.DataQuestList.Count + " Data Quests loaded for this mob.",
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
        }
        catch (Exception ex)
        {
    ...
    private void equipinfo(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        var message = string.Format("			         Inventory: {0}{1}, equip template ID: {2}",
            targetMob.Inventory.GetType().ToString(), closed, targetMob.EquipmentTemplateID);
        client.Out.SendMessage(message, eChatType.CT_System, eChatLoc.CL_PopupWindow);
        client.Out.SendMessage("-------------------------------", eChatType.CT_System, eChatLoc.CL_PopupWindow);
        client.Out.SendMessage("", eChatType.CT_System, eChatLoc.CL_PopupWindow);

        foreach (var item in targetMob.Inventory.AllItems)
        {
            client.Out.SendMessage("Slot Description : [" + GlobalConstants.SlotToName(item.SlotPosition) + "]",
                eChatType.CT_System, eChatLoc.CL_PopupWindow);
            client.Out.SendMessage("------------", eChatType.CT_System, eChatLoc.CL_PopupWindow);
            client.Out.SendMessage("         Slot: " + GlobalConstants.SlotToName(item.Item_Type),
                eChatType.CT_System, eChatLoc.CL_PopupWindow);
    ...
    private void equiptemplate(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        else if (args[2].ToLower() == "create")
        {
            try
            {
                ...
                {
                    client.Out.SendMessage(
                        "Target mob inventory is set to " + targetMob.Inventory.GetType() + ", remove it first.",
                        eChatType.CT_System, eChatLoc.CL_SystemWindow);
                    return;
                }
                ...
                client.Out.SendMessage("Inventory template created.", eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
            }
            catch
            {
        ...
        else if (args[2].ToLower() == "load")
        {
            if (args.Length > 3)
            {
                ...
                try
                {
                    ...
                    {
                        client.Out.SendMessage("Error loading equipment template \"" + args[3] + "\"",
                            eChatType.CT_System, eChatLoc.CL_SystemWindow);
                        return;
                    }
        ...
        switch (args[2])
        {
            case "add":
            {
                if (args.Length >= 5)
                {
                    try
                    {
                        ...
                        {
                            client.Out.SendMessage(
                                "No such slot available, remember to use slot name (distance, torso, cloak, etc.)!",
                                eChatType.CT_System, eChatLoc.CL_SystemWindow);
                            return;
                        }

                        var model = Convert.ToInt32(args[4]);
                        var color = 0;
                        var effect = 0;
                        var extension = 0;
                        ...
                        {
                            client.Out.SendMessage(
                                "Couldn't add new item to slot " + slot + ". Template could be closed.",
                                eChatType.CT_System, eChatLoc.CL_SystemWindow);
                            return;
                        }
            ...
            case "remove":
            {
                if (args.Length > 3)
                {
                    try
                    {
                        ...
                        if (slot == 0)
                        {
                            client.Out.SendMessage("No such slot available!", eChatType.CT_System,
                                eChatLoc.CL_SystemWindow);
                            return;
                        }
                        ...
                        {
                            client.Out.SendMessage(
                                "Couldn't remove item from slot " + slot + ". Template could be closed.",
                                eChatType.CT_System, eChatLoc.CL_SystemWindow);
                            return;
                        }

                        client.Out.SendMessage("Mob inventory template slot " + slot + " cleaned!",
                            eChatType.CT_System, eChatLoc.CL_SystemWindow);
                    }
                    catch
                    {
            ...
            case "close":
            {
                ...
                {
                    client.Out.SendMessage("Template is already closed.", eChatType.CT_System,
                        eChatLoc.CL_SystemWindow);
                    return;
                }

                targetMob.Inventory = template.CloseTemplate();
                client.Out.SendMessage("Inventory template closed succesfully.", eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
            }
                break;
            ...
            case "save":
            {
                if (args.Length > 3)
                {
                    var replace = args.Length > 4 && args[4].ToLower() == "replace";

                    var existingTemplates =
                        DOLDB<NPCEquipment>.SelectObjects(DB.Column("TemplateID").IsEqualTo(args[3]));
                    ...
                    if (existingTemplates.Count > 0)
                    {
                        ...
                        else
                        {
                            client.Out.SendMessage(
                                ...
                                "' already exists. Use the 'replace' parameter if you want to overwrite it.",
                                eChatType.CT_System, eChatLoc.CL_SystemWindow);
                            return;
                        }
                    }
                    ...
                    client.Out.SendMessage("Target mob equipment template is saved as '" + args[3] + "'",
                        eChatType.CT_System, eChatLoc.CL_SystemWindow);
                    return;
                }
                else
    ...
    private void visibleslot(GameClient client, GameNPC targetMob, string[] args)
    {
        try
        {
            ...
            if (slot == 0)
            {
                client.Out.SendMessage("Bad slot.  Use names like right, left, two, distance.", eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
                return;
            }

            var slotname = GlobalConstants.SlotToName(slot);
            ...
            switch (slotname)
            {
                ...
                default:
                    client.Out.SendMessage("Invalid slot, must be a weapon slot (right, left, two, distance)!",
                        eChatType.CT_System, eChatLoc.CL_SystemWindow);
                    return;
            }

            targetMob.SaveIntoDatabase();
            client.Out.SendMessage("Visible weapon slot set to " + slotname, eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
        }
        catch
        {
    ...
    {
        var mxlt = DOLDB<T>.SelectObject(DB.Column("MobName").IsEqualTo(targetMob.Name)
            .And(DB.Column("LootTemplateName").IsEqualTo(targetMob.Name)));
        ...
        else
        {
            ...
            DisplayMessage(client,
                "Mob '" + targetMob.Name + "' will drop a maximum of " + mxlt.DropCount + " items!");
        }
    }
        ...
        where LootTemplateType : LootTemplate
    {
        try
        {
            var lootTemplateID = args[2];
            var name = targetMob.Name;
            int chance = Convert.ToInt16(args[3]);
            var numDrops = 0;

            if (chance == 100 && args.Length > 4) numDrops = Convert.ToInt16(args[4]);
            ...
            var template = DOLDB<LootTemplateType>.SelectObjects(DB.Column("TemplateName").IsEqualTo(name)
                .And(DB.Column("ItemTemplateID").IsEqualTo(lootTemplateID)));
            if (template != null)
            {
                GameServer.Database.DeleteObject(template);

                var lt = Activator.CreateInstance<LootTemplateType>();
                lt.Chance = chance;
            ...
            if (chance < 100)
                client.Out.SendMessage(
                    item.Name + " was succesfully added to the loot list for  " + name + " with a " + chance +
                    "% chance to drop!",
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
            else
                client.Out.SendMessage(
                    item.Name + " was succesfully added to the loot list for " + name + " with a drop count of " +
                    numDrops + "!",
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);

            var mxlt = DOLDB<MobXLootType>.SelectObject(DB.Column("MobName").IsEqualTo(targetMob.Name)
                .And(DB.Column("LootTemplateName").IsEqualTo(name)));
            ...
            if (mxlt == null)
                ...
                DisplayMessage(client,
                    "A MobXLootTemplate entry exists for this mob and limits the total drops per kill to " +
                    mxlt.DropCount);
        }
        catch (Exception)
        {
    ...
    private void addotd(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        {
            var mobName = targetMob.Name;
            var itemTemplateID = args[2];
            var minlevel = Convert.ToInt32(args[3]);

            var item = GameServer.Database.FindObjectByKey<ItemTemplate>(itemTemplateID);
            if (item == null)
            {
                DisplayMessage(client,
                    "You cannot add the " + itemTemplateID + " to the " + targetMob.Name +
                    " because the item does not exist.");
                return;
            }

            var otd = DOLDB<LootOTD>.SelectObject(DB.Column("MobName").IsEqualTo(mobName)
                .And(DB.Column("ItemTemplateID").IsEqualTo(itemTemplateID)));

            if (otd != null)
            {
                DisplayMessage(client,
                    "ItemTemplate " + itemTemplateID + " is already in this in " + mobName + "'s OTD list!");
            }
            else
            {
                ...
                refreshloot(client, targetMob, null);
                client.Out.SendMessage(
                    itemTemplateID + " was succesfully added to " + mobName + "'s one time drop list.",
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
            }
        }
        catch (Exception)
    ...
    private void viewloot(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        if (args.Length > 2 && args[2] == "random")
        {
            ...
            var templates = LootMgr.GetLoot(targetMob, client.Player);
            DisplayMessage(client, "[ " + targetMob.Name + "'s Loot Table ]\n\n");
            foreach (var temp in templates)
            {
                var message = string.Format("Name: {0}, Id_nb: {1}", temp.Name, temp.Id_nb);
        ...
        else
        {
            ...
            var otds = DOLDB<LootOTD>.SelectObjects(DB.Column("MobName").IsEqualTo(targetMob.Name));
            ...
            if (otds != null && otds.Count > 0)
            {
                ...
                {
                    var drop = GameServer.Database.FindObjectByKey<ItemTemplate>(otd.ItemTemplateID);
        ...
        where LootTemplateType : LootTemplate
    {
        ...
        {
            fromNPCT = true;
            mobXloot = DOLDB<MobDropTemplateType>.SelectObjects(DB.Column("MobName")
                .IsEqualTo(mob.NPCTemplate.TemplateId));
        }

        if (mobXloot == null || (mobXloot != null && mobXloot.Count() == 0))
            mobXloot = DOLDB<MobDropTemplateType>.SelectObjects(DB.Column("MobName").IsEqualTo(mobName));

        foreach (var mobXtemplate in mobXloot)
        {
            didDefault = didDefault || mobXtemplate.LootTemplateName == mobName;
            var template =
                DOLDB<LootTemplateType>.SelectObjects(DB.Column("TemplateName")
                    .IsEqualTo(mobXtemplate.LootTemplateName));
            if (template.Count > 0)
                text.Add("+ Mob's template [from " + (fromNPCT ? mob.NPCTemplate.TemplateId.ToString() : mobName) +
                         "]: " + mobXtemplate.LootTemplateName + " (DropCount: " + mobXtemplate.DropCount + ")");
            text.AddRange(
        ...
        where LootTemplateType : LootTemplate
    {
        ...
        if (lootTemplateID.ToLower() == "all items")
        {
            ...
            if (template != null && template.Count > 0)
            {
                ...
                refreshloot(client, targetMob, null);
                client.Out.SendMessage("Removed all items from " + targetMob.Name, eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
            }
            else
            {
                client.Out.SendMessage("No items found on " + targetMob.Name, eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
            }
        }
        else
        {
            var template = DOLDB<LootTemplateType>.SelectObjects(DB.Column("TemplateName")
                .IsEqualTo(name).And(DB.Column("ItemTemplateID").IsEqualTo(lootTemplateID)));
            ...
            if (template != null && template.Count > 0)
            {
                ...
                refreshloot(client, targetMob, null);
                client.Out.SendMessage(lootTemplateID + " removed from " + targetMob.Name, eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
            }
            else
            {
                client.Out.SendMessage(lootTemplateID + " does not exist on " + name, eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
            }
        }
    }
    ...
    private void removeotd(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        var template = DOLDB<LootOTD>.SelectObjects(DB.Column("MobName").IsEqualTo(name)
            .And(DB.Column("ItemTemplateID").IsEqualTo(itemTemplateID)));
        ...
        if (template != null)
        {
            ...
            client.Out.SendMessage(itemTemplateID + " OTD removed from " + targetMob.Name, eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
        }
        else
        {
            client.Out.SendMessage(itemTemplateID + " OTD does not exist on " + name, eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
        }
    }
    ...
    private void setClass(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        if (mob == null)
            try
            {
                foreach (var assembly in ScriptMgr.Scripts)
                {
                    mob = assembly.CreateInstance(args[2], true) as GameNPC;
        ...
        if (mob == null)
        {
            client.Out.SendMessage("There was an error creating an instance of " + args[2] + ".",
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return;
        }
        ...
        client.Out.SendMessage("Mob class changed: OID=" + mob.ObjectID, eChatType.CT_System,
            eChatLoc.CL_SystemWindow);
    }
    ...
    private void copy(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        if (args.Length > 2)
        {
            var mobName = string.Join(" ", args, 2, args.Length - 2);
            ...
            if (dbMob != null)
            {
                ...
                if (targetMob != null) targetMob.LoadFromDatabase(dbMob);
            }

            if (mob == null || targetMob == null)
            {
                client.Out.SendMessage("Unable to find mob named:  " + mobName, eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
                return;
            }
        }
        else
        {
            if (targetMob == null)
            {
                client.Out.SendMessage("You must have a mob targeted to copy.", eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
                return;
            }
            ...
            {
                client.Out.SendMessage(
                    "There was an error creating an instance of " + targetMob.GetType().FullName + "!",
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
                return;
            }
        }
        ...
        if (mob is GameMerchant) ((GameMerchant) mob).TradeItems = ((GameMerchant) targetMob).TradeItems;
        ...
        if ((mob.Flags & GameNPC.eFlags.PEACE) != 0)
            ...
            client.Out.SendMessage("This mobs PEACE flag is set!", eChatType.CT_Important,
                eChatLoc.CL_SystemWindow);
    }
    ...
    private void npctCreate(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        var replace = args[args.Length - 1].Equals("replace");

        var template = NpcTemplateMgr.GetTemplate(id);
    ...
    private void path(GameClient client, GameNPC targetMob, string[] args)
    {
        try
        {
            var pathname = string.Join(" ", args, 2, args.Length - 2);

            if (pathname != "" && MovementMgr.LoadPath(pathname) == null)
            {
                client.Out.SendMessage("The specified path does not exist", eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
            }
            else
            {
                ...
                client.Out.SendMessage("The path has been assigned to this mob", eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
            }
        }
        catch
    ...
    private void house(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        try
        {
            ...
            if (H != null)
            {
                ...
                targetMob.SaveIntoDatabase();
                client.Out.SendMessage("Mob house changed to: " + house, eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
            }
            else
            {
                client.Out.SendMessage("House number " + house + " doesn't exist.", eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
            }
        }
        catch (Exception)
    ...
    private void stat(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        try
        {
            ...
            targetMob.SaveIntoDatabase();
            client.Out.SendMessage("Mob " + statType + " changed to: " + statval, eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
            ...
            if (targetMob.LoadedFromScript == true)
                ...
                client.Out.SendMessage("This mob is loaded from a script - stat changes cannot be saved.",
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
        }
        catch (Exception)
        {
    ...
    private void tether(GameClient client, GameNPC targetMob, string[] args)
    {
        try
        {
            var tether = Convert.ToInt32(args[2]);
            targetMob.TetherRange = tether;
            client.Out.SendMessage("Mob tether range changed to: " + tether, eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
            client.Out.SendMessage(
    ...
    private void cloak(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        targetMob.BroadcastLivingEquipmentUpdate();
        targetMob.SaveIntoDatabase();
        client.Out.SendMessage("Mob IsCloakInvisible flag is set to " + targetMob.IsCloakHoodUp,
            eChatType.CT_System, eChatLoc.CL_SystemWindow);
    }
    ...
    private string CheckName(string name, GameClient client)
    {
        if (name.Length > 47)
            client.Out.SendMessage(
                "WARNING: name length=" + name.Length + " but only first 47 chars will be shown.",
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
        return name;
    }
    ...
    private string CheckGuildName(string name, GameClient client)
    {
        if (name.Length > 47)
            client.Out.SendMessage(
                "WARNING: guild name length=" + name.Length + " but only first 47 chars will be shown.",
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
        return name;
    }
    ...
    private GameNPC select(ushort range, GameClient client)
    {
        ...
        foreach (GameNPC wantedMob in client.Player.GetNPCsInRadius(range))
        {
            ...
            {
                client.Out.SendMessage("You have autoselected the mob with OID " + wantedMob.ObjectID.ToString(),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
    ...
    private void reload(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        {
            // Reload the mob(s)
            for (var i = eRealm._First; i <= eRealm._Last; i++) mobs.Add(WorldMgr.GetNPCsByName(args[2], i));
            ...
            foreach (var n in ma)
                if (n.LoadedFromScript == false)
                {
                    ...
                    n.AddToWorld();
                    client.Player.Out.SendMessage(n.Name + " reloaded!", eChatType.CT_System,
                        eChatLoc.CL_SystemWindow);
                }
        }
        else if (targetMob != null)
        {
            ...
            if (targetMob.LoadedFromScript == false)
            {
                ...
                targetMob.AddToWorld();
                client.Player.Out.SendMessage(targetMob.Name + " reloaded!", eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
            }
            else
            {
                client.Player.Out.SendMessage(targetMob.Name + " is loaded from a script and can't be reloaded!",
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
            }
        }
    }
    ...
    private void load(GameClient client, string[] args)
    {
        if (args.Length > 2)
        {
            var mob = GameServer.Database.FindObjectByKey<Mob>(args[2]);
            if (mob != null)
            {
                ...
                npc.AddToWorld();
                DisplayMessage(client,
                    "Mob {0} added to the world.  Use care if this is a duplicate, removing original will delete mob from the DB!",
                    args[2]);
            }
            else
            {
    ...
    private void findname(GameClient client, string[] args)
    {
        ...
        var mobs = DOLDB<Mob>.SelectObjects(DB.Column("Name").IsLike($"%{args[2]}%"))
            .OrderByDescending(m => m.Level).Take(maxreturn).ToArray();
        if (mobs != null && mobs.Length > 0)
        {
            var mnames = "Found : \n";
            for (var i = 0; i < mobs.Length; i++) mnames = mnames + mobs[i].Name + "\n";
    ...
    private void state(GameClient client, GameNPC targetMob)
    {
        ...
        {
            var aggroList = (targetMob.Brain as StandardMobBrain).AggroTable;
            ...
            if (aggroList.Count > 0)
            {
                ...
                foreach (var living in aggroList.Keys) text.Add(living.Name + ": " + aggroList[living]);
            }
        }
        ...
        if (targetMob.attackComponent.Attackers != null && targetMob.attackComponent.Attackers.Count > 0)
        {
            ...
            foreach (GameLiving attacker in targetMob.attackComponent.Attackers) text.Add(attacker.Name);
        }
        ...
        if (targetMob.EffectList.Count > 0)
        {
            ...
            foreach (var effect in targetMob.EffectList) text.Add(effect.Name + " remaining " + effect.RemainingTime);
        }
    ...
    private void trigger(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        try
        {
            ...
            {
                client.Out.SendMessage(
                    "You must specify a proper type for the trigger <spawning|aggroing|dying|fighting|moving|roaming|seeing|interact>.",
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
                client.Out.SendMessage("example: dying 0 This is what I will say when I die!", eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
                return;
            }
            ...
            {
                client.Out.SendMessage("You must specify a valid chance percent/emote number", eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
            }
            ...
            if (text == "")
            {
                client.Out.SendMessage("You must specify some text for the trigger.", eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
                return;
            }
            ...
            if (text.Contains("{c}")) // For eAmbientTrigger.interact, send System message in Chat window
                voice = "c";
            text = text.Replace("{b}", string.Empty).Replace("{y}", string.Empty).Replace("{s}", string.Empty)
                .Replace("{c}", string.Empty);
            GameServer.Database.AddObject(
                new MobXAmbientBehaviour(targetMob.Name, trig.ToString(), emote, text, chance, voice)
                    {Dirty = true, AllowAdd = true});
            client.Out.SendMessage(
                " Trigger added to mobs with name " + targetMob.Name + " when they " + type + ".",
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return;
        }
        catch (Exception)
    ...
    private void trigger_remove(GameClient client, GameNPC targetMob, string[] args)
    {
        ...
        ChatUtil.SendSystemMessage(client,
            "Trigger: \"" + trigger.Trigger + ", chance: " + trigger.Chance + ", voice: " + trigger.Voice +
            ", emote: " + trigger.Emote + ", text: " + trigger.Text + "\" has been removed.");
    }
    ...
    private void trigger_info(GameClient client, GameNPC targetMob)
    {
        ...
        foreach (var trigger in triggers)
            ChatUtil.SendSystemMessage(client,
                ++i + ". " + trigger.Trigger + ", chance: " + trigger.Chance + ", voice: " + trigger.Voice +
                ", emote: " + trigger.Emote + ", text: " + trigger.Text);
    }

    private void trigger_help(GameClient client)
    {
        client.Out.SendMessage(
            "The trigger command lets you add sentences for the mob to say when he spawns, aggros, fights or dies.",
            eChatType.CT_System, eChatLoc.CL_PopupWindow);
        client.Out.SendMessage(
            "Triggers apply to all mobs with the same mob name.  Each mob name can have multiple triggers and trigger types.",
            eChatType.CT_System, eChatLoc.CL_PopupWindow);
        client.Out.SendMessage(
            "The aggro and die trigger types allow for keywords of {targetname} (name of the mob/NPC's target), {class} (target class if player), {race} (target race if player), and {sourcename} (mob/NPC's name) and {controller} (the pet's controller).",
            eChatType.CT_System, eChatLoc.CL_PopupWindow);
        client.Out.SendMessage("Ex: /mob trigger aggroing 50 10 This is what I'll say 50% time when I aggro!",
            eChatType.CT_System, eChatLoc.CL_PopupWindow);
        client.Out.SendMessage("Ex: /mob trigger dying 100 5 This is what I'll say when I die!",
            eChatType.CT_System, eChatLoc.CL_PopupWindow);
        client.Out.SendMessage("Ex: /mob trigger aggroing 100 0 {y}I really hate {class}'s like you!",
            eChatType.CT_System, eChatLoc.CL_PopupWindow);
        client.Out.SendMessage("Ex: /mob trigger roaming 5 12 Prepare to die {targetname}!", eChatType.CT_System,
            eChatLoc.CL_PopupWindow);
        client.Out.SendMessage(
            "Ex: /mob trigger aggroing 5 0 {b}I've been waiting for this moment ever since I was a young {sourcename}!",
            eChatType.CT_System, eChatLoc.CL_PopupWindow);
        client.Out.SendMessage(
            "Usage: '/mob trigger <type(dying|aggroing|spawning|fighting|killing|roaming|interact)> <percentChance> <emote {0 for no emote{> <sentence(can include {targetname},{sourcename},{class},{race}, {controller})(can also be formatted with {y} for yelled and {b} for broadcasted sentence)>'",
            eChatType.CT_System, eChatLoc.CL_PopupWindow);
        client.Out.SendMessage(
            "Usage: '/mob trigger info' - Give information regarding a selected mob/NPC's ambient trigger(s).",
            eChatType.CT_System, eChatLoc.CL_PopupWindow);
        client.Out.SendMessage("Usage: '/mob trigger remove <id>' Remove a trigger", eChatType.CT_System,
            eChatLoc.CL_PopupWindow);
    }
}
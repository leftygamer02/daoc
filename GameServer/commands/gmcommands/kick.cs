    ...
    public void OnCommand(GameClient client, string[] args)
    {
        ...
        if (clientc == null)
        {
            DisplayMessage(client,
                LanguageMgr.GetTranslation(client.Account.Language, "GMCommands.Kick.NoPlayerOnLine"));
            return;
        }
        ...
        for (var i = 0; i < 8; i++)
        {
            ...
            if (client != null && client.Player != null)
                message = LanguageMgr.GetTranslation(clientc, "GMCommands.Kick.RemovedFromServerByGM",
                    client.Player.Name);
            else

        ...
        public static void ExecuteCode(GameClient client, string methodBody)
        {
            ...
            if (errorMessages.Any())
            {
                if (client.Player != null)
                {
                    ...
                    ChatUtil.SendTypeMessage("error", client, "AdminCommands.Code.Err.Compiling", null);

                    // Send each error message that occurs
                    foreach (var errorMessage in errorMessages)
                        ChatUtil.SendTypeMessage("error", client, errorMessage);
                }
                else
                {
            ...
            try
            {
                ...
                if (client.Player != null)
                {
                    ...
                    ChatUtil.SendTypeMessage("success", client, "AdminCommands.Code.Msg.CodeExecuted", null);
                }
                else
                {
            ...
            catch (Exception ex)
            {
                if (client.Player != null)
                {
                    ...
                    foreach (string error in errors)
                        ChatUtil.SendTypeMessage("error", client, error, null);
                }
                else
                {

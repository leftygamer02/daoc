        ...
        switch (args[1])
        {
            ...
            case "single":
            {
                switch (args.Length)
                {
                    ...
                    case >= 4:
                    {
                        var targetClient = WorldMgr.GetClientByPlayerName(args[3], true, true);
                        ...
                        ChatUtil.SendErrorMessage(client, "AdminCommands.Plvl.Msg.AddSinglePerm", target.Name,
                            args[2]);

                        if (target != client.Player)
                            // Message: "{0} has given you access to the '/{1}' command! Type '/{1}' to view the command list."
                            ChatUtil.SendErrorMessage(target.Client, "AdminCommands.Plvl.Msg.GaveSinglePerm",
                ...
                switch (args.Length)
                {
                    ...
                    case >= 4:
                    {
                        ...
                        if (target != client.Player)
                            ...
                            ChatUtil.SendErrorMessage(target.Client, "AdminCommands.Plvl.Msg.GaveAcct",
                                client.Player.Name, args[2]);
            ...
            case "remove":
            {
                switch (args.Length)
                {
                    ...
                    case >= 4:
                    {
                        ...
                        ChatUtil.SendErrorMessage(client, "AdminCommands.Plvl.Msg.RevokeSinglePerm", target.Name,
                            args[2]);
                ...
                switch (args.Length)
                {
                    ...
                    case >= 4:
                    {
                        ...
                        else
                        {
                            ...
                            ChatUtil.SendErrorMessage(client, "AdminCommands.Plvl.Err.NoAcctPermFound", target.Name,
                                args[2]);
                            return;
                        }

                        // Message: "You have revoked {0}'s account access to the '/{1}' command!"
                        ChatUtil.SendErrorMessage(client, "AdminCommands.Plvl.Msg.RevokeAcctPerm", target.Name,
                            args[2]);
                        ...
                        if (target != client.Player)
                        {
                            ...
                            ChatUtil.SendErrorMessage(target.Client, "AdminCommands.Plvl.Msg.DelAcctPerm",
                                client.Player.Name, args[2]);
                            return;
                        }
                    }
            ...
            default:
            {
                ...
                if (args.Length > 2)
                {
                    var targetClient = WorldMgr.GetClientByPlayerName(args[2], true, true);
                ...
                if (args[1] == "1" || (args[1] == "2" && client.Player == target && target == null))
                    ...
                    if (SinglePermission.HasPermission(client.Player, "plvl") == false)
                    {
                        ...
                        client.Out.SendDialogBox(eDialogCode.SimpleWarning, 0, 0, 0, 0, eDialogType.Ok, true,
                            LanguageMgr.GetTranslation(client, "AdminCommands.Plvl.Err.NoPlvlPerm", null));
                        return;
                    }

...
public class FreelevelCommandHandler : AbstractCommandHandler, ICommandHandler
{
    public void OnCommand(GameClient client, string[] args)
    {
        ...
        var state = client.Player.FreeLevelState;
        var message = "";
        ...
        {
            case eRealm.Albion:
                t = client.Player.LastFreeLeveled.AddDays(ServerProperties.Properties
                    .FREELEVEL_DAYS_ALBION) - DateTime.Now;
                break;
            case eRealm.Midgard:
                t = client.Player.LastFreeLeveled.AddDays(ServerProperties.Properties
                    .FREELEVEL_DAYS_MIDGARD) - DateTime.Now;
                break;
            case eRealm.Hibernia:
                t = client.Player.LastFreeLeveled.AddDays(
                    ServerProperties.Properties.FREELEVEL_DAYS_HIBERNIA) - DateTime.Now;
        ...
        switch (state)
        {
            case 1:
                message = LanguageMgr.GetTranslation(client.Account.Language,
                    "PLCommands.FreeLevel.AboveMaximumLevel");
                break;
            case 2:
                message = LanguageMgr.GetTranslation(client.Account.Language,
                    "PLCommands.FreeLevel.EligibleFreeLevel");
                break;
            case 3:
                // NOT SURE FOR THIS MESSAGE
                message = LanguageMgr.GetTranslation(client.Account.Language, "PLCommands.FreeLevel.FreeLevelIn",
                    t.Days, t.Hours, t.Minutes);
                break;
            case 4:
                // NOT SURE FOR THIS MESSAGE
                message = LanguageMgr.GetTranslation(client.Account.Language, "PLCommands.FreeLevel.FreeLevelIn2",
                    t.Days, t.Hours, t.Minutes);
                break;
            case 5:

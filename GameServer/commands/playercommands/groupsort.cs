    ...
    public void OnCommand(GameClient client, string[] args)
    {
        if (client.Player.Group == null)
        {
            DisplayMessage(client,
                LanguageMgr.GetTranslation(client.Account.Language, "Scripts.Players.Groupsort.InGroup"));
            return;
        }
        ...
        var switchX = string.Empty;
        var switchY = string.Empty;
        ...
        if (command == "manual" || command == "switch")
        {
            ...
            {
                DisplayMessage(client,
                    LanguageMgr.GetTranslation(client.Account.Language, "Scripts.Players.Groupsort.Leader"));
                return;
            }
            ...
            switch (command)
            {
                ...
                case "switch":
                    ...
                    var switchXIndex = Convert.ToInt32(switchX);
                    var switchYIndex = Convert.ToInt32(switchY);

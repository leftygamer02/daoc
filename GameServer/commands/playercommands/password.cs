...
public class PasswordCommand : AbstractCommandHandler, ICommandHandler
{
    ...
    {
        var usage = "Usage: /password <current_password> <new_password>";
        ...
        try
        {
            ...
            if (client.Account != null &&
                LoginRequestHandler.CryptPassword(oldPassword) == client.Account.Password)
            {
            ...
            {
                client.Out.SendMessage("Your current password was incorrect.", eChatType.CT_Important,

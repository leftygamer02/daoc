    ...
    public void OnCommand(GameClient client, string[] args)
    {
        ...
        if (args[1].ToLower().Equals("on"))
        {
            ...
            client.Out.SendMessage(
                "You will now see detailed combat stats. Use '/combatstats off' to stop seeing these details.",
        ...
        else if (args[1].ToLower().Equals("off"))
        {
            ...
            client.Out.SendMessage(
                "You will no longer see detailed combat stats. Use '/combatstats on' to see these details once more.",
                eChatType.CT_Important, eChatLoc.CL_SystemWindow);
        }
    }
}
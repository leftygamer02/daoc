...
namespace DOL.GS.Commands
{
	...
	public class LevelCommandHandler : AbstractCommandHandler, ICommandHandler
	{
		public void OnCommand(GameClient client, string[] args)
		{
			...
			if (client.Player.ExpComponent.Experience >= client.Player.ExpComponent.GetExperienceNeededForLevel(ServerProperties.Properties.SLASH_LEVEL_TARGET - 1))
			{
			...
			long newXP;
			newXP = client.Player.ExpComponent.GetExperienceNeededForLevel(targetLevel - 1) - client.Player.ExpComponent.Experience;

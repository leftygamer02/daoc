...
public class FormationHandler : AbstractCommandHandler, ICommandHandler
{
    public void OnCommand(GameClient client, string[] args)
    {
        ...
        {
            client.Out.SendMessage("Only Bonedancers can use this command!", eChatType.CT_System,
        ...
        if (args.Length == 1)
        {
            ...
            client.Out.SendMessage("'/formation triangle' Place the pets in a triangle formation.",
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            client.Out.SendMessage("'/formation line' Place the pets in a line formation.", eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
            client.Out.SendMessage(
                "'/formation protect' Place the pets in a protect formation that surrounds the commander.",
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return;
        }
        ...
        switch (args[1].ToLower())
        {
            ...
            case "protect":
                ...
                break;
            default:
                client.Out.SendMessage("Unrecognized argument: " + args[1], eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
                break;
        }
    }

    ...
    public void OnCommand(GameClient client, string[] args)
    {
        ...
        if (args.Length >= 2 && args[1].ToLower() == "off")
        {
            ...
            DisplayMessage(client,
                "Your safety flag is now set to OFF!  You can now attack non allied players, as well as be attacked.");
        }
        else if (client.Player.SafetyFlag)
        {
            ...
            DisplayMessage(client,
                "Type /safety off to begin participating in PvP combat in these zones, though once it is off it can NOT be turned back on!");
        }
        else
        {

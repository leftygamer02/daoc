        ...
        switch (args[1].ToLower())
        {
            case "on":
                ...
                client.Out.SendMessage(
                    "Your rp flag is ON. You will gain realm points. Use '/rp off' to stop gaining realm points.",
                    eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                break;
            case "off":
                client.Player.GainRP = false;
                client.Out.SendMessage(
                    "Your rp flag is OFF. You will no longer gain realm points. Use '/rp on' to start gaining realm points again.",
                    eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                break;
        }
    }

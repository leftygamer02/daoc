...
public class SetWhoCommandHandler : AbstractCommandHandler, ICommandHandler
{
    public void OnCommand(GameClient client, string[] args)
    {
        ...
        if ((client.Player.Level == 50 && played < 15 && args[1].ToLower() == "class" &&
             !client.Player.ClassNameFlag && client.Player.Advisor) || (client.Player.Level != 50 &&
                                                                        totalPlayed < 15 && client.Player.Advisor &&
                                                                        args[1].ToLower() == "class" &&
                                                                        !client.Player.ClassNameFlag))
        {

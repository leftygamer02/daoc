    ...
    public void OnCommand(GameClient client, string[] args)
    {
        ...
        if (args[1].ToLower().Equals("on"))
        {
            ...
            client.Out.SendMessage(
                "Your roleplay flag is ON. You will now be flagged as a roleplayer. Use '/roleplay off' to turn the flag off.",
        ...
        else if (args[1].ToLower().Equals("off"))
        {
            ...
            client.Out.SendMessage(
                "Your roleplay flag is OFF. You will be flagged as a roleplayer. Use '/roleplay on' to turn the flag back on.",
                eChatType.CT_Important, eChatLoc.CL_SystemWindow);
        }
    }
}
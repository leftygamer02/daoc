    ...
    public void OnCommand(GameClient client, string[] args)
    {
        ...
        if (args[1].ToLower().Equals("on"))
        {
            ...
            client.Out.SendMessage(
                "You will now see detailed experience gain stats. Use '/xpstats off' to stop seeing these details.",
        ...
        else if (args[1].ToLower().Equals("off"))
        {
            ...
            client.Out.SendMessage(
                "You will no longer see detailed experience gain stats. Use '/xpstats on' to see these details once more.",
                eChatType.CT_Important, eChatLoc.CL_SystemWindow);
        }
        else if (args[1].ToLower().Equals("verbose"))
        {
            ...
            client.Out.SendMessage(
                "You will see verbose experience gain stats. Use '/xpstats off' to stop seeing these details.",
                eChatType.CT_Important, eChatLoc.CL_SystemWindow);
        }
    }
}
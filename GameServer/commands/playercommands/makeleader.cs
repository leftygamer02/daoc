...
public class MakeLeaderCommandHandler : ICommandHandler
{
    public void OnCommand(GameClient client, string[] args)
    {
        ...
        else //Setting by name
        {
            ...
            var targetClient = WorldMgr.GetClientByPlayerName(targetName, false, true);
            ...
            {
                // Invalid target
                client.Out.SendMessage("No players in group with that name.", eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
                return;
            }
            ...
            {
                client.Out.SendMessage("You are the group leader already.", eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
                return;
            }
        }

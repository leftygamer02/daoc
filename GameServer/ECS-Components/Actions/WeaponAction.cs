...
namespace DOL.GS
{
    public class WeaponAction
    {
        ...
        public WeaponAction(GameLiving owner, GameObject target, InventoryItem attackWeapon, InventoryItem leftWeapon, double effectiveness, int interruptDuration, Styles.Style combatStyle, long time)
        {
            this.owner = owner;
            m_target = target;
        ...
        public void Tick(long time)
        {
            if (time > startTime)
            {
                ...
                else if (owner.attackComponent.CanUseLefthandedWeapon && leftWeapon != null && leftWeapon.ItemTemplate.ObjectType != (int)eObjectType.Shield

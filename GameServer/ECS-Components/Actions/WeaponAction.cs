...
namespace DOL.GS
{
    public class WeaponAction
    {
        ...
        public WeaponAction(GameLiving owner, GameObject target, InventoryItem attackWeapon, InventoryItem leftWeapon, double effectiveness, int interruptDuration, Styles.Style combatStyle)
        {
            this.owner = owner;
            m_target = target;

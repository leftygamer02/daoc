...
{
    public ECSGameEffectInitParams(GameLiving target, int duration, double effectiveness,
...
public class ECSGameEffect
{
    ...
    /// </summary>
    public virtual ushort Icon => (ushort) 0;
    ...
    public virtual bool IsConcentrationEffect()
    {
        return false;
    }

    public virtual bool ShouldBeAddedToConcentrationList()
    {
        return false;
    }

    public virtual bool ShouldBeRemovedFromConcentrationList()
    {
        return false;
    }
    ...
    public virtual PlayerXEffect getSavedEffect()
    {
        return null;
    }
}
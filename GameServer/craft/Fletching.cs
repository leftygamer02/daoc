...
{
    protected override string Profession => "CraftersProfession.Fletcher";
    ...
    protected override bool CheckForTools(GamePlayer player, Recipe recipe)
    {
            ...
            recipe.Product.Object_Type != (int) eObjectType.Bolt)
        {
            ...
            player.Out.SendMessage(
                LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Crafting.CheckTool.FindLathe"),

...
public class SalvageCalculator
{
    public SalvageReturn GetSalvage(GamePlayer Player, InventoryItem Item)
    {
        ...
        */
        ...
        var MaterialType = 0;
        var SubTier = 0;
        var MaterialSize = 0; //Small, Medium, Large 1, 2, 3


        var iLevel = Item.Level / 5.1;
        ...
        var Material_Offset = 0; //Offset used to select realm
        var ClothSalvageList = new string[30];
        ...
        var LeatherSalvageList = new string[30];
        ...
        var StripsSalvageList = new string[30];
        ...
        var WoodSalvageList = new string[30];
        ...
        var MetalSalvageList = new string[30];
        ...
        var JewelSalvageList = new string[33];
        ...
        var ClothSquareCost = new int[10];
        ...
        var LeatherSquareCost = new int[10];
        ...
        switch (MaterialType)
        {
            case 0: //Cloth
                ...
                Yield.MSRP = DropPenalty == true
                    ? ClothSquareCost[Yield.Tier + 1] * Yield.Count * 2
                    : ClothSquareCost[Yield.Tier] * Yield.Count * 2;
            ...
            case 1: //Leather
                ...
                Yield.Count = Yield.Count < 1 ? 0 : Yield.Count;
                Yield.MSRP = DropPenalty == true
                    ? LeatherSquareCost[Yield.Tier + 1] * Yield.Count * 2
                    : LeatherSquareCost[Yield.Tier] * Yield.Count * 2;
            ...
            case 2: //Strips or Metal
                ...
                Yield.Count = Yield.Count < 1 ? 0 : Yield.Count;
                Yield.MSRP = DropPenalty == true
                    ? MetalBarCost[Yield.Tier + 1] * Yield.Count * 2
                    : MetalBarCost[Yield.Tier] * Yield.Count * 2;
            ...
            case 3: //Wood
                ...
                Yield.Count = Yield.Count < 1 ? 0 : Yield.Count;
                Yield.MSRP = DropPenalty == true
                    ? WoodPlankCost[Yield.Tier + 1] * Yield.Count * 2
                    : WoodPlankCost[Yield.Tier] * Yield.Count * 2;
            ...
            case 5: //Magicals
                ...
                Yield.Count = 1;
                Yield.MSRP = DropPenalty == true
                    ? JewelCost[Yield.Tier + 1] * Yield.Count * 2
                    : JewelCost[Yield.Tier] * Yield.Count * 2;
            ...
            case 0:
                if (Player.Client.Account.PrivLevel != 1)
                    Player.Out.SendDebugMessage(
                        "Items with a price set to 0 cannot be salvaged or sold to merchants, the MSRP for this item is " +
                        Yield.MSRP + "c Use /setsalvage if return value needs changed");

                Yield.Count = 0;
                break;
            default:
                if (Player.Client.Account.PrivLevel != 1)
                    Player.Out.SendDebugMessage("CALCULATOR: ObjectType " + ObjectType + " ItemType " + ItemType +
                                                " Count " + Yield.Count + " Material " + Yield.Material +
                                                " Item.Price " + Item.Price + " MSRP " + Yield.MSRP);
        ...
        if (Description.Contains("Atlas ROG")) Yield.Count = 2;

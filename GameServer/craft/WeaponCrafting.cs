...
public class WeaponCrafting : AbstractProfession
{
    ...
    protected override string Profession => "CraftersProfession.Weaponcrafter";
    ...
    protected override bool CheckForTools(GamePlayer player, Recipe recipe)
    {
        ...
        player.Out.SendMessage(
            LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Crafting.CheckTool.FindForge"),

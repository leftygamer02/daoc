...
public class Alchemy : AdvancedCraftingSkill
{
    ...
    protected override string Profession => "CraftersProfession.Alchemist";
    ...
    protected override void ApplyMagicalEffect(GamePlayer player, InventoryItem item)
    {
        ...
        else
        {
            ChatUtil.SendErrorMessage(player,
                "Alchemy crafting error: Item was not an ItemUnique, crafting changes not saved to DB!");
            log.ErrorFormat(
                "Alchemy crafting error: Item {0} was not an ItemUnique for player {1}, crafting changes not saved to DB!",

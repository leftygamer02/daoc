...
public class Researcher : GameNPC
{
    ...
    public override bool AddToWorld()
    {
        ...
        switch (Realm)
        {
            ...
            case eRealm.Hibernia:
                template.AddNPCEquipment(eInventorySlot.TorsoArmor, 2231);
                ;
                break;
        }
    ...
    public override IList GetExamineMessages(GamePlayer player)
    {
        ...
        list.Add(string.Format(LanguageMgr.GetTranslation(player.Client.Account.Language,
            "Researcher.GetExamineMessages.YouExamine",
            Name,
            Name.EndsWith("a") || Name.EndsWith("le")

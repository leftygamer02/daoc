...
public class Gjalpinulva : GameDragon
{
    ...
    private ArrayList m_retrieverList = new();
    ...
    private void SpawnDrakulvs(int numAdds, int x, int y)
    {
        ...
        for (var add = 0; add < numAdds; ++add)
        {
            ...
            drakulv = SpawnTimedAdd(isDisciple ? 613 : 612, Util.Random(62, 68), x + Util.Random(250),

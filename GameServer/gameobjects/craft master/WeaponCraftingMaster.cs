...
public class WeaponCraftingMaster : CraftNPC
{
    ...
    public override string GUILD_ORDER =>
        LanguageMgr.GetTranslation(ServerProperties.Properties.SERV_LANGUAGE,
            "WeaponCraftingMaster.GuildOrder");

    public override string ACCEPTED_BY_ORDER_NAME =>
        LanguageMgr.GetTranslation(ServerProperties.Properties.SERV_LANGUAGE,
            "WeaponCraftingMaster.AcceptedByOrderName");

    public override eCraftingSkill TheCraftingSkill => eCraftingSkill.WeaponCrafting;

    public override string InitialEntersentence =>
        LanguageMgr.GetTranslation(ServerProperties.Properties.SERV_LANGUAGE,
            "WeaponCraftingMaster.InitialEntersentence");
}
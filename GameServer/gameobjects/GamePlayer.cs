...
public class GamePlayer : GameLiving
{
    ...
    public ECSGameTimer EnduRegenTimer => m_enduRegenerationTimer;
    ...
    public static readonly string DUEL_PREVIOUS_LASTATTACKEDBYENEMYTICKPVP =
        "DUEL_PREVIOUS_LASTATTACKEDBYENEMYTICKPVP";
    ...
    /// </summary>
    private ArrayList m_mlSteps = new();

    private bool m_gmStealthed = false;

    public bool GMStealthed
    {
        get => m_gmStealthed;
        set => m_gmStealthed = value;
    }

    /// <summary>
    /// Can this living accept any item regardless of tradable or droppable?
    /// </summary>
    public override bool CanTradeAnyItem => Client.Account.PrivLevel > (int) ePrivLevel.Player;
    ...
    public override bool TargetInView
    {
        get
        {
            var targetPlayer = TargetObject as GamePlayer;

            if (targetPlayer != null && targetPlayer.IsMoving
                    ? GetDistanceTo(targetPlayer) < 100
                    : GetDistanceTo(targetPlayer) < 64)
                return true;
    ...
    /// </summary>
    public virtual GameClient Client => m_client;

    /// <summary>
    /// Returns the PacketSender for this player
    /// </summary>
    public virtual IPacketLib Out => Client.Out;

    /// <summary>
    /// The character the player is based on
    /// </summary>
    internal DOLCharacters DBCharacter => m_dbCharacter;
    ...
    public bool IsAnonymous
    {
        get =>
            DBCharacter != null
                ? DBCharacter.IsAnonymous && Properties.ANON_MODIFIER != -1
                : false;
        set
        {
            var old = IsAnonymous;
    ...
    /// </summary>
    public override bool IsAttackable => Client.Account.PrivLevel <= (uint) ePrivLevel.Player && base.IsAttackable;
    ...
    public virtual bool IsPvP =>
        ...
        (CurrentRegionID == 27 && Properties.EVENT_PVP);

    /// <summary>
    /// Can this player use cross realm items
    /// </summary>
    public virtual bool CanUseCrossRealmItems => Properties.ALLOW_CROSS_REALM_ITEMS;

    protected bool m_canUseSlashLevel = false;

    public bool CanUseSlashLevel => m_canUseSlashLevel;
    ...
    {
        get => m_wasmovedbycorpsesummoner;
    ...
    public void SendDoorUpdate(IDoor door, bool forceUpdate = false)
    {
        ...
        else if (forceUpdate || m_doorUpdateList.ContainsKey(door.ObjectID) == false ||
    ...
    {
        get => DBCharacter != null ? DBCharacter.ObjectId : InternalID;
        set
        {
            if (DBCharacter != null) DBCharacter.ObjectId = value;
        }
    }
    ...
    public bool NoHelp
    {
        get => DBCharacter != null ? DBCharacter.NoHelp : false;
        set
        {
            if (DBCharacter != null) DBCharacter.NoHelp = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.ShowGuildLogins : false;
        set
        {
            if (DBCharacter != null) DBCharacter.ShowGuildLogins = value;
        }
    }
    ...
    public bool GainXP
    {
        get => DBCharacter != null ? DBCharacter.GainXP : true;
        set
        {
            if (DBCharacter != null) DBCharacter.GainXP = value;
        }
    }
    ...
    public bool GainRP
    {
        get => DBCharacter != null ? DBCharacter.GainRP : true;
        set
        {
            if (DBCharacter != null) DBCharacter.GainRP = value;
        }
    }
    ...
    public bool RPFlag
    {
        get => DBCharacter != null ? DBCharacter.RPFlag : true;
        set
        {
            if (DBCharacter != null) DBCharacter.RPFlag = value;
        }
    }
    ...
    public bool HCFlag
    {
        get => DBCharacter != null ? DBCharacter.HCFlag : true;
        set
        {
            if (DBCharacter != null) DBCharacter.HCFlag = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.HideSpecializationAPI : false;
        set
        {
            if (DBCharacter != null) DBCharacter.HideSpecializationAPI = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.HCCompleted : true;
        set
        {
            if (DBCharacter != null) DBCharacter.HCCompleted = value;
        }
    }
    ...
    public bool Boosted
    {
        get => DBCharacter != null ? DBCharacter.isBoosted : true;
        set
        {
            if (DBCharacter != null) DBCharacter.isBoosted = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.GuildNote : string.Empty;
        set
        {
            if (DBCharacter != null) DBCharacter.GuildNote = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.Autoloot : true;
        set
        {
            if (DBCharacter != null) DBCharacter.Autoloot = value;
        }
    }
    ...
    public bool Advisor
    {
        get => DBCharacter != null ? DBCharacter.Advisor : false;
        set
        {
            if (DBCharacter != null) DBCharacter.Advisor = value;
        }
    }
    ...
    public string[] SerializedFriendsList
    {
        get
        {
            return DBCharacter != null
                ? DBCharacter.SerializedFriendsList.Split(',').Select(name => name.Trim())
        ...
        {
            if (DBCharacter != null)
                DBCharacter.SerializedFriendsList = string.Join(",",
                    value.Select(name => name.Trim()).Where(name => !string.IsNullOrEmpty(name)));
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.NotDisplayedInHerald : (byte) 0;
        set
        {
            if (DBCharacter != null) DBCharacter.NotDisplayedInHerald = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.LastFreeLevel : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.LastFreeLevel = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.LastFreeLeveled : DateTime.MinValue;
        set
        {
            if (DBCharacter != null) DBCharacter.LastFreeLeveled = value;
        }
    }
    ...
    public string[] SerializedIgnoreList
    {
        ...
        {
            return DBCharacter != null
                ? DBCharacter.SerializedIgnoreList.Split(',').Select(name => name.Trim())
                    .Where(name => !string.IsNullOrEmpty(name)).ToArray()
                : new string[0];
        }
        set
        {
            if (DBCharacter != null)
                DBCharacter.SerializedIgnoreList = string.Join(",",
                    value.Select(name => name.Trim()).Where(name => !string.IsNullOrEmpty(name)));
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.UsedLevelCommand : false;
        set
        {
            if (DBCharacter != null) DBCharacter.UsedLevelCommand = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.BindHouseRegion : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.BindHouseRegion = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.BindHouseXpos : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.BindHouseXpos = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.BindHouseYpos : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.BindHouseYpos = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.BindHouseZpos : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.BindHouseZpos = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.BindHouseHeading : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.BindHouseHeading = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.CustomisationStep : (byte) 0;
        set
        {
            if (DBCharacter != null) DBCharacter.CustomisationStep = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.IgnoreStatistics : false;
        set
        {
            if (DBCharacter != null) DBCharacter.IgnoreStatistics = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.DeathTime : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.DeathTime = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.ShowXFireInfo : false;
        set
        {
            if (DBCharacter != null) DBCharacter.ShowXFireInfo = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.ReceiveROG : true;
        set
        {
            if (DBCharacter != null) DBCharacter.ReceiveROG = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.BindRegion : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.BindRegion = value;
        }
    }
    ...
    public int BindXpos
    {
        get => DBCharacter != null ? DBCharacter.BindXpos : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.BindXpos = value;
        }
    }
    ...
    public int BindYpos
    {
        get => DBCharacter != null ? DBCharacter.BindYpos : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.BindYpos = value;
        }
    }
    ...
    public int BindZpos
    {
        get => DBCharacter != null ? DBCharacter.BindZpos : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.BindZpos = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.BindHeading : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.BindHeading = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.MaxEndurance : 100;
        set
        {
            if (DBCharacter != null) DBCharacter.MaxEndurance = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.DeathCount : (byte) 0;
        set
        {
            if (DBCharacter != null) DBCharacter.DeathCount = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.LastLevelUp : DateTime.MinValue;
        set
        {
            if (DBCharacter != null) DBCharacter.LastLevelUp = value;
        }
    }
    ...
    protected virtual int QuitTimerCallback(AuxECSGameTimer callingTimer)
    {
        ...
        var bInstaQuit = false;

        if (Client.Account.PrivLevel > 1) // GMs can always insta quit
            bInstaQuit = true;
        else if (Properties.DISABLE_QUIT_TIMER &&
                 Client.Player.InCombat == false) // Players can only insta quit if they aren't in combat
            bInstaQuit = true;
        ...
        if (bInstaQuit == false)
        {
            ...
            {
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Quit.CantQuitCrafting"),
                    eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                m_quitTimer = null;
                return 0;
            }

            var lastCombatAction = LastAttackedByEnemyTick;
            if (lastCombatAction < LastAttackTick) lastCombatAction = LastAttackTick;

            var secondsleft = 60 - (GameLoop.GameLoopTime - lastCombatAction + 500) / 1000; // 500 is for rounding
            if (secondsleft > 0)
            {
                if (secondsleft == 15 || secondsleft == 10 || secondsleft == 5)
                    Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Quit.YouWillQuit1",
                            secondsleft), eChatType.CT_Important, eChatLoc.CL_SystemWindow);
    ...
    public virtual int QuitTime
    {
        get
        {
            ...
            var lastCombatAction = LastAttackTick;
            if (lastCombatAction < LastAttackedByEnemyTick) lastCombatAction = LastAttackedByEnemyTick;
        ...
        try
        {
            if (!IsAlive)
            {
                ...
                if (log.IsInfoEnabled)
                    log.InfoFormat("Linkdead player {0}({1}) was auto-released from death!", Name,
                        Client.Account.Name);
            }
    ...
    public void OnLinkdeath()
    {
        ...
        if (Client.Player.CharacterClass.Player.IsShade) Client.Player.CharacterClass.Player.Shade(false);
        ...
        if (log.IsInfoEnabled)
            log.InfoFormat("Linkdead player {0}({1}) will quit in {2}", Name, Client.Account.Name,
                SECONDS_TO_QUIT_ON_LINKDEATH);
        ...
        foreach (GamePlayer player in GetPlayersInRadius(WorldMgr.INFO_DISTANCE))
        {
            ...
            if (GameServer.ServerRules.IsAllowedToUnderstand(this, player))
                player.Out.SendMessage(
                    LanguageMgr.GetTranslation(player.Client.Account.Language, "GamePlayer.OnLinkdeath.Linkdead",
                        Name), eChatType.CT_Important, eChatLoc.CL_SystemWindow);
        }
    ...
    {
        var keep =
            GameServer.KeepManager.GetKeepCloseToSpot(CurrentRegionID, this, WorldMgr.VISIBILITY_DISTANCE);
        if (keep != null && Client.Account.PrivLevel == 1 &&
            (GameServer.KeepManager.IsEnemy(keep, this) || keep.IsRelic))
        {
            if (WorldMgr.RvRLinkDeadPlayers.ContainsKey(m_InternalID)) WorldMgr.RvRLinkDeadPlayers.Remove(m_InternalID);
    ...
    protected virtual void CleanupOnDisconnect()
    {
        ...
        var mybattlegroup =
            (BattleGroup) TempProperties.getProperty<object>(BattleGroup.BATTLEGROUP_PROPERTY, null);
        ...
        var mychatgroup = (ChatGroup) TempProperties.getProperty<object>(ChatGroup.CHATGROUP_PROPERTY, null);
        if (mychatgroup != null)
        ...
        var bg = GameServer.KeepManager.GetBattleground(CurrentRegionID);
        if (bg != null)
        ...
        if (Properties.ACTIVATE_TEMP_PROPERTIES_MANAGER_CHECKUP)
            try
            {
                foreach (var p in TempProperties.getAllProperties())
                {
                    if (p == "")
                        continue;
                    ...
                    registered_temprop = Util.SplitCSV(Properties.TEMPPROPERTIES_TO_REGISTER)
                        .ToList();
                    ...
                    var v = TempProperties.getProperty<object>(p, null);
                    ...
                    if (long.TryParse(v.ToString(), out longresult))
                    {
                        if (Properties.ACTIVATE_TEMP_PROPERTIES_MANAGER_CHECKUP_DEBUG)
                            log.Debug("On Disconnection found and was saved: " + p + " with value: " +
                                      v.ToString() + " for player: " + Name);

                        TempPropertiesManager.TempPropContainerList.Add(
                            new TempPropertiesManager.TempPropContainer(DBCharacter.ObjectId, p, v.ToString()));
                        TempProperties.removeProperty(p);
                    }
                    else
                    {
                        if (Properties.ACTIVATE_TEMP_PROPERTIES_MANAGER_CHECKUP_DEBUG)
                            log.Debug("On Disconnection found but was not saved (not a long value): " + p +
                                      " with value: " + v.ToString() + " for player: " + Name);
                    }
                }
            }
            catch (Exception e)
    ...
    public virtual bool Quit(bool forced)
    {
        if (!forced)
        {
            if (!IsAlive)
            {
                Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Quit.CantQuitDead"),
            ...
            {
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Quit.CantQuitMount"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
                return false;
            }
            ...
            {
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Quit.CantQuitStanding"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
                return false;
            }
            ...
            {
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Quit.CantQuitInInstance"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
                return false;
            }
            ...
            if (Statistics != null)
            {
                var stats = Statistics.GetStatisticsMessage();
                if (stats != "") Out.SendMessage(stats, eChatType.CT_System, eChatLoc.CL_SystemWindow);
            }

            if (!IsSitting) Sit(true);

            var secondsleft = QuitTime;
            ...
            if (secondsleft > 20)
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Quit.RecentlyInCombat"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Quit.YouWillQuit2", secondsleft),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
        }
        else
        {
    ...
    /// </summary>
    protected virtual int CombatTimerInterval => 11000;

    /// <summary>
    /// Combat Timer Lock
    /// </summary>
    private object m_CombatTimerLock = new();
    ...
    /// </summary>
    public virtual int BindAllowInterval => 60000;
    ...
    public virtual void Bind(bool forced)
    {
        if (CurrentRegion.IsInstance)
        {
            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Bind.CantHere"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return;
        }
        ...
        if (!IsAlive)
        {
            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Bind.CantBindDead"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return;
        }

        //60 second rebind timer
        var lastBindTick = TempProperties.getProperty<long>(LAST_BIND_TICK, 0);
        var changeTime = CurrentRegion.Time - lastBindTick;
        if (Client.Account.PrivLevel <= (uint) ePrivLevel.Player && changeTime < BindAllowInterval)
        {
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Bind.MustWait",
                    1 + (BindAllowInterval - changeTime) / 1000), eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return;
        }

        var description = string.Format("in {0}", this.GetBindSpotDescription());
        Out.SendMessage(
            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Bind.LastBindPoint", description),
            eChatType.CT_System, eChatLoc.CL_SystemWindow);

        var bound = false;

        var bindarea = CurrentAreas.OfType<Area.BindArea>()
        ...
        if (!bound && InHouse && CurrentHouse != null)
        {
            ...
            try
            {
                canbindhere = house.HousepointItems.Any(kv =>
                    ((GameObject) kv.Value.GameObject).GetName(0, false)
                    .EndsWith("bindstone", StringComparison.OrdinalIgnoreCase));
            }
            catch
            {
                canbindhere = false;
            ...
            if (canbindhere)
            {
                ...
                {
                    bound = true;
                    var angle = house.Heading * (Math.PI * 2 / 360); // angle*2pi/360;
                    var outsideX = (int) (house.X + (0 * Math.Cos(angle) + 500 * Math.Sin(angle)));
                    var outsideY = (int) (house.Y - (500 * Math.Cos(angle) - 0 * Math.Sin(angle)));
                    var outsideHeading =
                        (ushort) ((house.Heading < 180 ? house.Heading + 180 : house.Heading - 180) / 0.08789);
        ...
        if (bound)
        {
            if (!IsMoving)
            {
                var bindEmote = eEmote.Bind;
                switch (Realm)
                {
                    case eRealm.Albion:
                        bindEmote = eEmote.BindAlb;
                        break;
                    case eRealm.Midgard:
                        bindEmote = eEmote.BindMid;
                        break;
                    case eRealm.Hibernia:
                        bindEmote = eEmote.BindHib;
                        break;
                }
            ...
            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Bind.Bound"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
        }
        else
        {
    ...
    /// </summary>
    public eReleaseType ReleaseType => m_releaseType;
    ...
    public virtual void Release(eReleaseType releaseCommand, bool forced)
    {
        ...
        {
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.NoValidBindpoint"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
        ...
        if (IsAlive)
        {
            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.NotDead"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return;
        }
        ...
        if (!forced)
        {
            ...
            {
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.CantReleaseDuel"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
                return;
            }
            ...
            var diff = m_deathTick - GameLoop.GameLoopTime + RELEASE_MINIMUM_WAIT * 1000;
            if (diff >= 1000)
            {
                if (m_automaticRelease)
                {
                    ...
                    Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language,
                            "GamePlayer.Release.NoLongerReleaseAuto", diff / 1000), eChatType.CT_System,
                ...
                switch (releaseCommand)
                {
                    default:
                    {
                        Out.SendMessage(
                            LanguageMgr.GetTranslation(Client.Account.Language,
                                "GamePlayer.Release.WillReleaseAuto", diff / 1000), eChatType.CT_System,
                            eChatLoc.CL_SystemWindow);
                        return;
                    }
                    case eReleaseType.City:
                    {
                        Out.SendMessage(
                            LanguageMgr.GetTranslation(Client.Account.Language,
                                "GamePlayer.Release.WillReleaseAutoCity", diff / 1000), eChatType.CT_System,
                            eChatLoc.CL_SystemWindow);
                        return;
                    }
                    case eReleaseType.RvR:
                    {
                        Out.SendMessage(
                            LanguageMgr.GetTranslation(Client.Account.Language,
                                "GamePlayer.Release.ReleaseToPortalKeep", diff / 1000), eChatType.CT_System,
                            eChatLoc.CL_SystemWindow);
                        return;
                    }
                    ...
                    {
                        Out.SendMessage(
                            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.ReleaseToHouse",
                                diff / 1000), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                        return;
                    }
                }
            }
        ...
        switch (m_releaseType)
        {
            ...
            case eReleaseType.RvR:
            {
                var player = Client.Player as GamePlayer;
                ...
                foreach (var keep in GameServer.KeepManager.GetKeepsOfRegion(CurrentRegionID))
                ...
                if (relX == 0)
                {
                    ...
                    GameServer.KeepManager.GetBorderKeepLocation((byte) Realm * 2 / 1, out relX, out relY,
                        out relZ, out relHeading);
                }
                    ...
                    case 163:
                    {
                        if (BindRegion != 163)
                        {
                            ...
                            switch (Realm)
                            {
                                case eRealm.Albion:
                                {
                                    GameServer.KeepManager.GetBorderKeepLocation(1, out relX, out relY, out relZ,
                                        out relHeading);
                                    break;
                                }
                                case eRealm.Midgard:
                                {
                                    GameServer.KeepManager.GetBorderKeepLocation(3, out relX, out relY, out relZ,
                                        out relHeading);
                                    break;
                                }
                                case eRealm.Hibernia:
                                {
                                    GameServer.KeepManager.GetBorderKeepLocation(5, out relX, out relY, out relZ,
                                        out relHeading);
                                    break;
                                }
                            }
        ...
        Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.YouRelease"),
            eChatType.CT_YouDied, eChatLoc.CL_SystemWindow);
        Out.SendCloseTimerWindow();
        if (m_releaseTimer != null)
        {
            m_releaseTimer.Stop();
        ...
        if (Realm != eRealm.None)
            if (Level >= Properties.PVE_EXP_LOSS_LEVEL && !HCFlag)
            {
                ...
                var lostExp = Experience;
                var lastDeathExpLoss = TempProperties.getProperty<long>(DEATH_EXP_LOSS_PROPERTY);
                ...
                if (lostExp > 0)
                {
                    ...
                    {
                        var reg = WorldMgr.GetRegion((ushort) character.GravestoneRegion);
                        if (reg != null)
                        {
                            var oldgrave = reg.FindGraveStone(this);
                            if (oldgrave != null) oldgrave.Delete();
                        }

                        character.HasGravestone = false;
                    }

                    var gravestone = new GameGravestone(this, lostExp);
                    gravestone.AddToWorld();
                    character.GravestoneRegion = gravestone.CurrentRegionID;
                    character.HasGravestone = true;
                    Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.GraveErected"),
                        eChatType.CT_YouDied, eChatLoc.CL_SystemWindow);
                    Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.ReturnToPray"),
                        eChatType.CT_YouDied, eChatLoc.CL_SystemWindow);
                }
            }
        ...
        {
            var deathConLoss =
                TempProperties.getProperty<int>(
                    DEATH_CONSTITUTION_LOSS_PROPERTY); // get back constitution lost at death
            if (deathConLoss > 0)
            {
                TotalConstitutionLostAtDeath += deathConLoss;
                Out.SendCharStatsUpdate();
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.LostConstitution"),
                    eChatType.CT_YouDied, eChatLoc.CL_SystemWindow);
            }
        }
        ...
        if ((region = WorldMgr.GetRegion((ushort) BindRegion)) != null &&
            region.GetZone(BindXpos, BindYpos) != null)
        {
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.SurroundingChange"),
                eChatType.CT_YouDied, eChatLoc.CL_SystemWindow);
        }
        else
        {
        ...
        {
            for (var i = 0; i < m_lastUniqueLocations.Length; i++)
            {
                var loc = m_lastUniqueLocations[i];
                loc.X = X;
                loc.Y = Y;
                loc.Z = Z;
                loc.Heading = Heading;
    ...
    protected virtual int ReleaseTimerCallback(ECSGameTimer callingTimer)
    {
        if (IsAlive)
            return 0;
        var diffToRelease = GameLoop.GameLoopTime - m_deathTick;
        ...
        {
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.WillReleaseIn", 10),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            m_releasePhase = 2;
        }
        ...
        {
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.WillReleaseIn", 30),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            m_releasePhase = 1;
        }
    ...
    public virtual void OnRevive(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var applyRezSick = true;

        // Used by spells like Perfect Recovery
        if (TempProperties.getAllProperties().Contains(RESURRECT_REZ_SICK_EFFECTIVENESS) &&
            TempProperties.getProperty<double>(RESURRECT_REZ_SICK_EFFECTIVENESS) == 0)
        {
            applyRezSick = false;
            TempProperties.removeProperty(RESURRECT_REZ_SICK_EFFECTIVENESS);
        }
        else if (player.Level < Properties.RESS_SICKNESS_LEVEL)
        {
            applyRezSick = false;
        }
        ...
        if (applyRezSick)
            ...
            {
                case eDeathType.RvR:
                    var rvrsick = SkillBase.GetSpellLine(GlobalSpellsLines.Realm_Spells);
                    if (rvrsick == null) return;
                    var rvrillness = SkillBase.FindSpell(8181, rvrsick);
                ...
                case eDeathType.PvE:
                    var pvesick = SkillBase.GetSpellLine(GlobalSpellsLines.Realm_Spells);
                    if (pvesick == null) return;
                    var pveillness = SkillBase.FindSpell(2435, pvesick);
    ...
    /// </summary>
    protected virtual ushort PrayDelay => 5000;

    /// <summary>
    /// Gets the praying-state of this living
    /// </summary>
    public virtual bool IsPraying => m_prayAction != null && m_prayAction.IsAlive;
    ...
    {
        var cantPrayMessage = string.Empty;
        var gravestone = TargetObject as GameGravestone;
        ...
        {
            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, cantPrayMessage),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return;
        }
        ...
        m_prayAction = new RegionTimerAction<GameGravestone>(gravestone, stn =>
        {
            if (stn.XPValue > 0)
            {
                Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Pray.GainBack"),
                    eChatType.CT_Important, eChatLoc.CL_SystemWindow);
        ...
        Sit(true);
        Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Pray.Begin"),
            eChatType.CT_System, eChatLoc.CL_SystemWindow);
    ...
    public override ushort Model
    {
        ...
        set
        {
            if (base.Model != value)
            {
                ...
                if (Client.Account.PrivLevel > (int) ePrivLevel.Player && DBCharacter != null &&
    ...
    public override eGender Gender
    {
        get
        {
            if (DBCharacter.Gender == 0) return eGender.Male;
    ...
    public eSize Size
    {
        get
        {
            var size = (ushort) (Model & (ushort) eSize.Tall);
        ...
        set
        {
            if (value != Size)
            {
                var modelID = (ushort) (Model & 0x7FF);
    ...
    public virtual byte FreeLevelState
    {
        get
        {
            var freelevel_days = 7;
            switch (Realm)
            {
                case eRealm.Albion:
                    if (Properties.FREELEVEL_DAYS_ALBION == -1)
                        return 1;
                    else
                        freelevel_days = Properties.FREELEVEL_DAYS_ALBION;
                    break;
                case eRealm.Midgard:
                    if (Properties.FREELEVEL_DAYS_MIDGARD == -1)
                        return 1;
                    else
                        freelevel_days = Properties.FREELEVEL_DAYS_MIDGARD;
                    break;
                case eRealm.Hibernia:
                    if (Properties.FREELEVEL_DAYS_HIBERNIA == -1)
                        return 1;
                    else
                        freelevel_days = Properties.FREELEVEL_DAYS_HIBERNIA;
                    break;
            }
            ...
            var t = new TimeSpan((long) (DateTime.Now.Ticks - LastFreeLeveled.Ticks));
    ...
    {
        get => DBCharacter != null ? DBCharacter.ConLostAtDeath : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.ConLostAtDeath = value;
        }
    }
    ...
    {
        var oldstat = GetBaseStat(stat);
        base.ChangeBaseStat(stat, val);
        var newstat = GetBaseStat(stat);
        var
            character =
                DBCharacter; // to call it only once, if in future there will be some special code to get the character
        ...
        if (character != null && oldstat != newstat)
            switch (stat)
            {
                ...
                case eStat.CON:
                    ...
                    break;
                case eStat.QUI:
                    character.Quickness = newstat;
                    break;
                case eStat.INT:
                    character.Intelligence = newstat;
                    break;
                case eStat.PIE:
                    character.Piety = newstat;
                    break;
                case eStat.EMP:
                    character.Empathy = newstat;
                    break;
                case eStat.CHR:
                    character.Charisma = newstat;
                    break;
            }
    }
    ...
    /// </summary>
    public int Constitution => GetModified(eProperty.Constitution);

    /// <summary>
    /// Gets player's dexterity
    /// </summary>
    public int Dexterity => GetModified(eProperty.Dexterity);

    /// <summary>
    /// Gets player's strength
    /// </summary>
    public int Strength => GetModified(eProperty.Strength);

    /// <summary>
    /// Gets player's quickness
    /// </summary>
    public int Quickness => GetModified(eProperty.Quickness);

    /// <summary>
    /// Gets player's intelligence
    /// </summary>
    public int Intelligence => GetModified(eProperty.Intelligence);

    /// <summary>
    /// Gets player's piety
    /// </summary>
    public int Piety => GetModified(eProperty.Piety);

    /// <summary>
    /// Gets player's empathy
    /// </summary>
    public int Empathy => GetModified(eProperty.Empathy);

    /// <summary>
    /// Gets player's charisma
    /// </summary>
    public int Charisma => GetModified(eProperty.Charisma);
    ...
    /// </summary>
    public virtual IPlayerStatistics Statistics => m_statistics;
    ...
    protected int HealthRegenerationTimerCallback(ECSGameTimer callingTimer)
    {
        ...
        if (IsSitting) return HealthRegenerationPeriod / 2;
    ...
    protected int PowerRegenerationTimerCallback(ECSGameTimer selfRegenerationTimer)
    {
        ...
        var interval = base.PowerRegenerationTimerCallback(selfRegenerationTimer);
        return interval;
    }
    ...
    protected int EnduranceRegenerationTimerCallback(ECSGameTimer selfRegenerationTimer)
    {
        ...
        {
            var regen = GetModified(eProperty.EnduranceRegenerationRate); //default is 1
            var endchant = GetModified(eProperty.FatigueConsumption); //Pull chant/buff value
            ...
            if (sprinting && IsMoving)
                if (charge is null)
                {
                    ...
                    var raLongWind = GetAbility<AtlasOF_LongWindAbility>();
                    if (raLongWind != null)
            ...
            if (regen != 0) ChangeEndurance(this, eEnduranceChangeType.Regenerate, regen);
        }
        ...
        {
            var lastmove = TempProperties.getProperty<long>(PlayerPositionUpdateHandler.LASTMOVEMENTTICK);
    ...
    public virtual int CalculateMaxHealth(int level, int constitution)
    {
        ...
        var hp1 = CharacterClass.BaseHP * level;
        var hp2 = hp1 * constitution / 10000;
        var hp3 = 0;
        if (ChampionLevel >= 1)
            hp3 = Properties.HPS_PER_CHAMPIONLEVEL * ChampionLevel;
    ...
    public virtual int CalculateMaxMana(int level, int manaStat)
    {
        ...
        else if (CharacterClass.ManaStat == eStat.UNDEFINED && Champion &&
                 ChampionLevel > 0) maxpower = 100; // This is a guess, need feedback

        #region Calculation : AtlasOF_EtheralBond

        // --- [START] --- AtlasOF_EtherealBond --------------------------------------------------------
        var raEtherealBond = GetAbility<AtlasOF_EtherealBondAbility>();
    ...
    {
        get => GetModified(eProperty.Fatigue);
        set
        {
            //If it is already set, don't do anything
    ...
    /// </summary>
    public override int Concentration => MaxConcentration - UsedConcentration;
    ...
    public virtual double CalcFallDamage(int fallDamagePercent)
    {
        ...
        var safeFallLevel = GetAbilityLevel(Abilities.SafeFall);
        var mythSafeFall = GetModified(eProperty.MythicalSafeFall);
        ...
        var damage = 0.01 * fallDamagePercent * (MaxHealth - 1);

        // [Freya] Nidel: CloudSong falling damage reduction
        var cloudSongFall = SpellHandler.FindEffectOnTarget(this, "CloudsongFall");
        ...
        Out.SendMessage(
            ...
            eChatType.CT_Damaged, eChatLoc.CL_SystemWindow);
        Out.SendMessage(
            LanguageMgr.GetTranslation(Client.Account.Language, "PlayerPositionUpdateHandler.FallPercent",
                fallDamagePercent), eChatType.CT_Damaged, eChatLoc.CL_SystemWindow);
    ...
    /// </summary>
    public virtual string RaceName => this.RaceToTranslatedName(Race, Gender);
    ...
    {
        get => (short) (DBCharacter != null ? DBCharacter.Race : 0);
        set
        {
            if (DBCharacter != null) DBCharacter.Race = value;
        }
    }
    ...
    {
        var cl = ScriptMgr.FindCharacterClass(id);
        ...
        if (Group != null) Group.UpdateMember(this, false, true);
    ...
    /// </summary>
    protected readonly ReaderWriterList<RealmAbility> m_realmAbilities = new();

    /// <summary>
    /// Holds the player specializable skills and style lines
    /// (KeyName -> Specialization)
    /// </summary>
    protected readonly Dictionary<string, Specialization> m_specialization = new();

    /// <summary>
    /// Holds the Spell lines the player can use
    /// </summary>
    protected readonly List<SpellLine> m_spellLines = new();

    /// <summary>
    /// Object to use when locking the SpellLines list
    /// </summary>
    protected readonly object lockSpellLinesList = new();
    ...
    {
        get => DBCharacter != null ? DBCharacter.RespecAmountAllSkill : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.RespecAmountAllSkill = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.RespecAmountSingleSkill : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.RespecAmountSingleSkill = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.RespecAmountRealmSkill : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.RespecAmountRealmSkill = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.RespecAmountDOL : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.RespecAmountDOL = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.IsLevelRespecUsed : true;
        set
        {
            if (DBCharacter != null) DBCharacter.IsLevelRespecUsed = value;
        }
    }
    ...
    /// </summary>
    public virtual bool CanBuyRespec => RespecBought < m_numRespecsCanBuyOnLevel[Level - 1];
    ...
    {
        get => DBCharacter != null ? DBCharacter.RespecBought : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.RespecBought = value;
        }
    }
    ...
    public virtual long RespecCost
    {
        get
        {
            ...
            {
                var t = 0;
                for (var i = 13; i < Level; i++) t += m_numRespecsCanBuyOnLevel[i - 1];
    ...
    protected virtual void AddSpecialization(Specialization skill, bool notify)
    {
        ...
        lock (((ICollection) m_specialization).SyncRoot)
        {
            ...
            if (!m_specialization.ContainsKey(skill.KeyName))
            {
                ...
                if (notify)
                    Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.AddSpecialisation.YouLearn",
                            skill.Name), eChatType.CT_System, eChatLoc.CL_SystemWindow);
            }
            else
            {
                // Updating
    ...
    public virtual bool RemoveSpecialization(string specKeyName)
    {
        ...
        Out.SendMessage(
            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.RemoveSpecialization.YouLose",
                playerSpec.Name), eChatType.CT_System, eChatLoc.CL_SystemWindow);
    ...
    protected virtual bool RemoveSpellLine(SpellLine line)
    {
        ...
        {
            if (!m_spellLines.Contains(line)) return false;

            m_spellLines.Remove(line);
        }

        Out.SendMessage(
            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.RemoveSpellLine.YouLose", line.Name),
            eChatType.CT_System, eChatLoc.CL_SystemWindow);
    ...
    {
        var line = GetSpellLine(lineKeyName);
        if (line == null)
            return false;
    ...
    public virtual void Reset()
    {
        ...
        if (Level < originalLevel && originalLevel > 5)
            for (var i = 6; i <= originalLevel; i++)
            {
                if (CharacterClass.PrimaryStat != eStat.UNDEFINED) ChangeBaseStat(CharacterClass.PrimaryStat, -1);
    ...
    {
        var specPoints = RespecSingleLine(specLine); // Wipe skills and styles.
        if (!Properties.FREE_RESPEC)
            RespecAmountSingleSkill--; // Decriment players respecs available.
        if (Level == 20 || Level == 40) IsLevelRespecUsed = true;
    ...
    {
        var specPoints = (specLine.Level * (specLine.Level + 1) - 2) / 2;
    ...
    public virtual IList<Specialization> GetSpecList()
    {
        ...
        lock (((ICollection) m_specialization).SyncRoot)
        {
            ...
            list = m_specialization.Select(item => item.Value).OrderBy(it => it.LevelRequired).ThenBy(it => it.ID)
                .ToList();
        }
    ...
    public virtual void AddRealmAbility(RealmAbility ability, bool sendUpdates)
    {
        ...
        {
            var index = list.FindIndex(ab => ab.KeyName == ability.KeyName);
            if (index > -1)
    ...
    public override int GetModifiedSpecLevel(string keyName)
    {
        ...
        lock (((ICollection) m_specialization).SyncRoot)
        {
            if (!m_specialization.TryGetValue(keyName, out spec))
            {
                ...
                {
                    if (CharacterClass.ID == (int) eCharacterClass.Reaver ||
                        CharacterClass.ID == (int) eCharacterClass.Heretic)
        ...
        if (spec != null)
        {
            ...
            var skillProp = SkillBase.SpecToSkill(keyName);
    ...
    public virtual void AddSpellLine(SpellLine line, bool notify)
    {
        ...
        var oldline = GetSpellLine(line.KeyName);
        if (oldline == null)
        {
            lock (lockSpellLinesList)
            {
            ...
            if (notify)
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.AddSpellLine.YouLearn",
                        line.Name), eChatType.CT_System, eChatLoc.CL_SystemWindow);
        }
        else
        {
            // message to player
            if (notify && oldline.Level < line.Level)
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UpdateSpellLine.GainPower",
                        line.Name), eChatType.CT_System, eChatLoc.CL_SystemWindow);
    ...
    public virtual SpellLine GetSpellLine(string keyname)
    {
        lock (lockSpellLinesList)
        {
            foreach (var line in m_spellLines)
    ...
    /// </summary>
    protected ReaderWriterList<Tuple<Skill, Skill>> m_usableSkills = new();

    /// <summary>
    /// List Cast cache, maintained for network order on "spell use" request...
    /// Second item is for "Parent" SpellLine if applicable
    /// </summary>
    protected ReaderWriterList<Tuple<SpellLine, List<Skill>>> m_usableListSpells = new();
    ...
    {
        var results = new List<Tuple<SpellLine, List<Skill>>>();
        ...
        {
            var finalbase = new List<Tuple<SpellLine, List<Skill>>>();
            var finalspec = new List<Tuple<SpellLine, List<Skill>>>();

            // Add Lists spells ordered.
            foreach (var spec in GetSpecList().Where(item => !item.HybridSpellList))
            {
                var spells = spec.GetLinesSpellsForLiving(this);

                foreach (var sl in spec.GetSpellLinesForLiving(this))
                {
                    ...
                    var sps = new List<Skill>();
                    var key = spells.Keys.FirstOrDefault(el => el.KeyName == sl.KeyName);

                    if (key != null && spells.ContainsKey(key))
                        foreach (var sp in spells[key])
                            sps.Add(sp);
    ...
    {
        var results = new List<Tuple<Skill, Skill>>();
        ...
        m_usableSkills.FreezeWhile(innerList =>
        {
            ...
            var copylist = new List<Tuple<Skill, Skill>>(innerList);

            // Add Spec
            foreach (var spec in specs.Where(item => item.Trainable))
            {
                var index = innerList.FindIndex(e =>
                    e.Item1 is Specialization && ((Specialization) e.Item1).KeyName == spec.KeyName);

                if (index < 0)
                {
                    // Specs must be appended to spec list
                    innerList.Insert(innerList.Count(e => e.Item1 is Specialization),
                        new Tuple<Skill, Skill>(spec, spec));
                }
                else
                {
            ...
            foreach (var abv in spec.GetAbilitiesForLiving(this))
            {
                // We need the Instantiated Ability Object for Displaying Correctly According to Player "Activation" Method (if Available)
                var ab = GetAbility(abv.KeyName);

                if (ab == null)
                    ab = abv;

                var index = innerList.FindIndex(k =>
                    k.Item1 is Ability && ((Ability) k.Item1).KeyName == ab.KeyName);
            ...
            // Add Hybrid spell
            foreach (var spec in specs.Where(item => item.HybridSpellList))
            {
                var index = -1;
                foreach (var sl in spec.GetLinesSpellsForLiving(this))
                foreach (var sp in sl.Value.Where(it => it is Spell && !((Spell) it).NeedInstrument)
                             .Cast<Spell>())
                {
                    if (index < innerList.Count)
                        index = innerList.FindIndex(index + 1,
                            e => e.Item2 is SpellLine && ((SpellLine) e.Item2).Spec == sl.Key.Spec &&
                                 e.Item1 is Spell && !((Spell) e.Item1).NeedInstrument);
                         ...
                         .Cast<Spell>())
            {
                if (songIndex < innerList.Count)
                    songIndex = innerList.FindIndex(songIndex + 1,
                        e => e.Item1 is Spell && ((Spell) e.Item1).NeedInstrument);
            ...
            // Add Styles
            foreach (var spec in specs)
            foreach (var st in spec.GetStylesForLiving(this))
            {
                var index = innerList.FindIndex(e => e.Item1 is Style && e.Item1.ID == st.ID);
                if (index < 0)
                {
                    // add
            ...
            foreach (var item in copylist) innerList.Remove(item);
    ...
    public virtual void RefreshSpecDependantSkills(bool sendMessages)
    {
        ...
        lock (((ICollection) m_specialization).SyncRoot)
        {
            foreach (var spec in m_specialization.Values)
            {
                // check for new Abilities
                foreach (var ab in spec.GetAbilitiesForLiving(this))
                    if (!HasAbility(ab.KeyName) || GetAbility(ab.KeyName).Level < ab.Level)
                        AddAbility(ab, sendMessages);

                // check for new Styles
                foreach (var st in spec.GetStylesForLiving(this)) styleComponent.AddStyle(st, sendMessages);

                // check for new SpellLine
                foreach (var sl in spec.GetSpellLinesForLiving(this)) AddSpellLine(sl, sendMessages);
            }
        }
    }
    ...
    {
        Out.SendMessage(
            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnSkillTrained.YouSpend", skill.Level,
                skill.Name), eChatType.CT_System, eChatLoc.CL_SystemWindow);
        Out.SendMessage(
            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnSkillTrained.YouHave",
                SkillSpecialtyPoints), eChatType.CT_System, eChatLoc.CL_SystemWindow);
        Message.SystemToOthers(this,
            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnSkillTrained.TrainsInVarious",
                GetName(0, true)), eChatType.CT_System);
    ...
    {
        get => DBCharacter != null ? DBCharacter.BountyPoints : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.BountyPoints = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.RealmPoints : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.RealmPoints = value;
        }
    }
    ...
    /// </summary>
    public virtual int SkillSpecialtyPoints => VerifySpecPoints();
    ...
    {
        get => DBCharacter != null ? DBCharacter.RealmLevel : 0;
        set
        {
            if (DBCharacter != null)
    ...
    {
        var translationId = string.Empty;
        ...
        if (Realm != eRealm.None && Realm != eRealm.Door)
        {
            ...
            var gender = Gender == eGender.Female ? "Female" : "Male";
        ...
        string translation;
        if (!LanguageMgr.TryGetTranslation(out translation, language,
                string.Format("GamePlayer.RealmTitle.{0}", translationId)))
    ...
    public virtual void GainRealmPoints(long amount, bool modify, bool sendMessage, bool notify)
    {
        ...
        {
            //rp rate modifier
            var modifier = Properties.RP_RATE;
            if (modifier != -1)
            ...
            {
                var zoneBonus = (int) amount * ZoneBonus.GetRPBonus(this) / 100;
                if (zoneBonus > 0)
                {
                    Out.SendMessage(
                        ZoneBonus.GetBonusMessage(this, (int) (zoneBonus * Properties.RP_RATE),
                            ZoneBonus.eZoneBonusType.RP),
                        eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                    GainRealmPoints((long) (zoneBonus * Properties.RP_RATE), false, false, false);
                }
            }

            //[Freya] Nidel: ToA Rp Bonus
            long rpBonus = GetModified(eProperty.RealmPoints);
            if (rpBonus > 0) amount += amount * rpBonus / 100;


            #region Kill Streak

            var killBonus = (int) (0.05 * (KillStreak > 10 ? 10 : KillStreak) * amount);
            Out.SendMessage($"{KillStreak} kill streak! ({killBonus} RPs)", eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
            amount += killBonus;
        ...
        if (sendMessage == true && amount > 0)
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.GainRealmPoints.YouGet",
                    amount.ToString()), eChatType.CT_Important, eChatLoc.CL_SystemWindow);
               ...
               RealmLevel < REALMPOINTS_FOR_LEVEL.Length - 1)
        {
            ...
            Out.SendUpdatePlayer();
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.GainRealmPoints.GainedLevel"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            if (RealmLevel % 10 == 0)
            {
                Out.SendUpdatePlayerSkills();
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.GainRealmPoints.GainedRank"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.GainRealmPoints.ReachedRank",
                        RealmLevel / 10 + 1), eChatType.CT_ScreenCenter, eChatLoc.CL_SystemWindow);
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.GainRealmPoints.NewRealmTitle",
                        RealmRankTitle(Client.Account.Language)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.GainRealmPoints.GainBonus",
                        RealmLevel / 10), eChatType.CT_System, eChatLoc.CL_SystemWindow);
            ...
            {
                var message = LanguageMgr.GetTranslation(Client.Account.Language,
                    "GamePlayer.GainRealmPoints.ReachedRankNews", Name, RealmLevel + 10,
                    LastPositionUpdateZone.Description);
                var newsmessage = LanguageMgr.GetTranslation(Client.Account.Language,
                    "GamePlayer.GainRealmPoints.ReachedRankNews", Name, RealmLevel + 10,
                    LastPositionUpdateZone.Description);
            ...
            {
                var message = LanguageMgr.GetTranslation(Client.Account.Language,
                    "GamePlayer.GainRealmPoints.Earned", Name, LastPositionUpdateZone.Description);
                var newsmessage = LanguageMgr.GetTranslation(Client.Account.Language,
                    "GamePlayer.GainRealmPoints.Earned", Name, LastPositionUpdateZone.Description);
                NewsMgr.CreateNews(newsmessage, Realm, eNewsType.RvRLocal, true);
            }
        ...
        if (GetAchievementProgress(AchievementUtils.AchievementNames.Realm_Rank) <=
            (int) Math.Floor((double) (RealmLevel + 10.0) / 10.0))
            SetAchievementTo(AchievementUtils.AchievementNames.Realm_Rank,
                (int) Math.Floor((double) (RealmLevel + 10.0) / 10.0));
    ...
    public virtual void GainBountyPoints(long amount, bool modify, bool sendMessage, bool notify)
    {
        ...
        {
            //bp rate modifier
            var modifier = Properties.BP_RATE;
            if (modifier != -1)
                amount = (long) (amount * modifier);
            ...
            if (Properties.ENABLE_ZONE_BONUSES)
            {
                var zoneBonus = (int) amount * ZoneBonus.GetBPBonus(this) / 100;
                if (zoneBonus > 0)
                {
                    Out.SendMessage(
                        ZoneBonus.GetBonusMessage(this, (int) (zoneBonus * Properties.BP_RATE),
                            ZoneBonus.eZoneBonusType.BP),
                        eChatType.CT_Important, eChatLoc.CL_SystemWindow);
            ...
            if (bpBonus > 0) amount += amount * bpBonus / 100;
        }
        ...
        if (sendMessage == true)
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.GainBountyPoints.YouGet",
                    amount.ToString()), eChatType.CT_Important, eChatLoc.CL_SystemWindow);
    ...
    protected virtual long CalculateRPsFromRealmLevel(int realmLevel)
    {
        ...
        return (long) (25.0 / 3.0 * (realmLevel * realmLevel * realmLevel) -
            25.0 / 2.0 * (realmLevel * realmLevel) + 25.0 / 6.0 * realmLevel);
    }
    ...
    /// </summary>
    public override long ExperienceValue => base.ExperienceValue * 4;
    ...
    /// </summary>
    public override long MoneyValue => 5 * prcRestore[Level < prcRestore.Length ? Level : prcRestore.Length - 1];
    ...
    {
        get => DBCharacter != null ? DBCharacter.Experience : 0;
        set
        {
            if (DBCharacter != null)
    ...
    /// </summary>
    public virtual long ExperienceForNextLevel => GetExperienceNeededForLevel(Level + 1);

    /// <summary>
    /// Returns the xp that were needed for the current level
    /// </summary>
    public virtual long ExperienceForCurrentLevel => GetExperienceNeededForLevel(Level);
    ...
    public void ForceGainExperience(long expTotal)
    {
        ...
        Out.SendMessage(
            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.GainExperience.YouGet",
                expTotal.ToString("N0", System.Globalization.NumberFormatInfo.InvariantInfo)),
            eChatType.CT_Important, eChatLoc.CL_SystemWindow);
        ...
        if (expTotal >= 0)
        {
            ...
            if (Level >= 5 && !CharacterClass.HasAdvancedFromBaseClass())
            {
                if (expTotal > 0)
                {
                    Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language,
                            "GamePlayer.GainExperience.CannotRaise"), eChatType.CT_Important,
                        eChatLoc.CL_SystemWindow);
                    Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language,
            ...
            else if (Level >= 40 && Level < MaxLevel && !IsLevelSecondStage &&
    ...
    /// <param name="allowMultiply"></param>
    /// <param name="notify"></param>
    public override void GainExperience(eXPSource xpSource, long expTotal, long expCampBonus, long expGroupBonus,
        long expOutpostBonus, long atlasBonus, bool sendMessage, bool allowMultiply, bool notify)
    {
        if (!GainXP && expTotal > 0)
            return;

        if (HCFlag && Group != null)
        {
            ...
            if (expTotal == 0)
                Out.SendMessage("This kill was not hardcore enough to gain experience.", eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
        }

        if (TempProperties.getProperty<object>(BattleGroup.BATTLEGROUP_PROPERTY, null) != null)
        {
            Out.SendMessage($"You may not gain experience while in a battlegroup.", eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
            return;
        }

        var numCurrentLoyalDays = TempProperties.getProperty<int>(CURRENT_LOYALTY_KEY);
        //check for cached loyalty days, and grab value if needed
        if (numCurrentLoyalDays == null || numCurrentLoyalDays == 0)
        {
            var realmLoyalty = DOLDB<AccountXRealmLoyalty>.SelectObject(DB.Column("AccountID")
                .IsEqualTo(Client.Account.ObjectId).And(DB.Column("Realm").IsEqualTo(Realm)));
            if (realmLoyalty == null)
            {
                var newLoyalty = new AccountXRealmLoyalty();
                newLoyalty.AccountId = Client.Account.ObjectId;
                newLoyalty.Realm = (int) Realm;
            ...
            TempProperties.setProperty(CURRENT_LOYALTY_KEY, numCurrentLoyalDays);
        }

        //check for realm loyalty
        var loyaltyCheck = TempProperties.getProperty<DateTime>(REALM_LOYALTY_KEY);
        ...
        if (loyaltyCheck < DateTime.Now.AddDays(-1))
        {
            var rloyal = new List<AccountXRealmLoyalty>(
                DOLDB<AccountXRealmLoyalty>.SelectObjects(DB.Column("AccountID")
                    .IsEqualTo(Client.Account.ObjectId)));
            var realmFound = false;
            foreach (var rl in rloyal)
            {
                if (rl.Realm == (int) Realm)
                {
            ...
            TempProperties.setProperty(REALM_LOYALTY_KEY, DateTime.Now);
            TempProperties.setProperty(CURRENT_LOYALTY_KEY, numCurrentLoyalDays);
        }

        if (xpSource == eXPSource.Player && !CurrentZone.IsBG) LoyaltyManager.HandlePVPKill(this);
        ...
        if (allowMultiply)
        {
            ...
            if (Properties.ENABLE_ZONE_BONUSES)
            {
                var zoneBonus = expTotal * ZoneBonus.GetXPBonus(this) / 100;
                if (zoneBonus > 0)
                {
                    var tmpBonus = (long) (zoneBonus * Properties.XP_RATE);
            ...
            if (xpBonus != 0) expTotal += expTotal * xpBonus / 100;

            var hardXPCap = (long) (GameServer.ServerRules.GetExperienceForLiving(Level) *
                Properties.XP_HARDCAP_PERCENT / 100);
        ...
        var loyaltyPercent = (double) RealmLoyaltyBonus / baseXp * 100.0;
        if (RealmLoyaltyBonus > 0 && XPLogState == eXPLogState.Verbose)
            Out.SendMessage(
                $"Loyalty: {RealmLoyaltyBonus.ToString("N0", System.Globalization.NumberFormatInfo.InvariantInfo)} | {loyaltyPercent.ToString("0.##")}% bonus",
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
        ...
        long guildBonus = 0;
        if (Guild != null && !Guild.IsStartingGuild &&
            Guild.BonusType == Guild.eBonusType.Experience && xpSource == eXPSource.NPC)
            guildBonus = (long) Math.Ceiling((double) expTotal * Properties.GUILD_BUFF_XP / 100);
        else if (Guild != null && Guild.IsStartingGuild && xpSource == eXPSource.NPC)
            guildBonus = (long) Math.Ceiling((double) expTotal * Properties.GUILD_BUFF_XP / 200);
        ...
        var relicBonus = (int) (baseXp * (0.05 * RelicMgr.GetRelicCount(Realm)));
        ...
        if (sendMessage && expTotal > 0)
        {
            ...
            var expSoloBonusStr = "";
            var expRealmLoyaltyStr = "";
            var expGuildBonusStr = "";
            var expRelicBonusStr = "";
            ...
            if (expGroupBonus > 0)
                expGroupBonusStr = LanguageMgr.GetTranslation(Client.Account.Language,
                    "GamePlayer.GainExperience.GroupBonus", expGroupBonus.ToString("N0", format)) + " ";

            if (expOutpostBonus > 0)
                expOutpostBonusStr = LanguageMgr.GetTranslation(Client.Account.Language,
            ...
            if (atlasBonus > 0) expSoloBonusStr = "(" + atlasBonus.ToString("N0", format) + " Atlas bonus)";

            if (guildBonus > 0) expGuildBonusStr = "(" + guildBonus.ToString("N0", format) + " Guild bonus)";

            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.GainExperience.YouGet",
                    totalExpStr) + expCampBonusStr + expGroupBonusStr + expOutpostBonusStr + expSoloBonusStr +
                expRealmLoyaltyStr + expGuildBonusStr + expRelicBonusStr, eChatType.CT_Important,
                eChatLoc.CL_SystemWindow);
        }
    ...
    {
        get => DBCharacter != null ? (byte) DBCharacter.Level : base.Level;
        set
        {
            int oldLevel = Level;
            base.Level = value;
    ...
    /// </summary>
    public override byte BaseLevel => DBCharacter != null ? (byte) DBCharacter.Level : base.BaseLevel;
    ...
    {
        get => DBCharacter != null ? DBCharacter.IsLevelSecondStage : false;
        set
        {
            if (DBCharacter != null) DBCharacter.IsLevelSecondStage = value;
        }
    }
    ...
    public virtual void OnLevelUp(int previouslevel)
    {
        ...
        Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnLevelUp.YouRaise", Level),
            eChatType.CT_Important, eChatLoc.CL_SystemWindow);
        Out.SendMessage(
            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnLevelUp.YouAchieved", Level),
            eChatType.CT_ScreenCenter, eChatLoc.CL_SystemWindow);
        Out.SendPlayerFreeLevelUpdate();
        if (FreeLevelState == 2)
            Out.SendDialogBox(eDialogCode.SimpleWarning, 0, 0, 0, 0, eDialogType.Ok, true,
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnLevelUp.FreeLevelEligible"));

        if (Level == 20)
            // Creates a TimeXLevel to track the levelling time to 20
            if (Client.Account.PrivLevel == 1)
            {
                var playedTime = TimeSpan.FromSeconds(PlayedTime);
                var MaxLevelTime = new DBTimeXLevel();
                MaxLevelTime.Character_ID = ObjectId;
                MaxLevelTime.Character_Name = Name;
                MaxLevelTime.Character_Realm = realm;
                MaxLevelTime.Character_Class = ((eCharacterClass) CharacterClass.ID).ToString();
                MaxLevelTime.Character_Level = Level;
                MaxLevelTime.Solo = isSolo;
                MaxLevelTime.Hardcore = isHardcore;
                MaxLevelTime.TimeToLevel =
                    playedTime.Days + "d " + playedTime.Hours + "h " + playedTime.Minutes + "m ";
        ...
        if (Level == 39)
        {
            ...
            if (today <= endSoftLaunch) Client.Player.Achieve("SoftLaunch39-Credit");
        }
        ...
        if (Level == 50)
        {
            ...
            if (HCFlag)
            {
                HCFlag = false;
                HCCompleted = true;
                Out.SendMessage("You have reached Level 50! Your Hardcore flag has been disabled.",
                    eChatType.CT_Important, eChatLoc.CL_SystemWindow);
        ...
        if (Level == MaxLevel)
            if (CanGenerateNews)
            {
                var message = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnLevelUp.Reached",
                    Name, Level, LastPositionUpdateZone.Description);
                var newsmessage = LanguageMgr.GetTranslation(Client.Account.Language,
                    "GamePlayer.OnLevelUp.Reached", Name, Level, LastPositionUpdateZone.Description);
        ...
        if (statsChanged)
            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnLevelUp.StatRaise"),
                eChatType.CT_Important, eChatLoc.CL_SystemWindow);
        ...
        var currenttitle = CharacterClass.GetTitle(this, Level);

        // check for difference
        if (CharacterClass.GetTitle(this, previouslevel) != currenttitle)
            // Inform player of new title.
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnLevelUp.AttainedRank",
                    currenttitle), eChatType.CT_Important, eChatLoc.CL_SystemWindow);
        ...
        if (specpoints > 0)
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnLevelUp.YouGetSpec", specpoints),
                eChatType.CT_Important, eChatLoc.CL_SystemWindow);

        // old hp
        var oldhp = CalculateMaxHealth(previouslevel, GetBaseStat(eStat.CON));
        ...
        // hp upgrade
        var newhp = CalculateMaxHealth(Level, GetBaseStat(eStat.CON));
        if (oldhp > 0 && oldhp < newhp)
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnLevelUp.HitsRaise",
                    newhp - oldhp), eChatType.CT_Important, eChatLoc.CL_SystemWindow);

        // power upgrade
        if (CharacterClass.ManaStat != eStat.UNDEFINED)
        {
            var newpow = CalculateMaxMana(Level, GetBaseStat(CharacterClass.ManaStat));
            if (newpow > 0 && oldpow < newpow)
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnLevelUp.PowerRaise",
                        newpow - oldpow), eChatType.CT_Important, eChatLoc.CL_SystemWindow);
        }
        ...
        if (Group != null) Group.UpdateGroupWindow();
    ...
    public virtual void OnLevelSecondStage()
    {
        ...
        Out.SendMessage(
            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnLevelUp.SecondStage", Level),
            eChatType.CT_Important, eChatLoc.CL_SystemWindow);

        // spec points
        var specpoints = CharacterClass.SpecPointsMultiplier * Level / 20;
        if (specpoints > 0)
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnLevelUp.YouGetSpec", specpoints),
                eChatType.CT_Important, eChatLoc.CL_SystemWindow);
    ...
    {
        var max_autotrain = Level / 4;
        if (max_autotrain == 0) max_autotrain = 1;

        foreach (var autotrainKey in CharacterClass.GetAutotrainableSkills())
            if (autotrainKey == spec.KeyName)
                switch (Mode)
                {
                    case 0: // return sum of all AT points in the spec
                    {
                        var pts_to_refund = Math.Min(max_autotrain, spec.Level);
                    ...
                    case 1: // return max AT level + message
                    {
                        if (Level % 4 == 0)
                            if (spec.Level >= max_autotrain)
                                ...
                                Out.SendDialogBox(eDialogCode.SimpleWarning, 0, 0, 0, 0, eDialogType.Ok, true,
                                    LanguageMgr.GetTranslation(Client.Account.Language,
                                        "PlayerClass.OnLevelUp.Autotrain", spec.Name, max_autotrain));
                        return 0;
                    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.SafetyFlag : false;
        set
        {
            if (DBCharacter != null) DBCharacter.SafetyFlag = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.IsCloakHoodUp : base.IsCloakHoodUp;
        set
        {
            ...
            if (value)
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.IsCloakHoodUp.NowWear"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
            else
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.IsCloakHoodUp.NoLongerWear"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.IsCloakInvisible : base.IsCloakInvisible;
        set
        {
            ...
            if (value)
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.IsCloakInvisible.Invisible"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
            else
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.IsCloakInvisible.Visible"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.IsHelmInvisible : base.IsHelmInvisible;
        set
        {
            ...
            if (value)
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.IsHelmInvisible.Invisible"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
            else
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.IsHelmInvisible.Visible"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.SpellQueue : false;
        set
        {
            if (DBCharacter != null) DBCharacter.SpellQueue = value;
        }
    }
    ...
    public override void SwitchWeapon(eActiveWeaponSlot slot)
    {
        ...
        if (attackComponent != null && attackComponent.AttackState && ActiveWeapon != null)
        {
            if (ActiveWeapon.Item_Type == (int) eInventorySlot.DistanceWeapon
                ...
                TempProperties.getProperty<long>(RangeAttackComponent.RANGED_ATTACK_START) > 100
        ...
        {
            var volley =
                (AtlasOF_VolleyECSEffect) EffectListService.GetEffectOnTarget(this, eEffect.Volley);
        ...
        {
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.SwitchWeapon.SpellCancelled"),
                eChatType.CT_SpellResisted, eChatLoc.CL_SystemWindow);
            StopCurrentSpellcast();
        }

        var song = EffectListService.GetPulseEffectOnTarget(this);
        ...
        var oldActiveSlots = new InventoryItem[4];
        var newActiveSlots = new InventoryItem[4];
        var rightHandSlot = Inventory.GetItem(eInventorySlot.RightHandWeapon);
        var leftHandSlot = Inventory.GetItem(eInventorySlot.LeftHandWeapon);
        var twoHandSlot = Inventory.GetItem(eInventorySlot.TwoHandWeapon);
        var distanceSlot = Inventory.GetItem(eInventorySlot.DistanceWeapon);
        ...
        {
            case 0:
                oldActiveSlots[0] = rightHandSlot;
                break;
            case 2:
                oldActiveSlots[2] = twoHandSlot;
                break;
            case 3:
                oldActiveSlots[3] = distanceSlot;
                break;
        }
        ...
        {
            case 0:
                newActiveSlots[0] = rightHandSlot;
                break;
            case 2:
                newActiveSlots[2] = twoHandSlot;
                break;
            case 3:
                newActiveSlots[3] = distanceSlot;
                break;
        }
        ...
        for (var i = 0; i < 4; i++)
            if (oldActiveSlots[i] != null && newActiveSlots[i] == null)
                Notify(PlayerInventoryEvent.ItemUnequipped, Inventory,
                    new ItemUnequippedArgs(oldActiveSlots[i], oldActiveSlots[i].SlotPosition));

        // equip new active items
        for (var i = 0; i < 4; i++)
            if (newActiveSlots[i] != null && oldActiveSlots[i] == null)
                Notify(PlayerInventoryEvent.ItemEquipped, Inventory,
                    new ItemEquippedArgs(newActiveSlots[i], newActiveSlots[i].SlotPosition));
    ...
    public virtual void SwitchQuiver(eActiveQuiverSlot slot, bool forced)
    {
        ...
        {
            var updatedSlot = eInventorySlot.Invalid;
            ...
            if (Inventory.GetItem(updatedSlot) != null && (rangeAttackComponent.ActiveQuiverSlot != slot || forced))
            {
                ...
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.SwitchQuiver.ShootWith",
                        Inventory.GetItem(updatedSlot).GetName(0, false)), eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
            }
            else
            {
                ...
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.SwitchQuiver.NoMoreAmmo"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
            }
        ...
        else
        {
            ...
            else
            {
                rangeAttackComponent.ActiveQuiverSlot = eActiveQuiverSlot.None;
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.SwitchQuiver.NotUseQuiver"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
            }
    ...
    public override void OnAttackedByEnemy(AttackData ad)
    {
        ...
        switch (ad.AttackResult)
        {
            ...
            case eAttackResult.Parried:
                if (ad.Attacker is GameNPC)
                    ...
                    Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Parry",
                            ad.Attacker.GetName(0, true)) + " (" + /*GetParryChance()*/
                        ad.ParryChance.ToString("0.0") + "%)", eChatType.CT_Missed, eChatLoc.CL_SystemWindow);
                break;
            case eAttackResult.Evaded:
                if (ad.Attacker is GameNPC)
                    Out.SendMessage(
                    ...
                    Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Evade",
                            ad.Attacker.GetName(0, true)) + " (" + /*GetEvadeChance()*/
                        ad.EvadeChance.ToString("0.0") + "%)", eChatType.CT_Missed, eChatLoc.CL_SystemWindow);
                break;
            case eAttackResult.Fumbled:
                if (ad.Attacker is GameNPC)
                    Out.SendMessage(
            ...
            case eAttackResult.HitUnstyled:
            {
                ...
                if (IsStealthed && !effectListComponent.ContainsEffectForEffectType(eEffect.Vanish))
                    if (!(ad.AttackType == AttackData.eAttackType.Spell &&
                          ad.SpellHandler.Spell.SpellType == (byte) eSpellType.DamageOverTime))
                        Stealth(false);
                ...
                switch (ad.ArmorHitLocation)
                {
                    ...
                    case eArmorSlot.TORSO:
                        hitLocName = LanguageMgr.GetTranslation(Client.Account.Language,
                            "GamePlayer.Attack.Location.Torso");
                        break;
                    case eArmorSlot.ARMS:
                        hitLocName = LanguageMgr.GetTranslation(Client.Account.Language,
                            "GamePlayer.Attack.Location.Arm");
                        break;
                    case eArmorSlot.HEAD:
                        hitLocName = LanguageMgr.GetTranslation(Client.Account.Language,
                            "GamePlayer.Attack.Location.Head");
                        break;
                    case eArmorSlot.LEGS:
                        hitLocName = LanguageMgr.GetTranslation(Client.Account.Language,
                            "GamePlayer.Attack.Location.Leg");
                        break;
                    case eArmorSlot.HAND:
                        hitLocName = LanguageMgr.GetTranslation(Client.Account.Language,
                            "GamePlayer.Attack.Location.Hand");
                        break;
                    case eArmorSlot.FEET:
                        hitLocName = LanguageMgr.GetTranslation(Client.Account.Language,
                            "GamePlayer.Attack.Location.Foot");
                        break;
                }
                ...
                {
                    var item = Inventory.GetItem((eInventorySlot) ad.ArmorHitLocation);

                    if (item != null)
                    {
                        TryReactiveEffect(item, ad.Attacker);

                        if (item is GameInventoryItem) (item as GameInventoryItem).OnStruckByEnemy(this, ad.Attacker);
                    }
                }
            ...
            case eAttackResult.Blocked:
            {
                var reactiveItem = Inventory.GetItem(eInventorySlot.LeftHandWeapon);
        ...
        {
            var removeEffect = SpellHandler.FindEffectOnTarget(this, "VampiirSpeedEnhancement");
            if (removeEffect != null)
                removeEffect.Cancel(false);
        }
        ...
        {
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.InterruptedCrafting"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            //CraftTimer.Stop();
            craftComponent.StopCraft();
            CraftTimer = null;
    ...
    protected virtual void TryReactiveEffect(InventoryItem reactiveItem, GameLiving target)
    {
        ...
        {
            var requiredLevel = reactiveItem.Template.LevelRequirement > 0
                ? reactiveItem.Template.LevelRequirement
                : Math.Min(MaxLevel, reactiveItem.Level);

            if (requiredLevel <= Level)
            {
                var reactiveEffectLine = SkillBase.GetSpellLine(GlobalSpellsLines.Item_Effects);

                if (reactiveEffectLine != null)
                {
                    if (reactiveItem.ProcSpellID != 0)
                    {
                        var spell = SkillBase.FindSpell(reactiveItem.ProcSpellID, reactiveEffectLine);

                        if (spell != null)
                        {
                            var chance = reactiveItem.ProcChance > 0 ? reactiveItem.ProcChance : 10;

                            if (Util.Chance(chance))
                            {
                                var spellHandler =
                                    ScriptMgr.CreateSpellHandler(this, spell, reactiveEffectLine);
                                if (spellHandler != null) spellHandler.StartSpell(target, reactiveItem);
                            }
                        }
                    }
                    ...
                    {
                        var spell = SkillBase.FindSpell(reactiveItem.ProcSpellID1, reactiveEffectLine);
    ...
    public override void TakeDamage(GameObject source, eDamageType damageType, int damageAmount, int criticalAmount)
    {
        ...
        if (source is GamePlayer ||
            (source is GameNPC && (source as GameNPC).Brain is IControlledBrain &&
             ((source as GameNPC).Brain as IControlledBrain).GetPlayerOwner() != null) || source is GameSiegeWeapon)
        ...
        get
        {
            ...
            foreach (var item in Inventory.VisibleItems)
            {
                ...
                if (factor > 0)
                {
                    ...
                    if (af > itemAFCap)
                        af = itemAFCap;
                    var piece_eaf = af * item.Quality / 100.0 * item.ConditionPercent / 100.0 *
                                    (1 + abs / 100.0);
            ...
            switch (bestLevel)
            {
                ...
                case ArmorLevel.Leather:
                    abs = 10;
                    break;
                case ArmorLevel.Studded:
                    abs = 19;
                    break;
                case ArmorLevel.Chain:
                    abs = 27;
                    break;
                case ArmorLevel.Plate:
                    abs = 34;
                    break;
            }

            eaf += BaseBuffBonusCategory[(int) eProperty.ArmorFactor]; // base buff before cap
            var eafcap = (int) (10 * Level * (1 + abs * 0.01));
            if (eaf > eafcap)
                eaf = eafcap;
    ...
    public virtual eArmorSlot CalculateArmorHitLocation(AttackData ad)
    {
        ...
        var chancehit = Util.Random(1, 100);
        if (chancehit <= 40)
    ...
    public override double GetWeaponSkill(InventoryItem weapon)
    {
        ...
        var preBuff = Level * classbase / 200 * (1 + .01 * GetWeaponStat(weapon) / 2) * Effectiveness;
    ...
    public override double GetArmorAF(eArmorSlot slot)
    {
        ...
        if (RealmLevel > 39)
            itemAFcap++;
        if (item.Object_Type != (int) eObjectType.Cloth) itemAFcap <<= 1;
    ...
    public override double GetArmorAbsorb(eArmorSlot slot)
    {
        ...
        var eaf = (item.SPD_ABS + GetModified(eProperty.ArmorAbsorption)) * 0.01;
        return eaf;
    }
    ...
    public virtual int DisplayedWeaponSkill
    {
        get
        {
            var itemBonus = WeaponSpecLevel(ActiveWeapon) - WeaponBaseSpecLevel(ActiveWeapon) - RealmLevel / 10;
            var m = 0.56 + itemBonus / 70.0;
            var weaponSpec = WeaponSpecLevel(ActiveWeapon) + itemBonus * m;
            var oldWStoNewWSScalar =
                (3 + .02 * GetWeaponStat(ActiveWeapon)) / (1 + .005 * GetWeaponStat(ActiveWeapon));
    ...
    public override double WeaponDamage(InventoryItem weapon)
    {
        if (weapon != null)
        {
            ...
            var wdamage = 0.001 * DPS * weapon.Quality * weapon.Condition / weapon.MaxCondition;
            return wdamage;
        }
        else
        {
    ...
    public static void BroadcastDeathOnDiscord(string message, string name, string lastname, string playerClass,
        int level, long playedTime)
    {
        var color = 0;
        var timeLived = TimeSpan.FromSeconds(playedTime);
        var timeLivedString = timeLived.Days + "d " + timeLived.Hours + "h " + timeLived.Minutes + "m ";
        ...
        var discordMessage = new DiscordMessage(
            "",
            "Atlas Obituary",
            "https://cdn.discordapp.com/attachments/919610633656369214/928726197645496382/skull2.png",
            false,
            new[]
            {
    ...
    public override void ProcessDeath(GameObject killer)
    {
        ...
        var realmDeath = killer != null && killer.Realm != eRealm.None && killer.Realm != Realm;
        ...
        var messageDistance = WorldMgr.DEATH_MESSAGE_DISTANCE;
        m_releaseType = eReleaseType.Normal;
        ...
        if (killer == null)
        {
            if (realmDeath)
            {
                playerMessage = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Die.KilledLocation",
                    GetName(0, true), location);
                publicMessage = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Die.KilledLocation",
                    GetName(0, true), location);
            }
            else
            {
                playerMessage = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Die.Killed",
                    GetName(0, true));
                publicMessage = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Die.Killed",
                    GetName(0, true));
            }
        }
        else
        {
            if (DuelTarget == killer)
            {
                ...
                playerMessage = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Die.DuelDefeated",
                    GetName(0, true), killer.GetName(1, false));
                publicMessage = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Die.DuelDefeated",
                    GetName(0, true), killer.GetName(1, false));
            }
            else
            {
                ...
                if (realmDeath)
                {
                    playerMessage = LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.Die.KilledByLocation", GetName(0, true), killer.GetName(1, false), location);
                    publicMessage = LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.Die.KilledByLocation", GetName(0, true), killer.GetName(1, false), location);
                }
                else
                {
                    playerMessage = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Die.KilledBy",
                        GetName(0, true), killer.GetName(1, false));
                    publicMessage = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Die.KilledBy",
                        GetName(0, true), killer.GetName(1, false));
                }

                if (ConquestService.ConquestManager.IsPlayerInConquestArea(this) && killer.Realm != Realm &&
                    killer is GamePlayer && killer != DuelTarget)
        ...
        {
            ((GamePlayer) killer).Out.SendMessage(
                LanguageMgr.GetTranslation(((GamePlayer) killer).Client.Account.Language,
                    "GamePlayer.Die.YouKilled", GetName(0, false)), eChatType.CT_PlayerDied,
                eChatLoc.CL_SystemWindow);
        ...
        if (messageDistance == 0)
            foreach (var client in WorldMgr.GetClientsOfRegion(CurrentRegionID))
        ...
        foreach (GamePlayer player in players)
            ...
            if (
                player != killer && (
                    (killer != null && killer is GamePlayer &&
                     GameServer.ServerRules.IsSameRealm((GamePlayer) killer, player, true))
                    || GameServer.ServerRules.IsSameRealm(this, player, true)
                    || (Properties.DEATH_MESSAGES_ALL_REALMS &&
                        (killer is GamePlayer ||
                         killer is GameKeepGuard))) //Only show Player/Guard kills if shown to all realms
            )
                if (player == this)
        ...
        lock (m_LockObject)
        {
            ...
            Out.SendTimerWindow(LanguageMgr.GetTranslation(Client.Account.Language, "System.ReleaseTimer"),
                m_automaticRelease ? RELEASE_MINIMUM_WAIT : RELEASE_TIME);
            ...
            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Die.ReleaseToReturn"),
                eChatType.CT_YouDied, eChatLoc.CL_SystemWindow);
            ...
            if (realmDeath ||
                killer?.Realm ==
                Realm) //Live PvP servers have 3 con loss on pvp death, can be turned off in server properties -Unty
            {
                var conpenalty = 0;
                switch (GameServer.Instance.Configuration.ServerType)
                {
                    case eGameServerType.GST_Normal:
                        Out.SendMessage(
                            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Die.DeadRVR"),
                            eChatType.CT_YouDied, eChatLoc.CL_SystemWindow);
                        xpLossPercent = 0;
            ...
            else
            {
                ...
                {
                    Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Die.LoseExperience"),
                        eChatType.CT_YouDied, eChatLoc.CL_SystemWindow);
                    ...
                    switch (DeathCount)
                    {
                        case 0:
                            Out.SendMessage(
                                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Die.DeathN1"),
                                eChatType.CT_YouDied, eChatLoc.CL_SystemWindow);
                            xpLossPercent /= 3;
                            break;
                        case 1:
                            Out.SendMessage(
                                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Die.DeathN2"),
                                eChatType.CT_YouDied, eChatLoc.CL_SystemWindow);
                    ...
                    var xpLoss = (ExperienceForNextLevel - ExperienceForCurrentLevel) * xpLossPercent / 1000;
        ...
        Message.SystemToOthers2(this, eChatType.CT_PlayerDied, "GamePlayer.Die.CorpseLies", GetName(0, true),
            GetPronoun(Client, 1, true));
                ...
                if (player != killer)
                    ...
                    player.Out.SendMessage(
                        LanguageMgr.GetTranslation(player.Client.Account.Language,
                            "GamePlayer.Duel.Die.KillerWinsDuel", killer.Name), eChatType.CT_Emote,
                        eChatLoc.CL_SystemWindow);
        // Message: {0} wins the duel!
        ...
        if (PredatorManager.PlayerIsActive(this)) PredatorManager.RemoveActivePlayer(this);

        if (HCFlag)
        {
            var cha = DOLDB<DOLCharacters>.SelectObject(DB.Column("Name").IsEqualTo(Name));
            if (cha == null) return;
    ...
    public override void EnemyKilled(GameLiving enemy)
    {
        if (Group != null)
            foreach (var player in Group.GetPlayersInTheGroup())
            {
                ...
                if (player.ControlledBrain != null &&
                    player.ControlledBrain.Body.attackComponent.Attackers.Contains(enemy))
        ...
        if (CurrentZone.IsRvR)
        {
            ...
            var baseContribution = enemy.RealmPointsValue / 2; //todo turn it into a server prop?

            if (activeConquest != null &&
                GetDistance(new Point2D(activeConquest.Keep.X, activeConquest.Keep.Y)) <=
                Properties.MAX_CONQUEST_RANGE)
            {
    ...
    /// </summary>
    public GamePlayer DuelTarget => Duel != null ? Duel.Target : null;
    ...
    /// </summary>
    protected object m_spellQueueAccessMonitor = new();
    ...
    {
        var lastUsedItem = TempProperties.getProperty<InventoryItem>(LAST_USED_ITEM_SPELL, null);
        if (lastUsedItem != null)
        {
            if (handler.StartReuseTimer) lastUsedItem.CanUseAgainIn = lastUsedItem.CanUseEvery;
        ...
        lock (m_spellQueueAccessMonitor)
        {
            var nextSpell = m_nextSpell;
            var nextSpellLine = m_nextSpellLine;
            var nextSpellTarget = m_nextSpellTarget;
            // warlock
            if (nextSpell != null)
                if (nextSpell.IsSecondary)
                {
                    var effect = SpellHandler.FindEffectOnTarget(this, "Powerless");
                    if (effect == null)
    ...
    public override bool CastSpell(Spell spell, SpellLine line)
    {
        ...
        if (spell.SpellType == (byte) eSpellType.StyleHandler ||
            spell.SpellType == (byte) eSpellType.MLStyleHandler)
        {
        ...
        {
            var ab = SkillBase.GetAbility("Bodyguard");
        ...
        else
        {
            ...
            {
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CastSpell.CantCastStunned"),
                    eChatType.CT_SpellResisted, eChatLoc.CL_SystemWindow);
                return false;
            }
            ...
            {
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CastSpell.CantCastMezzed"),
                    eChatType.CT_SpellResisted, eChatLoc.CL_SystemWindow);
                return false;
            }
            ...
            if (IsSilenced)
            {
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.CastSpell.CantCastFumblingWords"), eChatType.CT_Spell,
                    eChatLoc.CL_SystemWindow);
                return false;
            }
            ...
            lock (m_spellQueueAccessMonitor)
            {
                if (CurrentSpellHandler != null)
                {
                    ...
                    if (spell.CastTime > 0 && !(CurrentSpellHandler is ChamberSpellHandler) &&
                        spell.SpellType != (byte) eSpellType.Chamber)
                    {
                        if (CurrentSpellHandler.Spell.InstrumentRequirement != 0)
                        {
                            Out.SendMessage(
                                LanguageMgr.GetTranslation(Client.Account.Language,
                                    "GamePlayer.CastSpell.AlreadyPlaySong"), eChatType.CT_SpellResisted,
                                eChatLoc.CL_SystemWindow);
                            return false;
                        }
                        ...
                        if (SpellQueue)
                        {
                            if (spell.SpellType == (byte) eSpellType.Archery)
                                Out.SendMessage(
                                    LanguageMgr.GetTranslation(Client.Account.Language,
                                        "GamePlayer.CastSpell.FollowSpell", spell.Name), eChatType.CT_YouHit,
                                    eChatLoc.CL_SystemWindow);
                            else
                                Out.SendMessage(
                                    LanguageMgr.GetTranslation(Client.Account.Language,
                                        "GamePlayer.CastSpell.AlreadyCastFollow"), eChatType.CT_SpellResisted,
                                    eChatLoc.CL_SystemWindow);
                        ...
                        else
                        {
                            Out.SendMessage(
                                LanguageMgr.GetTranslation(Client.Account.Language,
                                    "GamePlayer.CastSpell.AlreadyCastNoQueue"), eChatType.CT_SpellResisted,
                                eChatLoc.CL_SystemWindow);
                        }
                    ...
                    else if (CurrentSpellHandler is PrimerSpellHandler)
                    {
                        if (!spell.IsSecondary)
                        {
                            Out.SendMessage(
                                LanguageMgr.GetTranslation(Client.Account.Language,
                                    "GamePlayer.CastSpell.OnlyASecondarySpell"), eChatType.CT_SpellResisted,
                                eChatLoc.CL_SystemWindow);
                        }
                        else
                        {
                            if (SpellQueue && !(CurrentSpellHandler is ChamberSpellHandler))
                            {
                                ...
                                Out.SendMessage(
                                    LanguageMgr.GetTranslation(Client.Account.Language,
                                        "GamePlayer.CastSpell.PrepareSecondarySpell"), eChatType.CT_SpellResisted,
                                    eChatLoc.CL_SystemWindow);
                            }
                    ...
                    {
                        var chamber = (ChamberSpellHandler) CurrentSpellHandler;
                        if (IsMoving || IsStrafing) return false;
                        ...
                        if (spell.IsPrimary)
                        {
                            if (spell.SpellType == (byte) eSpellType.Bolt && !chamber.Spell.AllowBolt)
                            {
                                Out.SendMessage(
                                    LanguageMgr.GetTranslation(Client.Account.Language,
                                        "GamePlayer.CastSpell.SpellNotInChamber"), eChatType.CT_SpellResisted,
                                    eChatLoc.CL_SystemWindow);
                                return false;
                            }
                            ...
                            if (chamber.PrimarySpell == null)
                            {
                                ...
                                Out.SendMessage(
                                    LanguageMgr.GetTranslation(Client.Account.Language,
                                        "GamePlayer.CastSpell.SpellInChamber", spell.Name,
                                        ((ChamberSpellHandler) CurrentSpellHandler).Spell.Name),
                                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                Out.SendMessage(
                                    LanguageMgr.GetTranslation(Client.Account.Language,
                                        "GamePlayer.CastSpell.SelectSecondSpell",
                                        ((ChamberSpellHandler) CurrentSpellHandler).Spell.Name),
                                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
                            }
                            else
                        ...
                        else if (spell.IsSecondary)
                        {
                            if (chamber.PrimarySpell != null)
                            {
                                ...
                                else
                                {
                                    Out.SendMessage(
                                        LanguageMgr.GetTranslation(Client.Account.Language,
                                            "GamePlayer.CastSpell.AlreadyChosenSpells"), eChatType.CT_SpellResisted,
                                        eChatLoc.CL_SystemWindow);
                                }
                            }
                            else
                            {
                                Out.SendMessage(
                                    LanguageMgr.GetTranslation(Client.Account.Language,
                                        "GamePlayer.CastSpell.PrimarySpellFirst"), eChatType.CT_SpellResisted,
                                    eChatLoc.CL_SystemWindow);
                            }
                        }
                    }
                             ...
                             spell.SpellType == (byte) eSpellType.Chamber)
                    {
                        Out.SendMessage(
                            LanguageMgr.GetTranslation(Client.Account.Language,
                                "GamePlayer.CastSpell.NotAFollowSpell"), eChatType.CT_SpellResisted,
                            eChatLoc.CL_SystemWindow);
                        return false;
                    }
                }
            ...
            var spellhandler = ScriptMgr.CreateSpellHandler(this, spell, line);
            if (spellhandler != null)
            {
                if (spell.CastTime > 0)
                {
                    var effect = SpellHandler.FindEffectOnTarget(this, "Chamber", spell.Name);
                    ...
                    else
                    {
                        ...
                        {
                            ((ChamberSpellHandler) spellhandler).EffectSlot =
                                ChamberSpellHandler.GetEffectSlot(spellhandler.Spell.Name);
                            CurrentSpellHandler.CastingCompleteEvent +=
                                new CastingCompleteCallback(OnAfterSpellCastSequence);
                            casted = spellhandler.CastSpell();
                        }
                ...
                else
                {
                    if (spell.IsSecondary)
                    {
                        ...
                        if (CurrentSpellHandler == null && effect == null)
                        {
                            Out.SendMessage(
                                LanguageMgr.GetTranslation(Client.Account.Language,
                                    "GamePlayer.CastSpell.CantSpellDirectly"), eChatType.CT_SpellResisted,
                                eChatLoc.CL_SystemWindow);
                        }
                        else if (CurrentSpellHandler != null)
                        {
                            if (CurrentSpellHandler.Spell.IsPrimary)
                                lock (m_spellQueueAccessMonitor)
                                {
                                    if (SpellQueue && !(CurrentSpellHandler is ChamberSpellHandler))
                                    {
                                        Out.SendMessage(
                                            LanguageMgr.GetTranslation(Client.Account.Language,
                                                "GamePlayer.CastSpell.PrepareSecondarySpell"),
                                            eChatType.CT_SpellResisted, eChatLoc.CL_SystemWindow);
                                        m_nextSpell = spell;
            ...
            {
                Out.SendMessage(spell.Name + " not implemented yet (" + spell.SpellType + ")", eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
                return false;
            }
        }
    ...
    public override bool CastSpell(ISpellCastingAbilityHandler ab)
    {
        ...
        var spellhandler = ScriptMgr.CreateSpellHandler(this, ab.Spell, ab.SpellLine);
        if (spellhandler != null)
        {
        ...
        {
            Out.SendMessage(ab.Spell.Name + " not implemented yet (" + ab.Spell.SpellType + ")",
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
        }
    ...
    public override int CalculateCastingTime(SpellLine line, Spell spell)
    {
        ...
        var percent = DexterityCastTimeReduction;
        ...
        if (UseDetailedCombatLog)
            Out.SendMessage($"Casting Speed: {ticks / 1000.0}s", eChatType.CT_DamageAdd,
                eChatLoc.CL_SystemWindow);
    ...
    /// </summary>
    public bool IsCastingRealmAbility => m_realmAbilityCastTimer != null && m_realmAbilityCastTimer.IsAlive;
    ...
    public virtual bool ReceiveTradeItem(GamePlayer source, InventoryItem item)
    {
        ...
        lock (m_LockObject)
        {
            lock (source)
            {
                if ((TradeWindow != null && source != TradeWindow.Partner) ||
                    (TradeWindow == null && !OpenTrade(source)))
                {
                    if (TradeWindow != null)
                    {
                        var partner = TradeWindow.Partner;
                        if (partner == null)
                            source.Out.SendMessage(Name + " is still selfcrafting.", eChatType.CT_System,
                                eChatLoc.CL_SystemWindow);
                        else
                            source.Out.SendMessage(Name + " is still trading with " + partner.Name + ".",
                                eChatType.CT_System, eChatLoc.CL_SystemWindow);
                    }
                    else if (source.TradeWindow != null)
                    {
                        var sourceTradePartner = source.TradeWindow.Partner;
                        if (sourceTradePartner == null)
                            source.Out.SendMessage(
                                LanguageMgr.GetTranslation(Client.Account.Language,
                                    "GamePlayer.ReceiveTradeItem.StillSelfcrafting"), eChatType.CT_System,
                                eChatLoc.CL_SystemWindow);
                        else
                            source.Out.SendMessage("You are still trading with " + sourceTradePartner.Name + ".",
                                eChatType.CT_System, eChatLoc.CL_SystemWindow);
                    }
                ...
                if (item.IsTradable == false && source.CanTradeAnyItem == false &&
                    TradeWindow.Partner.CanTradeAnyItem == false)
                {
                    source.Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language,
                            "GamePlayer.ReceiveTradeItem.CantTrade"), eChatType.CT_System,
                        eChatLoc.CL_SystemWindow);
                    return false;
                }
    ...
    /// </summary>
    public virtual int Mithril
    {
        get => m_Mithril;
        protected set
        {
            m_Mithril = value;
            if (DBCharacter != null) DBCharacter.Mithril = m_Mithril;
        }
    }
    ...
    /// </summary>
    public virtual int Platinum
    {
        get => m_Platinum;
        protected set
        {
            m_Platinum = value;
            if (DBCharacter != null) DBCharacter.Platinum = m_Platinum;
        }
    }
    ...
    public virtual int Gold
    {
        ...
        {
            m_Gold = value;
            if (DBCharacter != null) DBCharacter.Gold = m_Gold;
        }
    }
    ...
    public virtual int Silver
    {
        ...
        {
            m_Silver = value;
            if (DBCharacter != null) DBCharacter.Silver = m_Silver;
        }
    }
    ...
    /// </summary>
    public virtual int Copper
    {
        get => m_Copper;
        protected set
        {
            m_Copper = value;
            if (DBCharacter != null) DBCharacter.Copper = m_Copper;
        }
    }
    ...
    {
        var newMoney = GetCurrentMoney() + money;
        ...
        if (messageFormat != null) Out.SendMessage(string.Format(messageFormat, Money.GetString(money)), ct, cl);
    }
    ...
    public virtual void UseSlot(int slot, int type)
    {
        if (!IsAlive)
        {
            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UseSlot.CantFire"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return;
        }
        ...
        lock (Inventory)
        {
            var useItem = Inventory.GetItem((eInventorySlot) slot);
            UseItem = useItem;

            if (useItem == null)
            {
                if (slot >= Slot.FIRSTQUIVER && slot <= Slot.FOURTHQUIVER)
                    Out.SendMessage("The quiver slot " + (slot - Slot.FIRSTQUIVER + 1) + " is empty!",
                        eChatType.CT_System, eChatLoc.CL_SystemWindow);
                else
                    // don't allow using empty slots
                    Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language,
                            "GamePlayer.UseSlot.IllegalSourceObject", slot), eChatType.CT_System,
                        eChatLoc.CL_SystemWindow);
            ...
            if (useItem.Item_Type >= (int) eInventorySlot.LeftFrontSaddleBag &&
                useItem.Item_Type <= (int) eInventorySlot.RightRearSaddleBag)
            {
            ...
            if (useItem.Item_Type != Slot.RANGED && (slot != Slot.HORSE || type != 0))
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UseSlot.AttemptToUse",
                        useItem.GetName(0, false)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
            ...
            switch (slot)
            {
                    ...
                    if (type == 0)
                    {
                        ...
                        else
                        {
                            if (Level < useItem.Level)
                            {
                                Out.SendMessage(
                                    LanguageMgr.GetTranslation(Client.Account.Language,
                                        "GamePlayer.UseSlot.SummonHorseLevel", useItem.Level), eChatType.CT_System,
                                    eChatLoc.CL_SystemWindow);
                                return;
                            }

                            var reason = GameServer.ServerRules.ReasonForDisallowMounting(this);
                            if (!string.IsNullOrEmpty(reason))
                            {
                                Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, reason),
                                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                return;
                            }
                            ...
                            if (IsSummoningMount)
                            {
                                Out.SendMessage(
                                    LanguageMgr.GetTranslation(Client.Account.Language,
                                        "GamePlayer.UseSlot.StopCallingMount"), eChatType.CT_System,
                                    eChatLoc.CL_SystemWindow);
                                StopWhistleTimers();
                                return;
                            }
                            ...
                            // vampiir ~
                            var effects =
                                SpellHandler.FindEffectOnTarget(this, "VampiirSpeedEnhancement");
                            //GameSpellEffect effect = SpellHandler.FindEffectOnTarget(this, "SpeedEnhancement");
                            var effect =
                                EffectListService.GetEffectOnTarget(this, eEffect.MovementSpeedBuff);
                            if (effects != null)
                            ...
                            Out.SendMessage(
                                LanguageMgr.GetTranslation(Client.Account.Language,
                                    "GamePlayer.UseSlot.WhistleMount"), eChatType.CT_Emote,
                                eChatLoc.CL_SystemWindow);
                            m_whistleMountTimer = new ECSGameTimer(this);
                            m_whistleMountTimer.Callback =
                                new ECSGameTimer.ECSTimerCallback(WhistleMountTimerCallback);
                ...
                case Slot.RANGED:
                    ...
                    var
                        volley = EffectListService.GetEffectOnTarget(this,
                            eEffect.Volley); //check if player got volley
                        ...
                        volley == null) //volley check
                    {
                        ...
                        else if (rangeAttackComponent.RangedAttackState == eRangedAttackState.Aim)
                        {
                            if (!TargetInView)
                            {
                                ...
                                if (volley == null) //volley check
                                    Out.SendMessage(
                                        LanguageMgr.GetTranslation(Client.Account.Language,
                                            "GamePlayer.UseSlot.CantSeeTarget"), eChatType.CT_System,
                                        eChatLoc.CL_SystemWindow);
                            }
                            else
                            {
                                ...
                                Out.SendMessage(
                                    LanguageMgr.GetTranslation(Client.Account.Language,
                                        "GamePlayer.UseSlot.AutoReleaseShot"), eChatType.CT_System,
                                    eChatLoc.CL_SystemWindow);
                            }
                        }
                        else if (rangeAttackComponent.RangedAttackState == eRangedAttackState.AimFire)
                        {
                            ...
                            Out.SendMessage(
                                LanguageMgr.GetTranslation(Client.Account.Language,
                                    "GamePlayer.UseSlot.AutoReleaseShotReload"), eChatType.CT_System,
                                eChatLoc.CL_SystemWindow);
                        }
                        else if (rangeAttackComponent.RangedAttackState == eRangedAttackState.AimFireReload)
                        {
                            ...
                            Out.SendMessage(
                                LanguageMgr.GetTranslation(Client.Account.Language,
                                    "GamePlayer.UseSlot.NoAutoReleaseShotReload"), eChatType.CT_System,
                                eChatLoc.CL_SystemWindow);
                        }
                    }
            ...
            if (useItem.SpellID != 0 || useItem.SpellID1 != 0 ||
                useItem.PoisonSpellID != 0) // don't return without firing events
            {
                if (IsSitting && useItem.Object_Type != (int) eObjectType.Poison)
                {
                    Out.SendMessage("You can't use an item while sitting!", eChatType.CT_System,
                        eChatLoc.CL_SystemWindow);
                    return;
                }
                ...
                {
                    Out.SendMessage("The " + useItem.Name + " is out of charges.", eChatType.CT_System,
                        eChatLoc.CL_SystemWindow);
                    return;
                }
                else
                {
                    if (useItem.Object_Type == (int) eObjectType.Poison)
                    {
                        ...
                        else if (leftHand != null && leftHand.PoisonSpellID == 0) ApplyPoison(useItem, leftHand);
                    }
                    else if (useItem.SpellID > 0 && useItem.Charges > 0 &&
                             useItem.Object_Type == (int) eObjectType.Magical &&
                             (useItem.Item_Type == (int) eInventorySlot.FirstBackpack || useItem.Item_Type == 41))
                    {
                        ...
                        var spell = SkillBase.FindSpell(useItem.SpellID, potionEffectLine);
                        ...
                        if (spell != null)
                        {
                            ...
                            var nextPotionAvailTime =
                                TempProperties.getProperty<long>(NEXT_POTION_AVAIL_TIME + "_Type" +
                                                                 spell.SharedTimerGroup);

                            if (Client.Account.PrivLevel == 1 && nextPotionAvailTime > CurrentRegion.Time)
                            {
                                Out.SendMessage(
                                    LanguageMgr.GetTranslation(Client.Account.Language,
                                        "GamePlayer.UseSlot.MustWaitBeforeUse",
                                        (nextPotionAvailTime - CurrentRegion.Time) / 1000), eChatType.CT_System,
                                    eChatLoc.CL_SystemWindow);
                            }
                            else
                            {
                                ...
                                {
                                    var requiredLevel = useItem.Template.LevelRequirement > 0
                                        ? useItem.Template.LevelRequirement
                                        : Math.Min(MaxLevel, useItem.Level);
                                    ...
                                    if (requiredLevel <= Level)
                                    {
                                        if (spell.CastTime > 0 && attackComponent.AttackState)
                                        {
                                            Out.SendMessage(
                                                LanguageMgr.GetTranslation(Client.Account.Language,
                                                    "GamePlayer.UseSlot.CantUseInCombat"), eChatType.CT_System,
                                                eChatLoc.CL_SystemWindow);
                                        }
                                        //Eden
                                        else if ((IsStunned &&
                                                  !(Steed != null && Steed.Name == "Forceful Zephyr")) ||
                                                 IsMezzed || !IsAlive)
                                        {
                                            Out.SendMessage(
                                                LanguageMgr.GetTranslation(Client.Account.Language,
                                                    "GamePlayer.UseSlot.CantUseState", useItem.GetName(0, false)),
                                                eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                        }
                                        else if (spell.CastTime > 0 && IsCasting)
                                        {
                                            Out.SendMessage(
                                                LanguageMgr.GetTranslation(Client.Account.Language,
                                                    "GamePlayer.UseSlot.CantUseCast", useItem.GetName(0, false)),
                                                eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                        }
                                        else
                                        {
                                            var spellHandler =
                                                ScriptMgr.CreateSpellHandler(this, spell, potionEffectLine) as
                                                    SpellHandler;
                                            if (spellHandler != null)
                                            {
                                                var target = TargetObject as GameLiving;
                                                ...
                                                if (spell.Target.ToLower() == "enemy")
                                                    ...
                                                    if (!GameServer.ServerRules.IsAllowedToAttack(this, target,
                                                            true))
                                                    {
                                                        // not allowed to attack, so they are not an enemy.
                                                        Out.SendMessage("You need a target for this ability!",
                                                            eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                                        return;
                                                    }
                                                ...
                                                if (spell.IsHealing && spell.CastTime == 0 && IsAttacking)
                                                {
                                                    Out.SendMessage(
                                                        LanguageMgr.GetTranslation(Client.Account.Language,
                                                            "GamePlayer.UseSlot.CantUseAttacking",
                                                            useItem.GetName(0, false)), eChatType.CT_System,
                                                        eChatLoc.CL_SystemWindow);
                                                    return;
                                                }
                                                ...
                                                if (useItem.Item_Type == (int) eInventorySlot.FirstBackpack)
                                                {
                                                    ...
                                                    if (spell.CastTime > 0)
                                                        TempProperties.setProperty(
                                                            NEXT_SPELL_AVAIL_TIME_BECAUSE_USE_POTION,
                                                            6 * 1000 + CurrentRegion.Time);
                                                }
                                                ...
                                                if (spellHandler.StartSpell(target, useItem))
                                                {
                                                    if (useItem.Count > 1)
                                                    {
                                                        ...
                                                        InventoryLogging.LogInventoryAction(this, "(potion)",
                                                            eInventoryActionType.Other, useItem.Template);
                                                    }
                                                    else
                                                    {
                                                        useItem.Charges--;
                                                    ...
                                                    Out.SendMessage(
                                                        LanguageMgr.GetTranslation(Client.Account.Language,
                                                            "GamePlayer.UseSlot.Used", useItem.GetName(0, false)),
                                                        eChatType.CT_System, eChatLoc.CL_SystemWindow);

                                                    TempProperties.setProperty(
                                                        NEXT_POTION_AVAIL_TIME + "_Type" + spell.SharedTimerGroup,
                                                        useItem.CanUseEvery * 1000 + CurrentRegion.Time);
                                                }
                                                else
                                                {
                                            ...
                                            {
                                                Out.SendMessage(
                                                    "Potion effect ID " + spell.ID + " is not implemented yet.",
                                                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                            }
                                        }
                                    }
                                    else
                                    {
                                        Out.SendMessage(
                                            LanguageMgr.GetTranslation(Client.Account.Language,
                                                "GamePlayer.UseSlot.NotEnouthPower"), eChatType.CT_System,
                                            eChatLoc.CL_SystemWindow);
                                    }
                                }
                                else
                                {
                                    Out.SendMessage("Potion effect line not found", eChatType.CT_System,
                                        eChatLoc.CL_SystemWindow);
                                }
                            }
                        }
                        ...
                        {
                            Out.SendMessage("Potion effect spell ID " + useItem.SpellID + " not found.",
                                eChatType.CT_System, eChatLoc.CL_SystemWindow);
                        }
                    }
                    else if (type > 0)
                    {
                        if (!Inventory.EquippedItems.Contains(useItem))
                        {
                            Out.SendMessage(
                                LanguageMgr.GetTranslation(Client.Account.Language,
                                    "GamePlayer.UseSlot.CantUseFromBackpack"), eChatType.CT_System,
                                eChatLoc.CL_SystemWindow);
                        }
                        else
                        {
                            var lastChargedItemUseTick =
                                TempProperties.getProperty<long>(LAST_CHARGED_ITEM_USE_TICK);
                            var changeTime = CurrentRegion.Time - lastChargedItemUseTick;
                            var delay = TempProperties.getProperty<long>(ITEM_USE_DELAY, 0L);
                            var itemdelay = TempProperties.getProperty<long>("ITEMREUSEDELAY" + useItem.Id_nb);
                            var itemreuse = (long) useItem.CanUseEvery * 1000;
                            if (itemdelay == 0) itemdelay = CurrentRegion.Time - itemreuse;

                            if ((IsStunned && !(Steed != null && Steed.Name == "Forceful Zephyr")) || IsMezzed ||
                                !IsAlive)
                            {
                                Out.SendMessage("In your state you can't discharge any object.",
                                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
                            }
                                     ...
                                     (type == 2 && SelfBuffChargeIDs.Contains(useItem.SpellID1)))
                            {
                                UseItemCharge(useItem, type);
                                     ...
                                     (changeTime < delay ||
                                      CurrentRegion.Time - itemdelay < itemreuse)) //2 minutes reuse timer
                            {
                                if (CurrentRegion.Time - itemdelay < itemreuse)
                                    Out.SendMessage(
                                        "You must wait " + (itemreuse - (CurrentRegion.Time - itemdelay)) / 1000 +
                                        " more second before discharge " + useItem.Name + "!", eChatType.CT_System,
                                        eChatLoc.CL_SystemWindow);
                                else
                                    Out.SendMessage(
                                        "You must wait " + (delay - changeTime) / 1000 +
                                        " more second before discharge another object!", eChatType.CT_System,
                                        eChatLoc.CL_SystemWindow);
    ...
    protected virtual void UseSaddleBag(InventoryItem useItem)
    {
        ...
        switch ((eInventorySlot) useItem.Item_Type)
        {
            case eInventorySlot.LeftFrontSaddleBag:
                if (ChampionLevel >= 2)
                    ...
                    Out.SendMessage("This saddlebag requires Champion Level 2!", eChatType.CT_SpellResisted,
                        eChatLoc.CL_SystemWindow);
            ...
            case eInventorySlot.RightFrontSaddleBag:
                if (ChampionLevel >= 3)
                    ...
                    Out.SendMessage("This saddlebag requires Champion Level 3!", eChatType.CT_SpellResisted,
                        eChatLoc.CL_SystemWindow);
            ...
            case eInventorySlot.LeftRearSaddleBag:
                if (ChampionLevel >= 4)
                    ...
                    Out.SendMessage("This saddlebag requires Champion Level 4!", eChatType.CT_SpellResisted,
                        eChatLoc.CL_SystemWindow);
            ...
            case eInventorySlot.RightRearSaddleBag:
                if (ChampionLevel >= 5)
                    ...
                    Out.SendMessage("This saddlebag requires Champion Level 5!", eChatType.CT_SpellResisted,
                        eChatLoc.CL_SystemWindow);
        ...
        if (bag != eHorseSaddleBag.None)
        {
            if ((ActiveSaddleBags & (byte) bag) == 0)
            {
                ...
                {
                    InventoryLogging.LogInventoryAction(this, "(HorseSaddleBag)", eInventoryActionType.Other,
                        useItem.Template, useItem.Count);
                    ActiveSaddleBags |= (byte) bag;
                    Out.SendSetControlledHorse(this);
                    Out.SendMessage("You've activated a saddlebag!", eChatType.CT_Important,
                        eChatLoc.CL_SystemWindow);
                    SaveIntoDatabase();
                }
                else
                {
                    Out.SendMessage("An error occurred while trying to activate this saddlebag!",
                        eChatType.CT_SpellResisted, eChatLoc.CL_SystemWindow);
                }
            }
            else
            {
                Out.SendMessage("You've already activated this saddlebag!", eChatType.CT_SpellResisted,
                    eChatLoc.CL_SystemWindow);
            }
        }
    }
    ...
    public virtual bool CanUseHorseInventorySlot(int slot)
    {
        ...
        if (IsOnHorse == false)
        {
            Out.SendMessage("You must be on your horse to use this inventory.", eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
            return false;
        }
        ...
        if (ChampionLevel == 0)
        {
            Out.SendMessage("You must be a champion to use this inventory.", eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
            return false;
        }

        if (slot < (int) eInventorySlot.FirstBagHorse || slot > (int) eInventorySlot.LastBagHorse ||
            (ChampionLevel >= 5 && ActiveSaddleBags == (byte) eHorseSaddleBag.All))
            return true;

        try
        {
            var saddleBagRequired = (eHorseSaddleBag) Enum.GetValues(typeof(eHorseSaddleBag))
                .GetValue(slot / NUM_SLOTS_PER_SADDLEBAG - 19); // 1, 2, 3, or 4
            ...
            if ((ActiveSaddleBags & (byte) saddleBagRequired) > 0)
            {
                if (ChampionLevel >= 2 && slot < (int) eInventorySlot.FirstBagHorse + NUM_SLOTS_PER_SADDLEBAG)
                    return true;
                         ...
                         slot < (int) eInventorySlot.FirstBagHorse + NUM_SLOTS_PER_SADDLEBAG * 2)
                    return true;
                else if (ChampionLevel >= 4 &&
                         slot < (int) eInventorySlot.FirstBagHorse + NUM_SLOTS_PER_SADDLEBAG * 3)
                    return true;
            }
        }
        catch (Exception ex)
    ...
    protected virtual void UseItemCharge(InventoryItem useItem, int type)
    {
        ...
        if (requiredLevel > Level)
        {
            Out.SendMessage("You are not powerful enough to use this item's spell.", eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
            return;
        }

        var chargeEffectLine = SkillBase.GetSpellLine(GlobalSpellsLines.Item_Effects);
        Spell spell = null;
        ...
        if (spell != null)
        {
            if (ActiveBuffCharges >= Properties.MAX_CHARGE_ITEMS
                ...
                && effectListComponent.GetSpellEffects().FirstOrDefault(x => x.SpellHandler.Spell.ID == spell.ID) ==
                null)
            {
                Out.SendMessage("You may only use two buff charge effects.", eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
                return;
            }
            ...
            var spellHandler = ScriptMgr.CreateSpellHandler(this, spell, chargeEffectLine);
            if (spellHandler != null)
            {
                ...
                {
                    var castOk = spellHandler.StartReuseTimer;

                    if (spell.SubSpellID > 0)
                    {
                        var subspell = SkillBase.GetSpellByID(spell.SubSpellID);
                        if (subspell != null)
                        {
                            var subSpellHandler =
                                ScriptMgr.CreateSpellHandler(this, subspell, chargeEffectLine);
                            if (subSpellHandler != null) subSpellHandler.CastSpell();
                        }
                    }

                    if (useItem.MaxCharges > 0) useItem.Charges--;
            ...
            {
                Out.SendMessage("Charge effect ID " + spell.ID + " is not implemented yet.", eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
            }
        }
        else
        {
            if (type == 1)
                Out.SendMessage("Charge effect ID " + useItem.SpellID + " not found.", eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
            else
                Out.SendMessage("Charge effect ID " + useItem.SpellID1 + " not found.", eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
        }
    }
    ...
    protected virtual bool UseMagicalItem(InventoryItem item, int type)
    {
        ...
        var cooldown = item.CanUseAgainIn;
        ...
        var itemSpellLine = SkillBase.GetSpellLine(GlobalSpellsLines.Item_Effects);
        ...
        if (type == 1 || type == 0)
        {
            var spell = SkillBase.FindSpell(item.SpellID, itemSpellLine);

            if (spell != null)
            {
                var requiredLevel = item.Template.LevelRequirement > 0
                    ? item.Template.LevelRequirement
                    : Math.Min(MaxLevel, item.Level);
                ...
                Out.SendMessage(string.Format("You use {0}.", item.GetName(0, false)), eChatType.CT_Skill,
                    eChatLoc.CL_SystemWindow);

                var spellHandler = ScriptMgr.CreateSpellHandler(this, spell, itemSpellLine);
                if (spellHandler == null)
                    return false;
    ...
    public bool ApplyPoison(InventoryItem poisonPotion, InventoryItem toItem)
    {
        ...
        var envenomSpec = GetModifiedSpecLevel(Specs.Envenom);
        if (envenomSpec < 1)
        {
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ApplyPoison.CantUsePoisons"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return false;
        }
        ...
        {
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ApplyPoison.PoisonsAppliedWeapons"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return false;
        }
        ...
        {
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ApplyPoison.CantPoisonWeapon"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return false;
        }
        ...
        {
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ApplyPoison.CantUsePoison"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return false;
        }
        ...
        {
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ApplyPoison.CantApplyRecentCombat"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return false;
        }
        ...
        Out.SendMessage(
            string.Format("You apply {0} to {1}.", poisonPotion.GetName(0, false), toItem.GetName(0, false)),
            eChatType.CT_System, eChatLoc.CL_SystemWindow);
        return true;
    }
    ...
    public virtual bool PrivateMessageReceive(GamePlayer source, string str)
    {
        ...
        if (GameServer.ServerRules.IsAllowedToUnderstand(source, this))
        {
            ...
            if (Client != source.Client && Client.Account.PrivLevel != 1 &&
                TempProperties.getProperty<bool>("SendAlert") == false)
    ...
    public override bool SayReceive(GameLiving source, string str)
    {
        ...
        if (Properties.EVENT_CROSS_REALM_SAY)
            foreach (AbstractArea area in source.CurrentAreas)
            {
                if (area.IsSafeArea)
                    Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.SayReceive.Says",
                            source.GetName(0, false), str),
        ...
        if (GameServer.ServerRules.IsAllowedToUnderstand(source, this) || Properties.ENABLE_DEBUG)
            ...
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.SayReceive.FalseLanguage",
                    source.GetName(0, false)),
                eChatType.CT_Say, eChatLoc.CL_ChatWindow);
        return true;
    }
    ...
    public override bool Say(string str)
    {
        ...
        if (!base.Say(str))
            return false;
        Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Say.YouSay", str),
            eChatType.CT_Say,
    ...
    public override bool Whisper(GameObject target, string str)
    {
        if (target == null)
        {
            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Whisper.SelectTarget"),
                eChatType.CT_System,
                eChatLoc.CL_ChatWindow);
            return false;
        }
    ...
    public virtual void MessageFromArea(GameObject source, string message, eChatType chatType,
        eChatLoc chatLocation)
    {
    ...
    public virtual bool IsRiding => Steed != null;
    ...
    public override bool AddToWorld()
    {
        ...
        if (SpecPointsOk == false)
        {
            ...
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.AddToWorld.SpecsPointsIncorrect"),
                eChatType.CT_Important, eChatLoc.CL_SystemWindow);
            SpecPointsOk = true;
        }
        ...
        var playerDeck =
            DOLDB<DOLCharactersXDeck>.SelectObject(DB.Column("DOLCharactersObjectId").IsEqualTo(ObjectId));
        if (playerDeck != null)
    ...
    {
        if (CharacterClass.RemoveFromWorld() == false) return false;
        ...
        if (ObjectState == eObjectState.Active)
        {
            ...
            {
                if (this is GamePlayer && Client.Account.PrivLevel < 3 &&
                    !(this as GamePlayer).TempProperties.getProperty("isbeingbanned", false))
                {
    ...
    public override void Delete()
    {
        ...
        var mybattlegroup =
            (BattleGroup) TempProperties.getProperty<object>(BattleGroup.BATTLEGROUP_PROPERTY, null);
        if (mybattlegroup != null) mybattlegroup.RemoveBattlePlayer(this);

        if (m_guild != null) m_guild.RemoveOnlineMember(this);
        ...
        //     return;
        // }
        if (log.IsDebugEnabled) log.DebugFormat("({0}) player.Delete()", Name);
    ...
    public override bool MoveTo(ushort regionID, int x, int y, int z, ushort heading)
    {
        ...
        var rgn = WorldMgr.GetRegion(regionID);
        ...
        else
        {
            ...
            {
                if (player == null) continue;
                if (player != this) player.Out.SendObjectRemove(this);
            }

            IsJumping = true;
        }

        var hasPetToMove = false;
        ...
        if (ControlledBrain != null && ControlledBrain.WalkState != eWalkState.Stay)
            if (CharacterClass.ID != (int) eCharacterClass.Theurgist &&
                CharacterClass.ID != (int) eCharacterClass.Animist)
                hasPetToMove = true;
        ...
        var originalPoint = new Point3D(X, Y, Z);
        X = x;
        Y = y;
        Z = z;
        Heading = heading;
        ...
        else
        {
            ...
            if (hasPetToMove)
            {
                var point = GetPointFromHeading(Heading, 64);

                var npc = ControlledBrain;
                if (npc != null)
                {
                    var petBody = npc.Body;

                    petBody.MoveInRegion(CurrentRegionID, point.X, point.Y, Z + 10,
                        (ushort) ((Heading + 2048) % 4096), false);

                    if (petBody != null && petBody.ControlledNpcList != null)
                        foreach (var icb in petBody.ControlledNpcList)
                            if (icb != null && icb.Body != null)
                            {
                                var petBody2 = icb.Body;
                                if (petBody2 != null && originalPoint.IsWithinRadius(petBody2, 500))
                                    petBody2.MoveInRegion(CurrentRegionID, point.X, point.Y, Z + 10,
                                        (ushort) ((Heading + 2048) % 4096), false);
                            }
                }
            }
    ...
    public virtual void RefreshWorld()
    {
        ...
        foreach (GamePlayer player in GetPlayersInRadius(WorldMgr.VISIBILITY_DISTANCE))
            if (player != null && player != this)
            {
                if (IsStealthed == false || player.CanDetect(this)) player.Out.SendPlayerCreate(this);
    ...
    public virtual bool MoveToBind()
    {
        ...
        {
            if (log.IsErrorEnabled)
                log.Error("Player: " + Name + " unknown bind point : (R/X/Y) " + BindRegion + "/" + BindXpos + "/" +
                          BindYpos);
            ...
            if (Properties.BAN_HACKERS)
            {
                ...
                var message = "Unknown bind point, your account is banned, contact a GM.";
    ...
    public DBRank GuildRank
    {
        ...
        set
        {
            ...
            if (value != null && DBCharacter != null)
                DBCharacter.GuildRank =
                    value.RankLevel; //maybe mistake here and need to change and make an index var
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.GuildID : string.Empty;
        set
        {
            if (DBCharacter != null) DBCharacter.GuildID = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.FlagClassName : false;
        set
        {
            if (DBCharacter != null) DBCharacter.FlagClassName = value;
        }
    }
    ...
    /// </summary>
    private ReaderWriterList<IArea> m_currentAreas = new();
    ...
    {
        get => m_lastPositionUpdateTick;
        set => m_lastPositionUpdateTick = value;
    }

    private Point3DFloat m_lastPositionUpdatePoint = new(0, 0, 0);
    ...
    {
        get => DBCharacter != null ? (eRealm) DBCharacter.Realm : base.Realm;
        set
        {
            base.Realm = value;
    ...
    public override ushort Heading
    {
        set
        {
            ...
            {
                var ad = TempProperties.getProperty<object>(LAST_ATTACK_DATA, null) as AttackData;
                if (ad != null && ad.IsMeleeAttack && (ad.AttackResult == eAttackResult.TargetNotVisible ||
                    ...
                    if (ad.Target != null && IsObjectInFront(ad.Target, 120) &&
                        IsWithinRadius(ad.Target, attackComponent.AttackRange) &&
                        attackComponent.attackAction != null)
                        //m_attackAction.Start(1);
                        attackComponent.attackAction.StartTime = 1;
            }
    ...
    protected int LavaBurnTimerCallback(ECSGameTimer callingTimer)
    {
        ...
        Out.SendMessage(
            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.LavaBurnTimerCallback.YourInLava"),
            eChatType.CT_Damaged, eChatLoc.CL_SystemWindow);
        Out.SendMessage(
            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.LavaBurnTimerCallback.Take34%Damage"),
            eChatType.CT_Damaged, eChatLoc.CL_SystemWindow);
        if (Client.Account.PrivLevel == 1)
        {
    ...
    public override bool IsSitting
    {
        ...
        set
        {
            ...
            if (value)
            {
                ...
                if (attackComponent.AttackState && ActiveWeaponSlot == eActiveWeaponSlot.Distance)
                {
                    var attackTypeMsg = "shot";
                    if (ActiveWeapon.Object_Type == (int) eObjectType.Thrown)
                        attackTypeMsg = "throw";
                    Out.SendMessage("You move and interrupt your " + attackTypeMsg + "!", eChatType.CT_Important,
                        eChatLoc.CL_SystemWindow);
                    attackComponent.StopAttack();
                }
            }
    ...
    {
        get => (short) (DBCharacter != null ? DBCharacter.MaxSpeed : base.MaxSpeedBase);
        set
        {
    ...
    public virtual bool Sprint(bool state)
    {
        ...
        if (state)
        {
            ...
            {
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sprint.TooFatigued"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
                return false;
            }
            ...
            {
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sprint.CantSprintHidden"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
                return false;
            }
            ...
            {
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sprint.CantSprintDead"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
                return false;
            }
        ...
        else
        {
            if (effectListComponent.ContainsEffectForEffectType(eEffect.Sprint))
                EffectService.RequestImmediateCancelEffect(
                    EffectListService.GetEffectOnTarget(this, eEffect.Sprint), false);
    ...
    public virtual void OnPlayerMove()
    {
        ...
        if (IsCasting) CurrentSpellHandler.CasterMoves();

        if (IsCastingRealmAbility)
        {
            Out.SendInterruptAnimation(this);
            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "SpellHandler.CasterMove"),
                eChatType.CT_Important, eChatLoc.CL_SystemWindow);
        ...
        {
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnPlayerMove.InterruptCrafting"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            //CraftTimer.Stop();
            //CraftTimer = null;
            craftComponent.StopCraft();
        ...
        {
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnPlayerMove.CannotCallMount"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            StopWhistleTimers();
        }
        ...
        if (attackComponent.AttackState)
        {
            if (ActiveWeaponSlot == eActiveWeaponSlot.Distance)
            {
                var attackTypeMsg = ActiveWeapon.Object_Type == (int) eObjectType.Thrown ? "throw" : "shot";
                Out.SendMessage("You move and interrupt your " + attackTypeMsg + "!", eChatType.CT_Important,
                    eChatLoc.CL_SystemWindow);
                attackComponent.StopAttack();
            }
    ...
    public virtual void Sit(bool sit)
    {
        ...
        {
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sit.InterruptCallMount"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            StopWhistleTimers();
        }
        ...
        if (IsSitting == sit)
        {
            if (sit)
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sit.AlreadySitting"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
            if (!sit)
                Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sit.NotSitting"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return; // already done
        }
        ...
        if (!IsAlive)
        {
            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sit.CantSitDead"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return;
        }
        ...
        if (IsStunned)
        {
            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sit.CantSitStunned"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return;
        }
        ...
        if (IsMezzed)
        {
            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sit.CantSitMezzed"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return;
        }
        ...
        {
            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sit.MustStandingStill"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return;
        }
        ...
        if (Steed != null || IsOnHorse)
        {
            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sit.MustDismount"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return;
        }

        if (sit)
            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sit.YouSitDown"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
        else
            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sit.YouStandUp"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);

        //Stop attack if you sit down while attacking
        if (sit && attackComponent.AttackState) attackComponent.StopAttack();
        ...
        if (!sit)
        {
            ...
            if (m_quitTimer != null)
            {
                ...
                Stuck = false;
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sit.NoLongerWaitingQuit"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
            }

            //Stop praying if the player stands up...
            if (IsPraying) m_prayAction.Stop();
        }
    ...
    {
        var volley = EffectListService.GetEffectOnTarget(this, eEffect.Volley); //volley check for gt
        if (volley != null)
        {
            Out.SendMessage("You can't change ground target under volley effect!", eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
            return;
        }
        else
        {
            ...
            Out.SendMessage(string.Format("You ground-target {0},{1},{2}", groundX, groundY, groundZ),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            if (SiegeWeapon != null)
    ...
    /// </summary>
    public GameLocation[] LastUniqueLocations => m_lastUniqueLocations;
    ...
    /// </summary>
    public virtual int Encumberance => Inventory.InventoryWeight;
    ...
    public void UpdateEncumberance()
    {
        if (Inventory.InventoryWeight > MaxEncumberance)
        {
            ...
            if (MaxSpeed == 0)
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "PropertyCalc.MaxSpeed.YouAreEncumbered"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
            else
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.UpdateEncumberance.EncumberedMoveSlowly"), eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
        }
    ...
    public string ItemBonusName(int BonusType)
    {
        ...
        if (BonusType == 1)
            BonusName = LanguageMgr.GetTranslation(Client.Account.Language,
                "GamePlayer.ItemBonusName.Bonus1"); //Strength
        if (BonusType == 2)
            BonusName = LanguageMgr.GetTranslation(Client.Account.Language,
                "GamePlayer.ItemBonusName.Bonus2"); //Dexterity
        if (BonusType == 3)
            BonusName = LanguageMgr.GetTranslation(Client.Account.Language,
                "GamePlayer.ItemBonusName.Bonus3"); //Constitution
        if (BonusType == 4)
            BonusName = LanguageMgr.GetTranslation(Client.Account.Language,
                "GamePlayer.ItemBonusName.Bonus4"); //Quickness
        if (BonusType == 5)
            BonusName = LanguageMgr.GetTranslation(Client.Account.Language,
                "GamePlayer.ItemBonusName.Bonus5"); //Intelligence
        if (BonusType == 6)
            BonusName = LanguageMgr.GetTranslation(Client.Account.Language,
                "GamePlayer.ItemBonusName.Bonus6"); //Piety
        if (BonusType == 7)
            BonusName = LanguageMgr.GetTranslation(Client.Account.Language,
                "GamePlayer.ItemBonusName.Bonus7"); //Empathy
        if (BonusType == 8)
            BonusName = LanguageMgr.GetTranslation(Client.Account.Language,
                "GamePlayer.ItemBonusName.Bonus8"); //Charisma
        if (BonusType == 9)
            BonusName = LanguageMgr.GetTranslation(Client.Account.Language,
                "GamePlayer.ItemBonusName.Bonus9"); //Power
        if (BonusType == 10)
            BonusName = LanguageMgr.GetTranslation(Client.Account.Language,
                "GamePlayer.ItemBonusName.Bonus10"); //Hits
        if (BonusType == 11)
            BonusName = LanguageMgr.GetTranslation(Client.Account.Language,
                "GamePlayer.ItemBonusName.Bonus11"); //Body
        if (BonusType == 12)
            BonusName = LanguageMgr.GetTranslation(Client.Account.Language,
                "GamePlayer.ItemBonusName.Bonus12"); //Cold
        if (BonusType == 13)
            BonusName = LanguageMgr.GetTranslation(Client.Account.Language,
                "GamePlayer.ItemBonusName.Bonus13"); //Crush
        if (BonusType == 14)
            BonusName = LanguageMgr.GetTranslation(Client.Account.Language,
                "GamePlayer.ItemBonusName.Bonus14"); //Energy
        if (BonusType == 15)
            BonusName = LanguageMgr.GetTranslation(Client.Account.Language,
                "GamePlayer.ItemBonusName.Bonus15"); //Heat
        if (BonusType == 16)
            BonusName = LanguageMgr.GetTranslation(Client.Account.Language,
                "GamePlayer.ItemBonusName.Bonus16"); //Matter
        if (BonusType == 17)
            BonusName = LanguageMgr.GetTranslation(Client.Account.Language,
                "GamePlayer.ItemBonusName.Bonus17"); //Slash
        if (BonusType == 18)
            BonusName = LanguageMgr.GetTranslation(Client.Account.Language,
                "GamePlayer.ItemBonusName.Bonus18"); //Spirit
        if (BonusType == 19)
            BonusName = LanguageMgr.GetTranslation(Client.Account.Language,
                "GamePlayer.ItemBonusName.Bonus19"); //Thrust
        return BonusName;
    }
    ...
    protected virtual void OnItemEquipped(DOLEvent e, object sender, EventArgs arguments)
    {
        ...
        var item = ((ItemEquippedArgs) arguments).Item;
        if (item == null) return;

        if (item is IGameInventoryItem) (item as IGameInventoryItem).OnEquipped(this);
            ...
            if (item.Hand == 1) // 2h
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemEquipped.WieldBothHands", item.GetName(0, false))), eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
            else if (item.SlotPosition == Slot.LEFTHAND)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemEquipped.WieldLeftHand", item.GetName(0, false))), eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
            else
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemEquipped.WieldRightHand", item.GetName(0, false))), eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
        }
        ...
        Out.SendMessage(
            string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemEquipped.Magic",
                item.GetName(0, false))), eChatType.CT_Skill, eChatLoc.CL_SystemWindow);
        ...
        if (item.Bonus1 != 0)
        {
            ...
            if (item.Bonus1Type < 20)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemEquipped.Increased", ItemBonusName(item.Bonus1Type))), eChatType.CT_Skill,
                    eChatLoc.CL_SystemWindow);
        }
        ...
        if (item.Bonus2 != 0)
        {
            ...
            if (item.Bonus2Type < 20)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemEquipped.Increased", ItemBonusName(item.Bonus2Type))), eChatType.CT_Skill,
                    eChatLoc.CL_SystemWindow);
        }
        ...
        if (item.Bonus3 != 0)
        {
            ...
            if (item.Bonus3Type < 20)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemEquipped.Increased", ItemBonusName(item.Bonus3Type))), eChatType.CT_Skill,
                    eChatLoc.CL_SystemWindow);
        }
        ...
        if (item.Bonus4 != 0)
        {
            ...
            if (item.Bonus4Type < 20)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemEquipped.Increased", ItemBonusName(item.Bonus4Type))), eChatType.CT_Skill,
                    eChatLoc.CL_SystemWindow);
        }
        ...
        if (item.Bonus5 != 0)
        {
            ...
            if (item.Bonus5Type < 20)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemEquipped.Increased", ItemBonusName(item.Bonus5Type))), eChatType.CT_Skill,
                    eChatLoc.CL_SystemWindow);
        }
        ...
        if (item.Bonus6 != 0)
        {
            ...
            if (item.Bonus6Type < 20)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemEquipped.Increased", ItemBonusName(item.Bonus6Type))), eChatType.CT_Skill,
                    eChatLoc.CL_SystemWindow);
        }
        ...
        if (item.Bonus7 != 0)
        {
            ...
            if (item.Bonus7Type < 20)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemEquipped.Increased", ItemBonusName(item.Bonus7Type))), eChatType.CT_Skill,
                    eChatLoc.CL_SystemWindow);
        }
        ...
        if (item.Bonus8 != 0)
        {
            ...
            if (item.Bonus8Type < 20)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemEquipped.Increased", ItemBonusName(item.Bonus8Type))), eChatType.CT_Skill,
                    eChatLoc.CL_SystemWindow);
        }
        ...
        if (item.Bonus9 != 0)
        {
            ...
            if (item.Bonus9Type < 20)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemEquipped.Increased", ItemBonusName(item.Bonus9Type))), eChatType.CT_Skill,
                    eChatLoc.CL_SystemWindow);
        }
        ...
        if (item.Bonus10 != 0)
        {
            ...
            if (item.Bonus10Type < 20)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemEquipped.Increased", ItemBonusName(item.Bonus10Type))),
        ...
        if (Client.Account.PrivLevel == (uint) ePrivLevel.Player && Client.Player != null &&
    ...
    {
        get => m_activeBuffCharges;
        set => m_activeBuffCharges = value;
    }
    ...
    protected virtual void OnItemUnequipped(DOLEvent e, object sender, EventArgs arguments)
    {
        ...
        var item = ((ItemUnequippedArgs) arguments).Item;
        var prevSlot = (int) ((ItemUnequippedArgs) arguments).PreviousSlotPosition;
        if (item == null) return;
        ...
        if (item.Item_Type >= Slot.RIGHTHAND && item.Item_Type <= Slot.RANGED)
        {
            if (item.Hand == 1) // 2h
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemUnequipped.BothHandsFree", item.GetName(0, false))), eChatType.CT_Skill,
                    eChatLoc.CL_SystemWindow);
            else if (prevSlot == Slot.LEFTHAND)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemUnequipped.LeftHandFree", item.GetName(0, false))), eChatType.CT_Skill,
                    eChatLoc.CL_SystemWindow);
            else
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemUnequipped.RightHandFree", item.GetName(0, false))), eChatType.CT_Skill,
                    eChatLoc.CL_SystemWindow);
        }

        if (item.Item_Type == Slot.RANGED && (rangeAttackComponent.RangedAttackState == eRangedAttackState.Aim
                                              || rangeAttackComponent.RangedAttackState ==
                                              eRangedAttackState.AimFire ||
                                              rangeAttackComponent.RangedAttackState ==
                                              eRangedAttackState.AimFireReload ||
                                              rangeAttackComponent.RangedAttackState ==
                                              eRangedAttackState.ReadyToFire
            )) attackComponent.attackAction = null;
        ...
        if (item.SpellID > 0 && SelfBuffChargeIDs.Contains(item.SpellID) &&
            Inventory.EquippedItems.Where(x => x.SpellID == item.SpellID).Count() <= 1)
        ...
        if (item.Bonus1 != 0)
        {
            ...
            if (item.Bonus1Type < 20)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemUnequipped.Decreased", ItemBonusName(item.Bonus1Type))),
                    eChatType.CT_Skill, eChatLoc.CL_SystemWindow);
        }
        ...
        if (item.Bonus2 != 0)
        {
            ...
            if (item.Bonus2Type < 20)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemUnequipped.Decreased", ItemBonusName(item.Bonus2Type))),
                    eChatType.CT_Skill, eChatLoc.CL_SystemWindow);
        }
        ...
        if (item.Bonus3 != 0)
        {
            ...
            if (item.Bonus3Type < 20)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemUnequipped.Decreased", ItemBonusName(item.Bonus3Type))),
                    eChatType.CT_Skill, eChatLoc.CL_SystemWindow);
        }
        ...
        if (item.Bonus4 != 0)
        {
            ...
            if (item.Bonus4Type < 20)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemUnequipped.Decreased", ItemBonusName(item.Bonus4Type))),
                    eChatType.CT_Skill, eChatLoc.CL_SystemWindow);
        }
        ...
        if (item.Bonus5 != 0)
        {
            ...
            if (item.Bonus5Type < 20)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemUnequipped.Decreased", ItemBonusName(item.Bonus5Type))),
                    eChatType.CT_Skill, eChatLoc.CL_SystemWindow);
        }
        ...
        if (item.Bonus6 != 0)
        {
            ...
            if (item.Bonus6Type < 20)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemUnequipped.Decreased", ItemBonusName(item.Bonus6Type))),
                    eChatType.CT_Skill, eChatLoc.CL_SystemWindow);
        }
        ...
        if (item.Bonus7 != 0)
        {
            ...
            if (item.Bonus7Type < 20)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemUnequipped.Decreased", ItemBonusName(item.Bonus7Type))),
                    eChatType.CT_Skill, eChatLoc.CL_SystemWindow);
        }
        ...
        if (item.Bonus8 != 0)
        {
            ...
            if (item.Bonus8Type < 20)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemUnequipped.Decreased", ItemBonusName(item.Bonus8Type))),
                    eChatType.CT_Skill, eChatLoc.CL_SystemWindow);
        }
        ...
        if (item.Bonus9 != 0)
        {
            ...
            if (item.Bonus9Type < 20)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemUnequipped.Decreased", ItemBonusName(item.Bonus9Type))),
                    eChatType.CT_Skill, eChatLoc.CL_SystemWindow);
        }
        ...
        if (item.Bonus10 != 0)
        {
            ...
            if (item.Bonus10Type < 20)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OnItemUnequipped.Decreased", ItemBonusName(item.Bonus10Type))),
                    eChatType.CT_Skill, eChatLoc.CL_SystemWindow);
        }
        ...
        if (item is IGameInventoryItem) (item as IGameInventoryItem).OnUnEquipped(this);
    ...
    {
        EffectService.RequestCancelEffect(effectListComponent.GetSpellEffects()
            .FirstOrDefault(x => x.SpellHandler.Spell.ID == spellID));
    }
    ...
    public virtual void RefreshItemBonuses()
    {
        ...
        {
            case 16:
                slotToLoad = "rightandleftHandSlot";
                break;
            case 18:
                slotToLoad = "leftandtwoHandSlot";
                break;
            case 31:
                slotToLoad = "leftHandSlot";
                break;
            case 34:
                slotToLoad = "twoHandSlot";
                break;
            case 51:
                slotToLoad = "distanceSlot";
                break;
            case 240:
                slotToLoad = "righttHandSlot";
                break;
            case 242:
                slotToLoad = "twoHandSlot";
                break;
        ...
        foreach (var item in Inventory.EquippedItems)
        {
            ...
            if (slotToLoad != "")
                ...
                {
                    case Slot.TWOHAND:
                        if (slotToLoad.Contains("twoHandSlot") == false) add = false;

                        break;

                    case Slot.RIGHTHAND:
                        if (slotToLoad.Contains("right") == false) add = false;

                        break;
                    case Slot.SHIELD:
                    case Slot.LEFTHAND:
                        if (slotToLoad.Contains("left") == false) add = false;

                        break;
                    case Slot.RANGED:
                        if (slotToLoad != "distanceSlot") add = false;
            ...
            if (!add) continue;
            if (item is IGameInventoryItem) (item as IGameInventoryItem).CheckValid(this);
    ...
    {
        var changeArgs = args as ItemBonusChangedEventArgs;
    ...
    public override bool ReceiveItem(GameLiving source, InventoryItem item)
    {
        ...
        {
            Out.SendMessage(
                string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ReceiveItem.Receive",
                    item.GetName(0, false))), eChatType.CT_Skill, eChatLoc.CL_SystemWindow);
        }
        else
        {
            if (source is GameNPC)
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.ReceiveItem.ReceiveFrom", item.GetName(0, false),
                        source.GetName(0, false, Client.Account.Language, source as GameNPC))),
                    eChatType.CT_Skill, eChatLoc.CL_SystemWindow);
            else
                Out.SendMessage(
                    string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.ReceiveItem.ReceiveFrom", item.GetName(0, false), source.GetName(0, false))),
                    eChatType.CT_Skill, eChatLoc.CL_SystemWindow);
        }
        ...
        if (sourcePlayer != null)
        {
            var privLevel1 = Client.Account.PrivLevel;
            var privLevel2 = sourcePlayer.Client.Account.PrivLevel;
            if (privLevel1 != privLevel2
                && (privLevel1 > 1 || privLevel2 > 1)
                && (privLevel1 == 1 || privLevel2 == 1))
                GameServer.Instance.LogGMAction("   Item: " + source.Name + "(" + sourcePlayer.Client.Account.Name +
                                                ") -> " + Name + "(" + Client.Account.Name + ") : " + item.Name +
                                                "(" + item.Id_nb + ")");
        }
    ...
    public virtual bool DropItem(eInventorySlot slot_pos, out WorldInventoryItem droppedItem)
    {
        ...
        if (slot_pos >= eInventorySlot.FirstBackpack && slot_pos <= eInventorySlot.LastBackpack)
            lock (Inventory)
            {
                var item = Inventory.GetItem(slot_pos);
                if (!item.IsDropable)
                {
                    Out.SendMessage(item.GetName(0, true) + " can not be dropped!", eChatType.CT_System,
                        eChatLoc.CL_SystemWindow);
                    return false;
                }

                if (!Inventory.RemoveItem(item)) return false;
                InventoryLogging.LogInventoryAction(this, "(ground)", eInventoryActionType.Other, item.Template,
                    item.Count);
    ...
    public virtual WorldInventoryItem CreateItemOnTheGround(InventoryItem item)
    {
        ...
        else
        {
            ...
            var itemloc = GetPointFromHeading(Heading, 30);
    ...
    public virtual void PickupObject(GameObject floorObject, bool checkRange)
    {
        ...
        {
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.MustHaveTarget"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return;
        }
        ...
        if (floorObject is GameStaticItemTimed staticItem && !staticItem.IsOwner(this) &&
            Client.Account.PrivLevel == (uint) ePrivLevel.Player)
        {
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.LootDoesntBelongYou"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return;
        }

        if (floorObject is not GameBoat && !checkRange &&
            !floorObject.IsWithinRadius(this, Properties.WORLD_PICKUP_DISTANCE, true))
        {
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.ObjectTooFarAway",
                    floorObject.Name), eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return;
        }

        if (floorObject is WorldInventoryItem)
        {
            var floorItem = floorObject as WorldInventoryItem;
            lock (floorItem)
            {
                ...
                {
                    Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.CantGetThat"),
                        eChatType.CT_System, eChatLoc.CL_SystemWindow);
                    return;
                }
                ...
                {
                    Out.SendMessage(
                        "You must wait another " + floorItem.GetPickupTime / 1000 + " seconds to pick up " +
                        floorItem.Name + "!", eChatType.CT_System, eChatLoc.CL_SystemWindow);
                    return;
                }
                ...
                if (mybattlegroup != null && mybattlegroup.GetBGLootType() == true &&
                    mybattlegroup.GetBGTreasurer() != null)
                {
                    var theTreasurer = mybattlegroup.GetBGTreasurer();
                    if (theTreasurer.CanSeeObject(floorObject) || CanSeeObject(floorObject))
                    {
                        var good = false;
                        if (floorItem.Item.IsStackable)
                            good = theTreasurer.Inventory.AddTemplate(floorItem.Item, floorItem.Item.Count,
                                eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack);
                        else
                            good = theTreasurer.Inventory.AddItem(eInventorySlot.FirstEmptyBackpack,
                                floorItem.Item);

                        if (!good)
                        {
                            theTreasurer.Out.SendMessage(
                                LanguageMgr.GetTranslation(Client.Account.Language,
                                    "GamePlayer.PickupObject.BackpackFull"), eChatType.CT_System,
                                eChatLoc.CL_SystemWindow);
                            return;
                        }

                        theTreasurer.Out.SendMessage(
                            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.YouGet",
                                floorItem.Item.GetName(1, false)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                        Message.SystemToOthers(this,
                            LanguageMgr.GetTranslation(Client.Account.Language,
                                "GamePlayer.PickupObject.GroupMemberPicksUp", Name,
                                floorItem.Item.GetName(1, false)), eChatType.CT_System);
                        InventoryLogging.LogInventoryAction("(ground)", this, eInventoryActionType.Loot,
                            floorItem.Item.Template, floorItem.Item.IsStackable ? floorItem.Item.Count : 1);
                    }
                    else
                    {
                        mybattlegroup.SendMessageToBattleGroupMembers(
                            LanguageMgr.GetTranslation(Client.Account.Language,
                                "GamePlayer.PickupObject.NoOneWantsThis", floorObject.Name), eChatType.CT_System,
                            eChatLoc.CL_SystemWindow);
                    }
                }
                else if (group != null && group.AutosplitLoot)
                {
                    var owners = new List<GameObject>((GameObject[]) floorItem.Owners);
                    var eligibleMembers = new List<GamePlayer>(8);
                    foreach (var ply in group.GetNearbyPlayersInTheGroup(this))
                        if (ply.IsAlive
                            ...
                            && ply.Inventory.FindFirstEmptySlot(eInventorySlot.FirstBackpack,
                    ...
                    var i = Util.Random(0, eligibleMembers.Count - 1);
                    var eligibleMember = eligibleMembers[i];
                    if (eligibleMember != null)
                    {
                        var good = false;
                        if (floorItem.Item.IsStackable) // poison ID is lost here
                            good = eligibleMember.Inventory.AddTemplate(floorItem.Item, floorItem.Item.Count,
                                eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack);
                        else
                            good = eligibleMember.Inventory.AddItem(eInventorySlot.FirstEmptyBackpack,
                                floorItem.Item);

                        if (!good)
                        {
                            eligibleMember.Out.SendMessage(
                                LanguageMgr.GetTranslation(Client.Account.Language,
                                    "GamePlayer.PickupObject.BackpackFull"), eChatType.CT_System,
                                eChatLoc.CL_SystemWindow);
                            return;
                        ...
                        group.SendMessageToGroupMembers(
                            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.Autosplit",
                                floorItem.Item.GetName(1, true), eligibleMember.Name), eChatType.CT_System,
                            eChatLoc.CL_SystemWindow);
                        InventoryLogging.LogInventoryAction("(ground)", this, eInventoryActionType.Loot,
                            floorItem.Item.Template, floorItem.Item.IsStackable ? floorItem.Item.Count : 1);
                    }
                ...
                else
                {
                    var good = false;
                    if (floorItem.Item.IsStackable)
                        good = Inventory.AddTemplate(GameInventoryItem.Create(floorItem.Item), floorItem.Item.Count,
                            eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack);
                    else
                    ...
                    Message.SystemToOthers(this,
                        LanguageMgr.GetTranslation(Client.Account.Language,
                            "GamePlayer.PickupObject.GroupMemberPicksUp", Name, floorItem.Item.GetName(1, false)),
                        eChatType.CT_System);
                    InventoryLogging.LogInventoryAction("(ground)", this, eInventoryActionType.Loot,
                        floorItem.Item.Template, floorItem.Item.IsStackable ? floorItem.Item.Count : 1);
                }
        ...
        {
            var moneyObject = floorObject as GameMoney;
            lock (moneyObject)
            {
                ...
                if (Group != null && Group.AutosplitCoins)
                {
                    ...
                    if (!gamePlayers.Any())
                    {
                        Out.SendMessage(
                            LanguageMgr.GetTranslation(Client.Account.Language,
                                "GamePlayer.PickupObject.NoOneGroupWantsMoney"), eChatType.CT_System,
                            eChatLoc.CL_SystemWindow);
                        return;
                    }

                    var moneyToPlayer = moneyObject.TotalCopper / gamePlayers.Count();
                    foreach (var eligibleMember in gamePlayers)
                        if (eligibleMember.Guild != null && eligibleMember.Guild.IsGuildDuesOn())
                        {
                            var moneyToGuild = moneyToPlayer * eligibleMember.Guild.GetGuildDuesPercent() / 100;
                            if (eligibleMember.Guild.GetGuildDuesPercent() != 100)
                                eligibleMember.AddMoney(moneyToPlayer,
                                    LanguageMgr.GetTranslation(Client.Account.Language,
                                        "GamePlayer.PickupObject.YourLootShare", Money.GetString(moneyToPlayer)));
                            else
                                eligibleMember.AddMoney(moneyToPlayer);

                            InventoryLogging.LogInventoryAction("(ground)", eligibleMember,
                                eInventoryActionType.Loot, moneyToPlayer);
                ...
                else
                {
                    ...
                    if (Guild != null && Guild.IsGuildDuesOn() && moneyObject.TotalCopper > 0 &&
                        Guild.GetGuildDuesPercent() > 0)
                    {
                        var moneyToGuild = moneyObject.TotalCopper * Guild.GetGuildDuesPercent() / 100;
                        if (Guild.GetGuildDuesPercent() != 100)
                            AddMoney(moneyObject.TotalCopper,
                                LanguageMgr.GetTranslation(Client.Account.Language,
                                    "GamePlayer.PickupObject.YouPickUp", Money.GetString(moneyObject.TotalCopper)));
                        else
                            AddMoney(moneyObject.TotalCopper);

                        InventoryLogging.LogInventoryAction("(ground)", this, eInventoryActionType.Loot,
                            moneyObject.TotalCopper);
                        Guild.SetGuildBank(this, moneyToGuild);
                    }
                    else
                    {
                        AddMoney(moneyObject.TotalCopper,
                            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.YouPickUp",
                                Money.GetString(moneyObject.TotalCopper)));
                        InventoryLogging.LogInventoryAction("(ground)", this, eInventoryActionType.Loot,
                            moneyObject.TotalCopper);
                    }
                }
        ...
        if (floorObject is GameBoat)
        {
            ...
            {
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.TooFarFromBoat"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
                return;
            }
        ...
        {
            var houseVault = floorObject as GameHouseVault;
            if (houseVault.Detach(this))
            {
                var template = GameServer.Database.FindObjectByKey<ItemTemplate>(houseVault.TemplateID);
                Inventory.AddItem(eInventorySlot.FirstEmptyBackpack, GameInventoryItem.Create(template));
                InventoryLogging.LogInventoryAction("(HOUSE;" + floorObject.CurrentHouse.HouseNumber + ")", this,
                    eInventoryActionType.Other, template);
            }
        ...
        Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.CantGetThat"),
            eChatType.CT_System, eChatLoc.CL_SystemWindow);
        return;
    }
    ...
    public long PlayedTime
    {
        get
        {
            ...
            var oldLast = LastPlayed;
            // Get the total amount of time played between now and lastplayed
            // This is safe as lastPlayed is updated on char load.
            var playaPlayed = rightNow.Subtract(oldLast);
            var newPlayed = playaPlayed + TimeSpan.FromSeconds(DBCharacter.PlayedTime);
    ...
    public long PlayedTimeSinceLevel
    {
        get
        {
            ...
            // This is safe as lastPlayed is updated on char load.
            var playaPlayed = rightNow.Subtract(oldLast);
            var newPlayed = playaPlayed + TimeSpan.FromSeconds(DBCharacter.PlayedTimeSinceLevel);
            return (long) newPlayed.TotalSeconds;
        }
    }
    ...
    protected virtual void SaveSkillsToCharacter()
    {
        ...
        foreach (var ability in m_usableSkills.Where(e => e.Item1 is Ability).Select(e => e.Item1)
                     .Cast<Ability>())
            if (ability != null)
            {
        ...
        var disabledSpells = new StringBuilder();
        var disabledAbilities = new StringBuilder();

        var disabledSkills = GetAllDisabledSkills();

        foreach (var skill in disabledSkills)
        {
            var duration = GetSkillDisabledDuration(skill);
        ...
        var sra = new StringBuilder();

        foreach (var rab in m_realmAbilities)
        {
            if (sra.Length > 0)
                sra.Append(";");
    ...
    {
        var character = DBCharacter; // if its derived and filled with some code
        ...
        var tmpStr = character.SerializedSpecs;
        if (tmpStr != null && tmpStr.Length > 0)
            foreach (var spec in Util.SplitCSV(tmpStr))
            {
                var values = spec.Split('|');
                if (values.Length >= 2)
                {
                    var tempSpec = SkillBase.GetSpecialization(values[0], false);
        ...
        if (tmpStr != null && tmpStr.Length > 0 && m_usableSkills.Count == 0)
            foreach (var abilities in Util.SplitCSV(tmpStr))
            {
                var values = abilities.Split('|');
                if (values.Length >= 2)
                {
                    int level;
                    if (int.TryParse(values[1], out level))
                    {
                        var ability = SkillBase.GetAbility(values[0], level);
                        if (ability != null)
        ...
        if (tmpStr != null && tmpStr.Length > 0)
            foreach (var str in Util.SplitCSV(tmpStr))
            {
                var values = str.Split('|');
                if (values.Length >= 2)
                {
                    var keyname = values[0];
                    int duration;
        ...
        if (!string.IsNullOrEmpty(tmpStr))
            foreach (var str in Util.SplitCSV(tmpStr))
            {
                ...
                int spellid;
                int duration;
                if (values.Length >= 2 && int.TryParse(values[0], out spellid) &&
                    int.TryParse(values[1], out duration))
                {
                    var sp = SkillBase.GetSpellByID(spellid);
                    // disable
                    if (sp != null)
    ...
    public virtual void LoadClassSpecializations(bool sendMessages)
    {
        ...
        var careers = SkillBase.GetSpecializationCareer(CharacterClass.ID);
        ...
        foreach (var constraint in careers)
        {
            if (constraint.Key is IMasterLevelsSpecialization)
            {
                ...
                if (!MLGranted || MLLevel < 1) continue;
            }
    ...
    public virtual int VerifySpecPoints()
    {
        ...
        var usedpoints = 0;
        foreach (var spec in GetSpecList().Where(e => e.Trainable))
        {
        ...
        if (allpoints < 0)
            if (Client.Account.PrivLevel == 1)
            {
                log.WarnFormat("Spec points total for player {0} incorrect: {1} instead of {2}.", Name, usedpoints,
                    allpoints + usedpoints);
                RespecAllLines();
    ...
    public override void LoadFromDatabase(DataObject obj)
    {
        ...
        var realmLoyaltyList =
            DOLDB<AccountXRealmLoyalty>.SelectObjects(
                DB.Column("AccountID").IsEqualTo(Client.Account.ObjectId)) as List<AccountXRealmLoyalty>;
        var lastRealmLoyaltyUpdateTime = DateTime.UnixEpoch;
        var loyaltyDays = 0;
        ...
        else
        {
            ...
            foreach (var rloy in realmLoyaltyList)
            {
                ...
                if (rloy.Realm == (int) Realm)
                    loyaltyDays = rloy.LoyalDays;
            }
        }

        //set that date as our temp property for reference on kill
        TempProperties.setProperty(REALM_LOYALTY_KEY, lastRealmLoyaltyUpdateTime);
        TempProperties.setProperty(CURRENT_LOYALTY_KEY, loyaltyDays);

        var MoneyForRealm = DOLDB<AccountXMoney>.SelectObject(DB.Column("AccountID")
            .IsEqualTo(Client.Account.ObjectId).And(DB.Column("Realm").IsEqualTo(Realm)));
        ...
        if (MoneyForRealm == null)
        {
            ...
            var newMoney = new AccountXMoney();
            newMoney.AccountId = Client.Account.ObjectId;
            newMoney.Realm = (int) Realm;

            foreach (var character in Client.Account.Characters) // cycling through their toons
                if ((eRealm) character.Realm == Realm) // account money is realm bound
                {
        ...
        if (m_guild != null)
        {
            foreach (var rank in m_guild.Ranks)
            {
        ...
        {
            log.WarnFormat(
                "Invalid region/zone on char load ({0}): x={1} y={2} z={3} reg={4}; moving to bind point.",
                DBCharacter.Name, X, Y, Z, DBCharacter.Region);
        ...
        if (DBCharacter.PlayedTime <
            1) //added to make character start with 100% Health and Mana/Endurance when DB Start Lvl >1 :Loki
        {
            Health = MaxHealth;
            Mana = MaxMana;
            Endurance = MaxEndurance;
        ...
        else
        {
            ...
            Endurance = DBCharacter
                .Endurance; // has to be set after max, same applies to other values with max properties
        }
        ...
        var mlsteps =
            DOLDB<DBCharacterXMasterLevel>.SelectObjects(DB.Column("Character_ID").IsEqualTo(QuestPlayerID));
        if (mlsteps.Count > 0)
            foreach (var mlstep in mlsteps)
        ...
        var t = PlayerTitleMgr.GetTitleByTypeName(DBCharacter.CurrentTitleType);
        if (t == null)
    ...
    public override void SaveIntoDatabase()
    {
        try
        {
            ...
            {
                var playerDeck = new DOLCharactersXDeck();
                playerDeck.DOLCharactersObjectId = ObjectId;
            ...
            if (realmLoyalty == null)
            {
                ...
                realmLoyalty.AccountId = Client.Account.ObjectId;
                realmLoyalty.Realm = (int) Realm;
            ...
            {
                realmLoyalty.LastLoyaltyUpdate = TempProperties.getProperty<DateTime>(REALM_LOYALTY_KEY);
                GameServer.Database.SaveObject(realmLoyalty);
            }
            ...
            //SaveCraftingSkills();
            DBCharacter.PlayedTime =
                PlayedTime; //We have to set the PlayedTime on the character before setting the LastPlayed
            DBCharacter.PlayedTimeSinceLevel = PlayedTimeSinceLevel;
            DBCharacter.LastLevelUp = DateTime.Now;
            DBCharacter.LastPlayed = DateTime.Now;

            DBCharacter.ActiveWeaponSlot =
                (byte) ((byte) ActiveWeaponSlot | (byte) rangeAttackComponent.ActiveQuiverSlot);
            if (m_stuckFlag)
                lock (m_lastUniqueLocations)
                {
                    var loc = m_lastUniqueLocations[m_lastUniqueLocations.Length - 1];
            ...
            foreach (var accountChar in Client.Account.Characters)
            ...
            if (cachedCharacter != null) cachedCharacter = DBCharacter;
            ...
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.SaveIntoDatabase.CharacterSaved"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
        }
        catch (Exception e)
        {
            ...
            switch (form)
            {
                default:
                    return Capitalize(capitalize,
                        LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Pronoun.Male.Subjective"));
                case 1:
                    return Capitalize(capitalize,
                        LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Pronoun.Male.Possessive"));
                case 2:
                    return Capitalize(capitalize,
                        LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Pronoun.Male.Objective"));
            }
        else
            switch (form)
            {
                default:
                    return Capitalize(capitalize,
                        LanguageMgr.GetTranslation(Client.Account.Language,
                            "GamePlayer.Pronoun.Female.Subjective"));
                case 1:
                    return Capitalize(capitalize,
                        LanguageMgr.GetTranslation(Client.Account.Language,
                            "GamePlayer.Pronoun.Female.Possessive"));
                case 2:
                    return Capitalize(capitalize,
                        LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Pronoun.Female.Objective"));
            }
    }
        ...
        switch (GameServer.Instance.Configuration.ServerType)
        {
            ...
            case eGameServerType.GST_Normal:
            {
                if (Realm == player.Realm || Client.Account.PrivLevel > 1 || player.Client.Account.PrivLevel > 1)
                    message = LanguageMgr.GetTranslation(player.Client.Account.Language,
                        "GamePlayer.GetExamineMessages.RealmMember", player.GetName(this),
                        GetPronoun(Client, 0, true), CharacterClass.Name);
                else
                    message = LanguageMgr.GetTranslation(player.Client.Account.Language,
                        "GamePlayer.GetExamineMessages.EnemyRealmMember", player.GetName(this),
                        GetPronoun(Client, 0, true));
                break;
            }
            ...
            case eGameServerType.GST_PvP:
            {
                if (Client.Account.PrivLevel > 1 || player.Client.Account.PrivLevel > 1)
                    message = LanguageMgr.GetTranslation(player.Client.Account.Language,
                        "GamePlayer.GetExamineMessages.YourGuildMember", player.GetName(this),
                        GetPronoun(Client, 0, true), CharacterClass.Name);
                else if (Guild == null)
                    message = LanguageMgr.GetTranslation(player.Client.Account.Language,
                        "GamePlayer.GetExamineMessages.NeutralMember", player.GetName(this),
                        GetPronoun(Client, 0, true));
                else if (Guild == player.Guild || Client.Account.PrivLevel > 1 ||
                    ...
                    message = LanguageMgr.GetTranslation(player.Client.Account.Language,
                        "GamePlayer.GetExamineMessages.OtherGuildMember", player.GetName(this),
                        GetPronoun(Client, 0, true), GuildName);
                break;
            }
            ...
            {
                message = LanguageMgr.GetTranslation(player.Client.Account.Language,
                    "GamePlayer.GetExamineMessages.YouExamine", player.GetName(this));
                break;
            }
        }
    ...
    public bool IsWireframe
    {
        ...
        set
        {
            var needUpdate = m_isWireframe != value;
            m_isWireframe = value;
    ...
    {
        var atkArgs = args as AttackedByEnemyEventArgs;
    ...
    public virtual void Stealth(bool goStealth)
    {
        ...
        {
            Out.SendMessage("You currently have an active, pulsing spell effect and cannot hide!",
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return;
        }
        ...
        else
        {
            if (effectListComponent.ContainsEffectForEffectType(eEffect.Stealth))
                EffectService.RequestImmediateCancelEffect(
                    EffectListService.GetEffectOnTarget(this, eEffect.Stealth), false);

            if (effectListComponent.ContainsEffectForEffectType(eEffect.Vanish))
                EffectService.RequestImmediateCancelEffect(
                    EffectListService.GetEffectOnTarget(this, eEffect.Vanish));
        }
    }
    ...
    {
        var action =
            (UncoverStealthAction) TempProperties.getProperty<object>(UNCOVER_STEALTH_ACTION_PROP, null);
    ...
    protected class UncoverStealthAction : RegionECSAction
    {
        ...
        protected override int OnTick(ECSGameTimer timer)
        {
            ...
            foreach (GameNPC npc in player.GetNPCsInRadius(1024))
            {
                ...
                var npcLevel = Math.Max(npc.Level, 1.0);
                double stealthLevel = player.GetModifiedSpecLevel(Specs.Stealth);
                var detectRadius = 125.0 + (npcLevel - stealthLevel) * 20.0;

                // we have detect hidden and enemy don't = higher range
                if (npc.HasAbility(Abilities.DetectHidden) &&
                    EffectListService.GetAbilityEffectOnTarget(player, eEffect.Camouflage) == null)
                    detectRadius += 125;
                ...
                var fieldOfView = 90.0; //90 degrees  = standard FOV
                var fieldOfListen = 120.0; //120 degrees = standard field of listening
                ...
                //player in front
                fieldOfView /= 2.0;
                var canSeePlayer = angle >= 360 - fieldOfView || angle < fieldOfView;
                ...
                var chanceToUncover = 0.1 + (npc.Level - stealthLevel) * 0.01 * chanceMod;
    ...
    {
        var target = CurrentRegion.GetObject(targetOID);
    ...
    public virtual bool CanDetect(GamePlayer enemy)
    {
        ...
        var EnemyStealthLevel = enemy.GetModifiedSpecLevel(Specs.Stealth);
        if (EnemyStealthLevel > 50)
            EnemyStealthLevel = 50;
        var levelDiff = Level - EnemyStealthLevel;
        if (levelDiff < 0) levelDiff = 0;

        var range = 0;
        var enemyHasCamouflage = EffectListService.GetAbilityEffectOnTarget(enemy, eEffect.Camouflage) != null;
        var enemyHasVanish = EffectListService.GetAbilityEffectOnTarget(enemy, eEffect.Vanish) != null;
        ...
        if (ConquestService.ConquestManager.IsPlayerNearFlag(this)) range += 50;
        ...
        */
        ...
        else if (enemy.Group != null && Group != null && enemy.Group == Group) range = 2500;
    ...
    /// </summary>
    private AbstractTask m_task = null;
    ...
    /// </summary>
    public virtual string QuestPlayerID => InternalID;
    ...
    public virtual void LoadQuests()
    {
        ...
        foreach (var dbquest in quests)
        {
            var quest = AbstractQuest.LoadFromDatabase(this, dbquest);
            if (quest != null)
            {
                if (quest.Step < 0)
        ...
        var dataQuests =
            DOLDB<CharacterXDataQuest>.SelectObjects(DB.Column("Character_ID").IsEqualTo(QuestPlayerID));
        foreach (var quest in dataQuests)
        {
            var dbDataQuest = GameServer.Database.FindObjectByKey<DBDataQuest>(quest.DataQuestID);
            if (dbDataQuest != null && dbDataQuest.StartType != (byte) DataQuest.eStartType.Collection)
            {
                var dataQuest = new DataQuest(this, dbDataQuest, quest);

                if (quest.Step > 0)
                    m_questList.Add((AbstractQuest) dataQuest);
                else if (quest.Count > 0) m_questListFinished.Add((AbstractQuest) dataQuest);
            }
        }
    }
    ...
    /// </summary>
    public virtual List<AbstractQuest> QuestList => m_questList;

    /// <summary>
    /// Gets the finished quests of this player
    /// </summary>
    public virtual List<AbstractQuest> QuestListFinished => m_questListFinished;
    ...
    public bool RemoveEncounterCredit(Type questType)
    {
        ...
        {
            foreach (var q in m_questListFinished)
    ...
    public object CraftingLock = new();

    /// <summary>
    /// Store all player crafting skill and their value (eCraftingSkill => Value)
    /// </summary>
    protected Dictionary<eCraftingSkill, int> m_craftingSkills = new();
    ...
    /// </summary>
    public Dictionary<eCraftingSkill, int> CraftingSkills => m_craftingSkills;
    ...
    public virtual bool GainCraftingSkill(eCraftingSkill skill, int count)
    {
        ...
        lock (CraftingLock)
        {
            var craftingSkill = CraftingMgr.getSkillbyEnum(skill);
            if (craftingSkill != null && count > 0)
            {
                ...
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.GainCraftingSkill.GainSkill",
                        craftingSkill.Name, m_craftingSkills[skill]), eChatType.CT_Important,
                    eChatLoc.CL_SystemWindow);
                var currentSkillLevel = GetCraftingSkillValue(skill);
                if (HasPlayerReachedNewCraftingTitle(currentSkillLevel))
                    GameEventMgr.Notify(GamePlayerEvent.NextCraftingTierReached, this,
                        new NextCraftingTierReachedEventArgs(skill, currentSkillLevel));

                if (CanGenerateNews && currentSkillLevel >= 1000 && currentSkillLevel - count < 1000)
                {
                    var message = string.Format(LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.GainCraftingSkill.ReachedSkill", Name, craftingSkill.Name));
    ...
    {
        get => m_canGenerateNews && GameServer.ServerRules.CanGenerateNews(this);
    ...
    public virtual double CraftingSpeed
    {
        get
        {
            var speed = Properties.CRAFTING_SPEED;
            var craftSpeedBonus = false;
            ushort[]
                keepIDs =
                {
                    50, 75, 100, 57, 111, 198
                }; // beno bled crauch and the strength relic keeps in each realm
            ...
            else if (CurrentZone.IsOF && m_currentAreas.Count > 0)
            {
                ...
                if (craftSpeedBonus) speed = speed * Properties.KEEP_CRAFTING_SPEED_BONUS;
            }
    ...
    public virtual int CraftingSkillBonus
    {
        get
        {
            if (CurrentRegion.IsCapitalCity) return Properties.CAPITAL_CITY_CRAFTING_SKILL_GAIN_BONUS;
        ...
        lock (CraftingLock)
        {
            if (m_craftingSkills.ContainsKey(skill))
            {
                ...
                if (craftingSkill != null)
                {
                    ...
                    CraftingProgressMgr.TrackChange(this, m_craftingSkills);
                    Out.SendMessage("You gain skill in " + craftingSkill.Name + "! (" + startValue + ").",
                        eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                    return true;
                }
            }
    ...
    /// </summary>
    public bool IsSalvagingOrRepairing => m_crafttimer != null && m_crafttimer.IsAlive;
    ...
    protected void LoadCraftingSkills()
    {
        ...
        var CraftingForRealm = DOLDB<AccountXCrafting>.SelectObject(DB.Column("AccountID")
            .IsEqualTo(AccountName).And(DB.Column("Realm").IsEqualTo(Realm)));

        if (CraftingForRealm == null)
        {
            var newCrafting = new AccountXCrafting();
            newCrafting.AccountId = AccountName;
            newCrafting.Realm = (int) Realm;
        ...
        try
        {
            ...
            lock (CraftingLock)
            {
                foreach (var skill in Util.SplitCSV(CraftingForRealm.SerializedCraftingSkills))
                {
                    var values = skill.Split('|');
                        ...
                        if (!m_craftingSkills.ContainsKey((eCraftingSkill) i))
                        {
                            if (IsCraftingSkillDefined(Convert.ToInt32(values[0])))
                            {
                                if (Properties.CRAFTING_MAX_SKILLS)
                                    m_craftingSkills.Add((eCraftingSkill) Convert.ToInt32(values[0]),
                                        Properties.CRAFTING_MAX_SKILLS_AMOUNT);
                                else
        ...
        catch (Exception e)
        {
            if (log.IsErrorEnabled)
                log.Error(
                    Name + ": error in loading playerCraftingSkills => " + DBCharacter.SerializedCraftingSkills, e);
        }
    }
    ...
    public virtual void CraftItem(ushort itemID)
    {
        ...
        var skill = CraftingMgr.getSkillbyEnum(recipe.RequiredCraftingSkill);
        if (skill != null)
            skill.CraftItem(this, recipe);
        else
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CraftItem.DontHaveAbilityMake"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
    }
    ...
    public bool OpenTrade(GamePlayer tradePartner)
    {
        lock (m_LockObject)
        {
            lock (tradePartner)
            {
                ...
                var sync = new object();
                var initiantWindow = new PlayerTradeWindow(tradePartner, false, sync);
                var recipientWindow = new PlayerTradeWindow(this, true, sync);
    ...
    public bool OpenSelfCraft(InventoryItem item)
    {
        ...
        lock (m_LockObject)
        {
            if (TradeWindow != null)
            {
                var sourceTradePartner = TradeWindow.Partner;
                if (sourceTradePartner == null)
                    Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language,
                            "GamePlayer.OpenSelfCraft.AlreadySelfCrafting"), eChatType.CT_System,
                        eChatLoc.CL_SystemWindow);
                else
                    Out.SendMessage("You are still trading with " + sourceTradePartner.Name + ".",
                        eChatType.CT_System, eChatLoc.CL_SystemWindow);
                ...
                item.SlotPosition > (int) eInventorySlot.LastBackpack)
            {
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language,
                        "GamePlayer.OpenSelfCraft.CanOnlyCraftBackpack"), eChatType.CT_System,
                    eChatLoc.CL_SystemWindow);
                return false;
            }
    ...
    public virtual void CommandNpcAttack()
    {
        ...
        {
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CommandNpcAttack.IsConfused",
                    npc.Body.Name), eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return;
        }
        ...
        {
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CommandNpcAttack.TooFarAwayForPet"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            return;
        }
        ...
        if (!TargetInView)
        {
            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.CantSeeTarget"),
                eChatType.CT_SpellResisted, eChatLoc.CL_SystemWindow);
            return;
        }

        Out.SendMessage(
            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CommandNpcAttack.KillTarget",
                npc.Body.GetName(0, false)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
    ...
    public virtual void CommandNpcFollow()
    {
        ...
        Out.SendMessage(
            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CommandNpcAttack.FollowYou",
                npc.Body.GetName(0, false)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
        npc.Disengage();
        npc.Follow(this);
    }
    ...
    public virtual void CommandNpcStay()
    {
        ...
        Out.SendMessage(
            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CommandNpcAttack.Stay",
                npc.Body.GetName(0, false)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
        npc.Disengage();
        npc.Stay();
    }
    ...
    public virtual void CommandNpcComeHere()
    {
        ...
        Out.SendMessage(
            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CommandNpcAttack.ComeHere",
                npc.Body.GetName(0, false)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
        npc.Disengage();
        npc.ComeHere();
    }
    ...
    public virtual void CommandNpcGoTarget()
    {
        ...
        if (target == null)
        {
            Out.SendMessage(
                LanguageMgr.GetTranslation(Client.Account.Language,
                    "GamePlayer.CommandNpcGoTarget.MustSelectDestination"), eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
            return;
        }
        ...
        {
            Out.SendMessage("Your target is too far away for your pet to reach!", eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
            return;
        }

        Out.SendMessage(
            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CommandNpcAttack.GoToTarget",
                npc.Body.GetName(0, false)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
        npc.Disengage();
        npc.Goto(target);
    }
    ...
    public virtual void CommandNpcPassive()
    {
        ...
        Out.SendMessage(
            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CommandNpcAttack.Passive",
                npc.Body.GetName(0, false)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
    ...
    public virtual void CommandNpcAgressive()
    {
        ...
        Out.SendMessage(
            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CommandNpcAttack.Aggressive",
                npc.Body.GetName(0, false)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
    ...
    public virtual void CommandNpcDefensive()
    {
        ...
        Out.SendMessage(
            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CommandNpcAttack.Denfensive",
                npc.Body.GetName(0, false)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
    ...
    public bool IsShade
    {
        get
        {
            var shadeModel = Model == ShadeModel;
    ...
    /// </summary>
    public ushort CreationModel => (ushort) m_client.Account.Characters[m_client.ActiveCharIndex].CreationModel;
    ...
    {
        if (siegeWeapon.Realm != Realm)
        {
            Out.SendMessage("You cannot salvage another realm's siege weapon!", eChatType.CT_Say,
                eChatLoc.CL_SystemWindow);
            return;
        }
    ...
    public virtual bool StartInvulnerabilityTimer(int duration, InvulnerabilityExpiredCallback callback)
    {
        ...
        var newTick = CurrentRegion.Time + duration;
    ...
    /// </summary>
    public virtual bool IsInvulnerableToAttack => m_invulnerabilityTick > CurrentRegion.Time;
    ...
    /// </summary>
    protected readonly ReaderWriterHashSet<IPlayerTitle> m_titles = new();
    ...
    /// </summary>
    public virtual ISet<IPlayerTitle> Titles => m_titles;
    ...
    public void Achieve(string achievementName, int count = 1)
    {
        ...
        var achievement = DOLDB<Achievement>.SelectObject(DB.Column("AccountID")
            .IsEqualTo(Client.Account.ObjectId).And(DB.Column("Realm").IsEqualTo((int) Realm))
    ...
    public virtual int DeathsPvP
    {
        ...
        set
        {
            if (DBCharacter != null) DBCharacter.DeathsPvP = value;
        }
    }
    ...
    public bool IsSummoningMount => m_whistleMountTimer != null && m_whistleMountTimer.IsAlive;
    ...
    public virtual bool IsOnHorse
    {
        ...
        set
        {
            ...
            if (m_isOnHorse)
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.IsOnHorse.MountSteed"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
            else
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.IsOnHorse.DismountSteed"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
            Out.SendUpdateMaxSpeed();
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.ActiveSaddleBags : (byte) 0;
        set
        {
            if (DBCharacter != null) DBCharacter.ActiveSaddleBags = value;
        }
    }

    public ControlledHorse ActiveHorse => m_controlledHorse;
    ...
    public class ControlledHorse
    {
        ...
        public byte ID
        {
            ...
            {
                m_id = value;
                var item = m_player.Inventory.GetItem(eInventorySlot.Horse);
                if (item != null)
                    m_level = item.Level;
                else
        ...
        public byte Barding
        {
            get
            {
                var barding = m_player.Inventory.GetItem(eInventorySlot.HorseBarding);
                if (barding != null)
        ...
        public byte Saddle
        {
            get
            {
                var armor = m_player.Inventory.GetItem(eInventorySlot.HorseArmor);
                if (armor != null)
        ...
        public byte Slots => m_player.ActiveSaddleBags;

        public byte Armor => m_armor;
        ...
        public short Speed
        {
            ...
            {
                if (m_level <= 35)
                    return Properties.MOUNT_UNDER_LEVEL_35_SPEED;
                else
                    return Properties.MOUNT_OVER_LEVEL_35_SPEED;
            }
        }
        ...
        public bool IsCombatHorse => false;
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.Champion : false;
        set
        {
            if (DBCharacter != null) DBCharacter.Champion = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.ChampionLevel : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.ChampionLevel = value;
        }
    }
    ...
    /// </summary>
    public virtual int ChampionMaxLevel => CL_MAX_LEVEL;
    ...
    {
        get => DBCharacter != null ? DBCharacter.ChampionExperience : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.ChampionExperience = value;
        }
    }
    ...
    public virtual ushort ChampionLevelPermill
    {
        get
        {
            ...
            if (ChampionExperienceForNextLevel - ChampionExperienceForCurrentLevel > 0)
                return (ushort) (1000 * (ChampionExperience - ChampionExperienceForCurrentLevel) /
                                 (ChampionExperienceForNextLevel - ChampionExperienceForCurrentLevel));
            else return 0;
        }
    }
    ...
    /// Returns the xp that are needed for the next level
    /// </summary>
    public virtual long ChampionExperienceForNextLevel => GetChampionExperienceForLevel(ChampionLevel + 1);

    /// <summary>
    /// Returns the xp that were needed for the current level
    /// </summary>
    public virtual long ChampionExperienceForCurrentLevel => GetChampionExperienceForLevel(ChampionLevel);
    ...
    {
        get => DBCharacter != null ? DBCharacter.RespecAmountChampionSkill : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.RespecAmountChampionSkill = value;
        }
    }
    ...
    public virtual long GetChampionExperienceForLevel(int level)
    {
        if (level > CL_MAX_LEVEL)
            return CLXPLevel[CL_MAX_LEVEL]; // exp for level 51, needed to get exp after 50
        if (level <= 0)
            return CLXPLevel[0];
    ...
    public virtual void GainChampionExperience(long experience, eXPSource source)
    {
        ...
        {
            var modifier = Properties.CL_XP_RATE;
        ...
        var format = System.Globalization.NumberFormatInfo.InvariantInfo;
        Out.SendMessage("You get " + experience.ToString("N0", format) + " champion experience points.",
            eChatType.CT_Important, eChatLoc.CL_SystemWindow);
    ...
    {
        foreach (var spec in GetSpecList().Where(sp => sp is LiveChampionsLineSpec)) RemoveSpecialization(spec.KeyName);
    ...
    public virtual void ChampionLevelUp()
    {
        ...
        if (ChampionLevel == 1 && CharacterClass.ClassType == eClassType.PureTank) Mana = CalculateMaxMana(Level, 0);
    ...
    {
        get => DBCharacter != null ? DBCharacter.MLGranted : false;
        set
        {
            if (DBCharacter != null) DBCharacter.MLGranted = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.ML : (byte) 0;
        set
        {
            if (DBCharacter != null) DBCharacter.ML = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.MLLevel : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.MLLevel = value;
        }
    }
    ...
    {
        get => DBCharacter != null ? DBCharacter.MLExperience : 0;
        set
        {
            if (DBCharacter != null) DBCharacter.MLExperience = value;
        }
    }
    ...
    public virtual void SetFinishedMLStep(int mlLevel, int step, bool setFinished = true)
    {
        ...
        {
            // Register new step
            var newStep = new DBCharacterXMasterLevel();
    ...
    public virtual long GetMLExperienceForLevel(int level)
    {
        if (level >= ML_MAX_LEVEL)
            return MLXPLevel[ML_MAX_LEVEL - 1]; // exp for level 9, needed to get exp after 9
        if (level <= 0)
            return MLXPLevel[0];
    ...
    public virtual string GetMLStepDescription(byte ml, int step)
    {
        ...
        if (HasFinishedMLStep(ml, step))
            description = LanguageMgr.GetTranslation(Client.Account.Language,
                string.Format("SendMasterLevelWindow.Complete.ML{0}.Step{1}", ml, step));
        else
            description = LanguageMgr.GetTranslation(Client.Account.Language,
                string.Format("SendMasterLevelWindow.Uncomplete.ML{0}.Step{1}", ml, step));
    ...
    public static GamePlayer CreateTestableGamePlayer()
    {
        return CreateTestableGamePlayer(new DefaultCharacterClass());
    }

    public static GamePlayer CreateTestableGamePlayer(ICharacterClass charClass)
    {
        return new GamePlayer(charClass);
    }
        ...
        : base()
    {
        ...
        CreateInventory();
        GameEventMgr.AddHandler(m_inventory, PlayerInventoryEvent.ItemEquipped,
            new DOLEventHandler(OnItemEquipped));
        GameEventMgr.AddHandler(m_inventory, PlayerInventoryEvent.ItemUnequipped,
            new DOLEventHandler(OnItemUnequipped));
        GameEventMgr.AddHandler(m_inventory, PlayerInventoryEvent.ItemBonusChanged,
            new DOLEventHandler(OnItemBonusChanged));
    ...
    public virtual bool DelveItem<T>(T item, List<string> delveInfo)
    {
        ...
        {
            var tempItem = GameInventoryItem.Create(item as InventoryItem);
            tempItem.Delve(delveInfo, this);
        }
        else if (item is ItemTemplate)
        {
            var tempItem = GameInventoryItem.Create(item as ItemTemplate);
            tempItem.Delve(delveInfo, this);
        }
        else
        {
    ...
    public virtual double GetEvadeChance()
    {
        ...
        var evade =
            EffectListService.GetEffectOnTarget(this, eEffect.SavageBuff, eSpellType.SavageEvadeBuff);
        ...
        {
            var res = GetModified(eProperty.EvadeChance);
            if (res > 0)
                evadeChance = res;
        }
    ...
    public virtual double GetBlockChance()
    {
        ...
        if (HasAbility(Abilities.Shield))
        {
            ...
            if (lefthand != null && (ActiveWeapon == null || ActiveWeapon.Item_Type == Slot.RIGHTHAND ||
                                     ActiveWeapon.Item_Type == Slot.LEFTHAND))
    ...
    public virtual double GetParryChance()
    {
        ...
        var parry =
            EffectListService.GetEffectOnTarget(this, eEffect.SavageBuff, eSpellType.SavageParryBuff);
    ...
    private bool IsStandingStill
    {
        get
        {
            ...
            var lastMovementTick = TempProperties.getProperty<long>("PLAYERPOSITION_LASTMOVEMENTTICK");
    ...
    public GamePlayer Bodyguard
    {
        get
        {
            ...
            var bodyguardEffect = bodyguardEffects.FirstOrDefault();
            if (bodyguardEffect == null || bodyguardEffect.GuardTarget != this)
                return null;

            var guard = bodyguardEffect.GuardSource;
            var guardee = this;

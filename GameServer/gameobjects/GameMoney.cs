...
public class GameMoney : GameStaticItemTimed
{
    ...
    /// </summary>
    protected static readonly string[] NAMES = new string[]
    ...
    /// </summary>
    public int Mithril => Money.GetMithril(m_copperValue);

    /// <summary>
    /// Returns the number of platinum pieces in this bag
    /// </summary>
    public int Platinum => Money.GetPlatinum(m_copperValue);

    /// <summary>
    /// Returns the number of gold pieces in this bag
    /// </summary>
    public int Gold => Money.GetGold(m_copperValue);

    /// <summary>
    /// Returns the number of silver pieces in this bag
    /// </summary>
    public int Silver => Money.GetSilver(m_copperValue);

    /// <summary>
    /// Returns the number of copper pieces in this bag
    /// </summary>
    public int Copper => Money.GetCopper(m_copperValue);

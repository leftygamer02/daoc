...
public class Doppelganger : GameSummoner
{
    ...
    public override int PetSummonThreshold => 50;

    public override NpcTemplate PetTemplate => m_petTemplate;

    private static NpcTemplate m_petTemplate = null;

    public override byte PetLevel => 50;

    public override byte PetSize => 50;
    ...
    {
        var chthonian =
            DOLDB<DBNpcTemplate>.SelectObject(DB.Column("Name").IsEqualTo("chthonian crawler"));
        if (chthonian != null)
    ...
    /// </summary>
    public override int RealmPointsValue => Properties.DOPPELGANGER_REALM_POINTS;

    /// <summary>
    /// Bounty point value of this living
    /// </summary>
    public override int BountyPointsValue => Properties.DOPPELGANGER_BOUNTY_POINTS;
    ...
    public void StartAttack(GameObject attackTarget)
    {
        ...
        {
            var standard = Inventory.GetItem(eInventorySlot.RightHandWeapon) != null;
            var twoHanded = Inventory.GetItem(eInventorySlot.TwoHandWeapon) != null;
    ...
    protected void Disguise()
    {
        ...
        switch (Util.Random(2))
        {
            case 0: // Albion
                Name =
                    $"Albion {LanguageMgr.GetTranslation(LanguageMgr.DefaultLanguage, "GamePlayer.RealmTitle.Invader")}";
            ...
            case 1: // Hibernia
                Name =
                    $"Hibernia {LanguageMgr.GetTranslation(LanguageMgr.DefaultLanguage, "GamePlayer.RealmTitle.Invader")}";
            ...
            case 2: // Midgard
                Name =
                    $"Midgard {LanguageMgr.GetTranslation(LanguageMgr.DefaultLanguage, "GamePlayer.RealmTitle.Invader")}";
        ...
        var distance = Inventory.GetItem(eInventorySlot.DistanceWeapon) != null;
        var standard = Inventory.GetItem(eInventorySlot.RightHandWeapon) != null;
        var twoHanded = Inventory.GetItem(eInventorySlot.TwoHandWeapon) != null;

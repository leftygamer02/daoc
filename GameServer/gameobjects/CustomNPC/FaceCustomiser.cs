...
public class FaceCustomiser : GameNPC
{
    ...
    public override bool Interact(GamePlayer player)
    {
        ...
        if (player.CustomisationStep == 2)
            SayTo(player, eChatLoc.CL_PopupWindow,
                ...
                ", I have discovered a secret spell that will allow you to change your appearance. I can cast this spell upon you if you wish. All you must do is say the word and I will [change your appearance].");
        else if (player.CustomisationStep == 3)
            SayTo(player, eChatLoc.CL_PopupWindow,
                "You have already been granted the ability to change your appearance. You must leave this world to make the changes. (Log out to change your appearance.)");
    ...
    public override bool WhisperReceive(GameLiving source, string text)
    {
        ...
        if (player.CustomisationStep == 2 && text == "change your appearance")
        {
            ...
            SayTo(player, eChatLoc.CL_PopupWindow,
                "There it is done! Now, you must leave this world for a short time for the magic to work. (You must log out to change your appearance.)");

...
public class StatsCustomiser : GameNPC
{
    ...
    public override bool Interact(GamePlayer player)
    {
        ...
        if (alreadyReset == null)
            SayTo(player, eChatLoc.CL_PopupWindow,
                $"Hello {player.CharacterClass.Name}, I can grant you a [stats respec] if you need one.");
        else
            SayTo(player, eChatLoc.CL_PopupWindow,
                "You have already been granted a reset.\n If you haven't used it yet, logout to customise your stats.");
    ...
    public override bool WhisperReceive(GameLiving source, string text)
    {
        ...
        if (alreadyReset == null && text == "stats respec")
        {
            ...
            var statsReset = new DOLCharactersXCustomParam();

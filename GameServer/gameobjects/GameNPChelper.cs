...
public static class GameNPCHelper
{
    ...
    public static void CastSpellOnOwnerAndPets(this GameNPC sourceNPC, GamePlayer player, Spell spell,
        SpellLine line, bool checkLOS)
    {
        ...
        if (player.ControlledBrain != null)
        {
            ...
            if (player.ControlledBrain.Body.ControlledNpcList != null)
                foreach (var subpet in player.ControlledBrain.Body.ControlledNpcList)

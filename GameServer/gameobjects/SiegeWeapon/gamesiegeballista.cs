...
public class GameSiegeBallista : GameSiegeWeapon
{
    ...
    public override void Fire()
    {
        ...
        // }
            ...
            Owner.Out.SendCheckLOS(Owner, TargetObject,
                new CheckLOSResponse(
                    FireCheckLOS)); //Have to use owner as "source" for now as checking with ballista the client always returns LOS of true
    }
    ...
    public override void DoDamage()
    {
        ...
        var damageAmount = CalcDamageToTarget(target) + Util.Random(50);

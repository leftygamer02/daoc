...
public class CamouflageSpecHandler : IAbilityActionHandler
{
    ...
    public void Execute(Ability ab, GamePlayer player)
    {
        ...
        var camouflage =
            (CamouflageECSGameEffect) EffectListService.GetAbilityEffectOnTarget(player, eEffect.Camouflage);

        if (camouflage != null)
        {
            player.Out.SendMessage(
                LanguageMgr.GetTranslation(player.Client.Account.Language, "Skill.Ability.Camouflage.UseCamo"),

...
public class PacketHandlerAttribute : Attribute
{
    ...
    /// <param name="desc">Description of the packet handler</param>
    /// <param name="preprocessorId">ID of the preprocessor to use for this packet</param>
    public PacketHandlerAttribute(PacketHandlerType type, eClientPackets code, string desc,
        eClientStatus preprocessorId)
    {
        m_type = type;
        m_code = (int) code;
        m_desc = desc;
    ...
    /// </summary>
    public PacketHandlerType Type => m_type;
    ...
    /// </summary>
    public int PreprocessorID => m_preprocessorId;
}
...
namespace DOL.GS.PacketHandler
{
	...
	public class PacketLib189 : PacketLib188
	{
		...
		protected virtual void WriteItemData(GSTCPPacketOut pak, InventoryItem item)
		{
			...
			// ChatUtil.SendDebugMessage(m_gameClient, string.Format("WriteItemDate189: name {0}, level {1}, object {2}, value1 {3}, value2 {4}", item.Id, item.ItemTemplate.Level, item.ItemTemplate.ObjectType, value1, value2));

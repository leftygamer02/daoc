...
public class PacketLib189 : PacketLib188
{
    ...
    public override void SendInventoryItemsUpdate(IDictionary<int, InventoryItem> updateItems,
    ...
    /// <param name="windowType"></param>
    protected override void SendInventoryItemsPartialUpdate(IDictionary<int, InventoryItem> items,
        eInventoryWindowType windowType)
    {
    ...
    protected virtual void WriteItemData(GSTCPPacketOut pak, InventoryItem item)
    {
        ...
        if (item.Count > 1) name = item.Count + " " + name;

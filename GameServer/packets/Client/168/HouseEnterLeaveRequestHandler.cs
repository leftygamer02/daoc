...
[PacketHandlerAttribute(PacketHandlerType.TCP, eClientPackets.HouseEnterLeave, "Housing Enter Leave Request.",
                ...
                case 1:
                    if (!player.IsWithinRadius(_house, 1000) || player.CurrentRegionID != _house.RegionID)
                    {
                        ChatUtil.SendSystemMessage(player,
                            string.Format("You are too far away to enter house {0}.", _house.HouseNumber));
                        return 0;
                    }
                    ...
                    {
                        ChatUtil.SendSystemMessage(player,
                            string.Format("You can't enter house {0}.", _house.HouseNumber));
                        return 0;
                    }

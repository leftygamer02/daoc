...
/// </summary>
[PacketHandlerAttribute(PacketHandlerType.TCP, eClientPackets.CharacterDeleteRequest,
    "Handles character delete requests", eClientStatus.LoggedIn)]
public class CharacterDeleteRequestHandler : IPacketHandler
{
    ...
    {
        var charName = packet.ReadString(30);
        var chars = client.Account.Characters;

...
[PacketHandlerAttribute(PacketHandlerType.TCP, eClientPackets.HouseUserPermissionSet,
    "Handles housing Users permissions requests", eClientStatus.PlayerInGame)]
public class HouseUsersPermissionsSetHandler : IPacketHandler
{
    public void HandlePacket(GameClient client, GSPacketIn packet)
    {
        var permissionSlot = packet.ReadByte();
        var newPermissionLevel = packet.ReadByte();

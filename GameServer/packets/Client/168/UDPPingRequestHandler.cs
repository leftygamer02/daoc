...
/// </summary>
[PacketHandlerAttribute(PacketHandlerType.UDP, eClientPackets.UDPPingRequest, "Sends the UDP Init reply",
    eClientStatus.None)]
public class UDPPingRequestHandler : IPacketHandler
{
    ...
    public void HandlePacket(GameClient client, GSPacketIn packet)
    {
        ...
        {
            var localIP = packet.ReadString(22);
            var localPort = packet.ReadShort();

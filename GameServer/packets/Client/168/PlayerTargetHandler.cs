...
/// </summary>
[PacketHandlerAttribute(PacketHandlerType.TCP, eClientPackets.PlayerTarget, "Handle Player Target Change.",
...
public class PlayerTargetHandler : IPacketHandler
{
    ...
    public void HandlePacket(GameClient client, GSPacketIn packet)
    {
        ...
        //Changing it so the change target method is called instantly rather than using a timer on the gameloop. Timer caused target switch delays before
        ChangeTarget(client.Player, targetID, (flags & (0x4000 | 0x2000)) != 0, (flags & 0x8000) != 0);
    }


    private void ChangeTarget(GamePlayer m_actionSource, ushort m_newTargetId, bool m_targetInView,
        bool m_examineTarget)
    {
        var player = (GamePlayer) m_actionSource;

        var myTarget = player.CurrentRegion.GetObject((ushort) m_newTargetId);
        ...
        if (player.IsPraying)
        {
            ...
            {
                player.Out.SendMessage("You are no longer targetting your grave. Your prayers fail.",

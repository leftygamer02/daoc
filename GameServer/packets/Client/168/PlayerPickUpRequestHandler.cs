...
[PacketHandlerAttribute(PacketHandlerType.TCP, eClientPackets.PickUpRequest, "Handles Pick up object request",
...
public class PlayerPickUpRequestHandler : IPacketHandler
{
    public void HandlePacket(GameClient client, GSPacketIn packet)
    {
        ...
        if (target == null)
        {
            client.Out.SendMessage(
                LanguageMgr.GetTranslation(client.Account.Language,
                    "PlayerPickUpRequestHandler.HandlePacket.Target"), eChatType.CT_System,
        ...
        if (target.ObjectState != GameObject.eObjectState.Active)
        {
            client.Out.SendMessage(
                LanguageMgr.GetTranslation(client.Account.Language,
                    "PlayerPickUpRequestHandler.HandlePacket.InvalidTarget"), eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
            return;
        }

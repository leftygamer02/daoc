...
[PacketHandlerAttribute(PacketHandlerType.TCP, eClientPackets.HouseMenuRequest, "Handles housing menu requests",
...
public class HousingMenuRequestHandler : IPacketHandler
{
    ...
    private static Dictionary<int, eMerchantWindowType> _menu168 = new()
    {
    ...
    private static Dictionary<int, eMerchantWindowType> _menu1127 = new()
    {
        {0, eMerchantWindowType.HousingOutsideShop},
        {1, eMerchantWindowType.HousingInsideShop},

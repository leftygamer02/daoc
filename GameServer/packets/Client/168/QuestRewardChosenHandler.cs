...
[PacketHandlerAttribute(PacketHandlerType.TCP, eClientPackets.QuestRewardChosen, "Quest Reward Choosing Handler",
...
public class QuestRewardChosenHandler : IPacketHandler
{
    public void HandlePacket(GameClient client, GSPacketIn packet)
    {
        ...
        var data2 = packet.ReadShort(); // unknown
        var data3 = packet.ReadShort(); // unknown
        var data4 = packet.ReadShort(); // unknown

        var questID = packet.ReadShort();
        var questGiverID = packet.ReadShort();

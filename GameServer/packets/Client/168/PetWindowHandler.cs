...
[PacketHandlerAttribute(PacketHandlerType.TCP, eClientPackets.PetWindow, "Handle Pet Window Command",
    ...
    protected class HandlePetCommandAction : RegionECSAction
    {
        ...
        protected override int OnTick(ECSGameTimer timer)
        {
            ...
            switch (_aggroState)
            {
                ...
                default:
                    Log.Warn(
                        $"unknown aggro state {_aggroState}, player={player.Name}  version={player.Client.Version}  client type={player.Client.ClientType}");
                    break;
            }
            ...
            switch (_walkState)
            {
                ...
                default:
                    Log.Warn(
                        $"unknown walk state {_walkState}, player={player.Name}  version={player.Client.Version}  client type={player.Client.ClientType}");
                    break;
            }
            ...
            switch (_command)
            {
                ...
                default:
                    Log.Warn(
                        $"unknown command state {_command}, player={player.Name}  version={player.Client.Version}  client type={player.Client.ClientType}");
                    break;
            }

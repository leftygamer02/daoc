...
[PacketHandlerAttribute(PacketHandlerType.TCP, eClientPackets.PlayerAttackRequest, "Handles Player Attack Request",
...
public class PlayerAttackRequestHandler : IPacketHandler
{
    public void HandlePacket(GameClient client, GSPacketIn packet)
    {
        ...
        var userAction = packet.ReadByte() == 0;
    ...
    protected class AttackRequestHandler : RegionECSAction
    {
        ...
        protected override int OnTick(ECSGameTimer timer)
        {
            ...
            {
                if (m_userAction)
                    player.Out.SendMessage("You can't enter melee combat mode with a fired weapon!",
                        eChatType.CT_YouHit,

...
[PacketHandlerAttribute(PacketHandlerType.TCP, eClientPackets.PlayerAppraiseItemRequest,
    "Player Appraise Item Request handler.", eClientStatus.PlayerInGame)]
public class PlayerAppraiseItemRequestHandler : IPacketHandler
{
    ...
    protected class AppraiseActionHandler : RegionECSAction
    {
        ...
        protected override int OnTick(ECSGameTimer timer)
        {
            ...
            var item = player.Inventory.GetItem((eInventorySlot) m_slot);

        ...
        switch (skill.KeyName)
        {
            case Specs.RecurveBow:
                if (ServerProperties.Properties.ALLOW_OLD_ARCHERY == true)
                {
                    ...
                    else if (skill.Level >= 35) player.AddAbility(SkillBase.GetAbility(Abilities.RapidFire, 1));

                    if (skill.Level >= 45) player.AddAbility(SkillBase.GetAbility(Abilities.SureShot));
                    ...
                    else if (skill.Level >= 30) player.AddAbility(SkillBase.GetAbility(Abilities.PenetratingArrow, 1));
                }

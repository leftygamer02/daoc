...
namespace DOL.GS
{
    public class DirtyTricksECSGameEffect : ECSGameAbilityEffect
    {
        ...
        {
            foreach (GamePlayer plyr in Owner.GetPlayersInRadius(500)) plyr.Out.SendSoundEffect(163, 0, 0, 0, 0, 0);
        }
        ...
        public void EventHandler(AttackData attackData)
        {
            ...
            var attacker = Owner as GameLiving;
            ...
            var dt =
                (DirtyTricksDetrimentalECSGameEffect) EffectListService.GetAbilityEffectOnTarget(target,
                    eEffect.DirtyTricksDetrimental);
            if (dt == null) new DirtyTricksDetrimentalECSGameEffect(new ECSGameEffectInitParams(target, 10000, 1));
        }
    }
}
    ...
    public class DirtyTricksDetrimentalECSGameEffect : ECSGameAbilityEffect
    {
        ...
        public override void OnStartEffect()
        {
            ...
            if (OwnerPlayer != null)
                ...
                OwnerPlayer.Out.SendMessage(
                    LanguageMgr.GetTranslation(OwnerPlayer.Client.Account.Language, "Effects.DirtyTricks.EffectStart"),
        ...
        public override void OnStopEffect()
        {
            ...
            if (OwnerPlayer != null)
            {
                ...
                OwnerPlayer.Out.SendMessage(
                    LanguageMgr.GetTranslation(OwnerPlayer.Client.Account.Language, "Effects.DirtyTricks.EffectCancel"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
                // Message: "{0} can see clearly again."
                Message.SystemToArea(Owner,
                    LanguageMgr.GetTranslation(OwnerPlayer.Client.Account.Language,
                        "Effects.DirtyTricks.AreaEffectCancel", Owner.GetName(0, true)), eChatType.CT_System);
            }
        }
    }
}
...
public class EngageECSGameEffect : ECSGameAbilityEffect
{
    ...
    public override void OnStartEffect()
    {
        ...
        if (OwnerPlayer != null)
            OwnerPlayer.Out.SendMessage(
                LanguageMgr.GetTranslation(OwnerPlayer.Client, "Effects.EngageEffect.ConcOnBlockingX",
    ...
    public void Cancel(bool playerCancel)
    {
        ...
        if (OwnerPlayer != null)
        {
            if (playerCancel)
                OwnerPlayer.Out.SendMessage(
                    LanguageMgr.GetTranslation(OwnerPlayer.Client, "Effects.EngageEffect.YouNoConcOnBlock"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
            else
                OwnerPlayer.Out.SendMessage(
                    LanguageMgr.GetTranslation(OwnerPlayer.Client, "Effects.EngageEffect.YouNoAttemptToEngageT"),
                    eChatType.CT_System, eChatLoc.CL_SystemWindow);
        }
    }
}
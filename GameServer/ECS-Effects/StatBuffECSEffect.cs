...
public class StatBuffECSEffect : ECSGameSpellEffect
{
    ...
    public override void OnStartEffect()
    {
        ...
        if (EffectType == eEffect.StrengthConBuff || EffectType == eEffect.DexQuickBuff)
            foreach (var prop in EffectService.GetPropertiesFromEffect(EffectType))
                ...
                ApplyBonus(Owner, eBuffBonusCategory.SpecBuff, prop, SpellHandler.Spell.Value, Effectiveness,
                    false);
            ...
            foreach (var prop in EffectService.GetPropertiesFromEffect(EffectType))
            {
                ...
                if (EffectType == eEffect.MovementSpeedBuff)
                {
                    ...
                    if (Owner.IsStealthed) EffectService.RequestDisableEffect(this);
                }
    ...
    protected static void ApplyBonus(GameLiving owner, eBuffBonusCategory BonusCat, eProperty Property,
        double Value, double Effectiveness, bool IsSubstracted)
    {

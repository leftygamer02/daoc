...
public class StagECSGameEffect : ECSGameAbilityEffect
{
    ...
    public override void OnStartEffect()
    {
        ...
        if (OwnerPlayer != null)
            m_amount = (int) (OwnerPlayer.CalculateMaxHealth(OwnerPlayer.Level,
                OwnerPlayer.GetModified(eProperty.Constitution)) * m_amountPercent);
        ...
        if (OwnerPlayer != null)
        {
            ...
            OwnerPlayer.Out.SendMessage(
                LanguageMgr.GetTranslation(OwnerPlayer.Client, "Effects.StagEffect.HuntsSpiritChannel"),
    ...
    public override void OnStopEffect()
    {
        ...
        if (OwnerPlayer != null)
        {
            ...
            OwnerPlayer.Out.SendMessage(
                LanguageMgr.GetTranslation(OwnerPlayer.Client, "Effects.StagEffect.YourHuntsSpiritEnds"),
                eChatType.CT_YouHit, eChatLoc.CL_SystemWindow);
        }
    }
}
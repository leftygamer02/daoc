    ...
    public override void OnStartEffect()
    {
        ...
        if (OwnerPlayer.ObjectState == GameObject.eObjectState.Active)
            OwnerPlayer.Out.SendMessage(
                LanguageMgr.GetTranslation(OwnerPlayer.Client.Account.Language, "GamePlayer.Stealth.NowHidden"),
        ...
        if (OwnerPlayer.ObjectState == GameObject.eObjectState.Active)
            OwnerPlayer.Out.SendMessage(
                LanguageMgr.GetTranslation(OwnerPlayer.Client.Account.Language,
                    "GamePlayer.Stealth.NoLongerHidden"), eChatType.CT_System, eChatLoc.CL_SystemWindow);

...
public class BerserkECSGameEffect : ECSGameAbilityEffect
{
    ...
    public override ushort Icon => 479;

    public override string Name => LanguageMgr.GetTranslation(OwnerPlayer.Client, "Effects.BerserkEffect.Name");
    ...
    public override void OnStartEffect()
    {
        ...
        if (OwnerPlayer != null)
        {
            ...
            OwnerPlayer.Out.SendMessage(
                LanguageMgr.GetTranslation(OwnerPlayer.Client, "Effects.BerserkEffect.StartFrenzy"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            // "{0} goes into a berserker frenzy!"
            Message.SystemToArea(OwnerPlayer,
                LanguageMgr.GetTranslation(OwnerPlayer.Client, "Effects.BerserkEffect.AreaStartFrenzy",
    ...
    public override void OnStopEffect()
    {
        ...
        if (OwnerPlayer != null)
        {
            ...
            OwnerPlayer.Out.SendMessage(
                LanguageMgr.GetTranslation(OwnerPlayer.Client, "Effects.BerserkEffect.EndFrenzy"),
                eChatType.CT_System, eChatLoc.CL_SystemWindow);
            // "{0}'s berserker frenzy ends."
            Message.SystemToArea(OwnerPlayer,
                LanguageMgr.GetTranslation(OwnerPlayer.Client, "Effects.BerserkEffect.AreaEndFrenzy",
                    OwnerPlayer.GetName(0, true)), eChatType.CT_System, OwnerPlayer);
        }
    }
}
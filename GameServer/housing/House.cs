...
public class House : Point3D, IGameLocation
{
    ...
    {
        get => _databaseItem.HouseNumber;
        set => _databaseItem.HouseNumber = value;
    }

    public string OwnerID
    {
        get => _databaseItem.OwnerID;
        set => _databaseItem.OwnerID = value;
    }

    public int Model
    {
        get => _databaseItem.Model;
    ...
    public IDictionary<int, DBHouseCharsXPerms> CharXPermissions => _housePermissions;

    public IDictionary<int, DBHousePermissions> PermissionLevels => _permissionLevels;

    public GameConsignmentMerchant ConsignmentMerchant
    {
        get => _consignmentMerchant;
    ...
    public bool IsOccupied
    {
        get
        {
            foreach (GamePlayer player in WorldMgr.GetPlayersCloseToSpot(RegionID, X, Y, 25000,
                         WorldMgr.VISIBILITY_DISTANCE))
    ...
    public GameLocation OutdoorJumpPoint
    {
        get
        {
            var angle = Heading * (Math.PI * 2 / 360); // angle*2pi/360;
    ...
    public void SendUpdate()
    {
        ...
        foreach (var player in GetAllPlayersInHouse()) player.Out.SendEnterHouse(this);
    }
    ...
    public void Exit(GamePlayer player, bool silent)
    {
        ...
        if (!silent) ChatUtil.SendSystemMessage(player, "House.Exit.LeftHouse", HouseNumber);
    ...
    {
        var level = Model - (Model - 1) / 4 * 4;
        var due = LastPaid.AddDays(ServerProperties.Properties.RENT_DUE_DAYS).AddHours(1) - DateTime.Now;
        var text = new List<string>();

        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.Owner", Name));
        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.Lotnum",
            HouseNumber));

        if (level > 0)
            text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.Level",
                level));
        else
            text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.Level",
                "Lot"));
        ...
        text.Add(" ");
        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.Lockbox",
            Money.GetString(KeptMoney)));
        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.RentalPrice",
            Money.GetString(HouseMgr.GetRentByModel(Model))));
        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.MaxLockbox",
            Money.GetString(HouseMgr.GetRentByModel(Model) * ServerProperties.Properties.RENT_LOCKBOX_PAYMENTS)));
        if (ServerProperties.Properties.RENT_DUE_DAYS > 0)
            text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.RentDueIn",
                due.Days, due.Hours));
        else
            text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.RentDueIn",
                "No Rent! 0", "0"));
        ...
        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.PorchEnabled",
            Porch ? "Y" : "N"));
        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.PorchRoofColor",
            PorchRoofColor));
        text.Add(" ");
        text.Add(
            LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.ExteriorMaterials"));
        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.RoofMaterial",
            RoofMaterial));
        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.WallMaterial",
            WallMaterial));
        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.DoorMaterial",
            DoorMaterial));
        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.TrussMaterial",
            TrussMaterial));
        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.PorchMaterial",
            PorchMaterial));
        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.WindowMaterial",
            WindowMaterial));
        text.Add(" ");
        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language,
            "House.SendHouseInfo.ExteriorUpgrades"));
        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language,
            "House.SendHouseInfo.OutdoorGuildBanner", OutdoorGuildBanner ? "Y" : "N"));
        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language,
            "House.SendHouseInfo.OutdoorGuildShield", OutdoorGuildShield ? "Y" : "N"));
        text.Add(" ");
        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language,
            "House.SendHouseInfo.InteriorUpgrades"));
        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.IndoorGuildBanner",
            IndoorGuildBanner ? "Y" : "N"));
        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.IndoorGuildShield",
        ...
        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.Rug1Color",
            Rug1Color));
        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.Rug2Color",
            Rug2Color));
        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.Rug3Color",
            Rug3Color));
        text.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.Rug4Color",
            Rug4Color));

        player.Out.SendCustomTextWindow(
            LanguageMgr.GetTranslation(player.Client.Account.Language, "House.SendHouseInfo.HouseOwner", Name),
            text);
    }
    ...
    public int GetFreeVaultNumber()
    {
        ...
        foreach (var housePointItem in DOLDB<DBHouseHookpointItem>.SelectObjects(DB.Column("HouseNumber")
                     .IsEqualTo(HouseNumber).And(DB.Column("ItemTemplateID").IsLike("%_vault"))))
            if (housePointItem.Index >= 0 && housePointItem.Index <= 3)
                usedVaults[housePointItem.Index] = true;

        for (var freeVault = 0; freeVault <= 3; ++freeVault)
    ...
    public static bool AddNewOffset(HouseHookpointOffset o)
    {
        ...
        {
            HousingConstants.RelativeHookpointsCoords[o.HouseModel][o.HookpointID] =
                new[] {o.X, o.Y, o.Z, o.Heading};
            return true;
        }

        log.Error("[Housing]: HouseHookPointOffset exceeds array size.  Model " + o.HouseModel + ", hookpoint " +
                  o.HookpointID);
    ...
    {
        for (var i = HousingConstants.MaxHouseModel; i > 0; i--)
        for (var j = 1; j < HousingConstants.RelativeHookpointsCoords[i].Length; j++)
            HousingConstants.RelativeHookpointsCoords[i][j] = null;

        var objs = GameServer.Database.SelectAllObjects<HouseHookpointOffset>();
        foreach (var o in objs) AddNewOffset(o);
    }
    ...
    public Point3D GetHookpointLocation(uint n)
    {
        ...
        var hookpointsCoords = HousingConstants.RelativeHookpointsCoords[Model][n];
    ...
    private int GetHookpointPosition(int objX, int objY, int objZ)
    {
        ...
        for (var i = 0; i < HousingConstants.MaxHookpointLocations; i++)
    ...
    {
        var item = GameServer.Database.FindObjectByKey<ItemTemplate>(templateID);
        ...
        switch ((eObjectType) item.Object_Type)
        {
            ...
            {
                hookpointObject =
                    GameServer.ServerRules.PlaceHousingNPC(this, item, location, GetHookpointHeading(position));
                break;
            }
    ...
    public void EmptyHookpoint(GamePlayer player, GameObject obj, bool addToInventory = true)
    {
        ...
        {
            ChatUtil.SendSystemMessage(player,
                "Only the Owner of a House can remove or place Items on Hookpoints!");
            return;
        }

        var position = GetHookpointPosition(obj.X, obj.Y, obj.Z);
        ...
        var items = DOLDB<DBHouseHookpointItem>.SelectObjects(DB.Column("HookpointID").IsEqualTo(position)
            .And(DB.Column("HouseNumber").IsEqualTo(obj.CurrentHouse.HouseNumber)));
        if (items.Count == 0)
        {
        ...
        if (addToInventory)
        {
            ...
            if (template != null)
                if (player.Inventory.AddItem(eInventorySlot.FirstEmptyBackpack, GameInventoryItem.Create(template)))
                    InventoryLogging.LogInventoryAction("(HOUSE;" + HouseNumber + ")", player,
                        eInventoryActionType.Loot, template);
        }
    }
    ...
    public bool AddConsignment(long startValue)
    {
        ...
        {
            log.DebugFormat(
                "Add CM: Found active consignment merchant in HousingConsignmentMerchant table for house {0}.",
                HouseNumber);
            return false;
        }
        ...
        {
            log.DebugFormat(
                "Add CM: Found consignment merchant in Mob table for house {0} but none in HousingConsignmentMerchant!  Creating a new merchant.",
                HouseNumber);
        ...
        if (DatabaseItem.HasConsignment == true)
            log.ErrorFormat(
                "Add CM: No Consignment Merchant found but House DB record HasConsignment for house {0}!  Creating a new merchant.",
                HouseNumber);
        ...
        if (houseCM != null)
        {
            ...
            {
                log.ErrorFormat(
                    "Add CM: Found active consignment merchant for this owner, can't add new one to house {0}!",
                    HouseNumber);
                return false;
            }
        ...
        if (houseCM == null)
        {
            ...
            houseCM = new HouseConsignmentMerchant
                {OwnerID = OwnerID, HouseNumber = HouseNumber, Money = startValue};
            GameServer.Database.AddObject(houseCM);
        }

        var consignmentCoords = HousingConstants.ConsignmentPositioning[Model];
        ...
        var con = GameServer.ServerRules.CreateHousingConsignmentMerchant(this);
    ...
    public bool RemoveConsignmentMerchant()
    {
        ...
        var count = 0;
        foreach (var item in ConsignmentMerchant.DBItems(null))
        {
            item.OwnerLot = 0;
        ...
        if (count > 0) log.Warn("HOUSING: Cleared OwnerLot for " + count + " items on the consignment merchant!");
    ...
    public void PickUpConsignmentMerchant(GamePlayer player)
    {
        ...
        {
            ChatUtil.SendSystemMessage(player,
                "You don't have the permission to remove this consignment merchant.");
            return;
        }

        var itemTemplate = GameServer.Database.FindObjectByKey<ItemTemplate>("housing_consignment_deed");

        if (itemTemplate == null || !RemoveConsignmentMerchant())
        {
            ChatUtil.SendSystemMessage(player,
                "Couldn't pick up the Consignment Merchant due to an internal error.");
            return;
        }
        ...
        {
            ChatUtil.SendSystemMessage(player,
                LanguageMgr.GetTranslation(player.Client.Account.Language, "GamePlayer.PickupObject.BackpackFull"));
            return;
        }

        InventoryLogging.LogInventoryAction("(HOUSE;" + HouseNumber + ")", player, eInventoryActionType.Loot,
            itemTemplate);
    }
    ...
    {
        var items =
            player.InHouse ? HouseTemplateMgr.IndoorMenuItems : HouseTemplateMgr.OutdoorMenuItems;
        if (items == null)
            return;
        ...
        foreach (var slot in changes)
        {
            ...
            var item = items.GetItem(page, (eMerchantWindowSlot) pslot);
            if (item != null) price += item.Price;
        }

        // make sure player has enough money to cover the changes
        if (!player.RemoveMoney(price))
        {
            InventoryLogging.LogInventoryAction(player, "(HOUSE;" + HouseNumber + ")",
                eInventoryActionType.Merchant, price);
    ...
    public bool AddPermission(GamePlayer player, PermissionType permType, int permLevel)
    {
        ...
        var targetName = permType == PermissionType.Account ? player.Client.Account.Name : player.Name;

        //  check to make sure an existing mapping doesn't exist.
        foreach (var perm in _housePermissions.Values)
        ...
        var housePermission =
            new DBHouseCharsXPerms(HouseNumber, targetName, player.Name, permLevel, (int) permType);
    ...
    public bool AddPermission(string targetName, PermissionType permType, int permLevel)
    {
        ...
        // no matching permissions, create a new one and add it.
        var housePermission =
            new DBHouseCharsXPerms(HouseNumber, targetName, targetName, permLevel, (int) permType);
        GameServer.Database.AddObject(housePermission);
    ...
    private int GetOpenPermissionSlot()
    {
        ...
        while (_housePermissions.ContainsKey(startingSlot)) startingSlot++;
    ...
    public void AdjustPermissionSlot(int slot, int newPermLevel)
    {
        ...
        if (newPermLevel < HousingConstants.MinPermissionLevel ||
            newPermLevel > HousingConstants.MaxPermissionLevel)
            return;
    ...
    private DBHouseCharsXPerms GetPlayerPermissions(GamePlayer player)
    {
        ...
        var charPermissions = from cp in _housePermissions.Values
            where
        ...
        var acctPermissions = from cp in _housePermissions.Values
            where
        ...
        if (player.Guild != null)
        {
            ...
            var guildPermissions = from cp in _housePermissions.Values
                where
        ...
        var allPermissions = from cp in _housePermissions.Values
    ...
    public bool CanUseVault(GamePlayer player, GameHouseVault vault, VaultPermissions vaultPerms)
    {
        ...
        var activeVaultPermissions = VaultPermissions.None;
        ...
        ChatUtil.SendDebugMessage(player,
            string.Format("Vault permissions = {0} for vault index {1}", activeVaultPermissions & vaultPerms,
                vault.Index));
    ...
    public void LoadFromDatabase()
    {
        var i = 0;
        _indoorItems.Clear();
        foreach (var dbiitem in DOLDB<DBHouseIndoorItem>.SelectObjects(DB.Column("HouseNumber")
                     .IsEqualTo(HouseNumber)))
            _indoorItems.Add(i++, new IndoorItem(dbiitem));

        i = 0;
        _outdoorItems.Clear();
        foreach (var dboitem in DOLDB<DBHouseOutdoorItem>.SelectObjects(DB.Column("HouseNumber")
                     .IsEqualTo(HouseNumber)))
            _outdoorItems.Add(i++, new OutdoorItem(dboitem));

        _housePermissions.Clear();
        foreach (var d in DOLDB<DBHouseCharsXPerms>.SelectObjects(DB.Column("HouseNumber")
                     .IsEqualTo(HouseNumber)))
            _housePermissions.Add(GetOpenPermissionSlot(), d);

        _permissionLevels.Clear();
        foreach (var dbperm in DOLDB<DBHousePermissions>.SelectObjects(DB.Column("HouseNumber")
                     .IsEqualTo(HouseNumber)))
            if (_permissionLevels.ContainsKey(dbperm.PermissionLevel) == false)
                _permissionLevels.Add(dbperm.PermissionLevel, dbperm);
            else
                log.ErrorFormat("Duplicate permission level {0} for house {1}", dbperm.PermissionLevel,
                    HouseNumber);

        HousepointItems.Clear();
        foreach (var item in DOLDB<DBHouseHookpointItem>.SelectObjects(DB.Column("HouseNumber")
                     .IsEqualTo(HouseNumber)))
            ...
            {
                log.ErrorFormat("Duplicate item {0} attached to hookpoint {1} for house {2}!", item.ItemTemplateID,
                    item.HookpointID, HouseNumber);
            }
    }

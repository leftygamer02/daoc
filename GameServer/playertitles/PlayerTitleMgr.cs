...
public static class PlayerTitleMgr
{
    ...
    /// </summary>
    private static readonly HashSet<IPlayerTitle> m_titles = new();

    /// <summary>
    /// Holds special "empty" title instance.
    /// </summary>
    public static readonly ClearTitle ClearTitle = new();
    ...
    {
        m_titles.Clear();
        foreach (var t in ScriptMgr.GetDerivedClasses(typeof(IPlayerTitle)))
        {

...
public class LaunchQuestTitle : SimplePlayerTitle
{
    ...
    {
        player.Out.SendMessage("You have gained the Launch Quest title!", eChatType.CT_Important,
...
public class LaunchDayTitle : SimplePlayerTitle
{
    ...
    public override void OnTitleGained(GamePlayer player)
    {
        player.Out.SendMessage("You have gained the Launch Day title!", eChatType.CT_Important,
            eChatLoc.CL_SystemWindow);
    }

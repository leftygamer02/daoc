...
public class GameLocation : Point3D, IGameLocation
{
    ...
    public GameLocation(string name, ushort regionId, ushort zoneId, int x, int y, int z, ushort heading) : this(
        name, regionId, ConvertLocalXToGlobalX(x, zoneId), ConvertLocalYToGlobalY(y, zoneId), z, heading)
    {
    }
    ...
    {
        var loc1 = new GameLocation("loc1", (ushort) r1, x1, y1, z1);
        var loc2 = new GameLocation("loc2", (ushort) r2, x2, y2, z2);

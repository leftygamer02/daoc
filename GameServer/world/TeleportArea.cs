...
public class TeleportArea : Area.Circle
{
    public override void OnPlayerEnter(GamePlayer player)
    {
        ...
        var destination = WorldMgr.GetTeleportLocation(player.Realm,
            string.Format("{0}:{1}", GetType(), Description));
        ...
        if (destination != null)
            ...
            player.Out.SendMessage(
                ...
                string.Format("{0}:{1}", GetType(), Description) + ".", eChatType.CT_System,

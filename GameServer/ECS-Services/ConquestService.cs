...
public class ConquestService
{
    ...
    public static void Tick(long tick)
    {
        ...
        long fullCycle =
            ServerProperties.Properties.MAX_CONQUEST_TASK_DURATION *
            60000; //ServerProperties.Properties.MAX_CONQUEST_INTERVAL
        long tallyCycle =
            ServerProperties.Properties.CONQUEST_TALLY_INTERVAL * 1000; //multiply by 000 to accomodate for second input
        var subCycle = fullCycle / 6;
    ...
    {
        return ConquestManager.LastConquestWindowStart +
            ServerProperties.Properties.MAX_CONQUEST_TASK_DURATION * 60000 / 6 - GameLoop.GameLoopTime;
    }

    public static long GetTicksUntilNextAward()
    {
        return ConquestManager.ActiveObjective.LastRolloverTick +
            ServerProperties.Properties.CONQUEST_TALLY_INTERVAL * 1000 - GameLoop.GameLoopTime;
    }
}
...
public class DailyQuestService
{
    ...
    public static void Tick(long tick)
    {
        ...
        if (lastDailyRollover.Date.DayOfYear < DateTime.Now.Date.DayOfYear ||
            lastDailyRollover.Year < DateTime.Now.Year)
        {
            ...
            var existingDailyQuests =
                GameServer.Database.SelectObjects<DBQuest>(DB.Column("Name").IsLike("%DailyQuest%"));

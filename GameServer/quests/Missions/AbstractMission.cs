...
public class AbstractMission
{
    ...
    public virtual void FinishMission()
    {
        foreach (var player in Targets)
        {
            ...
            if (RewardMoney > 0)
            {
                ...
                InventoryLogging.LogInventoryAction("(MISSION;" + MissionType + ")", player,
        ...
        switch (MissionType)
        {
            case eMissionType.Personal:
                (m_owner as GamePlayer).Mission = null;
                break;
            case eMissionType.Group:
                (m_owner as Group).Mission = null;
                break;
    ...
    {
        foreach (var player in Targets) player.Out.SendQuestListUpdate();
    }

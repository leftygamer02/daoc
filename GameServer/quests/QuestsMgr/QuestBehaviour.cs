...
public class QuestBehaviour : BaseBehaviour
{
    ...
    public int MaxNumberOfExecutions => maxNumberOfExecutions;
    ...
    public override void Notify(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(QuestType);
        ...
        if (MaxNumberOfExecutions < 0 || executions < MaxNumberOfExecutions)
            ...
            {
                foreach (var action in Actions) action.Perform(e, sender, args);

...
public class CriticalMeleeHitChanceCalculator : PropertyCalculator
{
    ...
    public override int CalcValue(GameLiving living, eProperty property)
    {
        ...
        var berserk = EffectListService.GetEffectOnTarget(living, eEffect.Berserk);
        ...
        if (living is GameNPC npc && npc.Brain is IControlledBrain petBrain &&
            petBrain.GetPlayerOwner() is GamePlayer player)
        {

...
public class MeleeSpeedPercentCalculator : PropertyCalculator
{
    public override int CalcValue(GameLiving living, eProperty property)
    {
        if (living is GameNPC)
        {
            ...
            var buffs = living.BaseBuffBonusCategory[property] << 1;
            var debuff = Math.Abs(living.DebuffCategory[property]);
        ...
        return Math.Max(1, 100
                           ...
                           - Math.Min(10,
                               living.ItemBonus[(int) property])) // http://www.camelotherald.com/more/1325.shtml

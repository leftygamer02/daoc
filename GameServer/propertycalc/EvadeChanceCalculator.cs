    ...
    public override int CalcValue(GameLiving living, eProperty property)
    {
        ...
        if (player != null)
        {
            ...
            if (player.HasAbility(Abilities.Evade))
                evadechance += (int) ((((player.Dexterity + player.Quickness) / 2 - 50) * 0.05 +
                                       player.GetAbilityLevel(Abilities.Evade) * 5) * 10);
        ...
        if (npc != null) return living.AbilityBonus[(int) property] * 10 + npc.EvadeChance * 10;

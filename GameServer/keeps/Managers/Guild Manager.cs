...
public class KeepGuildMgr
{
    ...
    {
        var message = door.Name + " in your area " + door.Component.Keep.Name + " has been destroyed";
    ...
    {
        var message = "Your guild's keep " + keep.Name + " is now level " + keep.Level;
    ...
    public static void SendChangeLevelTimeMessage(AbstractGameKeep keep)
    {
        ...
        var maxlevel = (byte) ServerProperties.Properties.MAX_KEEP_LEVEL;
        ...
        message = "Your guild is starting to " + changeleveltext + " its area " + keep.Name + " to level " +
                  maxlevel;
        var time = keep.ChangeLevelTimeRemaining;

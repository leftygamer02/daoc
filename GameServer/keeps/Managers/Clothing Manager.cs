...
public class ClothingMgr
{
    ...
    public static GameNpcInventoryTemplate Albion_Archer = new();
    public static GameNpcInventoryTemplate Albion_Caster = new();
    public static GameNpcInventoryTemplate Albion_Fighter = new();
    public static GameNpcInventoryTemplate Albion_Commander = new();
    public static GameNpcInventoryTemplate Albion_Healer = new();
    public static GameNpcInventoryTemplate Albion_Stealther = new();
    public static GameNpcInventoryTemplate Albion_Lord = new();
    public static GameNpcInventoryTemplate Albion_Merchant = new();
    public static GameNpcInventoryTemplate Relic_Albion_Lord = new();
    public static GameNpcInventoryTemplate Albion_FighterPK = new();
    public static GameNpcInventoryTemplate Albion_ArcherPK = new();
    public static GameNpcInventoryTemplate Albion_CasterPK = new();

    #endregion

    #region Midgard

    public static GameNpcInventoryTemplate Midgard_Archer = new();
    public static GameNpcInventoryTemplate Midgard_Caster = new();
    public static GameNpcInventoryTemplate Midgard_Fighter = new();
    public static GameNpcInventoryTemplate Midgard_Commander = new();
    public static GameNpcInventoryTemplate Midgard_Merchant = new();
    public static GameNpcInventoryTemplate Midgard_Healer = new();
    public static GameNpcInventoryTemplate Midgard_Hastener = new();
    public static GameNpcInventoryTemplate Midgard_Stealther = new();
    public static GameNpcInventoryTemplate Midgard_Lord = new();
    public static GameNpcInventoryTemplate Relic_Midgard_Lord = new();
    public static GameNpcInventoryTemplate Midgard_FighterPK = new();
    public static GameNpcInventoryTemplate Midgard_ArcherPK = new();
    public static GameNpcInventoryTemplate Midgard_CasterPK = new();

    #endregion

    #region Hibernia

    public static GameNpcInventoryTemplate Hibernia_Archer = new();
    public static GameNpcInventoryTemplate Hibernia_Caster = new();
    public static GameNpcInventoryTemplate Hibernia_Fighter = new();
    public static GameNpcInventoryTemplate Hibernia_Commander = new();
    public static GameNpcInventoryTemplate Hibernia_Merchant = new();
    public static GameNpcInventoryTemplate Hibernia_Healer = new();
    public static GameNpcInventoryTemplate Hibernia_Stealther = new();
    public static GameNpcInventoryTemplate Hibernia_Lord = new();
    public static GameNpcInventoryTemplate Relic_Hibernia_Lord = new();
    public static GameNpcInventoryTemplate Hibernia_FighterPK = new();
    public static GameNpcInventoryTemplate Hibernia_ArcherPK = new();
    public static GameNpcInventoryTemplate Hibernia_CasterPK = new();
    ...
    public static void EquipGuard(GameKeepGuard guard)
    {
        ...
        if (guard is FrontierHastener || guard is GateKeeperIn || guard is GateKeeperOut)
            switch (guard.Realm)
            {
                ...
                case eRealm.Midgard:
                {
                    guard.Inventory = Midgard_Hastener.CloneTemplate();
                    break;
                }
            }
        ...
        switch (guard.ModelRealm)
        {
            ...
            case eRealm.Albion:
            {
                if (guard is GuardFighter)
                {
                    if (guard.IsPortalKeepGuard || guard.Level == 255)
                        guard.Inventory = Albion_FighterPK.CloneTemplate();
                    else guard.Inventory = Albion_Fighter.CloneTemplate();
                }
                else if (guard is GuardCommander)
                {
                    guard.Inventory = Albion_Commander.CloneTemplate();
                }
                ...
                {
                    guard.Inventory = Albion_Lord.CloneTemplate();
                }
                else if (guard is GuardMerchant)
                {
                    guard.Inventory = Albion_Merchant.CloneTemplate();
                }
                ...
                {
                    guard.Inventory = Albion_Healer.CloneTemplate();
                }
                else if (guard is GuardArcher)
                {
                    if (guard.IsPortalKeepGuard || guard.Level == 255)
                        guard.Inventory = Albion_ArcherPK.CloneTemplate();
                    else guard.Inventory = Albion_Archer.CloneTemplate();
                }
                else if (guard is GuardCaster)
                {
                    if (guard.IsPortalKeepGuard || guard.Level == 255)
                        guard.Inventory = Albion_CasterPK.CloneTemplate();
                    else guard.Inventory = Albion_Caster.CloneTemplate();
                }
                else if (guard is GuardStealther)
                {
                    guard.Inventory = Albion_Stealther.CloneTemplate();
                }
            ...
            case eRealm.Midgard:
            {
                ...
                {
                    if (guard.IsPortalKeepGuard || guard.Level == 255)
                        guard.Inventory = Midgard_FighterPK.CloneTemplate();
                    else guard.Inventory = Midgard_Fighter.CloneTemplate();
                }
                else if (guard is GuardCommander)
                {
                    guard.Inventory = Midgard_Commander.CloneTemplate();
                }
                else if (guard is GuardFighterRK)
                {
                    guard.Inventory = Midgard_FighterPK.CloneTemplate();
                ...
                {
                    guard.Inventory = Midgard_Lord.CloneTemplate();
                }
                else if (guard is GuardMerchant)
                {
                    guard.Inventory = Midgard_Merchant.CloneTemplate();
                }
                else if (guard is GuardCurrencyMerchant)
                {
                    guard.Inventory = Midgard_Merchant.CloneTemplate();
                ...
                {
                    guard.Inventory = Midgard_Healer.CloneTemplate();
                }
                else if (guard is GuardArcher)
                {
                    if (guard.IsPortalKeepGuard || guard.Level == 255)
                        guard.Inventory = Midgard_ArcherPK.CloneTemplate();
                    else guard.Inventory = Midgard_Archer.CloneTemplate();
                }
                else if (guard is GuardCaster)
                {
                    if (guard.IsPortalKeepGuard || guard.Level == 255)
                        guard.Inventory = Midgard_CasterPK.CloneTemplate();
                    else guard.Inventory = Midgard_Caster.CloneTemplate();
                }
                else if (guard is GuardStealther)
                {
                    guard.Inventory = Midgard_Stealther.CloneTemplate();
                }
            ...
            case eRealm.Hibernia:
            {
                ...
                {
                    if (guard.IsPortalKeepGuard || guard.Level == 255)
                        guard.Inventory = Hibernia_FighterPK.CloneTemplate();
                    else guard.Inventory = Hibernia_Fighter.CloneTemplate();
                }
                else if (guard is GuardCommander)
                {
                    guard.Inventory = Hibernia_Commander.CloneTemplate();
                }
                else if (guard is GuardFighterRK)
                {
                    guard.Inventory = Hibernia_FighterPK.CloneTemplate();
                ...
                {
                    guard.Inventory = Hibernia_Lord.CloneTemplate();
                }
                else if (guard is GuardMerchant)
                {
                    guard.Inventory = Hibernia_Merchant.CloneTemplate();
                }
                else if (guard is GuardCurrencyMerchant)
                {
                    guard.Inventory = Hibernia_Merchant.CloneTemplate();
                ...
                {
                    guard.Inventory = Hibernia_Healer.CloneTemplate();
                }
                else if (guard is GuardArcher)
                {
                    if (guard.IsPortalKeepGuard || guard.Level == 255)
                        guard.Inventory = Hibernia_ArcherPK.CloneTemplate();
                    else guard.Inventory = Hibernia_Archer.CloneTemplate();
                }
                else if (guard is GuardCaster)
                {
                    if (guard.IsPortalKeepGuard || guard.Level == 255)
                        guard.Inventory = Hibernia_CasterPK.CloneTemplate();
                    else guard.Inventory = Hibernia_Caster.CloneTemplate();
                }
                else if (guard is GuardStealther)
                {
                    guard.Inventory = Hibernia_Stealther.CloneTemplate();
                }
        ...
        {
            GameServer.KeepManager.Log.Warn("Clothing Manager: Guard Inventory is null for " +
                                            guard.GetType().ToString());
            return;
        }

        var template = guard.Inventory as GameNpcInventoryTemplate;
        ...
        if (guard.Realm == eRealm.None)
        {
            ...
            item = guard.Inventory.GetItem(eInventorySlot.TorsoArmor);
            if (item != null) item.Color = renegadeArmorColor;
        ...
        else if ((guard is GuardFighter || guard is GuardCommander || guard is GuardLord ||
                  guard is GuardFighterRK) && Util.Chance(50))
            guard.SwitchWeapon(eActiveWeaponSlot.TwoHanded);
    ...
    public static void SetEmblem(GameKeepGuard guard)
    {
        ...
        var shield = guard.Inventory.GetItem(eInventorySlot.LeftHandWeapon);

...
public class WarlockSpeedDecreaseSpellHandler : UnbreakableSpeedDecreaseSpellHandler
{
    ...
    public override int OnEffectExpires(GameSpellEffect effect, bool noMessages)
    {
        ...
        if (effect.Owner is GamePlayer) effect.Owner.Model = m_playerModel;
    ...
    // constructor
    public WarlockSpeedDecreaseSpellHandler(GameLiving caster, Spell spell, SpellLine line) : base(caster, spell,
        line)
    {
    }
}
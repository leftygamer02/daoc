...
public class Spell : Skill, ICustomParamsValuable
{
    ...
    public bool IsPrimary => m_isprimary;

    public bool IsSecondary => m_issecondary;
    ...
    public bool AllowBolt => m_allowbolt;
    ...
    public ushort ClientEffect => m_effectID;

    public string Description => m_description;

    public int SharedTimerGroup => m_sharedtimergroup;

    public virtual string Target => m_target;
    ...
    public virtual byte SpellType => m_spelltype;
    ...
    public virtual int Frequency => m_frequency;

    public virtual int Pulse => m_pulse;

    public int PulsePower => m_pulse_power;

    public int Radius => m_radius;

    public int RecastDelay => m_recastdelay;

    public int ResurrectHealth => m_reshealth;

    public int ResurrectMana => m_resmana;
    ...
    public int LifeDrainReturn => m_lifedrain_return;

    public int AmnesiaChance => m_amnesia_chance;

    public string Message1 => m_message1;

    public string Message2 => m_message2;

    public string Message3 => m_message3;

    public string Message4 => m_message4;

    public override eSkillPage SkillType => NeedInstrument ? eSkillPage.Songs : eSkillPage.Spells;

    public int InstrumentRequirement => m_instrumentRequirement;

    public int Group => m_spellGroup;

    public int EffectGroup => m_effectGroup;

    public int SubSpellID => m_subSpellID;

    public bool MoveCast => m_moveCast;

    public bool Uninterruptible => m_uninterruptible;

    public virtual bool IsFocus => m_isfocus;
    ...
    public bool ScaledToPetLevel
    {
        get => scaledToPetLevel;
        set => scaledToPetLevel = value;
    }

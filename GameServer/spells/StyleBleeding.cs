...
public class StyleBleeding : SpellHandler
{
    ...
    public override void OnEffectStart(GameSpellEffect effect)
    {
        ...
        effect.Owner.TempProperties.setProperty(BLEED_VALUE_PROPERTY,
            (int) Spell.Damage + (int) Spell.Damage * Util.Random(25) / 100); // + random max 25%
    }
    ...
    public override void OnEffectPulse(GameSpellEffect effect)
    {
        ...
        var bleedValue = effect.Owner.TempProperties.getProperty<int>(BLEED_VALUE_PROPERTY);

        var ad = CalculateDamageToTarget(effect.Owner, 1.0);
    ...
    {
        return new GameSpellEffect(this, CalculateEffectDuration(target, effectiveness), Spell.Frequency,
            effectiveness);
    }

    public override AttackData CalculateDamageToTarget(GameLiving target, double effectiveness)
    {
        var bleedValue = target.TempProperties.getProperty<int>(BLEED_VALUE_PROPERTY);

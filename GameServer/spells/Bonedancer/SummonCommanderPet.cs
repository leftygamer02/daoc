...
public class SummonCommanderPet : SummonSpellHandler
{
    ...
    public override bool CheckBeginCast(GameLiving selectedTarget)
    {
        ...
        {
            MessageToCaster(
                LanguageMgr.GetTranslation((Caster as GamePlayer).Client, "SummonCommanderPet.CheckBeginCast.Text"),
    ...
    protected override void OnNpcReleaseCommand(DOLEvent e, object sender, EventArgs arguments)
    {
        ...
        var pet = sender as CommanderPet;
    ...
    public override IList<string> DelveInfo
    {
        get
        {
            ...
            delve.Add(LanguageMgr.GetTranslation((Caster as GamePlayer).Client,
                "SummonCommanderPet.DelveInfo.Text1"));
            delve.Add("");
            delve.Add(LanguageMgr.GetTranslation((Caster as GamePlayer).Client,
                "SummonCommanderPet.DelveInfo.Text2"));
            delve.Add("");
            delve.Add(LanguageMgr.GetTranslation((Caster as GamePlayer).Client,
                "SummonCommanderPet.DelveInfo.Text3", Spell.Target));
            delve.Add(LanguageMgr.GetTranslation((Caster as GamePlayer).Client,
                "SummonCommanderPet.DelveInfo.Text4", Math.Abs(Spell.Power)));
            delve.Add(LanguageMgr.GetTranslation((Caster as GamePlayer).Client,
                "SummonCommanderPet.DelveInfo.Text5",

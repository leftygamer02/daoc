    ...
    public override IList<string> DelveInfo
    {
        get
        {
            ...
            if (Spell.InstrumentRequirement != 0)
                list.Add(LanguageMgr.GetTranslation((Caster as GamePlayer).Client, "DelveInfo.InstrumentRequire",
            ...
            if (Spell.LifeDrainReturn != 0)
                ...
                list.Add(LanguageMgr.GetTranslation((Caster as GamePlayer).Client, "DelveInfo.Value",
            ...
            if (Spell.Power != 0)
                list.Add(LanguageMgr.GetTranslation((Caster as GamePlayer).Client, "DelveInfo.HealthCost",
...
public abstract class AbstractSavageStatBuff : AbstractSavageBuff
{
    ...
    // constructor
    public AbstractSavageStatBuff(GameLiving caster, Spell spell, SpellLine spellLine) : base(caster, spell,
        spellLine)
    {
    }
}
...
public abstract class AbstractSavageResistBuff : AbstractSavageBuff
{
    ...
    // constructor
    public AbstractSavageResistBuff(GameLiving caster, Spell spell, SpellLine spellLine) : base(caster, spell,
        spellLine)
    {
    }
}
...
public class SavageCombatSpeedBuff : AbstractSavageStatBuff
{
    ...
    // constructor
    public SavageCombatSpeedBuff(GameLiving caster, Spell spell, SpellLine spellLine) : base(caster, spell,
        spellLine)
    {
    }
}
...
public class SavageSlashResistanceBuff : AbstractSavageResistBuff
{
    ...
    // constructor
    public SavageSlashResistanceBuff(GameLiving caster, Spell spell, SpellLine spellLine) : base(caster, spell,
        spellLine)
    {
    }
}
...
public class SavageThrustResistanceBuff : AbstractSavageResistBuff
{
    ...
    // constructor
    public SavageThrustResistanceBuff(GameLiving caster, Spell spell, SpellLine spellLine) : base(caster, spell,
        spellLine)
    {
    }
}
...
public class SavageCrushResistanceBuff : AbstractSavageResistBuff
{
    ...
    // constructor
    public SavageCrushResistanceBuff(GameLiving caster, Spell spell, SpellLine spellLine) : base(caster, spell,
        spellLine)
    {
    }
}
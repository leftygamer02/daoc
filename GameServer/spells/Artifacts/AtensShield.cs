...
public class AtensShield : SummonItemSpellHandler
{
        ...
        : base(caster, spell, line)
    {
        ...
        {
            m_goldenTridentofFlame = GameServer.Database.FindObjectByKey<ItemTemplate>("Golden_Trident_of_Flame") ??
                                     Javelin;
    ...
    private ItemTemplate Javelin
    {
        get
        {
            m_goldenTridentofFlame =
                (ItemTemplate) GameServer.Database.FindObjectByKey<ItemTemplate>("Golden_Trident_of_Flame");
    ...
    private ItemTemplate JavelinM
    {
        ...
        {
            m_goldenTridentofFlame =
                (ItemTemplate) GameServer.Database.FindObjectByKey<ItemTemplate>("Golden_Trident_of_FlameM");
            if (m_goldenTridentofFlame == null)
            {
                if (log.IsWarnEnabled) log.Warn("Could not find Golden_Trident_of_Flame, loading it ...");
                m_goldenTridentofFlame = new ItemTemplate();
    ...
    private ItemTemplate JavelinH
    {
        ...
        {
            m_goldenTridentofFlame =
                (ItemTemplate) GameServer.Database.FindObjectByKey<ItemTemplate>("Golden_Trident_of_FlameH");
            if (m_goldenTridentofFlame == null)
            {
                if (log.IsWarnEnabled) log.Warn("Could not find Golden_Trident_of_Flame, loading it ...");
                m_goldenTridentofFlame = new ItemTemplate();

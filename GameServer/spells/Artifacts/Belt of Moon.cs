...
public class BeltOfMoon : SummonItemSpellHandler
{
        ...
        : base(caster, spell, line)
    {
        ...
        {
            MessageToCaster("The powers of the Belt of Moon, can only be Summon under the Moon light!",
    ...
    private static void OnPlayerReleased(DOLEvent e, object sender, EventArgs arguments)
    {
        ...
        lock (player.Inventory)
        {
            ...
            {
                if (player.CurrentRegion.IsNightTime) return;
                ...
                player.Out.SendMessage("The Power of Belt of Moon, has left you!", eChatType.CT_System,

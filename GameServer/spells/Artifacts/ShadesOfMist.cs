...
public class ShadeOfMistDefensiveProcSpellHandler : SpellHandler
{
    ...
    public override void OnEffectStart(GameSpellEffect effect)
    {
        ...
        if (effect.Owner is GamePlayer)
        {
            ...
            GameEventMgr.AddHandler(effect.Owner, GameLivingEvent.AttackedByEnemy,
    ...
    public override int OnEffectExpires(GameSpellEffect effect, bool noMessages)
    {
        ...
        GameEventMgr.RemoveHandler(effect.Owner, GameLivingEvent.AttackedByEnemy,
            new DOLEventHandler(EventHandler));
    ...
    public void EventHandler(DOLEvent e, object sender, EventArgs arguments)
    {
        ...
        if (ablativehp != 0)
        {
            ...
            MessageToLiving(ad.Target, string.Format("Your ablative absorbs {0} damage!", damageAbsorbed),
                eChatType.CT_Spell); //since its not always Melee absorbing
    ...
    public ShadeOfMistDefensiveProcSpellHandler(GameLiving caster, Spell spell, SpellLine line) : base(caster,
        spell, line)
    {
    }
}
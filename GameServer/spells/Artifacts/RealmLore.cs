...
public class RealmLore : SpellHandler
{
    ...
    public override void OnDirectEffect(GameLiving target, double effectiveness)
    {
        ...
        text.Add("Realmpoints: " + player.RealmPoints + " = " + string.Format("{0:#L#} {1}", player.RealmLevel + 10,
            player.RealmRankTitle(player.Client.Account.Language)));
        text.Add("----------------------------------------------------");

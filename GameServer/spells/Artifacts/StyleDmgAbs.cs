...
public class StyleDmgAbsSpellHandler : SpellHandler
{
    ...
    public override void OnEffectStart(GameSpellEffect effect)
    {
        ...
        var toOther = Spell.Pulse == 0 ? eChatType.CT_System : eChatType.CT_SpellPulse;
    ...
    private void OnAttack(DOLEvent e, object sender, EventArgs arguments)
    {
        ...
        var damageAbsorbed = (int) (0.01 * absorbPercent * ad.StyleDamage);
        ...
        MessageToLiving(ad.Target, string.Format("Your style absorbtion absorbs {0} damage!", damageAbsorbed),
            eChatType.CT_Spell);
        MessageToLiving(ad.Attacker, string.Format("A barrier absorbs {0} damage of your attack!", damageAbsorbed),
            eChatType.CT_Spell);
    }

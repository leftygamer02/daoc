...
public class ResurrectSpellHandler : SpellHandler
{
    ...
    public override void OnDirectEffect(GameLiving target, double effectiveness)
    {
        ...
        else
        {
            ...
            targetPlayer.Out.SendCustomDialog(
                "Do you allow " + m_caster.GetName(0, true) + " to resurrected you\n with " +
                m_spell.ResurrectHealth + " percent hits/power?",
                new CustomDialogResponse(ResurrectResponceHandler));
        }
    }
    ...
    public override int PowerCost(GameLiving target)
    {
        ...
        var factor = Math.Max(0.1f, 0.5f + (target.Level - m_caster.Level) / (float) m_caster.Level);
        ...
        if (!player.IsAlive)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        var PRAbility = Ability as AtlasOF_PerfectRecovery;
    ...
    protected virtual void ResurrectLiving(GameLiving living)
    {
        ...
        var tempManaEnd = m_spell.ResurrectMana / 100.0;
        ...
        if (player != null)
        {
            ...
            player.Out.SendMessage("You have been resurrected by " + m_caster.GetName(0, false) + "!",
            ...
            {
                attackers = new List<GameObject>(player.attackComponent.Attackers);
            }
            ...
            {
                var rezRps = player.LastDeathRealmPoints * (Spell.ResurrectHealth + 50) / 1000;
                if (rezRps > 0)
                {
    ...
    public override bool CheckBeginCast(GameLiving target)
    {
        ...
        var resurrectionCaster =
            target.TempProperties.getProperty<object>(RESURRECT_CASTER_PROPERTY, null) as GameLiving;
    ...
    {
        return SpellLine.Name == "RealmAbilities";
    }
}
...
public class PowerRegenSpellHandler : PropertyChangingSpell
{
    ...
    public PowerRegenSpellHandler(GameLiving caster, Spell spell, SpellLine spellLine) : base(caster, spell,
        spellLine)
    {
    }
}
...
public class EnduranceRegenSpellHandler : PropertyChangingSpell
{
    ...
    public override void FinishSpellCast(GameLiving target)
    {
        if (Spell.Concentration > 0)
        {
            ...
            var rangeCheck = new RangeCheckAction(Caster, this);
    ...
    private void EnableEffect(GameSpellEffect effect)
    {
        ...
        var bonuscat = GetBonusCategory(effect.Owner, BonusCategory1);
    ...
    private sealed class RangeCheckAction : RegionECSAction
    {
        ...
        protected override int OnTick(ECSGameTimer timer)
        {
            ...
            lock (effects)
            {
                ...
                {
                    var effect = (GameSpellEffect) de.Key;
                    var effectOwner = effect.Owner;

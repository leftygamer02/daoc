...
public class SilenceSpellHandler : SpellHandler
{
    ...
    public override void OnEffectStart(GameSpellEffect effect)
    {
        ...
        {
            effect.Owner.SilencedTime = effect.Owner.CurrentRegion.Time +
                                        CalculateEffectDuration(effect.Owner, Caster.Effectiveness);
            effect.Owner.StopCurrentSpellcast();
            effect.Owner.StartInterruptTimer(effect.Owner.SpellInterruptDuration, AttackData.eAttackType.Spell,
                Caster);
        }
    }

...
public class EnduranceHealSpellHandler : SpellHandler
{
    ...
    public override bool StartSpell(GameLiving target)
    {
        ...
        var spellValue = (int) Math.Round(Spell.Value);
    ...
    public virtual bool HealTarget(GameLiving target, int amount)
    {
        ...
        var heal = target.ChangeEndurance(Caster, eEnduranceChangeType.Spell, amount);
        ...
        {
            MessageToCaster("You restore " + target.GetName(0, false) + " for " + heal + " ednurance points!",
                eChatType.CT_Spell);
            MessageToLiving(target,
                "Your endurance was restored by " + m_caster.GetName(0, false) + " for " + heal + " points.",
                eChatType.CT_Spell);
            if (heal < amount)
    ...
    public override bool CheckBeginCast(GameLiving selectedTarget)
    {
        ...
        {
            MessageToCaster("You cannot cast an endurance heal the target has above 90% endurance!",

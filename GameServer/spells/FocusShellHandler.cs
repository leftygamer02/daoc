...
public class FocusShellHandler : SpellHandler
{
    ...
    public override bool CheckBeginCast(GameLiving selectedTarget)
    {
        ...
        if (GameServer.ServerRules.IsAllowedToAttack(selectedTarget, Caster, true) == false)
        {
            ...
            {
                var currentSpell = Caster.LastPulseCast;

                if (currentSpell != null && currentSpell == Spell) Caster.CancelFocusSpell();
    ...
    {
        var attackArgs = args as AttackedByEnemyEventArgs;
        ...
        if (attackArgs.AttackData.Attacker.Realm != eRealm.None)
        {
            ...
            var damageAbsorbed = (int) (attackArgs.AttackData.Damage * (Spell.Value * .01));
    ...
    private class FSTimer : RegionECSAction
    {
        ...
        private FocusShellHandler m_handler;
        ...
        protected override int OnTick(ECSGameTimer ecsGameTimer)
        {
            ...
            if (m_handler.Caster.Mana >= m_handler.Spell.PulsePower &&
                m_handler.Caster.IsWithinRadius(m_handler.FSTarget, m_handler.Spell.Range))
            {

...
public class BeFriendSpellHandler : SpellHandler
{
    ...
    /// </summary>
    private readonly ReaderWriterDictionary<GameNPC, FriendBrain> m_NPCFriendBrain = new();
    ...
    public override void ApplyEffectOnTarget(GameLiving target, double effectiveness)
    {
        ...
        if (npcTarget.Level > Spell.Value)
        {
            ...
            this.MessageToCaster(eChatType.CT_SpellResisted, "{0} is too strong for you to charm!",
        ...
        {
            SendSpellResistAnimation(target);
            this.MessageToCaster(eChatType.CT_SpellResisted, "{0} is already under control.",
                target.GetName(0, true));
            return;
        }
    ...
    public override int OnEffectExpires(GameSpellEffect effect, bool noMessages)
    {
        ...
        if (m_NPCFriendBrain.TryRemove(npcTarget, out fearBrain)) npcTarget.RemoveBrain(fearBrain);

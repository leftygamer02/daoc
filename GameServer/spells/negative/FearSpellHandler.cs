...
public class FearSpellHandler : SpellHandler
{
    ...
    /// </summary>
    private readonly ReaderWriterDictionary<GameNPC, FearBrain> m_NPCFearBrains = new();
    ...
    public override int OnEffectExpires(GameSpellEffect effect, bool noMessages)
    {
        ...
        FearBrain fearBrain;
        if (m_NPCFearBrains.TryRemove(npcTarget, out fearBrain)) npcTarget.RemoveBrain(fearBrain);

...
public class WaterBreathingSpellHandler : SpellHandler
{
    ...
    public override int OnEffectExpires(GameSpellEffect effect, bool noMessages)
    {
        ...
        if (player != null)
        {
            ...
            var item = player.Inventory.GetItem((eInventorySlot) 37);
            if (item == null || !item.Name.ToLower().Contains("ektaktos")) player.CanBreathUnderWater = false;

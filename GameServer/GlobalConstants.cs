...
{
    private static readonly Dictionary<eAttackResult, byte> AttackResultByte = new()
    {
    ...
    {
        if (AttackResultByte.ContainsKey(attResult)) return AttackResultByte[attResult];
    ...
    {
        var enabled = true;
        foreach (var ex in Util.SplitCSV(ServerProperties.Properties.DISABLED_EXPANSIONS, true))
        {
            var exNum = 0;
    ...
    {
        return objectType == eObjectType.CompositeBow || objectType == eObjectType.Longbow ||
               objectType == eObjectType.RecurvedBow;
    }
    ...
    {
        var values = name.Trim().ToLower().Split(' ');
    ...
    public static string CraftLevelToCraftTitle(GameClient client, int craftLevel)
    {
        switch ((int) (craftLevel / 100))
        {
            ...
            case 1:
                return LanguageMgr.GetTranslation(client.Account.Language,
                    "CraftLevelToCraftTitle.JuniorApprentice");
            ...
            case 9:
                return LanguageMgr.GetTranslation(client.Account.Language, "CraftLevelToCraftTitle.Grandmaster");
            case 10: return LanguageMgr.GetTranslation(client.Account.Language, "CraftLevelToCraftTitle.Legendary");
            case 11:
                return LanguageMgr.GetTranslation(client.Account.Language,
                    "CraftLevelToCraftTitle.LegendaryGrandmaster");
        }
    ...
    /// </summary>
    public static readonly Dictionary<eRace, Dictionary<eStat, int>> STARTING_STATS_DICT =
        new()
        {
            {
                eRace.Unknown,
                ...
                {
                    {eStat.STR, 60}, {eStat.CON, 60}, {eStat.DEX, 60}, {eStat.QUI, 60}, {eStat.INT, 60},
                    {eStat.PIE, 60}, {eStat.EMP, 60}, {eStat.CHR, 60}
                }
            },
            {
                eRace.Briton,
            ...
            },
            {
                ...
                new Dictionary<eStat, int>()
                {
                    {eStat.STR, 45}, {eStat.CON, 45}, {eStat.DEX, 60}, {eStat.QUI, 70}, {eStat.INT, 80},
                    {eStat.PIE, 60}, {eStat.EMP, 60}, {eStat.CHR, 60}
                }
            },
            {
                ...
                new Dictionary<eStat, int>()
                {
                    {eStat.STR, 70}, {eStat.CON, 70}, {eStat.DEX, 50}, {eStat.QUI, 50}, {eStat.INT, 60},
                    {eStat.PIE, 60}, {eStat.EMP, 60}, {eStat.CHR, 60}
                }
            },
            {
                ...
                new Dictionary<eStat, int>()
                {
                    {eStat.STR, 50}, {eStat.CON, 50}, {eStat.DEX, 80}, {eStat.QUI, 60}, {eStat.INT, 60},
                    {eStat.PIE, 60}, {eStat.EMP, 60}, {eStat.CHR, 60}
                }
            },
            {
            ...
            },
            {
                ...
                new Dictionary<eStat, int>()
                {
                    {eStat.STR, 100}, {eStat.CON, 70}, {eStat.DEX, 35}, {eStat.QUI, 35}, {eStat.INT, 60},
                    {eStat.PIE, 60}, {eStat.EMP, 60}, {eStat.CHR, 60}
                }
            },
            {
                ...
                new Dictionary<eStat, int>()
                {
                    {eStat.STR, 60}, {eStat.CON, 80}, {eStat.DEX, 50}, {eStat.QUI, 50}, {eStat.INT, 60},
                    {eStat.PIE, 60}, {eStat.EMP, 60}, {eStat.CHR, 60}
                }
            },
            {
                ...
                new Dictionary<eStat, int>()
                {
                    {eStat.STR, 50}, {eStat.CON, 50}, {eStat.DEX, 70}, {eStat.QUI, 70}, {eStat.INT, 60},
                    {eStat.PIE, 60}, {eStat.EMP, 60}, {eStat.CHR, 60}
                }
            },
            {
            ...
            },
            {
                ...
                new Dictionary<eStat, int>()
                {
                    {eStat.STR, 90}, {eStat.CON, 60}, {eStat.DEX, 40}, {eStat.QUI, 40}, {eStat.INT, 60},
                    {eStat.PIE, 60}, {eStat.EMP, 70}, {eStat.CHR, 60}
                }
            },
            {
                eRace.Elf,
                new Dictionary<eStat, int>()
                {
                    {eStat.STR, 40}, {eStat.CON, 40}, {eStat.DEX, 75}, {eStat.QUI, 75}, {eStat.INT, 70},
                    {eStat.PIE, 60}, {eStat.EMP, 60}, {eStat.CHR, 60}
                }
            },
            {
                ...
                new Dictionary<eStat, int>()
                {
                    {eStat.STR, 40}, {eStat.CON, 40}, {eStat.DEX, 80}, {eStat.QUI, 80}, {eStat.INT, 60},
                    {eStat.PIE, 60}, {eStat.EMP, 60}, {eStat.CHR, 60}
                }
            },
            {
                ...
                new Dictionary<eStat, int>()
                {
                    {eStat.STR, 50}, {eStat.CON, 60}, {eStat.DEX, 70}, {eStat.QUI, 50}, {eStat.INT, 70},
                    {eStat.PIE, 60}, {eStat.EMP, 60}, {eStat.CHR, 60}
                }
            },
            {
                ...
                new Dictionary<eStat, int>()
                {
                    {eStat.STR, 55}, {eStat.CON, 45}, {eStat.DEX, 65}, {eStat.QUI, 75}, {eStat.INT, 60},
                    {eStat.PIE, 60}, {eStat.EMP, 60}, {eStat.CHR, 60}
                }
            },
            {
                ...
                new Dictionary<eStat, int>()
                {
                    {eStat.STR, 70}, {eStat.CON, 60}, {eStat.DEX, 55}, {eStat.QUI, 45}, {eStat.INT, 70},
                    {eStat.PIE, 60}, {eStat.EMP, 60}, {eStat.CHR, 60}
                }
            }
    ...
    /// </summary>
    public static readonly Dictionary<eRealm, List<eCharacterClass>> STARTING_CLASSES_DICT =
        new()
        {
            // pre 1.93
            {
                ...
                {
                    eCharacterClass.Fighter, eCharacterClass.Acolyte, eCharacterClass.Mage,
                    eCharacterClass.Elementalist, eCharacterClass.AlbionRogue, eCharacterClass.Disciple,
                    // post 1.93
            ...
            },
            {
                ...
                {
                    eCharacterClass.Viking, eCharacterClass.Mystic, eCharacterClass.Seer,
            ...
            },
            {
                ...
                {
                    eCharacterClass.Guardian, eCharacterClass.Stalker, eCharacterClass.Naturalist,
                    eCharacterClass.Magician, eCharacterClass.Forester,
                    // post 1.93
    ...
    /// </summary>
    public static readonly Dictionary<eRace, eGender> RACE_GENDER_CONSTRAINTS_DICT =
        new()
        {
    ...
    /// </summary>
    public static readonly Dictionary<eCharacterClass, eGender> CLASS_GENDER_CONSTRAINTS_DICT =
        new()
        {
    ...
    {
        var r = (eRace) race;
        var translationID = string.Format("GamePlayer.PlayerRace.{0}", r.ToString("F")); //Returns 'Unknown'

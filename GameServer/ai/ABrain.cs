...
public abstract class ABrain
{
    private readonly object
        m_LockObject =
            new(); // dummy object for locking - Mannen. // use this object for locking, instead of locking on 'this'

    public FSM FSM { get; set; }
    public virtual GameNPC Body { get; set; }

    public virtual bool IsActive => Body != null && Body.IsAlive &&
                                    Body.ObjectState == GameObject.eObjectState.Active && Body.IsVisibleToPlayers;

...
public class AggressiveBrain : APlayerVicinityBrain
{
    ...
    private object m_syncBehaviour = new();
    ...
    /// </summary>
    public virtual ushort AggressionRange => 1000;

    /// <summary>
    /// Level of aggression.
    /// </summary>
    public virtual ushort AggressionLevel => 100;
    ...
    private void PickTarget()
    {
        ...
        var target = Aggression.PrimaryTarget;
    ...
    protected virtual void OnAttacked(AttackData attackData)
    {
        ...
        if (attackData.Target == Body)
        {
            ...
            {
                var spellhandler = attackData.SpellHandler;
    ...
    public override void Notify(DOLEvent e, object sender, EventArgs args)
    {
        ...
        if (sender == Body)
        {
            ...
            if (e == GameLivingEvent.CastFinished || e == GameLivingEvent.CastFinished ||
        ...
        if (e == GameLivingEvent.AttackedByEnemy)
        {
            ...
            {
                var attackData = (args as AttackedByEnemyEventArgs).AttackData;
        ...
        if (e == GameLivingEvent.EnemyHealed)
        {
            ...
            {
                var healed = args as EnemyHealedEventArgs;
        ...
        if (e == GameLivingEvent.EnemyKilled)
        {
            ...
            {
                var killed = args as EnemyKilledEventArgs;
    ...
    private class InternalAggression
    {
        ...
        public IList<GameLiving> Targets
        {
            get
            {
                lock (m_syncObject)
                {
                    ...
                    foreach (var target in m_aggression.Keys)
                        targets.Add(target);
        ...
        public void Raise(GameLiving living, long amount)
        {
            ...
            lock (m_syncObject)
            {
                ...
                else
                {
                    ...
                    {
                        var group = (living as GamePlayer).Group;
        ...
        public void Lower(GameLiving living, long amount)
        {
            ...
            lock (m_syncObject)
            {
                if (m_aggression.ContainsKey(living))
                {
                    var current = m_aggression[living];
        ...
        public GameLiving PrimaryTarget
        {
            get
            {
                ...
                lock (m_syncObject)
                {
                    foreach (var living in m_aggression.Keys)

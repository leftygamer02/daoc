...
public class DragonBrain : StandardMobBrain
{
    ...
    public override void Notify(DOLEvent e, object sender, EventArgs args)
    {
        ...
        if (sender == Body)
        {
            var dragon = sender as GameDragon;
            if (e == GameObjectEvent.TakeDamage)
            {
                ...
                {
                    log.Error("Dragon takes damage from null source. args = " +
            ...
            else if (e == GameLivingEvent.EnemyHealed)
            {
                ...
                var source = (args as EnemyHealedEventArgs).HealSource;
    ...
    public bool CheckHealth()
    {
        ...
        var healthOld = dragon.HealthPercentOld / 10;
        var healthNow = dragon.HealthPercent / 10;

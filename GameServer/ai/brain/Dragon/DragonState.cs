...
public class DragonState_IDLE : DragonState
{
    ...
    {
        if (ECS.Debug.Diagnostics.StateMachineDebugEnabled) Console.WriteLine($"Dragon {_brain.Body} has entered IDLE");
...
public class DragonState_RETURN_TO_SPAWN : DragonState
{
    ...
    public override void Enter()
    {
        ...
        var dragon = _brain.Body as GameDragon;
        if (dragon != null) dragon.PrepareToStun();

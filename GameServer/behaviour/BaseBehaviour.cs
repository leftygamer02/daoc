...
public class BaseBehaviour
{
    ...
    /// </summary>
    public List<IBehaviourTrigger> Triggers => triggers;
    ...
    /// </summary>
    public List<IBehaviourAction> Actions => actions;
    ...
    /// </summary>
    public List<IBehaviourRequirement> Requirements => requirements;
    ...
    public void AddTrigger(eTriggerType triggerType, object keyword, object var)
    {
        ...
        var type = BehaviourMgr.GetTypeForTriggerType(triggerType);
        if (type != null)
        {
            trigger = (IBehaviourTrigger) Activator.CreateInstance(type,
                new object[] {NPC, NotifyHandler, keyword, var});
            AddTrigger(trigger);
        }
        else
        {
    ...
    public void AddAction(eActionType actionType, object p, object q)
    {
        ...
        var type = BehaviourMgr.GetTypeForActionType(actionType);
        if (type != null)
        {
    ...
    public void AddRequirement(eRequirementType requirementType, object requirementN,
        eComparator requirementComparator)
    {
    ...
    /// <param name="requirementComparator">Comparator used if some values are veeing compared</param>        
    public void AddRequirement(eRequirementType requirementType, object requirementN, object requirementV,
        eComparator requirementComparator)
    {
        IBehaviourRequirement requ = null;

        var type = BehaviourMgr.GetTypeForRequirementType(requirementType);
        if (type != null)
        {
            requ = (IBehaviourRequirement) Activator.CreateInstance(type,
                new object[] {NPC, requirementN, requirementV, requirementComparator});
            AddRequirement(requ);
        }
        else
        {

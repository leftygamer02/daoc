...
public abstract class AbstractAction<TypeP, TypeQ> : IBehaviourAction
{
    ...
    {
        var attr = BehaviourMgr.GetActionAttribute(GetType());

        // handle parameter P
        var defaultValueP = GetDefaultValue(attr.DefaultValueP);
        ...
        // handle parameter Q
        var defaultValueQ = GetDefaultValue(attr.DefaultValueQ);

				...
				case eProperty.Skill_Subterranean: 
					{
						...
						if((type == eObjectType.Shield && this.TypeDamage < 2) || type == eObjectType.Hammer) {
							return true;
                        }
						break;
                    }
				...
				case eProperty.Skill_Regrowth:
					{
						...
						if (type == eObjectType.Blunt || type == eObjectType.Blades || (type == eObjectType.Shield && this.TypeDamage < 2))
							return true;
						break;
					}
				//archery things

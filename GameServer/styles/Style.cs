...
public class Style : Skill
{
    ...
    public eAttackResultRequirement AttackResultRequirement =>
        (eAttackResultRequirement) baseStyle.AttackResultRequirement;
    ...
    public virtual string GetRequiredWeaponName()
    {
        switch (WeaponTypeRequirement)
        {
            case SpecialWeaponType.DualWield:
                ...
                var dwSpec = SkillBase.GetSpecialization(Spec);
            ...
            default:
                ...
                var specKeyName = SkillBase.ObjectTypeToSpec((eObjectType) WeaponTypeRequirement);
                if (specKeyName == null)
                    return "unknown weapon type";
                var spec = SkillBase.GetSpecialization(specKeyName);
                return spec.Name;
        }
    }

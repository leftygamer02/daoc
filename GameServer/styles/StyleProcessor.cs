			...
			switch (style.WeaponTypeRequirement)
			{
				...
				default:
					...
					if (style.WeaponTypeRequirement == (int)eObjectType.Shield
						&& (player.attackComponent.AttackWeapon == null || (player.attackComponent.AttackWeapon.ItemTemplate.ItemType != Slot.RIGHTHAND && player.attackComponent.AttackWeapon.ItemTemplate.ItemType != Slot.LEFTHAND)))
						return false;

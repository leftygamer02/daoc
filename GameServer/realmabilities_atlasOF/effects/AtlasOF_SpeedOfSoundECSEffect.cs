...
public class SpeedOfSoundECSEffect : ECSGameAbilityEffect
{
    ...
    public override void OnStartEffect()
    {
        ...
        if (OwnerPlayer.effectListComponent.ContainsEffectForEffectType(eEffect.Ichor))
            EffectService.RequestDisableEffect(OwnerPlayer.effectListComponent.GetAllEffects()
                .FirstOrDefault(e => e.EffectType == eEffect.Ichor));
    ...
    public override void OnStopEffect()
    {
        ...
        if (OwnerPlayer.effectListComponent.ContainsEffectForEffectType(eEffect.Ichor))
            EffectService.RequestEnableEffect(OwnerPlayer.effectListComponent.GetAllEffects()
                .FirstOrDefault(e => e.EffectType == eEffect.Ichor));

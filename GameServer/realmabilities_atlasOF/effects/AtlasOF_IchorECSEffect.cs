...
public class AtlasOF_IchorECSEffect : ECSGameAbilityEffect
{
    ...
    public override ushort Icon => 7029;

    public override string Name => "Ichor of the Deep";
    ...
    public override void OnStartEffect()
    {
        ...
        if (Owner is GamePlayer gpMessage)
            gpMessage.Out.SendMessage("Constricting bonds surround your body!", eChatType.CT_Spell,
        ...
        foreach (GamePlayer player in Owner.GetPlayersInRadius(WorldMgr.VISIBILITY_DISTANCE))
        {
            ...
            if (player.IsWithinRadius(Owner, WorldMgr.INFO_DISTANCE) && player != Owner)
                player.Out.SendMessage(Owner.GetName(0, false) + " is surrounded by constricting bonds!",

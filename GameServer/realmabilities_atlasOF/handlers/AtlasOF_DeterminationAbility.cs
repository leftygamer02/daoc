...
namespace DOL.GS.RealmAbilities
{
	...
	{
		public AtlasOF_DeterminationAbility(Atlas.DataLayer.Models.Ability dba, int level) : base(dba, level) { }
	...
	{
		public AtlasOF_DeterminationHybridAbility(Atlas.DataLayer.Models.Ability dba, int level) : base(dba, level) { }

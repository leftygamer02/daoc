...
public class AtlasOF_DefenderOfTheVale : TimedRealmAbility
{
    ...
    public override void Execute(GameLiving living)
    {
        ...
        if (living is GamePlayer p) m_player = p;
    ...
    protected void CastSpell(GameLiving target)
    {
        if (target.IsAlive && m_spell != null)
        {
            ...
            {
                var dd = ScriptMgr.CreateSpellHandler(target, m_spell, m_spellline);
    ...
    public override IList<string> DelveInfo
    {
        get
        {
            ...
            list.Add(
                "Applies hit point buffer that absorbs 50% damage for up to 500 hit points to group members in a 1500 radius.");

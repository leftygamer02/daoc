...
namespace DOL.GS.RealmAbilities
{
    ...
    {
        public AtlasOF_PurgeAbility(Atlas.DataLayer.Models.Ability dba, int level) : base(dba, level) { }
    ...
    {
        public AtlasOF_PurgeAbilityReduced(Atlas.DataLayer.Models.Ability dba, int level) : base(dba, level) { }
    ...
    {
        public AtlasOF_GroupPurge(Atlas.DataLayer.Models.Ability dba, int level) : base(dba, level) { }

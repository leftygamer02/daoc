...
public class AtlasOF_IgnorePain : TimedRealmAbility
{
    ...
    public override void Execute(GameLiving living)
    {
        ...
        var heal = 0;
        var currentCharMaxHealth = living.MaxHealth;

        var healed = living.ChangeHealth(living, eHealthChangeType.Spell, currentCharMaxHealth);
        ...
        {
            if (healed > 0)
                player.Out.SendMessage("You heal yourself for " + healed + " hit points.", eChatType.CT_Spell,
...
public class AtlasOF_IgnorePainTank : AtlasOF_IgnorePain
{
    ...
    public override string Name => "Ignore Pain";
}
...
public class AtlasOF_BatteryOfLife : TimedRealmAbility
{
    ...
    private SpellHandler CreateSpell(GameLiving owner)
    {
        ...
        tmpSpell.Description =
            "Creates a 1000HP buffer that is distributed to groupmembers within 1500 units as healing. Healing priority matches spreadheal.";

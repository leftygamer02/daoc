...
public class GameServerEvent : DOLEvent
{
    ...
    /// </summary>
    public static readonly GameServerEvent Started = new("Server.Started");

    /// <summary>
    /// The Stopped event is fired whenever the GameServer is stopping
    /// </summary>
    public static readonly GameServerEvent Stopped = new("Server.Stopped");

    /// <summary>
    /// The WorldSave event is fired whenever the GameServer saves the world
    /// </summary>
    public static readonly GameServerEvent WorldSave = new("Server.WorldSave");
}
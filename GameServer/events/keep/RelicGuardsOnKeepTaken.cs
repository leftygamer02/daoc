...
public class RelicGuardManager
{
    ...
    public static void InitGuards()
    {
        ...
        foreach (AbstractArea area in RenaCE.CurrentAreas)
            if (area is KeepArea)
            {
                var popkeep = (area as KeepArea).Keep;
    ...
    public static void Init()
    {
        ...
        var MidrelicCount = 0;
        var HibrelicCount = 0;
        var Albguardpercentrelic = 100;
        var Midguardpercentrelic = 100;
        var Hibguardpercentrelic = 100;
        var albMaxGuards = 12;
        var midMaxGuards = 12;
        var hibMaxGuards = 12;
        ...
        if (AlbrelicCount > 2)
            for (var i = 2; i < AlbrelicCount; i++)
                Albguardpercentrelic -= 25;

        if (MidrelicCount > 2)
            for (var i = 2; i < MidrelicCount; i++)
                Midguardpercentrelic -= 25;

        if (HibrelicCount > 2)
            for (var i = 2; i < HibrelicCount; i++)
        ...
        if (keep != null)
        {
            ...
            var npcs = WorldMgr.GetNPCsByName("Renaris Knight", eRealm.Albion);
        ...
        if (keep != null)
        {
            ...
            var npcs = WorldMgr.GetNPCsByName("Hurbury Knight", eRealm.Albion);
            if (keep.Realm == keep.OriginalRealm)
            {
                if (npcs.Length == 0)
                {
        ...
        if (keep != null)
        {
            ...
            var npcs = WorldMgr.GetNPCsByName("Berckstead Knight", eRealm.Albion);
            if (keep.Realm == keep.OriginalRealm)
            {
                if (npcs.Length == 0)
                {
        ...
        if (keep != null)
        {
            ...
            var npcs = WorldMgr.GetNPCsByName("Sursbrooke Knight", eRealm.Albion);
            if (keep.Realm == keep.OriginalRealm)
            {
                if (npcs.Length == 0)
                {
        ...
        if (keep != null)
        {
            ...
            var npcs = WorldMgr.GetNPCsByName("Boldiam Knight", eRealm.Albion);
            if (keep.Realm == keep.OriginalRealm)
            {
                if (npcs.Length == 0)
                {
        ...
        if (keep != null)
        {
            ...
            var npcs = WorldMgr.GetNPCsByName("Erasleigh Knight", eRealm.Albion);
            if (keep.Realm == keep.OriginalRealm)
            {
                if (npcs.Length == 0)
                {
        ...
        if (keep != null)
        {
            ...
            var npcs = WorldMgr.GetNPCsByName("Benowyc Knight", eRealm.Albion);
            if (keep.Realm == keep.OriginalRealm)
            {
                if (npcs.Length == 0)
                {
        ...
        if (keep != null)
        {
            ...
            var npcs = WorldMgr.GetNPCsByName("Fensalir Jarl", eRealm.Midgard);
            if (keep.Realm == keep.OriginalRealm)
            {
                if (npcs.Length == 0)
                {
        ...
        if (keep != null)
        {
            ...
            var npcs = WorldMgr.GetNPCsByName("Arvakr Jarl", eRealm.Midgard);
            if (keep.Realm == keep.OriginalRealm)
            {
                if (npcs.Length == 0)
                {
        ...
        if (keep != null)
        {
            ...
            var npcs = WorldMgr.GetNPCsByName("Glenlock Jarl", eRealm.Midgard);
            if (keep.Realm == keep.OriginalRealm)
            {
                if (npcs.Length == 0)
                {
        ...
        if (keep != null)
        {
            ...
            var npcs = WorldMgr.GetNPCsByName("Blendrake Jarl", eRealm.Midgard);
            if (keep.Realm == keep.OriginalRealm)
            {
                if (npcs.Length == 0)
                {
        ...
        if (keep != null)
        {
            ...
            var npcs = WorldMgr.GetNPCsByName("Hlidskialf Jarl", eRealm.Midgard);
            if (keep.Realm == keep.OriginalRealm)
            {
                if (npcs.Length == 0)
                {
        ...
        if (keep != null)
        {
            ...
            var npcs = WorldMgr.GetNPCsByName("Nottmoor Jarl", eRealm.Midgard);
            if (keep.Realm == keep.OriginalRealm)
            {
                if (npcs.Length == 0)
                {
        ...
        if (keep != null)
        {
            ...
            var npcs = WorldMgr.GetNPCsByName("Bledmeer Jarl", eRealm.Midgard);
            if (keep.Realm == keep.OriginalRealm)
            {
                if (npcs.Length == 0)
                {
        ...
        if (keep != null)
        {
            ...
            var npcs = WorldMgr.GetNPCsByName("Ailinne Sentinel", eRealm.Hibernia);
            if (keep.Realm == keep.OriginalRealm)
            {
                if (npcs.Length == 0)
                {
        ...
        if (keep != null)
        {
            ...
            var npcs = WorldMgr.GetNPCsByName("Scathaig Sentinel", eRealm.Hibernia);
            if (keep.Realm == keep.OriginalRealm)
            {
                if (npcs.Length == 0)
                {
        ...
        if (keep != null)
        {
            ...
            var npcs = WorldMgr.GetNPCsByName("nGed Sentinel", eRealm.Hibernia);
            if (keep.Realm == keep.OriginalRealm)
            {
                if (npcs.Length == 0)
                {
        ...
        if (keep != null)
        {
            ...
            var npcs = WorldMgr.GetNPCsByName("Bolg Sentinel", eRealm.Hibernia);
            if (keep.Realm == keep.OriginalRealm)
            {
                if (npcs.Length == 0)
                {
        ...
        if (keep != null)
        {
            ...
            var npcs = WorldMgr.GetNPCsByName("Behnn Sentinel", eRealm.Hibernia);
            if (keep.Realm == keep.OriginalRealm)
            {
                if (npcs.Length == 0)
                {
        ...
        if (keep != null)
        {
            ...
            var npcs = WorldMgr.GetNPCsByName("Crimthain Sentinel", eRealm.Hibernia);
            if (keep.Realm == keep.OriginalRealm)
            {
                if (npcs.Length == 0)
                {
        ...
        if (keep != null)
        {
            ...
            var npcs = WorldMgr.GetNPCsByName("Crauchon Sentinel", eRealm.Hibernia);
            if (keep.Realm == keep.OriginalRealm)
            {
                if (npcs.Length == 0)
                {
    ...
    public static void NotifyRelic(DOLEvent e, object sender, EventArgs args)
    {
        ...
        {
            var relicEvent = args as RelicPadEventArgs;
    ...
    public static void Notify(DOLEvent e, object sender, EventArgs args)
    {
        ...
        {
            var keepEvent = args as KeepEventArgs;
            if (keepEvent.Keep.CurrentZone.IsOF == false) return;

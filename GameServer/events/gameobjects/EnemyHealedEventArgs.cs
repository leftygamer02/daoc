...
public class EnemyHealedEventArgs : EventArgs
{
    ...
    public EnemyHealedEventArgs(GameLiving enemy, GameObject healSource, eHealthChangeType changeType,
        int healAmount)
    {
        m_enemy = enemy;
    ...
    /// </summary>
    public GameLiving Enemy => m_enemy;

    /// <summary>
    /// Gets the heal source
    /// </summary>
    public GameObject HealSource => m_healSource;

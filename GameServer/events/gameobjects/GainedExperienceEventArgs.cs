...
public class GainedExperienceEventArgs : EventArgs
{
    ...
    public GainedExperienceEventArgs(long expBase, long expCampBonus, long expGroupBonus, long expOutpostBonus,
        bool sendMessage, bool allowMultiply, eXPSource xpSource)
    {
        m_expBase = expBase;
    ...
    /// </summary>
    public long ExpBase => m_expBase;

    /// <summary>
    /// Gets the amount of camp bonus experience gained
    /// </summary>
    public long ExpCampBonus => m_expCampBonus;

    /// <summary>
    /// Gets the amount of group bonus experience gained
    /// </summary>
    public long ExpGroupBonus => m_expGroupBonus;

    /// <summary>
    /// gets the amount of outpost bonus experience gained
    /// </summary>
    public long ExpOutpostBonus => m_expOutpostBonus;

    /// <summary>
    /// True if experience gain message was sent
    /// </summary>
    public bool SendMessage => m_sendMessage;

    /// <summary>
    /// is the experience allowed to be multiplied
    /// </summary>
    public bool AllowMultiply => m_allowMultiply;

    public eXPSource XPSource => m_xpSource;
}
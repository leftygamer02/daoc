...
public class GameNPCEvent : GameLivingEvent
{
    ...
    /// </summary>
    public static readonly GameNPCEvent TurnTo = new("GameNPC.TurnTo");

    /// <summary>
    /// The TurnToHeading event is fired whenever the npc turns towards a specific heading
    /// <seealso cref="TurnToHeadingEventArgs"/>
    /// </summary>
    public static readonly GameNPCEvent TurnToHeading = new("GameNPC.TurnToHeading");
    ...
    /// </summary>
    public static readonly GameNPCEvent ArriveAtTarget = new("GameNPC.ArriveAtTarget");

    /// <summary>
    /// The ArriveAtSpawnPoint event is fired whenever the npc arrives at its spawn point
    /// <see cref="DOL.GS.GameNPC.WalkTo(int, int, int, int)"/>
    /// </summary>
    public static readonly GameNPCEvent ArriveAtSpawnPoint = new("GameNPC.ArriveAtSpawnPoint");

    /// <summary>
    /// The CloseToTarget event is fired whenever the npc is close to its WalkTo target
    /// <see cref="DOL.GS.GameNPC.WalkTo(int, int, int, int)"/>
    /// </summary>
    public static readonly GameNPCEvent CloseToTarget = new("GameNPC.CloseToTarget");

    /// <summary>
    /// The WalkTo event is fired whenever the npc is commanded to walk to a specific target
    /// <seealso cref="WalkToEventArgs"/>
    /// </summary>
    public static readonly GameNPCEvent WalkTo = new("GameNPC.WalkTo");

    /// <summary>
    /// The Walk event is fired whenever the npc is commanded to walk
    /// <seealso cref="WalkEventArgs"/>
    /// </summary>
    public static readonly GameNPCEvent Walk = new("GameNPC.Walk");

    /// <summary>
    /// The RiderMount event is fired whenever the npc is mounted by a ride
    /// <seealso cref="RiderMountEventArgs"/>
    /// </summary>
    public static readonly GameNPCEvent RiderMount = new("GameNPC.RiderMount");

    /// <summary>
    /// The RiderDismount event is fired whenever the rider dismounts from the npc
    /// <seealso cref="RiderDismountEventArgs"/>
    /// </summary>
    public static readonly GameNPCEvent RiderDismount = new("GameNPC.RiderDismount");

    /// <summary>
    /// Fired when pathing starts
    /// </summary>
    public static readonly GameNPCEvent PathMoveStarts = new("GameNPC.PathMoveStarts");

    /// <summary>
    /// Fired when npc is on end of path
    /// </summary>
    public static readonly GameNPCEvent PathMoveEnds = new("GameNPC.PathMoveEnds");

    /// <summary>
    /// Fired on every AI callback
    /// </summary>
    public static readonly GameNPCEvent OnAICallback = new("GameNPC.OnAICallback");

    /// <summary>
    /// Fired whenever following NPC lost its target
    /// </summary>
    public static readonly GameNPCEvent FollowLostTarget = new("GameNPC.FollowLostTarget");

    /// <summary>
    /// Fired whenever pet is supposed to cast a spell.
    /// </summary>
    public static readonly GameNPCEvent PetSpell = new("GameNPC.PetSpell");

    /// <summary>
    /// Fired whenever pet is out of tether range (necromancer).
    /// </summary>
    public static readonly GameNPCEvent OutOfTetherRange = new("GameNPC.OutOfTetherRange");

    /// <summary>
    /// Fired when pet is lost (necromancer).
    /// </summary>
    public static readonly GameNPCEvent PetLost = new("GameNPC.PetLost");

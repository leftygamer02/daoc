...
public class RegionEvent : DOLEvent
{
    ...
    /// </summary>
    public static readonly RegionEvent PlayerEnter = new("RegionEvent.PlayerEnter");

    /// <summary>
    /// The PlayerLeave event is fired whenever the player leaves an region		
    /// </summary>
    public static readonly RegionEvent PlayerLeave = new("RegionEvent.PlayerLeave");

    /// <summary>
    /// The RegionLoaded event is fired whenever the region is loaded	
    /// </summary>
    public static readonly RegionEvent RegionStart = new("RegionEvent.RegionStart");

    /// <summary>
    /// The RegionUnLoaded event is fired whenever the region is unloaded	
    /// </summary>
    public static readonly RegionEvent RegionStop = new("RegionEvent.RegionStop");
}
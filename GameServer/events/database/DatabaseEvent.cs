...
public class DatabaseEvent : DOLEvent
{
    ...
    /// </summary>
    public static readonly DatabaseEvent AccountCreated = new("Database.AccountCreated");

    /// <summary>
    /// The CharacterCreated event is fired whenever a new character is created
    /// <seealso cref="CharacterEventArgs"/>
    /// </summary>
    public static readonly DatabaseEvent CharacterCreated = new("Database.CharacterCreated");

    /// <summary>
    /// The CharacterDeleted event is fired whenever an account is deleted
    /// <seealso cref="CharacterEventArgs"/>
    /// </summary>
    public static readonly DatabaseEvent CharacterDeleted = new("Database.CharacterDeleted");

    /// <summary>
    /// The NewsCreated event is fired whenever news is created
    /// </summary>
    public static readonly DatabaseEvent NewsCreated = new("Database.NewsCreated");

    /// <summary>
    /// The CharacterSelected event is fired whenever the player hit "play" button with a valid character..
    /// </summary>
    public static readonly DatabaseEvent CharacterSelected = new("Database.CharacterSelected");
}
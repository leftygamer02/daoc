...
public class FollowingNPCEvent
{
    ...
    public class FollowingNPC : GameNPC
    {
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            player.Out.SendMessage(Name + " will follow you now!", eChatType.CT_Important,
        ...
        protected void CalculateWalkToSpot(object sender, ElapsedEventArgs args)
        {
            ...
            //our target position
            var newX = (int) (m_playerToFollow.X - diffx);
            var newY = (int) (m_playerToFollow.Y - diffy);

...
public class LootGeneratorUniqueItem : LootGeneratorBase
{
    ...
    public class LootGeneratorUniqueObjectCommandHandler : Commands.AbstractCommandHandler,
        ...
        public void OnCommand(GameClient client, string[] args)
        {
            try
            {
                ...
                if (args.Length > 1 && Convert.ToString(args[1]).ToUpper() == "SUIT")
                {
                    ...
                    var weapons = GenerateWeaponsForClass(charclass, player);
                }
                else
                {
                    for (var x = 0; x < 8; x++)
    ...
    public class ClearInventoryCommandHandler : Commands.AbstractCommandHandler,
        Commands.ICommandHandler
    {
        public void OnCommand(GameClient client, string[] args)
        {
            ...
            {
                foreach (var item in client.Player.Inventory.GetItemRange(eInventorySlot.FirstBackpack,
    ...
    public override LootList GenerateLoot(GameNPC mob, GameObject killer)
    {
        ...
        try
        {
            ...
            var classForLoot = (eCharacterClass) player.CharacterClass.ID;
            ...
            var killedCon = player.GetConLevel(mob);
            ...
            var chance = BASE_ROG_CHANCE + ((int) killedCon + 3) * 2;
            // toa item
            var toachance = false;
            ...
            var item = new GeneratedUniqueItem(toachance, player.Realm, classForLoot,
            ...
            if (player.Realm != 0) loot.AddRandom(chance, item, 1);
        }
        catch
        {
            return loot;
    ...
    private static void GenerateWeapon(GameLiving player, eCharacterClass charClass, eObjectType type,
        eInventorySlot invSlot)
    {
        ...
        else if (type == eObjectType.Flexible)
        {
            //slash flex
            var dmgTypeItem =
                new GeneratedUniqueItem(realm, charClass, (byte) 81, type, invSlot, eDamageType.Slash);
            ...
            //crush flex
            var dmgTypeItem2 =
                new GeneratedUniqueItem(realm, charClass, (byte) 81, type, invSlot, eDamageType.Crush);
                 ...
                 type == eObjectType.LargeWeapons)
        {
            ...
            {
                var dmgTypeItem =
                    new GeneratedUniqueItem(realm, charClass, (byte) 81, type, invSlot, (eDamageType) i);
                dmgTypeItem.AllowAdd = true;
                dmgTypeItem.IsTradable = false;
                dmgTypeItem.Price = 1;
                //dmgTypeItem.CapUtility(81);

    ...
    public class JailerBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            ...
            else if (Body.InCombatInLast(30 * 1000) == false && Body.InCombatInLast(35 * 1000))
            {
                ...
                if (!RemoveAdds)
                {
                    foreach (var npc in WorldMgr.GetNPCsFromRegion(160))
                        if (npc != null)
            ...
            if (Body.TargetObject != null && HasAggro)
            {
                ...
                {
                    var rand = Util.Random(25000, 45000);

...
namespace DOL.GS
{
    public class LordGildas : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new LordGildasBrain();
            SetOwnBrain(sbrain);
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (npcs.Length == 0)
            {
                ...
                HOC.Z = 12933;
                HOC.Heading = 2063;
                var ubrain = new LordGildasBrain();
                    ...
                    if (Stage2 == false)
                    {
                        ...
                        if (angle >= 160 && angle <= 200)
                        {
                            ...
                            Body.styleComponent.NextCombatStyle =
                                LordGildas.BackStyle; //do backstyle when angle allow it
                        }
                        else
                        {
                            Body.Strength = npcTemplate.Strength;
                            ...
                            Body.VisibleActiveWeaponSlots = 16;
                            Body.styleComponent.NextCombatStyle =
                                LordGildas.taunt; //if not backstyle for angle then do taunt
                        }
                            ...
                            !target.effectListComponent.ContainsEffectForEffectType(eEffect.StunImmunity))
                        {
                            ...
                            Body.BlockChance = 80;
                            Body.styleComponent.NextCombatStyle =
                                LordGildas.slam; //check if target has stun or immunity if not slam
                        }

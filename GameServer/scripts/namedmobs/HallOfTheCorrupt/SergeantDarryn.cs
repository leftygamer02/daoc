...
namespace DOL.GS
{
    public class SergeantDarryn : GameNPC
    {
        ...
        public override void OnAttackedByEnemy(AttackData ad) // on Boss actions
        {
            ...
            {
                styleComponent.NextCombatBackupStyle = ParryFollowUp;
        ...
        public override void OnAttackEnemy(AttackData ad) //on enemy actions
        {
                ...
                (ad.AttackResult == eAttackResult.HitStyle || ad.AttackResult == eAttackResult.HitUnstyled))
            {
                ...
                styleComponent.NextCombatStyle = ParryFollowUp; //after parry style as main
            }
        ...
        public override bool AddToWorld()
        {
            ...
            if (!Styles.Contains(AfterParry)) Styles.Add(AfterParry);

            if (!Styles.Contains(Taunt)) Styles.Add(Taunt);

            if (!Styles.Contains(ParryFollowUp)) Styles.Add(ParryFollowUp);

            VisibleActiveWeaponSlots = 34;
            MeleeDamageType = eDamageType.Slash;
            var sbrain = new SergeantDarrynBrain();
            SetOwnBrain(sbrain);
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (npcs.Length == 0)
            {
                ...
                HOC.Z = 14941;
                HOC.Heading = 3075;
                var ubrain = new SergeantDarrynBrain();
            ...
            {
                log.Warn(
                    "Sergeant Darryn exist ingame, remove it and restart server if you want to add by script code.");
            }
        }
    }
}

...
namespace DOL.GS
{
    public class LieutenantMeade : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new LieutenantMeadeBrain();
            SetOwnBrain(sbrain);
            SaveIntoDatabase();
            base.AddToWorld();
            return true;
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (npcs.Length == 0)
            {
                ...
                HOC.Z = 15366;
                HOC.Heading = 9;
                var ubrain = new LieutenantMeadeBrain();
            ...
            {
                log.Warn(
                    "Lieutenant Meade exist ingame, remove it and restart server if you want to add by script code.");
            }
        }
    }
}
                ...
                if (Body.TargetObject != null)
                {
                    ...
                    if (!living.effectListComponent.ContainsEffectForEffectType(eEffect.Stun) &&
                        ...
                        Body.styleComponent.NextCombatStyle =
                            LieutenantMeade.slam; //check if target has stun or immunity if not slam

...
namespace DOL.GS
{
    public class CaptainBardalph : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new CaptainBardalphBrain();
            SetOwnBrain(sbrain);
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (npcs.Length == 0)
            {
                ...
                HOC.Z = 14134;
                HOC.Heading = 1008;
                var ubrain = new CaptainBardalphBrain();
            ...
            {
                log.Warn(
                    "Captain Bardalph exist ingame, remove it and restart server if you want to add by script code.");
            }
        }

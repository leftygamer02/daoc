...
namespace DOL.GS
{
    public class Iarnvidiur : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new IarnvidiurBrain();
            SetOwnBrain(sbrain);
    ...
    public class IarnvidiurBrain : StandardMobBrain
    {
        ...
        public int TeleportPlayer(ECSGameTimer timer)
        {
            ...
            if (TeleportTarget.IsAlive && TeleportTarget != null)
            {
                ...
                {
                    case 1:
                        TeleportTarget.MoveTo(161, 12563, 13450, 18537, 2997);
                        break;
                    case 2:
                        TeleportTarget.MoveTo(161, 15212, 13331, 18537, 920);
                        break;
                    case 3:
                        TeleportTarget.MoveTo(161, 16958, 13269, 18537, 988);
                        break;
                    case 4:
                        TeleportTarget.MoveTo(161, 11829, 13530, 18537, 2985);
                        break;
                }
                ...
                else
                {
                    ...
                    if (damage_enemies.Count > 0)
                    {
                        ...
                        if (RandomTarget != null && RandomTarget.IsAlive)
                        {
                            ...
                            {
                                case 1:
                                    Body.CastSpell(Iarnvidiur_Dot,
                                        SkillBase.GetSpellLine(GlobalSpellsLines.Mob_Spells));
                                    break; //dot
                                case 2:
                                    Body.CastSpell(IarnvidiurDD, SkillBase.GetSpellLine(GlobalSpellsLines.Mob_Spells));
                                    break; //dd
                            }
            ...
            if (Body.InCombat && HasAggro)
            {
                if (Body.TargetObject != null)
                {
                    ...
                    if (Util.Chance(15))
                        ...
                        {
                            new ECSGameTimer(Body, new ECSGameTimer.ECSTimerCallback(PickPlayerToDD),

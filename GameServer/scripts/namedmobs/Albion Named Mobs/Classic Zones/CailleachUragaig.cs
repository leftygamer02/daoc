...
namespace DOL.GS
{
    public class CailleachUragaig : GameEpicNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new CailleachUragaigBrain();
            SetOwnBrain(sbrain);
...
namespace DOL.AI.Brain
{
    public class CailleachUragaigBrain : StandardMobBrain
    {
        ...
        private bool AggroMessage = false;
            ...
            if (HasAggro && Body.TargetObject != null)
            {
                ...
                if (!AggroMessage)
                {
                    BroadcastMessage(string.Format(
                        "{0} says, \"Father! Lend me your Torch of Light so we may be delivered from these aggressors!\"",
                        Body.Name));
                    AggroMessage = true;
                }
...
namespace DOL.GS
{
    public class TorchOfLight : GameNPC
    {
        ...
        {
            get => base.Charisma;
            set => base.Charisma = 100;
        }

        public override short Empathy
        {
            get => base.Empathy;
            set => base.Empathy = 100;
        }
        ...
        public override bool AddToWorld()
        {
            ...
            Size = 45;
            Flags = (eFlags) 44;
            var sbrain = new TorchOfLightBrain();
            SetOwnBrain(sbrain);

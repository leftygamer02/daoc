...
namespace DOL.GS
{
    public class Amphiptere : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new AmphiptereBrain();
            SetOwnBrain(sbrain);
        ...
        public override void Think()
        {
            ...
            if (HasAggro && Body.TargetObject != null)
            {
                ...
                if (target != null)
                {
                    ...
                    if (Util.Chance(25) && !Body.IsCasting &&
                    ...
                    if (Util.Chance(25) && !Body.IsCasting &&
                        !target.effectListComponent.ContainsEffectForEffectType(eEffect.Disease))
                        Body.CastSpell(AmphiptereDisease, SkillBase.GetSpellLine(GlobalSpellsLines.Mob_Spells), false);
                    if (Util.Chance(25) && !Body.IsCasting &&
                        !Body.effectListComponent.ContainsEffectForEffectType(eEffect.Bladeturn))
...
namespace DOL.GS
{
    public class AmphiptereAdds : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new AmphiptereAddsBrain();
            SetOwnBrain(sbrain);

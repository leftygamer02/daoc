...
namespace DOL.GS
{
    public class AbomosSoultrapper : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new AbomosSoultrapperBrain();
            SetOwnBrain(sbrain);
    ...
    public class AbomosSoultrapperBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            if (!CheckProximityAggro())
            {
                ...
                if (!RemoveAdds)
                {
                    foreach (var adds in WorldMgr.GetNPCsFromRegion(Body.CurrentRegionID))
                        if (adds != null)
            ...
            if (HasAggro && Body.TargetObject != null)
                RemoveAdds = false;
            if (Body.InCombat && HasAggro && Body.HealthPercent <= 50) SpawnAdds();

...
namespace DOL.GS
{
    public class QueenQunilaria : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new QueenQunilariaBrain();
            SetOwnBrain(sbrain);
        ...
        {
            for (var i = 0; i < Util.Random(15, 22); i++)
            {
                var Add1 = new QunilariaAdd2();

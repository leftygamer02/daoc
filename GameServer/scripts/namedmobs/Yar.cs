...
namespace DOL.GS
{
    public class Yar : GameEpicBoss
    {
        ...
        public virtual int YarDifficulty => ServerProperties.Properties.SET_DIFFICULTY_ON_EPIC_ENCOUNTERS / 100;
...
namespace DOL.AI.Brain
{
    public class YarBrain : StandardMobBrain
    {
        ...
        public override void Notify(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (e == GameLivingEvent.Dying) _isSpawning = true;
        }

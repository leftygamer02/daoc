...
namespace DOL.GS
{
    public class HibCuuldurach : GameEpicBoss
    {
        ...
        private static Point3D spawnPoint = new(408646, 706432, 2965);

        public override ushort SpawnHeading
        {
            get => base.SpawnHeading;
            set => base.SpawnHeading = 1764;
        }
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new HibCuuldurachBrain();
            SetOwnBrain(sbrain);
            sbrain.Start();
                ...
                foreach (var client in WorldMgr.GetClientsOfZone(CurrentZone.ID))
                {
                    ...
                    if (client.IsPlaying)
                        client.Out.SendMessage(
                            Name + " laughs at the " + player.CharacterClass.Name +
                            " who has fallen beneath his crushing blow.", eChatType.CT_Say, eChatLoc.CL_ChatWindow);
                }
            }
    ...
    public class HibCuuldurachBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            if (!CheckProximityAggro())
            {
                ...
                if (!checkForMessangers)
                {
                    if (DragonAdds.Count > 0)
                    {
                        ...
                        foreach (var glimmer in DragonAdds)
            ...
            if (Body.CurrentRegion.IsPM && Body.CurrentRegion.IsNightTime == false && !LockIsRestless &&
                !Body.InCombatInLast(30000)) //Dragon will start roam
            {
                ...
                foreach (var client in WorldMgr.GetClientsOfZone(Body.CurrentZone.ID)) //from current zone
                {
                    ...
                    if (client.IsPlaying)
                    {
                        ...
                        client.Out.SendMessage(
                            Body.Name + " bellows from the skies.'Let all who intrude into my domain pay heed. " +
                    ...
                    if (randomlyPickedPlayers.Count > 0)
                    {
                        foreach (var player in randomlyPickedPlayers)
                                ...
                                player.IsWithinRadius(Body, 2000))
                            {
                                ...
                                {
                                    case 1:
                                        player.MoveTo(Body.CurrentRegionID, 408807, 706640, 4315, 1588);
                                        break; //lair spawn point
                                    case 2:
                                        player.MoveTo(Body.CurrentRegionID, 404579, 699656, 4683, 1840);
                                        break;
                                    case 3:
                                        player.MoveTo(Body.CurrentRegionID, 410650, 698271, 4758, 2890);
                                        break;
                                    case 4:
                                        player.MoveTo(Body.CurrentRegionID, 402790, 707787, 4083, 2628);
                                        break;
                                    case 5:
                                        player.MoveTo(Body.CurrentRegionID, 407532, 695634, 4533, 281);
                                        break;
                                }
                            }
        ...
        private int SpawnMssengers(ECSGameTimer timer)
        {
            ...
            {
                var messenger = new CuuldurachMessenger();
...
namespace DOL.GS
{
    public class CuuldurachMessenger : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            Faction = FactionMgr.GetFactionByID(83);
            Faction.AddFriendFaction(FactionMgr.GetFactionByID(83));
            var adds = new CuuldurachMessengerBrain();
...
namespace DOL.AI.Brain
{
    public class CuuldurachMessengerBrain : StandardMobBrain
    {
        ...
        {
            var point1 = new Point3D(407371, 704161, 2760);
            var point2 = new Point3D(405306, 701159, 3491);
            var point3 = new Point3D(404443, 699515, 3783);
        ...
        {
            var point1 = new Point3D(411517, 704273, 2759);
            var point2 = new Point3D(410828, 699897, 3490);
            var point3 = new Point3D(410713, 698129, 3619);
        ...
        {
            var point1 = new Point3D(410511, 709059, 2760);
            var point2 = new Point3D(405922, 709976, 2735);
            var point3 = new Point3D(403053, 707551, 2474);
        ...
        {
            var point1 = new Point3D(405898, 707838, 2760);
            var point2 = new Point3D(403716, 705502, 2660);
            var point3 = new Point3D(401242, 704226, 3277);
        ...
        private protected void SpawnGlimmers()
        {
            for (var i = 0; i <= Util.Random(3, 5); i++)
            {
                var add = new CuuldurachSpawnedAdd();
...
namespace DOL.GS
{
    public class CuuldurachSpawnedAdd : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            MaxSpeedBase = 225;
            var sbrain = new CuuldurachSpawnedAdBrain();
...
namespace DOL.AI.Brain
{
    public class CuuldurachSpawnedAdBrain : StandardMobBrain
    {
        ...
        private protected void Path1()
        {
            var point1 = new Point3D(404443, 699515, 3783);
            var point2 = new Point3D(405306, 701159, 3491);
            var point3 = new Point3D(407371, 704161, 2760);
            var point4 = new Point3D(408646, 706432, 2965);
        ...
        private protected void Path2()
        {
            var point1 = new Point3D(410713, 698129, 3619);
            var point2 = new Point3D(410828, 699897, 3490);
            var point3 = new Point3D(411424, 704307, 2758);
            var point4 = new Point3D(408646, 706432, 2965);
        ...
        private protected void Path3()
        {
            var point1 = new Point3D(403053, 707551, 2474);
            var point2 = new Point3D(405922, 709976, 2735);
            var point3 = new Point3D(410511, 709059, 2760);
            var point4 = new Point3D(408646, 706432, 2965);
        ...
        private protected void Path4()
        {
            var point1 = new Point3D(401242, 704226, 3277);
            var point2 = new Point3D(403716, 705502, 2660);
            var point3 = new Point3D(405898, 707838, 2760);
            var point4 = new Point3D(408646, 706432, 2965);

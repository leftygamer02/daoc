...
namespace DOL.GS
{
    public class SummonerCunovinda : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new SummonerCunovindaBrain();
            SetOwnBrain(sbrain);
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (npcs.Length == 0)
            {
                ...
                var ubrain = new SummonerCunovindaBrain();
            ...
            {
                log.Warn(
                    "Summoner Cunovinda exist ingame, remove it and restart server if you want to add by script code.");
            }
        }
    }
}
...
namespace DOL.AI.Brain
{
    public class SummonerCunovindaBrain : StandardMobBrain
    {
        ...
        {
            var oldTarget = (GameLiving) Body.TargetObject; //old target
            ...
            new ECSGameTimer(Body, new ECSGameTimer.ECSTimerCallback(ResetBolt),
                Util.Random(8000, 12000)); //teleport every 8-12s if melee hit got chance to proc teleport
            return 0;
        }

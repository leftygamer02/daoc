...
namespace DOL.GS
{
    public class WrethOfWinterScorp : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new WrethOfWinterScorpBrain();
            SetOwnBrain(sbrain);
...
namespace DOL.GS
{
    public class WrethOfWinterSpider : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            Flags = eFlags.GHOST;
            MeleeDamageType = eDamageType.Thrust;
            var sbrain = new WrethOfWinterSpiderBrain();
            SetOwnBrain(sbrain);
            LoadedFromScript = false; //load from database
            SaveIntoDatabase();
            base.AddToWorld();
...
namespace DOL.GS
{
    public class WrethOfWinterCrab : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            Flags = eFlags.GHOST;
            MeleeDamageType = eDamageType.Thrust;
            var sbrain = new WrethOfWinterCrabBrain();
            SetOwnBrain(sbrain);
            LoadedFromScript = false; //load from database
            SaveIntoDatabase();
            base.AddToWorld();
...
namespace DOL.GS
{
    public class WrethOfWinterJotun : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            Flags = eFlags.GHOST;
            var sbrain = new WrethOfWinterJotunBrain();
            SetOwnBrain(sbrain);
            LoadedFromScript = false; //load from database
            SaveIntoDatabase();
            base.AddToWorld();
...
namespace DOL.GS
{
    public class WrethOfWinterOgre : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            MeleeDamageType = eDamageType.Crush;
            Flags = eFlags.GHOST;
            var sbrain = new WrethOfWinterOgreBrain();
            SetOwnBrain(sbrain);
            LoadedFromScript = false; //load from database
            SaveIntoDatabase();
            base.AddToWorld();
...
namespace DOL.GS
{
    public class WrethOfWinterIce : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            Flags = eFlags.GHOST;
            var sbrain = new WrethOfWinterIceBrain();
            SetOwnBrain(sbrain);
            LoadedFromScript = false; //load from database
            SaveIntoDatabase();
            base.AddToWorld();
...
namespace DOL.GS
{
    public class WrethOfWinterRaumarik : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            MeleeDamageType = eDamageType.Crush;
            Flags = eFlags.GHOST;
            var sbrain = new WrethOfWinterRaumarikBrain();
            SetOwnBrain(sbrain);
            LoadedFromScript = false; //load from database
            SaveIntoDatabase();
            base.AddToWorld();
...
namespace DOL.GS
{
    public class WrethOfWinterLich : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            MeleeDamageType = eDamageType.Crush;
            Flags = eFlags.GHOST;
            var sbrain = new WrethOfWinterLichBrain();
            SetOwnBrain(sbrain);
            LoadedFromScript = false; //load from database
            SaveIntoDatabase();
            base.AddToWorld();
...
namespace DOL.GS
{
    public class WrethOfWinterArachite : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            MeleeDamageType = eDamageType.Thrust;
            Flags = eFlags.GHOST;
            var sbrain = new WrethOfWinterArachiteBrain();
            SetOwnBrain(sbrain);
            LoadedFromScript = false; //load from database
            SaveIntoDatabase();
            base.AddToWorld();

        ...
        public override void Think()
        {
            ...
            if (Body.TargetObject != null && HasAggro)
            {
                ...
                foreach (GameNPC npc in Body.GetNPCsInRadius(2500))
                    if (npc != null && npc.IsAlive && npc.Name.ToLower() == "dark seithkona" &&
                ...
                {
                    var portTimer = new ECSGameTimer(Body, new ECSGameTimer.ECSTimerCallback(InitiatePort),
            ...
            if (target != null && target.IsAlive && target is GamePlayer player)
                switch (Util.Random(1, 4))
                {
                    case 1:
                        ...
                        player.Out.SendMessage("Ydenia of the Seithkona throws you into water and you take damage!",

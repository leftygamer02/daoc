...
namespace DOL.GS
{
    public class Loken : GameEpicNPC
    {
        ...
        {
            var spawn = new Point3D(636780, 762427, 4597);
            for (var i = 0; i < 2; i++)
            {
                var npc = new LokenWolf();

    ...
    public class BoligarBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            ...
            if (HasAggro && Body.TargetObject != null)
            {
                ...
                if (!target.effectListComponent.ContainsEffectForEffectType(eEffect.MezImmunity) &&
        ...
        public int TeleportPlayer(ECSGameTimer timer)
        {
            if (TeleportTarget.IsAlive && TeleportTarget != null && HasAggro)
            {
                ...
                {
                    case 1:
                        TeleportTarget.MoveTo(151, 409989, 378960, 7752, 3040);
                        break;
                    case 2:
                        TeleportTarget.MoveTo(151, 411003, 377902, 7704, 3070);
                        break;
                    case 3:
                        TeleportTarget.MoveTo(151, 409983, 376894, 7376, 3097);
                        break;
                    case 4:
                        TeleportTarget.MoveTo(151, 408968, 377920, 7440, 3047);
                        break;
                }

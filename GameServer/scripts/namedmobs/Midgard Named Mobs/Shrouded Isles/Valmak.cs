        ...
        public override void OnAttackEnemy(AttackData ad) //on enemy actions
        {
            if (Util.Chance(35))
                if (ad != null && (ad.AttackResult == eAttackResult.HitUnstyled ||
                               ...
                               && !ad.Target.effectListComponent.ContainsEffectForEffectType(eEffect.MezImmunity) &&
                               !ad.Target.effectListComponent.ContainsEffectForEffectType(eEffect.Mez))

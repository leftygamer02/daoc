...
namespace DOL.GS
{
    public class Myrddraxis : GameEpicBoss
    {
        ...
        {
            foreach (var heads in WorldMgr.GetNPCsFromRegion(CurrentRegionID))
                if (heads != null)
                    if (heads.IsAlive && (heads.Brain is MyrddraxisSecondHeadBrain ||
                                          heads.Brain is MyrddraxisThirdHeadBrain ||
                                          heads.Brain is MyrddraxisFourthHeadBrain ||
                                          heads.Brain is MyrddraxisFifthHeadBrain))
                        heads.Die(heads);
        ...
        public override void OnAttackEnemy(AttackData ad)
        {
            if (ad != null &&
                ...
                if (Util.Chance(25))
                    ...
                    {
                        case 1:
                            CastSpell(HydraDisease, SkillBase.GetSpellLine(GlobalSpellsLines.Mob_Spells));
                            break;
                        case 2:
                            CastSpell(Hydra_Haste_Debuff, SkillBase.GetSpellLine(GlobalSpellsLines.Mob_Spells));
                            break;
                    }
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new MyrddraxisBrain();
            SetOwnBrain(sbrain);
        ...
        {
            //Second Head
            var Add1 = new MyrddraxisSecondHead();
            Add1.X = 32384;
            Add1.Y = 31942;
            Add1.Z = 15931;
            ...
            //Third Head
            var Add2 = new MyrddraxisThirdHead();
            Add2.X = 32187;
            Add2.Y = 32205;
            Add2.Z = 15961;
            ...
            //Fourth Head
            var Add3 = new MyrddraxisFourthHead();
            Add3.X = 32371;
            Add3.Y = 32351;
            Add3.Z = 15936;
            ...
            //Fifth Head
            var Add4 = new MyrddraxisFifthHead();
            Add4.X = 32576;
            Add4.Y = 32133;
            Add4.Z = 15936;
    ...
    public class MyrddraxisBrain : StandardMobBrain
    {
            ...
            if (HasAggro)
            {
                ...
                if (Enemys_To_DD.Count > 0)
                    if (CanCast == false)
                    {
                        ...
                        BroadcastMessage(string.Format(Body.Name + " taking a big flame breath at " +
                                                       RandomTarget.Name + "."));
                        CanCast = true;
                    }
            }
        ...
        public override void Think()
        {
            ...
            if (Body.IsAlive && HasAggro && Body.TargetObject != null)
            {
                ...
                if (IsPulled == false)
                {
                    var ptarget = Body.TargetObject as GameLiving;
                ...
                if (Body.HealthPercent <= 75 && CanCastPBAOE1 == false)
                {
                    ...
                    BroadcastMessage(
                        string.Format(Body.Name + " taking a massive breath of flames to annihilate enemys."));
                    CanCastPBAOE1 = true;
                }
                ...
                if (target != null && !target.IsWithinRadius(Body, Body.AttackRange))
                {
                    ...
                    Body.CastSpell(Hydra_DD2,
                        SkillBase.GetSpellLine(GlobalSpellsLines
                            .Mob_Spells)); //cast dmg if main target is not in attack range
                }
            }
...
namespace DOL.GS
{
    public class MyrddraxisSecondHead : GameNPC
    {
        ...
        public override void DealDamage(AttackData ad)
        {
            if (ad != null)
            {
                ...
                foreach (GameNPC heads in GetNPCsInRadius(2000))
                    if (heads != null)
                        if (heads.IsAlive && (heads.Brain is MyrddraxisThirdHeadBrain ||
                                              heads.Brain is MyrddraxisFourthHeadBrain ||
                                              heads.Brain is MyrddraxisFifthHeadBrain))
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new MyrddraxisSecondHeadBrain();
            SetOwnBrain(sbrain);
...
namespace DOL.GS
{
    public class MyrddraxisThirdHead : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new MyrddraxisThirdHeadBrain();
            SetOwnBrain(sbrain);
            LoadedFromScript = true;
            base.AddToWorld();
            return true;
...
namespace DOL.GS
{
    public class MyrddraxisFourthHead : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new MyrddraxisFourthHeadBrain();
            SetOwnBrain(sbrain);
            LoadedFromScript = true;
            base.AddToWorld();
            return true;
...
namespace DOL.GS
{
    public class MyrddraxisFifthHead : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new MyrddraxisFifthHeadBrain();
            SetOwnBrain(sbrain);
            LoadedFromScript = true;
            base.AddToWorld();
            return true;

...
namespace DOL.GS
{
    public class Krackenschtein : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new KrackenschteinBrain();
            SetOwnBrain(sbrain);
...
namespace DOL.AI.Brain
{
    public class KrackenschteinBrain : StandardMobBrain
    {
        ...
        public void PickRandomTarget()
        {
            ...
            {
                var Target =
                    (GamePlayer) Enemys_To_DD[Util.Random(0, Enemys_To_DD.Count - 1)]; //pick random target from list
        ...
        public void TeleportRandomTarget()
        {
            ...
            if (CanPort == false)
            {
                ...
                {
                    case 1:
                        TeleportTarget.MoveTo(180, 32956, 37669, 16465, 1028);
                        break;
                    case 2:
                        TeleportTarget.MoveTo(180, 31879, 38149, 16465, 2109);
                        break;
                    case 3:
                        TeleportTarget.MoveTo(180, 31727, 37401, 16465, 3225);
                        break;
                    case 4:
                        TeleportTarget.MoveTo(180, 32159, 36387, 16465, 3618);
                        break;
                }

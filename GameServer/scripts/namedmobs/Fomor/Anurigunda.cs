...
namespace DOL.GS
{
    public class Anurigunda : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new AnurigundaBrain();
            SetOwnBrain(sbrain);
...
namespace DOL.AI.Brain
{
    public class AnurigundaBrain : StandardMobBrain
    {
        ...
        {
            var entrance = new Point3D(31234, 33215, 15842);
...
namespace DOL.GS
{
    public class AnurigundaAdds : GameNPC
    {
        ...
        private List<int> Id_npctemplates = new()
        {
        ...
        public override bool AddToWorld()
        {
            var idtemplate = Id_npctemplates[Util.Random(0, Id_npctemplates.Count - 1)];
            ...
            Faction = FactionMgr.GetFactionByID(82);
            Faction.AddFriendFaction(FactionMgr.GetFactionByID(82));
            var adds = new AnurigundaAddsBrain();
            SetOwnBrain(adds);
            base.AddToWorld();
            return true;
        }

...
namespace DOL.GS
{
    public class OreyEyedOghamist : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new OreyEyedOghamistBrain();
            SetOwnBrain(sbrain);
            base.AddToWorld();
            return true;
        }
...
namespace DOL.AI.Brain
{
    public class OreyEyedOghamistBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            if (Body.IsAlive)
            {
                var point1 = new Point3D(504754, 505351, 4939);
                var point2 = new Point3D(506042, 507443, 4945);
                var point3 = new Point3D(505194, 509109, 5052);
                var point4 = new Point3D(505401, 510887, 5382);
                var point5 = new Point3D(503682, 512545, 5423);
                var point6 = new Point3D(502505, 513021, 5204);
                var point7 = new Point3D(501470, 515019, 5120);
                var point8 = new Point3D(500667, 516402, 4848);
                var point9 = new Point3D(498310, 516387, 4923);
                var point10 = new Point3D(495586, 513451, 5510);
                var point11 = new Point3D(495006, 509166, 4991);
                var point12 = new Point3D(498351, 507021, 5059);
                var point13 = new Point3D(500833, 506164, 5074);
                ...
                {
                    var pathSpeed = Body.MaxSpeedBase;
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                point3check = true;
                                if (!Body.IsWithinRadius(point4, 30) && point1check && point2check && point3check &&
                                    !point4check)
                                {
                                ...
                                {
                                    point4check = true;
                                    if (!Body.IsWithinRadius(point5, 30) && point1check && point2check && point3check &&
                                        point4check && !point5check)
                                    {
                                    ...
                                    {
                                        point5check = true;
                                        if (!Body.IsWithinRadius(point6, 30) && point1check && point2check &&
                                            point3check && point4check && point5check && !point6check)
                                        {
                                        ...
                                        {
                                            point6check = true;
                                            if (!Body.IsWithinRadius(point7, 30) && point1check && point2check &&
                                                point3check && point4check && point5check && point6check &&
                                                !point7check)
                                            {
                                            ...
                                            {
                                                point7check = true;
                                                if (!Body.IsWithinRadius(point8, 30) && point1check && point2check &&
                                                    point3check && point4check && point5check && point6check &&
                                                    point7check && !point8check)
                                                {
                                                ...
                                                {
                                                    point8check = true;
                                                    if (!Body.IsWithinRadius(point9, 30) && point1check &&
                                                        point2check && point3check && point4check && point5check &&
                                                        point6check && point7check && point8check
                                                        && !point9check)
                                                    {
                                                    ...
                                                    {
                                                        point9check = true;
                                                        if (!Body.IsWithinRadius(point10, 30) && point1check &&
                                                            point2check && point3check && point4check && point5check &&
                                                            point6check && point7check && point8check
                                                        ...
                                                        {
                                                            point10check = true;
                                                            if (!Body.IsWithinRadius(point11, 30) && point1check &&
                                                                point2check && point3check && point4check &&
                                                                point5check && point6check && point7check && point8check
                                                            ...
                                                            {
                                                                point11check = true;
                                                                if (!Body.IsWithinRadius(point12, 30) && point1check &&
                                                                    point2check && point3check && point4check &&
                                                                    point5check && point6check && point7check &&
                                                                    point8check
                                                                    && point9check && point10check && point11check &&
                                                                    !point12check)
                                                                {
                                                                ...
                                                                else
                                                                {
                                                                    ...
                                                                    if (!Body.IsWithinRadius(point13, 30) &&
                                                                        point1check && point2check && point3check &&
                                                                        point4check && point5check && point6check &&
                                                                        point7check && point8check
                                                                        && point9check && point10check &&
                                                                        point11check && point12check && !point13check)
                                                                    {

...
namespace DOL.GS
{
    public class GreenMawAdd : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            Model = 136;
            Size = 120;
            var sbrain = new GreenMawAddBrain();
            SetOwnBrain(sbrain);
...
namespace DOL.GS
{
    public class GreenMawAdd2 : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            Model = 136;
            Size = 95;
            var sbrain = new GreenMawAdd2Brain();
            SetOwnBrain(sbrain);
            LoadedFromScript = true;
            RespawnInterval = -1;
            base.AddToWorld();
...
namespace DOL.GS
{
    public class GreenMawAdd3 : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            Model = 136;
            Size = 70;
            var sbrain = new GreenMawAdd3Brain();
            SetOwnBrain(sbrain);
            LoadedFromScript = true;
            RespawnInterval = -1;
            base.AddToWorld();

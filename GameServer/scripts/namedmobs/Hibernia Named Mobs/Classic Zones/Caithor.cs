...
namespace DOL.GS
{
    public class GhostOfCaithor : GameEpicNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new GhostOfCaithorBrain();
            SetOwnBrain(sbrain);
...
namespace DOL.AI.Brain
{
    public class GhostOfCaithorBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            ...
            {
                var _despawnTimer2 =
                    new ECSGameTimer(Body, new ECSGameTimer.ECSTimerCallback(DespawnGiantCaithor),
                        300000); //5min to despawn
...
namespace DOL.GS
{
    public class CaithorDorocha : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new CaithorDorochaBrain();
            SetOwnBrain(sbrain);
            LoadedFromScript = false;
            SaveIntoDatabase();
            base.AddToWorld();

...
namespace DOL.GS
{
    public class Cailean : GameEpicNPC
    {
            ...
            if (source is GamePlayer || source is GamePet)
            {
                if (IsOutOfTetherRange)
                {
                        ...
                        || damageType == eDamageType.Slash)
                    {
                        ...
                        if (truc != null)
                            truc.Out.SendMessage(
                                Name + " is too far away from it's habbitat and is immune to your damage!",
                                eChatType.CT_System,
        ...
        public override bool AddToWorld()
        {
            ...
            RespawnInterval =
                ServerProperties.Properties.SET_EPIC_QUEST_ENCOUNTER_RESPAWNINTERVAL *
                60000; //1min is 60000 miliseconds
            var sbrain = new CaileanBrain();
            SetOwnBrain(sbrain);
...
namespace DOL.AI.Brain
{
    public class CaileanBrain : StandardMobBrain
    {
            ...
            if (HasAggro && Body.TargetObject != null)
            {
                ...
                if (Body.TargetObject != null)
                {
                    ...
                    if (Util.Chance(20) &&
                        ...
                        !target.effectListComponent.ContainsEffectForEffectType(eEffect.Mez))
        ...
        private void SpawnTree()
        {
            ...
            for (var i = 0; i < Util.Random(4, 5); i++)
            {
                var tree = new WalkingTree();
        ...
        private void SpawnTree2()
        {
            ...
            var point1 = new Point3D(479778, 508293, 4534);
            var point2 = new Point3D(478647, 508450, 4639);
            var point3 = new Point3D(479444, 508548, 4532);
            for (var i = 0; i < Util.Random(8, 10); i++)
            {
                var tree = new WalkingTree2();
...
namespace DOL.GS
{
    public class WalkingTree : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new WalkingTreeBrain();
            SetOwnBrain(sbrain);
            base.AddToWorld();
            return true;
        }
...
namespace DOL.AI.Brain
{
    public class WalkingTreeBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            ...
            {
                var target = Body.TargetObject as GameLiving;
                if (Util.Chance(20) && !target.effectListComponent.ContainsEffectForEffectType(eEffect.SnareImmunity) &&
                    !target.effectListComponent.ContainsEffectForEffectType(eEffect.MovementSpeedDebuff))
...
namespace DOL.GS
{
    public class WalkingTree2 : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            LoadedFromScript = true;
            var sbrain = new WalkingTree2Brain();
            SetOwnBrain(sbrain);
            base.AddToWorld();
            return true;
        }

...
namespace DOL.GS
{
    public class FlameNormal : GameEpicNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new FlameNormalBrain();
            SetOwnBrain(sbrain);
            LoadedFromScript = true;
            var success = base.AddToWorld();
            if (success)
                new ECSGameTimer(this, new ECSGameTimer.ECSTimerCallback(Despawn),
                    120000); //2min before it will despawn

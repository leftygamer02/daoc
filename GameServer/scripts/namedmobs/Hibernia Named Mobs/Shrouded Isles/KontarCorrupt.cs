...
namespace DOL.GS
{
    public class KontarCorrupt : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new KontarCorruptBrain();
            SetOwnBrain(sbrain);
...
namespace DOL.AI.Brain
{
    public class KontarCorruptBrain : StandardMobBrain
    {
        ...
        private void SpawnAdds()
        {
            ...
            {
                var add = new CorruptorBodyguard();
...
namespace DOL.GS
{
    public class CorruptorBodyguard : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new CorruptorBodyguardBrain();
            SetOwnBrain(sbrain);
            base.AddToWorld();
            return true;
        }
                ...
                foreach (GameNPC npc in Body.GetNPCsInRadius(1500))
                    if (npc != null && npc.IsAlive && npc.Brain is KontarCorruptBrain && npc.HealthPercent < 100)
                        if (!Body.IsCasting)
                        {
                            ...
                            Body.TurnTo(npc);
                            Body.CastSpell(CorruptorBodyguardHeal, SkillBase.GetSpellLine(GlobalSpellsLines.Mob_Spells),
                                false);
                        }

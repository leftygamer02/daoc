...
namespace DOL.GS
{
    public class DremcisFuiloltair : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new DremcisFuiloltairBrain();
            SetOwnBrain(sbrain);
...
namespace DOL.AI.Brain
{
    public class DremcisFuiloltairBrain : StandardMobBrain
    {
        ...
        private void SpawnBlobs()
        {
            ...
            for (var i = 0; i < Util.Random(4, 6); i++)
            {
                var blobs = new Fuilslathach();
...
namespace DOL.GS
{
    public class Beomarbhan : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            RespawnInterval = -1;
            var sbrain = new BeomarbhanBrain();
            SetOwnBrain(sbrain);
...
namespace DOL.GS
{
    public class Fuilslathach : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            LoadedFromScript = true;
            var sbrain = new FuilslathachBrain();
            SetOwnBrain(sbrain);
            base.AddToWorld();
            return true;
        }

...
public class ArosBrain : StandardMobBrain
{
    ...
    public void Resists()
    {
        ...
        foreach (GameNPC npc in Body.GetNPCsInRadius(minradius))
    ...
    {
        var summonedValue = 1000;
        var min_value = 30;
        ushort radius = 3000;

        GameNPC summonedGuardian = null;
        foreach (GameNPC summonNpc in Body.GetNPCsInRadius(radius))
    ...
    public override void Notify(DOLEvent e, object sender, EventArgs args)
    {
        ...
        if (sender == Body)
        {
            var aros = sender as GameEpicAros;
    ...
    public int StageTwo
    {
        ...
        set
        {
            if (value >= 0 && value <= 10) m_stageTwo = value;
        }
    }
    ...
    public bool CheckHealth()
    {
        ...
        var healthOld = aros.HealthPercentOld / 10;
        var healthNow = aros.HealthPercent / 10;

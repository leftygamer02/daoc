...
namespace DOL.GS.Scripts
{
    public class SpectralProvisioner : GameEpicBoss
    {
        ...
        public override void TakeDamage(GameObject source, eDamageType damageType, int damageAmount, int criticalAmount)
        {
            ...
            {
                if (damageType == eDamageType.Heat || damageType == eDamageType.Spirit ||
                    damageType == eDamageType.Cold) //take no damage
                {
                    GamePlayer truc;
                    ...
                    if (truc != null)
                        truc.Out.SendMessage("The Spectral Provisioner is immune to this form of attack.",
        ...
        public override bool AddToWorld()
        {
            ...
            var sBrain = new SpectralProvisionerBrain();
            SetOwnBrain(sBrain);
...
namespace DOL.AI.Brain
{
    public class SpectralProvisionerBrain : StandardMobBrain
    {
        ...
        private Point3D point1 = new(30050, 39425, 17004);
        private Point3D point2 = new(30940, 39418, 17004);
        private Point3D point3 = new(32065, 40205, 17004);
        private Point3D point4 = new(32075, 42378, 17004);
        private Point3D point5 = new(32072, 40376, 17006);
        private Point3D point6 = new(32967, 39369, 17007);
        private Point3D point7 = new(32057, 38494, 17007);
        private Point3D point8 = new(31022, 39382, 17006);
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    if (!Body.IsWithinRadius(point6, 30) && point1check == true &&
                                        point2check == true &&
                                        point3check == true && point4check == true && point5check == true &&
                                        point6check == false)
                                    {
                                    ...
                                    {
                                        point6check = true;
                                        if (!Body.IsWithinRadius(point7, 30) && point1check == true &&
                                            point2check == true &&
                                            point3check == true && point4check == true && point5check == true &&
                                            point6check == true && point7check == false)
                                        {
                                        ...
                                        {
                                            point7check = true;
                                            if (!Body.IsWithinRadius(point8, 30) && point1check == true &&
                                                point2check == true &&
                                                point3check == true && point4check == true && point5check == true &&
                                                point6check == true && point7check == true && !point8check)
                                            {
        ...
        private Spell SpectralDD
        {
            get
            {
                if (m_SpectralDD == null)
                {
                    ...
                    spell.Description =
                        "Spectral Provisioner strike back attacker and makes him move 70% slower for the spell duration.";
...
namespace DOL.GS
{
    public class SpectralProvisionerSpawner : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new SpectralProvisionerSpawnerBrain();
            SetOwnBrain(sbrain);
            base.AddToWorld();
            return true;
        }
...
namespace DOL.AI.Brain
{
    public class SpectralProvisionerSpawnerBrain : StandardMobBrain
    {
        ...
        public void SpawnSpectralProvisioner(GamePlayer player)
        {
            ...
            var boss = new SpectralProvisioner();
            boss.X = Body.X;
            boss.Y = Body.Y;
            boss.Z = Body.Z;

...
namespace DOL.GS
{
    public class LurfosHerald : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new LurfosHeraldBrain();
            SetOwnBrain(sbrain);
        ...
        public override void Think()
        {
            ...
            if (HasAggro && Body.TargetObject != null)
            {
                ...
                if (StartSwitchWeapons == false)
                {
                    ...
                    {
                        case 1:
                            new ECSGameTimer(Body, new ECSGameTimer.ECSTimerCallback(SwitchToCold), 1000);
                            break;
                        case 2:
                            new ECSGameTimer(Body, new ECSGameTimer.ECSTimerCallback(SwitchToHeat), 1000);
                            break;
                    }

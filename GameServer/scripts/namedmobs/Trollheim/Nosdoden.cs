...
namespace DOL.GS
{
    public class Nosdoden : GameEpicBoss
    {
        ...
        {
            var numPlayers = GetPlayersInRadiusCount(WorldMgr.VISIBILITY_DISTANCE);
        ...
        public override bool AddToWorld()
        {
            ...
            RespawnInterval =
                Properties.SET_SI_EPIC_ENCOUNTER_RESPAWNINTERVAL * 60000; //1min is 60000 miliseconds
            var sbrain = new NosdodenBrain();
            SetOwnBrain(sbrain);
        ...
        {
            var player = enemy as GamePlayer;
            if (enemy is GamePlayer)
                if (player != null)
                {
                    var add = new NosdodenGhostAdd();
                    ...
                    {
                        var torso = player.Inventory.GetItem(eInventorySlot.TorsoArmor);
                        if (torso != null)
                            template.AddNPCEquipment(eInventorySlot.TorsoArmor, torso.Model, torso.Color, 0,
                                torso.Extension); //modelID,color,effect,extension
                    }

                    if (player.Inventory.GetItem(eInventorySlot.ArmsArmor) != null)
                    {
                        var arms = player.Inventory.GetItem(eInventorySlot.ArmsArmor);
                        if (arms != null)
                    ...
                    {
                        var legs = player.Inventory.GetItem(eInventorySlot.LegsArmor);
                        if (legs != null)
                    ...
                    {
                        var head = player.Inventory.GetItem(eInventorySlot.HeadArmor);
                        if (head != null)
                    ...
                    {
                        var hands = player.Inventory.GetItem(eInventorySlot.HandsArmor);
                        if (hands != null)
                            template.AddNPCEquipment(eInventorySlot.HandsArmor, hands.Model, hands.Color, 0,
                                hands.Extension);
                    }

                    if (player.Inventory.GetItem(eInventorySlot.FeetArmor) != null)
                    {
                        var feet = player.Inventory.GetItem(eInventorySlot.FeetArmor);
                        if (feet != null)
                            template.AddNPCEquipment(eInventorySlot.FeetArmor, feet.Model, feet.Color, 0,
                                feet.Extension);
                    }

                    if (player.Inventory.GetItem(eInventorySlot.Cloak) != null)
                    {
                        var cloak = player.Inventory.GetItem(eInventorySlot.Cloak);
                        if (cloak != null)
                            template.AddNPCEquipment(eInventorySlot.Cloak, cloak.Model, cloak.Color, 0, 0,
                                cloak.Emblem);
                    }

                    if (player.Inventory.GetItem(eInventorySlot.RightHandWeapon) != null)
                    {
                        var righthand = player.Inventory.GetItem(eInventorySlot.RightHandWeapon);
                        var lefthand = player.Inventory.GetItem(eInventorySlot.LeftHandWeapon);
                        if (righthand != null && lefthand != null)
                        {
                            template.AddNPCEquipment(eInventorySlot.RightHandWeapon, righthand.Model, righthand.Color,
                                righthand.Effect);

                            #region Styles for Warrior and Thane

                            if (player.CharacterClass.ID == (int) eCharacterClass.Warrior ||
                                player.CharacterClass.ID == (int) eCharacterClass.Thane)
                            {
                            ...
                            if (player.CharacterClass.ID == (int) eCharacterClass.Savage)
                                if (righthand.Object_Type == (int) eObjectType.HandToHand ||
                    ...
                    if (player.Inventory.GetItem(eInventorySlot.LeftHandWeapon) != null)
                    {
                        var lefthand = player.Inventory.GetItem(eInventorySlot.LeftHandWeapon);
                        if (lefthand != null)
                            template.AddNPCEquipment(eInventorySlot.LeftHandWeapon, lefthand.Model, lefthand.Color,
                                lefthand.Effect);
                    }

                    if (player.Inventory.GetItem(eInventorySlot.TwoHandWeapon) != null)
                    {
                        var twohand = player.Inventory.GetItem(eInventorySlot.TwoHandWeapon);
                        var righthand = player.Inventory.GetItem(eInventorySlot.RightHandWeapon);
                        if (twohand != null)
                        {
                            template.AddNPCEquipment(eInventorySlot.TwoHandWeapon, twohand.Model, twohand.Color,
                                twohand.Effect);
                            ...
                            if (player.CharacterClass.ID == (int) eCharacterClass.Hunter &&
                                twohand.Object_Type == (int) eObjectType.Spear)
                            {
                    ...
                    {
                        var distance = player.Inventory.GetItem(eInventorySlot.DistanceWeapon);
                        if (distance != null)
                            template.AddNPCEquipment(eInventorySlot.DistanceWeapon, distance.Model, distance.Color,
                                distance.Effect);
                    }
                    ...
                    var mob_twohand = template.GetItem(eInventorySlot.TwoHandWeapon);
                    var mob_righthand = template.GetItem(eInventorySlot.RightHandWeapon);
                    var mob_lefthand = template.GetItem(eInventorySlot.LeftHandWeapon);
                    var mob_distance = template.GetItem(eInventorySlot.LeftHandWeapon);
                    if (mob_lefthand != null && mob_righthand != null)
                        if ((mob_righthand.Object_Type == (int) eObjectType.Axe &&
                             mob_righthand.Item_Type == Slot.RIGHTHAND) /*axe*/ ||
                            (mob_righthand.Object_Type == (int) eObjectType.Sword &&
                             mob_righthand.Item_Type == Slot.RIGHTHAND) /*sword*/ ||
                            ((mob_righthand.Object_Type == (int) eObjectType.HandToHand ||
                              mob_lefthand.Object_Type == (int) eObjectType.HandToHand) &&
                             (mob_righthand.Item_Type == Slot.RIGHTHAND ||
                              mob_lefthand.Item_Type == Slot.LEFTHAND)) /*Hand-to-Hand*/ ||
                            (mob_righthand.Object_Type == (int) eObjectType.Hammer &&
                             mob_righthand.Item_Type == Slot.RIGHTHAND) /*hammer*/ ||
                    ...
                    if (mob_twohand != null)
                        if ((mob_twohand.Object_Type == (int) eObjectType.Hammer &&
                             mob_twohand.Item_Type == Slot.TWOHAND) /*axe2h*/ ||
                            (mob_twohand.Object_Type == (int) eObjectType.Sword &&
                             mob_twohand.Item_Type == Slot.TWOHAND) /*sword2h*/ ||
                            (mob_twohand.Object_Type == (int) eObjectType.Spear &&
                             mob_twohand.Item_Type == Slot.TWOHAND) /*spear*/ ||
                            (mob_twohand.Object_Type == (int) eObjectType.Staff &&
                             mob_twohand.Item_Type == Slot.TWOHAND)) /*Staff*/
                        {
                            add.SwitchWeapon(eActiveWeaponSlot.TwoHanded);
                            add.VisibleActiveWeaponSlots = 34;
                        }

                    if (mob_distance != null && mob_distance.Object_Type == (int) eObjectType.CompositeBow &&
                        mob_distance.Item_Type == Slot.RANGED) /*distance*/
                    {
...
namespace DOL.AI.Brain
{
    public class NosdodenBrain : StandardMobBrain
    {
        ...
        private List<GamePlayer> Enemys_To_DOT = new();
        ...
        public int PickRandomTarget2(ECSGameTimer timer)
        {
            if (HasAggro)
            {
                ...
                if (Enemys_To_DOT.Count > 0)
                    ...
                    {
                        var Target =
                            (GamePlayer) Enemys_To_DOT[
                                Util.Random(0, Enemys_To_DOT.Count - 1)]; //pick random target from list
        ...
        private List<GamePlayer> Enemys_To_DD = new();
        ...
        public int PickRandomTarget(ECSGameTimer timer)
        {
            if (HasAggro)
            {
                ...
                if (Enemys_To_DD.Count > 0)
                    ...
                    {
                        var Target =
                            (GamePlayer) Enemys_To_DD[
                                Util.Random(0, Enemys_To_DD.Count - 1)]; //pick random target from list
                        RandomTarget = Target; //set random target to static RandomTarget
                        new ECSGameTimer(Body, new ECSGameTimer.ECSTimerCallback(CastDD), 5000);
                        BroadcastMessage(string.Format(Body.Name + " starts casting void magic at " +
                                                       RandomTarget.Name + "."));
                        CanCast = true;
                    }
            }
        ...
        public override void Think()
        {
            ...
            if (Body.IsAlive && HasAggro && Body.TargetObject != null)
            {
                ...
                {
                    new ECSGameTimer(Body, new ECSGameTimer.ECSTimerCallback(PickRandomTarget2),
                    ...
                    if (player != null && player.IsAlive)
                        foreach (GameNPC ghosts in Body.GetNPCsInRadius(5000))
                            if (ghosts != null && ghosts.IsAlive && ghosts.Brain is NosdodenGhostAddBrain)
                                if (Regex.IsMatch(ghosts.Name,
                                        string.Format(@"\b{0}\b",
                                            player.Name))) //check if spirit name contains exact player name
                                {
                                    SpiritMob = ghosts;
                                    PlayerRezzed = player;
                                }
        ...
        {
            for (var i = 0; i < Util.Random(12, 18); i++)
            {
                var add = new NosdodenSummonedAdds();
...
namespace DOL.AI.Brain
{
    public class NosdodenGhostAddBrain : StandardMobBrain
    {
        ...
        public static Style AfterEvadeBerserker =
            SkillBase.GetStyleByID(AfterEvadeBerserkerID, AfterEvadeBerserkerClassID);

        public static int EvadeFollowUpBerserkerID = 203;
        public static int EvadeFollowUpBerserkerClassID = 31;

        public static Style EvadeFollowUpBerserker =
            SkillBase.GetStyleByID(EvadeFollowUpBerserkerID, EvadeFollowUpBerserkerClassID);
        ...
        public void IsBerserker()
        {
            if (Body.PackageID == "NosdodenGhostBerserker")
            {
                ...
                if (!CheckProximityAggro()) CanWalkBerserker = false;
                ...
                if (Body.InCombat && HasAggro)
                    if (Body.TargetObject != null)
                    {
                        ...
                        if (target.effectListComponent.ContainsEffectForEffectType(eEffect.Stun))
                            ...
                            {
                                new ECSGameTimer(Body, new ECSGameTimer.ECSTimerCallback(WalkBack),
                                    500); //if target got stun then start timer to run behind it
        ...
        public static Style tauntHammerWarrior =
            SkillBase.GetStyleByID(TauntHammerWarriorID, TauntHammerWarriorClassID);
        ...
        public void IsWarrior()
        {
            if (Body.PackageID == "NosdodenGhostWarrior")
            {
                ...
                if (!CheckProximityAggro()) CanWalkWarrior = false;
        ...
        public static Style AnyTimerFollowUpSB =
            SkillBase.GetStyleByID(AnyTimerFollowUpSBID, AnyTimerFollowUpSBClassID);
        ...
        public void IsShadowblade()
        {
            if (Body.PackageID == "NosdodenGhostShadowblade")
            {
                ...
                if (!CheckProximityAggro()) CanWalkShadowblade = false;
                    ...
                    if (Body.TargetObject != null)
                        if (!Body.IsCasting && !Body.IsMoving)
                            foreach (Spell spells in Body.Spells)
                                ...
                                {
                                    if (Body.IsMoving &&
                                        Body.TargetObject.IsWithinRadius(Body.TargetObject, spells.Range))
                                        Body.StopFollowing();
                                    else
                                    ...
                                    if (Util.Chance(100))
                                    {
                                        if (spells.HasRecastDelay && Body.GetSkillDisabledDuration(Rune_Bolt) == 0)
                                            Body.CastSpell(Rune_Bolt,
                                                SkillBase.GetSpellLine(GlobalSpellsLines.Mob_Spells), false);
                                        else
                                            Body.CastSpell(Rune_DD,
                                                SkillBase.GetSpellLine(GlobalSpellsLines.Mob_Spells), false);
                                    }
                                }
            }
            ...
            if (Body.PackageID == "NosdodenGhostSpiritmaster")
            {
                ...
                if (HasAggro)
                {
                    ...
                    foreach (GameNPC npc in Body.GetNPCsInRadius(2000))
                        if (npc != null)
                            if (npc.IsAlive && npc.Brain is GhostSpiritChampionBrain brain &&
                                npc.PackageID == Convert.ToString(Body.ObjectID))
                            {
                                var target = Body.TargetObject as GameLiving;
                                if (target != null)
                                    if (!brain.HasAggro)
                                ...
                                if (spells != null)
                                {
                                    ...
                                    if (Util.Chance(100))
                                    {
                                        if (spells.HasRecastDelay && Body.GetSkillDisabledDuration(Spirit_Mezz) == 0)
                                            Body.CastSpell(Spirit_Mezz,
                                                SkillBase.GetSpellLine(GlobalSpellsLines.Mob_Spells), false);
                                        else
                                            Body.CastSpell(Spirit_DD,
                                                SkillBase.GetSpellLine(GlobalSpellsLines.Mob_Spells), false);
                                    }
                                }
                }
        ...
        public void IsBonedancer()
        {
            if (Body.PackageID == "NosdodenGhostBonedancer")
            {
                ...
                if (HasAggro)
                {
                    ...
                    foreach (GameNPC npc in Body.GetNPCsInRadius(2000))
                        if (npc != null)
                            if (npc.IsAlive && npc.Brain is GhostSkeletalCommanderBrain brain &&
                                npc.PackageID == Convert.ToString(Body.ObjectID))
                            {
                                var target = Body.TargetObject as GameLiving;
                                if (target != null)
                                ...
                                if (spells != null)
                                {
                                    ...
                                    if (Util.Chance(100))
                                    {
                                        if (spells.HasRecastDelay && Body.GetSkillDisabledDuration(Bone_DD) == 0)
                                            Body.CastSpell(Bone_DD,
                                                SkillBase.GetSpellLine(GlobalSpellsLines.Mob_Spells), false);
                                        else
                                            Body.CastSpell(Bone_DD2,
                                                SkillBase.GetSpellLine(GlobalSpellsLines.Mob_Spells), false);
                                    }
                                }
                }
        ...
        {
            get => randomhealertarget;
            set => randomhealertarget = value;
        }

        private protected List<GamePlayer> HealerEnemys_To_Mezz = new();
        ...
        private protected void PickTargetToMezz()
        {
            if (HasAggro)
            {
                foreach (GamePlayer player in Body.GetPlayersInRadius(2500))
                    if (player != null)
                        if (player.IsAlive && player.Client.Account.PrivLevel == 1)
                            if (!HealerEnemys_To_Mezz.Contains(player) &&
                                (!player.effectListComponent.ContainsEffectForEffectType(eEffect.MezImmunity) ||
                                 !player.effectListComponent.ContainsEffectForEffectType(eEffect.Mez)))
                ...
                if (HealerEnemys_To_Mezz.Count > 0)
                    ...
                    {
                        var Target =
                            HealerEnemys_To_Mezz[
                                Util.Random(0, HealerEnemys_To_Mezz.Count - 1)]; //pick random target from list
                        RandomHealerTarget = Target;
                        if (RandomHealerTarget != null && RandomHealerTarget.IsAlive
                                                       && (!RandomHealerTarget.effectListComponent
                                                               .ContainsEffectForEffectType(eEffect.Mez) ||
                                                           !RandomHealerTarget.effectListComponent
                                                               .ContainsEffectForEffectType(eEffect.MezImmunity)))
                        {
        ...
        public void IsHealer()
        {
            if (Body.PackageID == "NosdodenGhostHealer")
            {
                    ...
                    foreach (GameNPC npc in Body.GetNPCsInRadius((ushort) Healer_Heal.Range))
                        if (npc != null)
                            if (npc.IsAlive && npc.Faction == Body.Faction && npc.HealthPercent < 100)
                            {
                                ...
                                if (npc != Body)
                                    Body.TurnTo(npc);
                                Body.CastSpell(Healer_Heal, SkillBase.GetSpellLine(GlobalSpellsLines.Mob_Spells),
                                    false);
                            }
                }
                ...
                if (HasAggro)
                    if (Body.TargetObject != null)
                    {
                        var oldtarget = Body.TargetObject as GameLiving;
                        if (!Body.IsCasting && !Body.IsMoving)
                            foreach (Spell spells in Body.Spells)
                                if (spells != null)
                                {
                                                ...
                                                if (npc != null)
                                                    if (npc.IsAlive && npc.Faction == Body.Faction)
                                                    {
                                                        if (npc.HealthPercent < 100)
                                                        {
                                                            ...
                                                            if (npc != Body)
                                                                Body.TurnTo(npc);
                                                            Body.CastSpell(Healer_Heal,
                                                                SkillBase.GetSpellLine(GlobalSpellsLines.Mob_Spells),
                                                                false);
                                                        }

                                                        if (npc.HealthPercent == 100)
                                                            if (oldtarget != null && oldtarget != Body &&
                                                                !HealerEnemys_To_Mezz.Contains(
                                                                    Body.TargetObject as GamePlayer))
                                                            {
                                                                Body.TargetObject = CalculateNextAttackTarget();
                                                                Body.TurnTo(Body.TargetObject);
                                                                Body.CastSpell(Healer_Amnesia,
                                                                    SkillBase.GetSpellLine(GlobalSpellsLines
                                                                        .Mob_Spells), false);
                                                            }
                                                    }
                                    }
                                ...
                                if (spells != null)
                                {
                                    ...
                                    if (Util.Chance(100))
                                    {
                                        if (spells.HasRecastDelay && Body.GetSkillDisabledDuration(Shamy_Bolt) == 0)
                                            Body.CastSpell(Shamy_Bolt,
                                                SkillBase.GetSpellLine(GlobalSpellsLines.Mob_Spells), false);
                                        else if (spells.HasRecastDelay &&
                                                 Body.GetSkillDisabledDuration(Shamy_AoeDot) == 0)
                                            Body.CastSpell(Shamy_AoeDot,
                                                SkillBase.GetSpellLine(GlobalSpellsLines.Mob_Spells), false);
                                        else if (spells.HasRecastDelay &&
                                                 Body.GetSkillDisabledDuration(Shamy_InstaAoeDisease) == 0)
                                            Body.CastSpell(Shamy_InstaAoeDisease,
                                                SkillBase.GetSpellLine(GlobalSpellsLines.Mob_Spells), false);
                                        else
                                            Body.CastSpell(Shamy_DD,
                                                SkillBase.GetSpellLine(GlobalSpellsLines.Mob_Spells), false);
                                    }
                                }
            }
        ...
        public int WalkBack(ECSGameTimer timer)
        {
            if (Body.InCombat && HasAggro && Body.TargetObject != null)
                if (Body.TargetObject is GameLiving)
                {
                    ...
                    positionalPoint =
                        living.GetPointFromHeading((ushort) (living.Heading + 180 * (4096.0 / 360.0)), 65);
        ...
        public void CreateHunterPet()
        {
            ...
            {
                var ptarget = CalculateNextAttackTarget();
                var pet = new GameNPC();
                ...
                var sbrain = new StandardMobBrain();
        ...
        {
            foreach (GameNPC npc in Body.GetNPCsInRadius(5000))
                if (npc.IsAlive && npc.RespawnInterval == -1 && npc.PackageID == Convert.ToString(Body.ObjectID) &&
                    npc.Brain is GhostSpiritChampionBrain)
                    return;

            if (Body.PackageID == "NosdodenGhostSpiritmaster")
            {
                var pet = new GhostSpiritChampion();
                pet.X = Body.X;
                pet.Y = Body.Y - 100;
                pet.Z = Body.Z;
                pet.Heading = Body.Heading;
                ...
                pet.RespawnInterval = -1;
                var sbrain = new GhostSpiritChampionBrain();
                pet.SetOwnBrain(sbrain);
                sbrain.AggroRange = 500;
                sbrain.AggroLevel = 100;
                pet.AddToWorld();
        ...
        public void SummonSkeletalCommander()
        {
            foreach (GameNPC npc in Body.GetNPCsInRadius(5000))
                if (npc.IsAlive && npc.RespawnInterval == -1 && npc.PackageID == Convert.ToString(Body.ObjectID) &&
                    npc.Brain is GhostSkeletalCommanderBrain)
                    return;

            if (Body.PackageID == "NosdodenGhostBonedancer")
            {
                var pet = new GhostSkeletalCommander();
                pet.X = Body.X;
                pet.Y = Body.Y - 100;
                pet.Z = Body.Z;
                pet.Heading = Body.Heading;
                ...
                pet.PackageID = Convert.ToString(Body.ObjectID);
                pet.RespawnInterval = -1;
                var sbrain = new GhostSkeletalCommanderBrain();
                pet.SetOwnBrain(sbrain);
                sbrain.AggroRange = 500;
                sbrain.AggroLevel = 100;
                pet.AddToWorld();
        ...
        private Spell Shamy_InstaAoeDisease
        {
            get
            {
                if (m_Shamy_InstaAoeDisease == null)
                {
                    ...
                    spell.DamageType = (int) eDamageType.Matter;
                    spell.Description =
                        "Inflicts a wasting disease on the target that slows it, weakens it, and inhibits heal spells.";
...
namespace DOL.GS
{
    public class NosdodenGhostAdd : GameNPC
    {
        ...
        {
            if (PackageID == "NosdodenGhostRunemaster" || PackageID == "NosdodenGhostSpiritmaster" ||
                PackageID == "NosdodenGhostBonedancer"
        ...
        public override void OnAttackEnemy(AttackData ad)
        {
            ...
            if (PackageID == "NosdodenGhostShadowblade")
            {
                if (ad != null &&
                    ...
                    !ad.Target.effectListComponent.ContainsEffectForEffectType(eEffect.DamageOverTime))
        ...
        public override void Die(GameObject killer)
        {
            ...
            if (PackageID == "NosdodenGhostSpiritmaster")
                foreach (GameNPC npc in GetNPCsInRadius(5000))
                    if (npc != null)
                        if (npc.IsAlive && npc.RespawnInterval == -1 && npc.PackageID == Convert.ToString(ObjectID) &&
                            npc.Brain is GhostSpiritChampionBrain)
                            npc.Die(npc);
        ...
        public override bool AddToWorld()
        {
            ...
            Faction = FactionMgr.GetFactionByID(150);
            Faction.AddFriendFaction(FactionMgr.GetFactionByID(150));
            var add = new NosdodenGhostAddBrain();
            SetOwnBrain(add);
            base.AddToWorld();
            return true;
        }
...
namespace DOL.GS
{
    ...
    {
        public override int MaxHealth => 2500;
            ...
            if (ad != null &&
                ...
                if (Util.Chance(25) &&
                    (!ad.Target.effectListComponent.ContainsEffectForEffectType(eEffect.StunImmunity) ||
                     !ad.Target.effectListComponent.ContainsEffectForEffectType(eEffect.Stun)) && ad.Target.IsAlive)
        ...
        private List<ushort> spirit_champion_models = new()
        {
        ...
        public override bool AddToWorld()
        {
            ...
            Flags ^= eFlags.GHOST;
            Realm = eRealm.None;
            var adds = new GhostSpiritChampionBrain();
            SetOwnBrain(adds);
            base.AddToWorld();
            return true;
        }
        ...
        private Spell SpiritChampion_stun
        {
            get
            {
                if (m_SpiritChampion_stun == null)
                {
                    ...
                    spell.Duration = 4;
                    spell.Description =
                        "Target is stunned and cannot move or take any other action for the duration of the spell.";
                    spell.Name = "Stun";
                    spell.Range = 400;
                    spell.SpellID = 11884;
                    spell.Target = "Enemy";
        ...
        public override void Think()
        {
            if (!CheckProximityAggro())
                foreach (GameNPC bone in Body.GetNPCsInRadius(5000))
                    if (bone != null)
                        if (bone.IsAlive && bone.Brain is NosdodenGhostAddBrain &&
                            bone.PackageID == "NosdodenGhostSpiritmaster" &&
                            Body.PackageID == Convert.ToString(bone.ObjectID))
                            Body.Follow(bone, 100, 5000);

            if (HasAggro)
                foreach (GameNPC bone in Body.GetNPCsInRadius(5000))
                    if (bone != null)
                        if (bone.IsAlive && bone.Brain is NosdodenGhostAddBrain brain &&
                            bone.PackageID == "NosdodenGhostSpiritmaster" &&
                            Body.PackageID == Convert.ToString(bone.ObjectID))
                        {
                            var target = Body.TargetObject as GameLiving;
...
namespace DOL.GS
{
    public class GhostSkeletalCommander : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            RespawnInterval = -1;
            Realm = eRealm.None;
            var adds = new GhostSkeletalCommanderBrain();
            SetOwnBrain(adds);
            base.AddToWorld();
            return true;
        }
        ...
        {
            foreach (GameNPC npc in GetNPCsInRadius(5000))
                if (npc.IsAlive && npc.RespawnInterval == -1 && npc.Brain is SkeletalCommanderHealerBrain &&
...
namespace DOL.AI.Brain
{
    public class GhostSkeletalCommanderBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            if (!CheckProximityAggro())
            {
                ...
                foreach (GameNPC bone in Body.GetNPCsInRadius(5000))
                    if (bone != null)
                        if (bone.IsAlive && bone.Brain is NosdodenGhostAddBrain &&
                            bone.PackageID == "NosdodenGhostBonedancer" &&
                            Body.PackageID == Convert.ToString(bone.ObjectID))
                            Body.Follow(bone, 100, 5000);
            }
        ...
        private protected void SummonBonemender()
        {
            foreach (GameNPC npc in Body.GetNPCsInRadius(5000))
                if (npc.IsAlive && npc.RespawnInterval == -1 && npc.Brain is SkeletalCommanderHealerBrain &&
                    npc.PackageID == Body.PackageID)
                    return;

            var pet = new SkeletalCommanderHealer();
            pet.X = Body.X;
            pet.Y = Body.Y - 50;
            pet.Z = Body.Z;
...
namespace DOL.GS
{
    public class SkeletalCommanderHealer : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            Flags ^= eFlags.GHOST;
            Realm = eRealm.None;
            var adds = new SkeletalCommanderHealerBrain();
            SetOwnBrain(adds);
            base.AddToWorld();
            return true;
        }
            ...
            if (Body.IsAlive)
            {
                ...
                foreach (GameNPC bone in Body.GetNPCsInRadius(5000))
                    if (commander != null && bone != null)
                        if (commander.IsAlive && commander.Brain is GhostSkeletalCommanderBrain brain &&
                            commander.PackageID == Body.PackageID)
                            if (bone.IsAlive && bone.Brain is NosdodenGhostAddBrain brain2 &&
                                bone.PackageID == "NosdodenGhostBonedancer" &&
                                bone.ObjectID == Convert.ToInt16(Body.PackageID))
                                if (!Body.IsCasting && !Body.IsMoving)
                                    foreach (Spell spells in Body.Spells)
                                        if (spells != null)
                                        {
...
namespace DOL.GS
{
    public class NosdodenSummonedAdds : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            Faction = FactionMgr.GetFactionByID(150);
            Faction.AddFriendFaction(FactionMgr.GetFactionByID(150));
            var adds = new NosdodenSummonedAddsBrain();
            SetOwnBrain(adds);
            base.AddToWorld();
            return true;
        }

    ...
    public void OnCommand(GameClient client, string[] args)
    {
        ...
        if (item == null)
        {
            client.Out.SendMessage(
                LanguageMgr.GetTranslation(client.Account.Language, "GMCommands.Item.Count.NoItemInSlot", slot),
        ...
        var temp = GameServer.Database.FindObjectByKey<ItemTemplate>(idnb);

...
namespace DOL.AI.Brain
{
    public class EquesBrain : StandardMobBrain
    {
        ...
        {
            var point1 = new Point3D(32964, 41982, 15007);
            var point2 = new Point3D(32083, 42010, 14767);
            var point3 = new Point3D(32098, 37126, 14767);
            var point4 = new Point3D(32974, 37123, 15007);
            var point5 = new Point3D(33758, 37121, 15007);
            var point6 = new Point3D(34641, 37118, 14767);
            var point7 = new Point3D(34652, 41983, 14767);
            var point8 = new Point3D(33748, 41983, 15007);
            if (Body.IsMoving)

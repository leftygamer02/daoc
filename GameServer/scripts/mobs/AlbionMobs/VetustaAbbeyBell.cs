...
namespace DOL.GS
{
    public class VetustaAbbeyBell : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new VetustaAbbeyBellBrain();
            SetOwnBrain(sbrain);
            base.AddToWorld();
            return true;
        }
...
namespace DOL.AI.Brain
{
    public class VetustaAbbeyBellBrain : APlayerVicinityBrain
    {
        ...
        private int RingBell(ECSGameTimer timer)
        {
            ...
            new ECSGameTimer(Body, new ECSGameTimer.ECSTimerCallback(ResetRingBell),
                10000); //reset ring bell after 10s to avoid double ding dong ^^
            return 0;
        }

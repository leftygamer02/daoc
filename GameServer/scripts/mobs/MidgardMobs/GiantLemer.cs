...
namespace DOL.GS
{
    public class GiantLemer : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new GiantLemerBrain();
            SetOwnBrain(sbrain);
...
namespace DOL.AI.Brain
{
    public class GiantLemerBrain : StandardMobBrain
    {
        ...
        private bool spawnRats = false;
        private bool RemoveAdds = false;

        public void BroadcastMessage(string message)
        {
            foreach (var player in WorldMgr.GetClientsOfZone(Body.CurrentZone.ID))
...
namespace DOL.GS
{
    public class GiantLemerAdd : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            Model = 567;
            Size = 20;
            var sbrain = new GiantLemerAddBrain();
            SetOwnBrain(sbrain);

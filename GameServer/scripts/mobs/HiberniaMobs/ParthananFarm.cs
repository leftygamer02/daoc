...
namespace DOL.GS
{
    public class AmalgamateParthanan : GameNPC
    {
        ...
        public override void TakeDamage(GameObject source, eDamageType damageType, int damageAmount, int criticalAmount)
        {
            ...
            {
                var target = source as GameLiving;
                if (target == null || target.ActiveWeapon == null) return;
                if (damageType == eDamageType.Body || damageType == eDamageType.Cold ||
                    damageType == eDamageType.Energy || damageType == eDamageType.Heat
                    || damageType == eDamageType.Matter || damageType == eDamageType.Spirit ||
                    target.ActiveWeapon.Object_Type == (int) eObjectType.RecurvedBow ||
                    target.ActiveWeapon.Object_Type == (int) eObjectType.Fired)
                {
                    GamePlayer truc;
                    ...
                    if (truc != null)
                        truc.Out.SendMessage(Name + " is immune to this form of attack!", eChatType.CT_SpellResisted,
        ...
        public override bool HasAbility(string keyName) //immune to cc and dmg(in certain situation only)
        {
            ...
            if (ParthananFarmController1Brain.SacrificeParthanan1 && PackageID == "ParthananBossLoughDerg" && IsAlive &&
                keyName == GS.Abilities.DamageImmunity)
                return true;
            ...
            if (ParthananFarmController2Brain.SacrificeParthanan2 && PackageID == "ParthananBossConnacht" && IsAlive &&
                keyName == GS.Abilities.DamageImmunity)
                return true;
            if (ParthananFarmController2bBrain.SacrificeParthanan2b && PackageID == "ParthananBossConnacht2" &&
                IsAlive && keyName == GS.Abilities.DamageImmunity)
                return true;
            ...
            if (ParthananFarmController3Brain.SacrificeParthanan3 && PackageID == "ParthananBossLoughGur" && IsAlive &&
                keyName == GS.Abilities.DamageImmunity)
                return true;
            if (ParthananFarmController3bBrain.SacrificeParthanan3b && PackageID == "ParthananBossLoughGur2" &&
                IsAlive && keyName == GS.Abilities.DamageImmunity)
                return true;
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new AmalgamateParthananBrain();
            SetOwnBrain(sbrain);
        ...
        protected int Show_Effect(ECSGameTimer timer)
        {
            ...
            if (IsAlive && !ParthananFarmController2bBrain.SacrificeParthanan2b &&
                PackageID == "ParthananBossConnacht2")
                new ECSGameTimer(this, new ECSGameTimer.ECSTimerCallback(DoEndCast), 100);
            ...
            if (IsAlive && !ParthananFarmController3bBrain.SacrificeParthanan3b &&
                PackageID == "ParthananBossLoughGur2")
                new ECSGameTimer(this, new ECSGameTimer.ECSTimerCallback(DoEndCast), 100);
    ...
    public class ParthananBrain : StandardMobBrain
    {
        ...
        public override void AttackMostWanted()
        {
            if (!Body.IsControlledNPC(Body))
            {
                ...
                {
                    if (ParthananFarmController1Brain.SacrificeParthanan1 &&
                        ParthananFarmController1Brain.ParthansCanDie)
                        return;
                    else
                ...
                {
                    if (ParthananFarmController2Brain.SacrificeParthanan2 &&
                        ParthananFarmController2Brain.ParthansCanDie2)
                        return;
                    else
                        base.AttackMostWanted();
                }
                ...
                {
                    if (ParthananFarmController2bBrain.SacrificeParthanan2b &&
                        ParthananFarmController2bBrain.ParthansCanDie2b)
                        return;
                    else
                        base.AttackMostWanted();
                }
                ...
                {
                    if (ParthananFarmController3Brain.SacrificeParthanan3 &&
                        ParthananFarmController3Brain.ParthansCanDie3)
                        return;
                    else
                        base.AttackMostWanted();
                }
                ...
                {
                    if (ParthananFarmController3bBrain.SacrificeParthanan3b &&
                        ParthananFarmController3bBrain.ParthansCanDie3b)
                        return;
                    else
                        base.AttackMostWanted();
                }
                ...
                if (Body.PackageID == "ParthananLoughGur")
                {
                        ...
                        ParthananFarmController3Brain.ParthansCanDie3)
                    {
                        ...
                        foreach (GameNPC npc in Body.GetNPCsInRadius(5000))
                            ...
                            {
                                var point = new Point3D(npc.X, npc.Y, npc.Z);
                                if (!Body.IsWithinRadius(npc, 50))
...
namespace DOL.GS
{
    public class ParthananFarmController1 : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new ParthananFarmController1Brain();
            SetOwnBrain(sbrain);
            base.AddToWorld();
            return true;
        }
...
namespace DOL.AI.Brain
{
    public class ParthananFarmController1Brain : APlayerVicinityBrain
    {
        ...
        public static List<GameNPC> MinParthAround = new();
            ...
            if (ParthanansKilledFarm1 >= MobsToKillLoughDerg)
            {
                ...
                if (SacrificeParthanan1)
                {
                    foreach (GameNPC npc in Body.GetNPCsInRadius(3000))
                        if (npc != null && npc.IsAlive && npc.Brain is ParthananBrain &&
                            npc.PackageID == "ParthananLoughDerg" && !MinParthAround.Contains(npc))
        ...
        public void SpawnBigOne()
        {
            ...
            var boss = new AmalgamateParthanan();
            boss.X = Body.X;
            boss.Y = Body.Y;
            boss.Z = Body.Z;
...
namespace DOL.GS
{
    public class ParthananFarmController2 : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new ParthananFarmController2Brain();
            SetOwnBrain(sbrain);
            base.AddToWorld();
            return true;
        }
...
namespace DOL.AI.Brain
{
    public class ParthananFarmController2Brain : APlayerVicinityBrain
    {
        ...
        public static List<GameNPC> MinParthAround2 = new();
        ...
        public override void Think()
        {
            if (ParthanansKilledFarm2 >= MobsToKillConnacht)
            {
                ...
                if (SacrificeParthanan2)
                {
                    foreach (GameNPC npc in Body.GetNPCsInRadius(3000))
                        if (npc != null && npc.IsAlive && npc.Brain is ParthananBrain &&
                            npc.PackageID == "ParthananConnacht" && !MinParthAround2.Contains(npc))
...
namespace DOL.GS
{
    public class ParthananFarmController2b : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new ParthananFarmController2bBrain();
            SetOwnBrain(sbrain);
            base.AddToWorld();
            return true;
        }
...
namespace DOL.AI.Brain
{
    public class ParthananFarmController2bBrain : APlayerVicinityBrain
    {
        ...
        public static List<GameNPC> MinParthAround2b = new();
        ...
        public override void Think()
        {
            if (ParthanansKilledFarm2b >= MobsToKillConnacht2)
            {
                ...
                if (SacrificeParthanan2b)
                {
                    foreach (GameNPC npc in Body.GetNPCsInRadius(3000))
                        if (npc != null && npc.IsAlive && npc.Brain is ParthananBrain &&
                            npc.PackageID == "ParthananConnacht2" && !MinParthAround2b.Contains(npc))
...
namespace DOL.GS
{
    public class ParthananFarmController3 : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new ParthananFarmController3Brain();
            SetOwnBrain(sbrain);
            base.AddToWorld();
            return true;
        }
...
namespace DOL.AI.Brain
{
    public class ParthananFarmController3Brain : StandardMobBrain
    {
        ...
        public static List<GameNPC> MinParthAround3 = new();
        ...
        public override void Think()
        {
            ...
            if (ParthanansKilledFarm3 >= MobsToKillLoughGur)
            {
                ...
                if (SacrificeParthanan3)
                {
                    foreach (GameNPC npc in Body.GetNPCsInRadius(3000))
                        if (npc != null && npc.IsAlive && npc.Brain is ParthananBrain &&
                            npc.PackageID == "ParthananLoughGur" && !MinParthAround3.Contains(npc))
...
namespace DOL.GS
{
    public class ParthananFarmController3b : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            var sbrain = new ParthananFarmController3bBrain();
            SetOwnBrain(sbrain);
            base.AddToWorld();
            return true;
        }
...
namespace DOL.AI.Brain
{
    public class ParthananFarmController3bBrain : StandardMobBrain
    {
        ...
        public static List<GameNPC> MinParthAround3b = new();
        ...
        public override void Think()
        {
            if (ParthanansKilledFarm3b >= MobsToKillLoughGur2)
            {
                ...
                if (SacrificeParthanan3b)
                {
                    foreach (GameNPC npc in Body.GetNPCsInRadius(3000))
                        if (npc != null && npc.IsAlive && npc.Brain is ParthananBrain &&
                            npc.PackageID == "ParthananLoughGur2" && !MinParthAround3b.Contains(npc))

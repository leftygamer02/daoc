...
public class Focus_50 : BaseQuest
{
    ...
    public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var npcs = WorldMgr.GetNPCsByName("Ainrebh", eRealm.Hibernia);
        ...
        if (Ainrebh == null)
        {
            ...
            Ainrebh.AddToWorld();
            if (SAVE_INTO_DATABASE) Ainrebh.SaveIntoDatabase();
        }
        // end npc
        ...
        if (GreenMaw == null)
        {
            ...
            GreenMaw.AddToWorld();
            if (SAVE_INTO_DATABASE) GreenMaw.SaveIntoDatabase();
        }
        // end npc
        ...
        if (GreenMaw_key == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(GreenMaw_key);
        }
...
// end item			
        ...
        if (RangerEpicBoots == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(RangerEpicBoots);
        }
...
//end item
        ...
        if (RangerEpicHelm == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(RangerEpicHelm);
        }
...
//end item
        ...
        if (RangerEpicGloves == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(RangerEpicGloves);
        }
        ...
        if (RangerEpicVest == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(RangerEpicVest);
        }
        ...
        if (RangerEpicLegs == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(RangerEpicLegs);
        ...
        if (RangerEpicArms == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(RangerEpicArms);
        }
...
//Hero Epic Sleeves End
        ...
        if (HeroEpicBoots == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(HeroEpicBoots);
        }
...
//end item
        ...
        if (HeroEpicHelm == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(HeroEpicHelm);
        }
...
//end item
        ...
        if (HeroEpicGloves == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(HeroEpicGloves);
        }
        ...
        if (HeroEpicVest == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(HeroEpicVest);
        }
        ...
        if (HeroEpicLegs == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(HeroEpicLegs);
        }
        ...
        if (HeroEpicArms == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(HeroEpicArms);
        }
        ...
        if (WardenEpicBoots == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(WardenEpicBoots);
        }
...
//end item
        ...
        if (WardenEpicHelm == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(WardenEpicHelm);
        }
...
//end item
        ...
        if (WardenEpicGloves == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(WardenEpicGloves);
        }
        ...
        if (WardenEpicVest == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(WardenEpicVest);
        }
        ...
        if (WardenEpicLegs == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(WardenEpicLegs);
        }
        ...
        if (WardenEpicArms == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(WardenEpicArms);
        }
        ...
        if (EldritchEpicBoots == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(EldritchEpicBoots);
        }
...
//end item
        ...
        if (EldritchEpicHelm == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(EldritchEpicHelm);
        }
...
//end item
        ...
        if (EldritchEpicGloves == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(EldritchEpicGloves);
        }
        ...
        if (EldritchEpicVest == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(EldritchEpicVest);
        }
        ...
        if (EldritchEpicLegs == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(EldritchEpicLegs);
        }
        ...
        if (EldritchEpicArms == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(EldritchEpicArms);
        }
...
//Item Descriptions End
    ...
    protected static void TalkToAinrebh(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(Focus_50)) as Focus_50;
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                ...
                {
                    case 1:
                        Ainrebh.SayTo(player,
                            "Seek out Green Maw in Cursed Forest and kill it. Green Maw is guarded by grannies and spectral manslayers.");
                        break;
                    case 2:
        ...
        else if (e == GameLivingEvent.WhisperReceive)
        {
            ...
            if (quest == null)
                ...
                {
                    case "services":
                        player.Out.SendQuestSubscribeCommand(Ainrebh, QuestMgr.GetIDForQuestType(typeof(Focus_50)),
                            "Will you help Ainrebh [Path of Focus Level 50 Epic]?");
                        break;
                }
            else
                switch (wArgs.Text)
    ...
    private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
    {
        ...
        else
        {
            ...
            if (!Ainrebh.GiveQuest(typeof(Focus_50), player, 1))
                return;
            player.Out.SendMessage("Kill Green Maw in Cursed Forest loc 37k, 38k!", eChatType.CT_System,
                eChatLoc.CL_PopupWindow);
        }
    }

    //Set quest name
    public override string Name => "Unnatural Powers (Level 50 Path of Focus Epic)";
    ...
    public override void Notify(DOLEvent e, object sender, EventArgs args)
    {
        ...
        if (Step == 1 && e == GameLivingEvent.EnemyKilled)
        {
            ...
            {
                m_questPlayer.Out.SendMessage("You collect Green Maw's Key", eChatType.CT_System,

...
public class Essence_50 : BaseQuest
{
    ...
    public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var npcs = WorldMgr.GetNPCsByName("Brigit", eRealm.Hibernia);
        ...
        if (Brigit == null)
        {
            ...
            Brigit.Heading = 2055;
            Brigit.AddToWorld();
            if (SAVE_INTO_DATABASE) Brigit.SaveIntoDatabase();
        }
        // end npc
        ...
        if (Caithor == null)
        {
            ...
            Caithor.AddToWorld();
            if (SAVE_INTO_DATABASE) Caithor.SaveIntoDatabase();
        }
        // end npc
        ...
        if (Moonstone == null)
        {
            ...
            Moonstone.Weight = 12;
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(Moonstone);
        }
...
// end item			
        ...
        if (BardEpicBoots == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(BardEpicBoots);
        }
...
//end item
        ...
        if (BardEpicHelm == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(BardEpicHelm);
        }
...
//end item
        ...
        if (BardEpicGloves == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(BardEpicGloves);
        }
        ...
        if (BardEpicVest == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(BardEpicVest);
        }
        ...
        if (BardEpicLegs == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(BardEpicLegs);
        }
        ...
        if (BardEpicArms == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(BardEpicArms);
        }
...
//Champion Epic Sleeves End
        ...
        if (ChampionEpicBoots == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ChampionEpicBoots);
        }
...
//end item
        ...
        if (ChampionEpicHelm == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ChampionEpicHelm);
        }
...
//end item
        ...
        if (ChampionEpicGloves == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ChampionEpicGloves);
        }
        ...
        if (ChampionEpicVest == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ChampionEpicVest);
        }
        ...
        if (ChampionEpicLegs == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ChampionEpicLegs);
        }
        ...
        if (ChampionEpicArms == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ChampionEpicArms);
        }
        ...
        if (NightshadeEpicBoots == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(NightshadeEpicBoots);
        }
...
//end item
        ...
        if (NightshadeEpicHelm == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(NightshadeEpicHelm);
        }
...
//end item
        ...
        if (NightshadeEpicGloves == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(NightshadeEpicGloves);
        }
        ...
        if (NightshadeEpicVest == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(NightshadeEpicVest);
        }
        ...
        if (NightshadeEpicLegs == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(NightshadeEpicLegs);
        }
        ...
        if (NightshadeEpicArms == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(NightshadeEpicArms);
        }
        ...
        if (EnchanterEpicBoots == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(EnchanterEpicBoots);
        }
...
//end item
        ...
        if (EnchanterEpicHelm == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(EnchanterEpicHelm);
        }
...
//end item
        ...
        if (EnchanterEpicGloves == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(EnchanterEpicGloves);
        }
        ...
        if (EnchanterEpicVest == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(EnchanterEpicVest);
        }
        ...
        if (EnchanterEpicLegs == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(EnchanterEpicLegs);
        }
        ...
        if (EnchanterEpicArms == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(EnchanterEpicArms);
        }
...
//Item Descriptions End
    ...
    protected static void TalkToBrigit(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(Essence_50)) as Essence_50;
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                switch (quest.Step)
                {
                    case 1:
                        Brigit.SayTo(player,
                            "Seek out Far Dorocha in Cursed Forest and kill them to spawn Giant Caithor! " +
        ...
        else if (e == GameLivingEvent.WhisperReceive)
        {
            ...
            if (quest == null)
                ...
                {
                    case "services":
                        player.Out.SendQuestSubscribeCommand(Brigit, QuestMgr.GetIDForQuestType(typeof(Essence_50)),
                            "Will you help Brigit [Path of Essence Level 50 Epic]?");
                        break;
                }
            else
                switch (wArgs.Text)
    ...
    private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
    {
        ...
        else
        {
            ...
            if (!Brigit.GiveQuest(typeof(Essence_50), player, 1))
                return;
            player.Out.SendMessage("Please kill Caithor in Cursed Forest!", eChatType.CT_System,
                eChatLoc.CL_PopupWindow);
        }
    }

    //Set quest name
    public override string Name => "The Moonstone Twin (Level 50 Path of Essence Epic)";
    ...
    public override string Description
    {
        get
        {
            switch (Step)
            {
                case 1:
                    return
                        "Seek out Far Dorocha in Cursed Forest and kill them to spawn Giant Caithor! After you kill Giant Caithor seek out real Caithor and kill him!";
                case 2:
    ...
    public override void Notify(DOLEvent e, object sender, EventArgs args)
    {
        ...
        if (Step == 1 && e == GameLivingEvent.EnemyKilled)
        {
            ...
            {
                m_questPlayer.Out.SendMessage("You collect the Moonstone from Caithor", eChatType.CT_System,

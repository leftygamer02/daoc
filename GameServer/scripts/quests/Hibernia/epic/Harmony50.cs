...
public class Harmony_50 : BaseQuest
{
    ...
    public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var npcs = WorldMgr.GetNPCsByName("Revelin", eRealm.Hibernia);
        ...
        if (Revelin == null)
        {
            ...
            Revelin.AddToWorld();
            if (SAVE_INTO_DATABASE) Revelin.SaveIntoDatabase();
        }
        // end npc
        ...
        if (Cailean == null)
        {
            ...
            Cailean.AddToWorld();
            if (SAVE_INTO_DATABASE) Cailean.SaveIntoDatabase();
        }
        // end npc
        ...
        if (Horn == null)
        {
            ...
            Horn.Quality = 100;
            Horn.Weight = 12;
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(Horn);
        }
    ...
    protected static void TalkToRevelin(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(Harmony_50)) as Harmony_50;
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                ...
                {
                    case 1:
                        Revelin.SayTo(player,
                            "Seek out Cailean in Cursed Forest and kill it. Cailean is a terrored tree that can be found North-West of Granny Fort across the river.");
                        break;
                    case 2:
        ...
        else if (e == GameLivingEvent.WhisperReceive)
        {
            ...
            if (quest == null)
                ...
                {
                    case "services":
                        player.Out.SendQuestSubscribeCommand(Revelin,
                            QuestMgr.GetIDForQuestType(typeof(Harmony_50)),
                            "Will you help Revelin [Path of Harmony Level 50 Epic]?");
                        break;
                }
            else
                switch (wArgs.Text)
    ...
    private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
    {
        ...
        else
        {
            ...
            if (!Revelin.GiveQuest(typeof(Harmony_50), player, 1))
                return;
            player.Out.SendMessage("Please kill Cailean in Cursed Forest.", eChatType.CT_System,
                eChatLoc.CL_PopupWindow);
        }
    }

    //Set quest name
    public override string Name => "The Horn Twin (Level 50 Path of Harmony Epic)";
    ...
    public override string Description
    {
        get
        {
            switch (Step)
            {
                case 1:
                    return
                        "Seek out Cailean in Cursed Forest and kill it! Cailean is in the middle of north-west forest";
                case 2:
    ...
    public override void Notify(DOLEvent e, object sender, EventArgs args)
    {
        ...
        if (Step == 1 && e == GameLivingEvent.EnemyKilled)
        {
            ...
            if (gArgs.Target.Name == Cailean.Name &&
                player.Inventory.IsSlotsFree(1, eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack))
            {
                m_questPlayer.Out.SendMessage("You collect the Horn from Cailean", eChatType.CT_System,

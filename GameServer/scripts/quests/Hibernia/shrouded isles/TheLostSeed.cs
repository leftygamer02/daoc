...
public class TheLostSeed : BaseQuest
{
    ...
    public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        treantArea = new Area.Circle("accursed piece of forest", treantLocation.X, treantLocation.Y,
            treantLocation.Z,
            radius);
    ...
    private static void PlayerEnterTreantArea(DOLEvent e, object sender, EventArgs args)
    {
        ...
        if (Monitor.TryEnter(spawnLock))
            try
            {
                ...
                player.Out.SendMessage("Feairna-Athar ambushes you!", eChatType.CT_ScreenCenter,
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                switch (quest.Step)
                {
                    case 1:
                        Terod.SayTo(player,
                            "I am very glad that you decided to help us! The [treant] in Cothrom Gorge is brutal and very aggressive. I heard it likes to torture everything that stands in its way.");
                        break;
                    case 2:
                        Terod.SayTo(player,
                            "Kredril has studied this treant for years, he will know much more about it. Seek for him in the outskirts of Droighaid, he will be able to help you.");
                        break;
                    case 3:
                        Terod.SayTo(player, "Greetings " + player.CharacterClass.Name +
                                            ", Kredril told me that you are on your way to visit Jandros, is that right? " +
                    ...
                    case 5:
                        Terod.SayTo(player,
                            "Jandros has told me that you defeated the treant Feairna-Athar. We all stand behind and thank you for your courage!");
                        break;
                    case 6:
                        Terod.SayTo(player,
                            "I dont know what to say, you are outstanding! Bring this Glowing Red Jewel to Jandros, he knows what to do.");
                        break;
                    case 7:
        ...
        else if (e == GameLivingEvent.WhisperReceive)
        {
            ...
            if (quest == null)
                switch (wArgs.Text)
                {
                    case "help us":
                        Terod.SayTo(player,
                            "Some friends and I have been looking for strong fighters and magicians to help us for a few days now. " +
                            "It's about the [Lost Seed].");
                        break;

                    case "Lost Seed":
                        player.Out.SendQuestSubscribeCommand(Terod, QuestMgr.GetIDForQuestType(typeof(TheLostSeed)),
                            "Will you help Terod find [The Lost Seed]?");
                        break;
                }
            else
                switch (wArgs.Text)
                {
                    case "treant":
                        ...
                        {
                            Terod.SayTo(player,
                                "Kredril knows much more about this treant, go find him outside of Droighaid.");
                            quest.Step = 2;
                        }

                        break;
                    case "reward":
                        if (quest.Step == 7) quest.FinishQuest();
            ...
            if (quest != null)
                switch (quest.Step)
                {
                    case 1:
                        ...
                        break;
                    case 2:
                        Kredril.SayTo(player,
                            "Hey " + player.CharacterClass.Name + ", has Terod told you about [the Lost Seed]?");
                        break;
                    case 3:
                        Kredril.SayTo(player,
                            "Hey " + player.Name +
                            ", you can find Emolia around Droighaid's Bindstone. She will teleport you to Aalid Feie.");
                        break;
                    case 4:
                        Kredril.SayTo(player,
                            player.Name +
                            " have you visited Jandros yet? You can find him in one of those big trees.");
                        break;
                    case 5:
                        Kredril.SayTo(player,
                            "Jandros has told Terod and I that you faced the treant Feairna-Athar. Thank you for your help and courage!");
                        break;
                    case 6:
                        Kredril.SayTo(player,
                            "Outstanding! Now everyone can sleep well again! Bring this Glowing Red Jewel to Jandros, he will tell you what to do next.");
                        break;
                    case 7:
                        Kredril.SayTo(player,
                            "Hey " + player.Name +
                            ", go tell Terod about it. I think he will want to thank you in a special way.");
                        break;
                }
            else
        ...
        else if (e == GameLivingEvent.WhisperReceive)
        {
            ...
            if (quest == null)
                ...
                switch (wArgs.Text)
                {
                    case "the Lost Seed":
                        Kredril.SayTo(player,
                            "Farmers of Hibernia found seeds in Cothrom Gorge, which were cursed. A Few seeds got destroyed, but one was lost. " +
                    ...
                    case "Jandros":
                        ...
                        {
                            Kredril.SayTo(player,
                                "Go to Emolia in Droighaid, she will teleport you to Aalid Feie. " +
    ...
    protected static void TalkToJandros(DOLEvent e, object sender, EventArgs args)
    {
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                ...
                {
                    case 1:
                        Jandros.SayTo(player, "Hello " + player.CharacterClass.Name +
                                              ", I saw you in Aalid Feie for a few times. Have you visited Droighaid yet? " +
                                              "It's a beautiful place, my friends Kredril and Terod live there.");
                        break;
                    case 2:
                        Jandros.SayTo(player,
                            "Hey " + player.CharacterClass.Name +
                            ", I am sorry for seeming so distracted. We found a track for the Lost Seed.");
                        break;
                    case 3:
                        Jandros.SayTo(player,
                            "Hello " + player.Name + ", has Emolia sent you? I wasn't expecting you anytime soon.");
                        break;
                    case 4:
                        Jandros.SayTo(player,
                            "Greetings " + player.Name + ", I am glad that you are here, has [Kredril] sent you?");
                        break;
                    case 5:
                        Jandros.SayTo(player,
                            "Hey " + player.Name + ", follow the path north towards Cothrom Gorge. " +
                            "Once in the forest, head West. There, you will find the Treant Feairna-Athar. Kill him and bring me proof.");
                        break;
                    case 6:
                        Jandros.SayTo(player,
                            player.Name +
                            " you are crazy. I know that you will do it! Please hand me [the Jewel].");
                        break;
                    case 7:
                        Jandros.SayTo(player,
                            "Hey " + player.Name +
                            ", have you visited Terod in Droighaid yet? Please do it, he needs to know about it.");
                        break;
                }
            else
                Jandros.SayTo(player,
                    "Hey " + player.Name +
                    ", I wish it rained way more often in Aalid Feie. I love the sound and feel.");
        }
        // The player whispered to the NPC
        else if (e == GameLivingEvent.WhisperReceive)
        {
            ...
            if (quest == null)
                ...
                switch (wArgs.Text)
                {
                    case "Kredril":
                        Jandros.SayTo(player,
                            "Thank you for your courage and help, indeed we need fighter and magicians to help us finding [the Lost Seed].");
                        break;
                    case "the Lost Seed":
                        Jandros.SayTo(player,
                            "I think Kredril has already told you about the farmers that found some cursed magical seeds. Many [died] because of them.");
                        break;
                    case "died":
                        Jandros.Emote(eEmote.Cry);
                        Jandros.SayTo(player,
                            "Some rangers went near the location where the farmers died and reported that something strange " +

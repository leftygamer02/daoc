...
public class BeetleRvRQuestHib : Quests.AtlasQuest
{
    ...
    public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var npcs = WorldMgr.GetNPCsByName("Harris", eRealm.Hibernia);
        ...
        if (Harris == null)
        {
            ...
            Harris.AddToWorld();
            if (SAVE_INTO_DATABASE) Harris.SaveIntoDatabase();
        }
    ...
    private static void TalkToHarris(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(BeetleRvRQuestHib)) as BeetleRvRQuestHib;
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                ...
                Harris.SayTo(player, "Hello " + player.Name +
                                     ", I am Harris. The mission is very dangerous and I hope you can help me and Hibernia. " +
            ...
            if (quest == null)
                switch (wArgs.Text)
                {
                    case "help Hibernia and the beetles":
                        player.Out.SendQuestSubscribeCommand(Harris,
                            QuestMgr.GetIDForQuestType(typeof(BeetleRvRQuestHib)),
                            "Will you help Harris " + questTitle + "?");
                        break;
                }
            else
                switch (wArgs.Text)
    ...
    public override string Description
    {
        get
        {
            switch (Step)
            {
                case 1:
                    return
                        "Invade the enemy realm for capturing a relic and slay enemies in the frontiers for Hibernia." +

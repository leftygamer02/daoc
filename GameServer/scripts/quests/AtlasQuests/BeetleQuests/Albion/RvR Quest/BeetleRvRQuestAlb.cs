...
public class BeetleRvRQuestAlb : Quests.AtlasQuest
{
    ...
    public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var npcs = WorldMgr.GetNPCsByName("Laura", eRealm.Albion);
        ...
        if (Laura == null)
        {
            ...
            Laura.AddToWorld();
            if (SAVE_INTO_DATABASE) Laura.SaveIntoDatabase();
        }
    ...
    private static void TalkToLaura(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(BeetleRvRQuestAlb)) as BeetleRvRQuestAlb;
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                ...
                Laura.SayTo(player, "Hello " + player.Name +
                                    ", I am Laura. The mission is very dangerous and I hope you can help me and Albion. " +
            ...
            if (quest == null)
                switch (wArgs.Text)
                {
                    case "help Albion and the beetles":
                        player.Out.SendQuestSubscribeCommand(Laura,
                            QuestMgr.GetIDForQuestType(typeof(BeetleRvRQuestAlb)),
                            "Will you help Laura " + questTitle + "?");
                        break;
                }
            else
                switch (wArgs.Text)
    ...
    public override string Description
    {
        get
        {
            switch (Step)
            {
                case 1:
                    return
                        "Invade the enemy realm for capturing a relic and slay enemies in the frontiers for Albion." +

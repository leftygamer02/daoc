...
public class FrontiersMonthlyQuestAlb : Quests.MonthlyQuest
{
    ...
    public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var npcs = WorldMgr.GetNPCsByName("Kelteen", eRealm.Albion);
    ...
    private static void TalkToKelteen(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest =
            player.IsDoingQuest(typeof(FrontiersMonthlyQuestAlb)) as FrontiersMonthlyQuestAlb;
                ...
                switch (quest.Step)
                {
                    case 1:
                        Kelteen.SayTo(player,
                            $"Hello {player.CharacterClass.Name}, you will find enemies in Midgard, Hibernia or in our lands. " +
                ...
                switch (wArgs.Text)
                {
                    case "order and security":
                        player.Out.SendQuestSubscribeCommand(Kelteen,
                            QuestMgr.GetIDForQuestType(typeof(FrontiersMonthlyQuestAlb)),
                    ...
                    case "capturing keeps and killing enemies":
                        if (quest.Step == 2)
                        {
                            player.Out.SendMessage(
                                "Thank you for your help! Albion will thank you for your contribution.",
    ...
    {
        PlayersKilled = GetCustomProperty("FrontiersMonthlyAlbKill") != null
            ? int.Parse(GetCustomProperty("FrontiersMonthlyAlbKill"))
            : 0;
        CapturedKeeps = GetCustomProperty("FrontiersMonthlyAlbKeep") != null
            ? int.Parse(GetCustomProperty("FrontiersMonthlyAlbKeep"))
            : 0;
    }

...
public class KillNPCInFrontiersAlb : Quests.DailyQuest
{
    ...
    private static void TalkToHaszan(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(KillNPCInFrontiersAlb)) as KillNPCInFrontiersAlb;
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                ...
                Haszan.SayTo(player, "Hello " + player.Name +
                                     ", I am Haszan. I serve the realm and ensure its borders are always protected. " +
                ...
                switch (wArgs.Text)
                {
                    case "clear the frontiers":
                        player.Out.SendQuestSubscribeCommand(Haszan,
                            QuestMgr.GetIDForQuestType(typeof(KillNPCInFrontiersAlb)),
    ...
    public override void Notify(DOLEvent e, object sender, EventArgs args)
    {
        ...
        FrontierMobsKilled++;
        player.Out.SendMessage("[Daily] Monsters Killed: (" + FrontierMobsKilled + " | " + MAX_KILLED + ")",
    ...
    public override void FinishQuest()
    {
        ...
        m_questPlayer.AddMoney(Money.GetMoney(0, 0, m_questPlayer.Level * 2, 50, Util.Random(50)),

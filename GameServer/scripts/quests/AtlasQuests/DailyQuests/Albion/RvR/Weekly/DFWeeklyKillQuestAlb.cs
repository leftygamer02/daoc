...
public class DFWeeklyKillQuestAlb : Quests.WeeklyQuest
{
    ...
    private static void TalkToJoe(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(DFWeeklyKillQuestAlb)) as DFWeeklyKillQuestAlb;
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                ...
                Joe.SayTo(player, "Oh, " + player.Name +
                ...
                switch (wArgs.Text)
                {
                    case "demonic aura":
                        player.Out.SendQuestSubscribeCommand(Joe,
                            QuestMgr.GetIDForQuestType(typeof(DFWeeklyKillQuestAlb)),

...
public class HardcoreKillOrangesAlb : Quests.DailyQuest
{
    ...
    public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var npcs = WorldMgr.GetNPCsByName("Succi", eRealm.Albion);
        ...
        if (SucciAlb == null)
        {
            ...
            SucciAlb.AddToWorld();
            if (SAVE_INTO_DATABASE) SucciAlb.SaveIntoDatabase();
        }
    ...
    private static void TalkToSucci(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var oranges =
            player.IsDoingQuest(typeof(HardcoreKillOrangesAlb)) as HardcoreKillOrangesAlb;
            ...
            if (oranges == null)
                switch (wArgs.Text)
                {
                    case "today is not the day":
                        player.Out.SendQuestSubscribeCommand(SucciAlb,
                            QuestMgr.GetIDForQuestType(typeof(HardcoreKillOrangesAlb)),

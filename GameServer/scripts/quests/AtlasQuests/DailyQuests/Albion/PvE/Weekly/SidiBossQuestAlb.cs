...
public class SidiBossQuestAlb : Quests.WeeklyQuest
{
    ...
    protected static void TalkToJames(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(SidiBossQuestAlb)) as SidiBossQuestAlb;
    ...
    public override void Notify(DOLEvent e, object sender, EventArgs args)
    {
        ...
        if (_deadSidiBossMob >= MAX_KILLGOAL) Step = 2;
    }
    ...
    {
        _deadSidiBossMob = GetCustomProperty(QuestPropertyKey) != null

...
public class KillNPCInFrontiersHib : Quests.DailyQuest
{
    ...
    private static void TalkToCola(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(KillNPCInFrontiersHib)) as KillNPCInFrontiersHib;
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                ...
                Cola.SayTo(player, "Hello " + player.Name +
                                   ", I am Cola. I serve the realm and ensure its borders are always protected. " +
                ...
                switch (wArgs.Text)
                {
                    case "clear the frontiers":
                        player.Out.SendQuestSubscribeCommand(Cola,
                            QuestMgr.GetIDForQuestType(typeof(KillNPCInFrontiersHib)),
    ...
    public override void Notify(DOLEvent e, object sender, EventArgs args)
    {
        ...
        FrontierMobsKilled++;
        player.Out.SendMessage("[Daily] Monster Killed: (" + FrontierMobsKilled + " | " + MAX_KILLED + ")",
    ...
    public override void FinishQuest()
    {
        m_questPlayer.ForceGainExperience((m_questPlayer.ExperienceForNextLevel -
                                           m_questPlayer.ExperienceForCurrentLevel) / 10);
        ...
        AtlasROGManager.GenerateJewel(m_questPlayer, (byte) (m_questPlayer.Level + 1),
            m_questPlayer.Level + Util.Random(5, 11));

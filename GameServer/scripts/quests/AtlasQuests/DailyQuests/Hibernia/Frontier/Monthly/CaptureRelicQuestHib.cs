...
public class CaptureRelicQuestHib : Quests.MonthlyQuest
{
    ...
    private static void TalkToKelteen(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(CaptureRelicQuestHib)) as CaptureRelicQuestHib;
                ...
                switch (quest.Step)
                {
                    case 1:
                        Kelteen.SayTo(player,
                            "Encourage allies to conquer a relic keep in Albion or Midgard and return the relic to your realm.");
                        break;
                    case 2:
                ...
                switch (wArgs.Text)
                {
                    case "securing a foothold":
                        player.Out.SendQuestSubscribeCommand(Kelteen,
                            QuestMgr.GetIDForQuestType(typeof(CaptureRelicQuestHib)),

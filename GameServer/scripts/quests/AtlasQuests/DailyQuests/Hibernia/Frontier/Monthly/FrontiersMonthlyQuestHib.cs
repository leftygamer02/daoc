...
public class FrontiersMonthlyQuestHib : Quests.MonthlyQuest
{
    ...
    public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var npcs = WorldMgr.GetNPCsByName("Kelteen", eRealm.Hibernia);
    ...
    private static void TalkToKelteen(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest =
            player.IsDoingQuest(typeof(FrontiersMonthlyQuestHib)) as FrontiersMonthlyQuestHib;
                ...
                switch (quest.Step)
                {
                    case 1:
                        Kelteen.SayTo(player,
                            $"Hello {player.CharacterClass.Name}, you will find enemies in Midgard, Albion or in our lands. " +
                ...
                switch (wArgs.Text)
                {
                    case "order and security":
                        player.Out.SendQuestSubscribeCommand(Kelteen,
                            QuestMgr.GetIDForQuestType(typeof(FrontiersMonthlyQuestHib)),
                    ...
                    case "capturing keeps and killing enemies":
                        if (quest.Step == 2)
                        {
                            player.Out.SendMessage(
                                "Thank you for your help! Hibernia will thank you for your contribution.",
    ...
    {
        PlayersKilled = GetCustomProperty("FrontiersMonthlyHibKill") != null
            ? int.Parse(GetCustomProperty("FrontiersMonthlyHibKill"))
            : 0;
        CapturedKeeps = GetCustomProperty("FrontiersMonthlyHibKeep") != null
            ? int.Parse(GetCustomProperty("FrontiersMonthlyHibKeep"))
            : 0;
    }

...
public class ForTheRealmQuestHib : Quests.WeeklyQuest
{
    ...
    private static void TalkToRey(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(ForTheRealmQuestHib)) as ForTheRealmQuestHib;
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                switch (quest.Step)
                {
                    case 1:
                        ReyHib.SayTo(player,
                            "Head into the enemy frontiers and slay their forces. There are many Midgard and Albion enemies, you will find them.");
                        break;
                    case 2:
                        ReyHib.SayTo(player,
                ...
                ReyHib.SayTo(player, "You won't believe it, " + player.Name +
                ...
                switch (wArgs.Text)
                {
                    case "bunch of toeknuckles":
                        player.Out.SendQuestSubscribeCommand(ReyHib,
                            QuestMgr.GetIDForQuestType(typeof(ForTheRealmQuestHib)),
    ...
    {
        _playersKilledAlb = GetCustomProperty("ForTheRealmKilledAlb") != null
            ? int.Parse(GetCustomProperty("ForTheRealmKilledAlb"))
            : 0;

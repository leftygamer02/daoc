...
public class DFWeeklyKillQuestHib : Quests.WeeklyQuest
{
    ...
    public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var npcs = WorldMgr.GetNPCsByName("Stefano", eRealm.Hibernia);
        ...
        if (Stefano == null)
        {
            ...
            Stefano.AddToWorld();
            if (SAVE_INTO_DATABASE) Stefano.SaveIntoDatabase();
        }
    ...
    private static void TalkToStefano(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(DFWeeklyKillQuestHib)) as DFWeeklyKillQuestHib;
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                ...
                {
                    case 1:
                        Stefano.SayTo(player,
                            "Please head into Darkness Falls and harvest parts from Hibernia's enemies!");
                        break;
                    case 2:
                ...
                Stefano.SayTo(player, "Oh, " + player.Name +
        ...
        else if (e == GameLivingEvent.WhisperReceive)
        {
            ...
            if (quest == null)
                ...
                {
                    case "demonic aura":
                        player.Out.SendQuestSubscribeCommand(Stefano,
                            QuestMgr.GetIDForQuestType(typeof(DFWeeklyKillQuestHib)),
                            "Will you help Stefano with " + questTitle + "?");
                        break;
                }
            else
                switch (wArgs.Text)

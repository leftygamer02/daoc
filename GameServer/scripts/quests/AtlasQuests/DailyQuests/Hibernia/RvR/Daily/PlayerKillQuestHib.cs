...
public class PlayerKillQuestHib : Quests.DailyQuest
{
    ...
    private static void TalkToRey(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(PlayerKillQuestHib)) as PlayerKillQuestHib;
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                ...
                ReyHib.SayTo(player, "Hello " + player.Name +
                                     ", I am Rey. My master, Fen, has tasked me with collecting bones for a project he's working on. " +
                ...
                switch (wArgs.Text)
                {
                    case "help me out":
                        player.Out.SendQuestSubscribeCommand(ReyHib,
                            QuestMgr.GetIDForQuestType(typeof(PlayerKillQuestHib)),
                    ...
                    case "hit your quota":
                        if (quest.Step == 2)
                        {
                            player.Out.SendMessage(
                                "Ugh, some of these are still dripping. Well done, he'll be pleased.",
    ...
    public override void Notify(DOLEvent e, object sender, EventArgs args)
    {
        ...
        PlayersKilled++;
        player.Out.SendMessage("[Daily] Enemy Killed: (" + PlayersKilled + " | " + MAX_KILLED + ")",

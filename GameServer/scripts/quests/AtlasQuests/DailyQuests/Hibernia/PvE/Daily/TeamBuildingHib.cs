...
public class TeamBuildingHib : Quests.DailyQuest
{
    ...
    public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var npcs = WorldMgr.GetNPCsByName("Dean", eRealm.Hibernia);
        ...
        if (Dean == null)
        {
            ...
            Dean.Heading = 1571;
            Dean.AddToWorld();
            if (SAVE_INTO_DATABASE) Dean.SaveIntoDatabase();
        }
    ...
    private static void TalkToDean(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(TeamBuildingHib)) as TeamBuildingHib;
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                ...
                Dean.SayTo(player, "Hello " + player.Name +
                                   ", I am Dean. I help the king with logistics, and he's tasked me with getting things done around here. " +
                ...
                switch (wArgs.Text)
                {
                    case "feeling social":
                        player.Out.SendQuestSubscribeCommand(Dean,
                            QuestMgr.GetIDForQuestType(typeof(TeamBuildingHib)),

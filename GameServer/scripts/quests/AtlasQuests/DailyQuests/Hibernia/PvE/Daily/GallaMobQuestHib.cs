...
public class GallaMobQuestHib : Quests.DailyQuest
{
    ...
    private static void TalkToAnthony(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(GallaMobQuestHib)) as GallaMobQuestHib;
    ...
    public override void Notify(DOLEvent e, object sender, EventArgs args)
    {
        ...
        if (_deadGallaMob >= MAX_KILLGOAL) Step = 2;
    }
    ...
    {
        _deadGallaMob = GetCustomProperty(QuestPropertyKey) != null

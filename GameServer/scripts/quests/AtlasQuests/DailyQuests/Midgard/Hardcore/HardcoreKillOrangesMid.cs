...
public class HardcoreKillOrangesMid : Quests.DailyQuest
{
    ...
    public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var npcs = WorldMgr.GetNPCsByName("Succi", eRealm.Midgard);
        ...
        if (SucciMid == null)
        {
            ...
            SucciMid.AddToWorld();
            if (SAVE_INTO_DATABASE) SucciMid.SaveIntoDatabase();
        }
    ...
    private static void TalkToSucci(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var oranges =
            player.IsDoingQuest(typeof(HardcoreKillOrangesMid)) as HardcoreKillOrangesMid;
            ...
            if (oranges == null)
                switch (wArgs.Text)
                {
                    case "today is not the day":
                        player.Out.SendQuestSubscribeCommand(SucciMid,
                            QuestMgr.GetIDForQuestType(typeof(HardcoreKillOrangesMid)),

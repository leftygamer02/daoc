...
public class HardcoreKillNPCInFrontiersMid : Quests.DailyQuest
{
    ...
    private static void TalkToSucci(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var oranges =
            player.IsDoingQuest(typeof(HardcoreKillNPCInFrontiersMid)) as HardcoreKillNPCInFrontiersMid;
                ...
                switch (wArgs.Text.ToLower())
                {
                    case "one can be brave":
                        player.Out.SendQuestSubscribeCommand(SucciMid,
                            QuestMgr.GetIDForQuestType(typeof(HardcoreKillNPCInFrontiersMid)),

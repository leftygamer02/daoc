...
public class EpicRvRMobsWeeklyQuestMid : Quests.WeeklyQuest
{
    ...
    public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var npcs = WorldMgr.GetNPCsByName("Herou", eRealm.Midgard);
        ...
        if (Herou == null)
        {
            ...
            Herou.Heading = 2284;
            Herou.AddToWorld();
            if (SAVE_INTO_DATABASE) Herou.SaveIntoDatabase();
        }
    ...
    private static void TalkToHerou(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest =
            player.IsDoingQuest(typeof(EpicRvRMobsWeeklyQuestMid)) as EpicRvRMobsWeeklyQuestMid;
            ...
            if (quest != null)
                switch (quest.Step)
                {
                    case 1:
                        Herou.SayTo(player,
                            player.Name +
                            ", please find allies and kill the epic creatures in frontiers for Midgard!");
                        break;
                    case 2:
                        Herou.SayTo(player,
                ...
                Herou.SayTo(player, "Hello " + player.Name +
                                    ", I am Herou. Some large monsters have blocked the supply lines in our frontier, and I could use your help in getting rid of them.\n" +
                ...
                switch (wArgs.Text)
                {
                    case "kill the epic creatures":
                        player.Out.SendQuestSubscribeCommand(Herou,
                            QuestMgr.GetIDForQuestType(typeof(EpicRvRMobsWeeklyQuestMid)),

...
public class CaptureRelicQuestMid : Quests.MonthlyQuest
{
    ...
    private static void TalkToKelteen(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(CaptureRelicQuestMid)) as CaptureRelicQuestMid;
                ...
                switch (quest.Step)
                {
                    case 1:
                        Kelteen.SayTo(player,
                            "Encourage allies to conquer a relic keep in Albion or Hibernia and return the relic to your realm.");
                        break;
                    case 2:
                ...
                switch (wArgs.Text)
                {
                    case "securing a foothold":
                        player.Out.SendQuestSubscribeCommand(Kelteen,
                            QuestMgr.GetIDForQuestType(typeof(CaptureRelicQuestMid)),
                            "Will you help Kelteen " + questTitle + "");
                        break;
                }
            else
                switch (wArgs.Text)
    ...
    public override void Notify(DOLEvent e, object sender, EventArgs args)
    {
        ...
        _isCaptured = 1;
        player.Out.SendMessage("[Monthly] Captured Relic: (" + _isCaptured + " | " + MAX_CAPTURED + ")",
    ...
    {
        _isCaptured = GetCustomProperty(QuestPropertyKey) != null
    ...
    public override void FinishQuest()
    {
        ...
        if (m_questPlayer.Inventory.IsSlotsFree(3, eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack))
        {
            ...
            m_questPlayer.AddMoney(Money.GetMoney(0, 0, m_questPlayer.Level * 8, 0, Util.Random(50)),

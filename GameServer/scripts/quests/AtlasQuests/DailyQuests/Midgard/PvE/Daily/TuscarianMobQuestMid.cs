...
public class TuscarianMobQuestMid : Quests.DailyQuest
{
    ...
    public static void TalkToJarek(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(TuscarianMobQuestMid)) as TuscarianMobQuestMid;
    ...
    public override string Description
    {
        get
        {
            switch (Step)
            {
                case 1:
                    return
                        "Find a way to Tuscaran Glacier and kill some monsters. \nKilled: Monsters in Tuscaran Glacier (" +
    ...
    public override void Notify(DOLEvent e, object sender, EventArgs args)
    {
        ...
        if (gArgs.Target.Realm == 0 && gArgs.Target is GameNPC && gArgs.Target.CurrentRegionID == 160)
        {
            ...
            if (_deadTuscaMob >= MAX_KILLGOAL) Step = 2;
        }
    }
    ...
    {
        _deadTuscaMob = GetCustomProperty(QuestPropertyKey) != null
    ...
    public override void FinishQuest()
    {
        ...
        m_questPlayer.AddMoney(Money.GetMoney(0, 0, m_questPlayer.Level, 0, Util.Random(50)),

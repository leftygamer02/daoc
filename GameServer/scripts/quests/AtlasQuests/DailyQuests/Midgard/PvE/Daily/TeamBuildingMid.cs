...
public class TeamBuildingMid : Quests.DailyQuest
{
    ...
    private static void TalkToIsaac(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(TeamBuildingMid)) as TeamBuildingMid;
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                ...
                Isaac.SayTo(player, "Hello " + player.Name +
                                    ", I am Isaac. I help the king with logistics, and he's tasked me with getting things done around here. " +
                ...
                switch (wArgs.Text)
                {
                    case "feeling social":
                        player.Out.SendQuestSubscribeCommand(Isaac,
                            QuestMgr.GetIDForQuestType(typeof(TeamBuildingMid)),

...
public class TuscarianBossQuestMid : Quests.WeeklyQuest
{
    ...
    private static void TalkToJarek(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(TuscarianBossQuestMid)) as TuscarianBossQuestMid;
    ...
    public override string Description
    {
        get
        {
            switch (Step)
            {
                case 1:
                    return
                        "Find a way to Tuscaran Glacier and kill strong opponents. \nKilled: Bosses in Tuscaran Glacier (" +
    ...
    {
        _deadTuscaBossMob = GetCustomProperty(QuestPropertyKey) != null
    ...
    public override void FinishQuest()
    {
        ...
        m_questPlayer.AddMoney(Money.GetMoney(0, 0, m_questPlayer.Level * 5, 0, Util.Random(50)),

...
public class EveryLittleBitHelpsQuestMid : Quests.DailyQuest
{
    ...
    private static void TalkToRey(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest =
            player.IsDoingQuest(typeof(EveryLittleBitHelpsQuestMid)) as EveryLittleBitHelpsQuestMid;
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                switch (quest.Step)
                {
                    case 1:
                        ReyMid.SayTo(player,
                            "Find and kill enemies of Albion and Hibernia. You will find suitable players in the frontiers.");
                        break;
                    case 2:
                ...
                ReyMid.SayTo(player, "Hello " + player.Name +
                ...
                switch (wArgs.Text)
                {
                    case "take the toeknuckle":
                        player.Out.SendQuestSubscribeCommand(ReyMid,
                            QuestMgr.GetIDForQuestType(typeof(EveryLittleBitHelpsQuestMid)),
    ...
    public override void Notify(DOLEvent e, object sender, EventArgs args)
    {
        ...
        if (gArgs.Target.Realm == eRealm.Albion && gArgs.Target.Realm != player.Realm &&

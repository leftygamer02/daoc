...
public class HelpSirLukas : BaseQuest
{
    ...
    public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var npcs = WorldMgr.GetNPCsByName("Sir Lukas", eRealm.Albion);
        ...
        if (Lukas == null)
        {
            ...
            Lukas.Heading = 820;
            Lukas.AddToWorld();
            if (SAVE_INTO_DATABASE) Lukas.SaveIntoDatabase();
        }
        ...
        if (SirLukas == null)
        {
            ...
            SirLukas.AddToWorld();
            if (SAVE_INTO_DATABASE) SirLukas.SaveIntoDatabase();
        }
        // end npc
        ...
        if (EllynWeyland == null)
        {
            ...
            if (SAVE_INTO_DATABASE) EllynWeyland.SaveIntoDatabase();
        }
        // end npc
        ...
        if (funeral_speech_scroll == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(funeral_speech_scroll);
        }
        ...
        if (FlitzitinaBow == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(FlitzitinaBow);
        } //end item
        ...
        GameEventMgr.AddHandler(EllynWeyland, GameLivingEvent.WhisperReceive,
            new DOLEventHandler(TalkToEllynWeyland));
    ...
    public static void ScriptUnloaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        GameEventMgr.RemoveHandler(EllynWeyland, GameLivingEvent.WhisperReceive,
            new DOLEventHandler(TalkToEllynWeyland));
    ...
    protected static void TalkToSirLukas(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(HelpSirLukas)) as HelpSirLukas;
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                switch (quest.Step)
                {
                    case 1:
                        SirLukas.SayTo(player,
                            "You will find Ellyn Weyland in the forge of Cotswold. She says she has something for me, could you please go and see what she's found?");
                        break;
                    case 2:
                        SirLukas.SayTo(player,
                            "Hey " + player.Name + ", good to see you. Do you have Ellyn Weylands [delivery]?");
                        break;
                    case 3:
                        SirLukas.Emote(eEmote.No);
                        SirLukas.SayTo(player,
                            "Thank you, " + player.Name + ". This bow... marks a terrible loss for our realm." +
                ...
                SirLukas.SayTo(player, "Hello " + player.Name +
                                       ", I am Sir Lukas, protector of Camelot and Albion. " +
                                       "I heard from your " + player.CharacterClass.Name +
                                       " Trainer that you are ready to take on tasks from Camelot. \n\n" +
            ...
            if (quest == null)
                switch (wArgs.Text)
                {
                    case "support Camelot":
                        player.Out.SendQuestSubscribeCommand(SirLukas,
                            QuestMgr.GetIDForQuestType(typeof(HelpSirLukas)),
                            "Will you help Sir Lukas [Memorial] All in the Gold]?");
                        break;
                }
            else
                switch (wArgs.Text)
                {
                    case "this speech":
                        SirLukas.SayTo(player,
                            ...
                            ", I need some time to collect my thoughts. Please go to [Vetusta Abbey] and I will meet you there.");
                        break;
                    case "the grave":
                        SirLukas.SayTo(player,
                            "Please go to the North Gates of Camelot. You will find Vetusta Abbey near the gates!");
                        break;
                    case "Vetusta Abbey":
                        ...
                        {
                            SirLukas.SayTo(player,
                                "Here, is the speech. Go to the North Gates of Camelot. You will find Vetusta Abbey near the gates.");
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                switch (quest.Step)
                {
                    ...
                    case 4:
                        EllynWeyland.SayTo(player,
                            "Vetusta Abbey? I know this place, when I was a child, I played there with some pigs and with my friends.");
                        break;
                }
            else
                EllynWeyland.SayTo(player,
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                switch (quest.Step)
                {
                    case 4:
                        Lukas.SayTo(player,
                            "Vetusta Abbey is a special and perfect place for my mother\'s funeral, thanks again for your help " +
                            player.Name + "!");
                        break;
                }
            else
                Lukas.SayTo(player,
                    "Hello " + player.Name +
                    ", good to see you. I know that you get stronger and more inquisitive every day, stick with it, you are doing well! You can [visit me] at anytime in Camelot if you want. \nHave a wonderful day!");
        }
        // The player whispered to the NPC
        else if (e == GameLivingEvent.WhisperReceive)
        {
            ...
            if (quest == null)
            {
                switch (wArgs.Text)
                {
                    case "visit me":
                        Lukas.SayTo(player,
                            "You can find me at the archery ranges where scouts are trained for the realm.");
                        break;
                }
            }
            else
    ...
    private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
    {
        ...
        if (response == 0x00)
        {
            player.Out.SendMessage(
                "Each arrow leaves a memory in your heart and the sum of those memories will make you shoot better every time.",
    ...
    //Set quest name
    public override string Name => "[Memorial] All in the Gold";
    ...
    public override void Notify(DOLEvent e, object sender, EventArgs args)
    {
        ...
        if (Step == 1 && e == GameObjectEvent.Interact)
        {
            var gArgs = (InteractEventArgs) args;
        ...
        if ((Step == 2 && e == GameObjectEvent.ReceiveItem) || (Step == 3 && e == GameObjectEvent.Interact))
        {
            /*
            ...
            SirLukas.SayTo(player,
                "We will prepare a dignified funeral for her, please bring this speech to Vetusta Abbey.");
            Step = 4;
        ...
        {
            var gArgs = (InteractWithEventArgs) args;
    ...
    {
        Lukas.SayTo(m_questPlayer,
            "You helped me preserve the history of this heroine of Albion, and I will follow in her steps and make her proud. " +

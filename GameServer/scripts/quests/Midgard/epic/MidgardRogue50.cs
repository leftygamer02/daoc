...
public class Rogue_50 : BaseQuest
{
    ...
    public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var npcs = WorldMgr.GetNPCsByName("Masrim", eRealm.Midgard);
        ...
        if (Masrim == null)
        {
            ...
            Masrim.Heading = 2605;
            Masrim.AddToWorld();
            if (SAVE_INTO_DATABASE) Masrim.SaveIntoDatabase();
        }
        // end npc
        ...
        if (Oona == null)
        {
            ...
            Oona.AddToWorld();
            if (SAVE_INTO_DATABASE) Oona.SaveIntoDatabase();
        }
        // end npc
        ...
        if (MorlinCaan == null)
        {
            ...
            if (SAVE_INTO_DATABASE) MorlinCaan.SaveIntoDatabase();
        }
        // end npc
        ...
        if (oona_head == null)
        {
            ...
            oona_head.Weight = 12;
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(oona_head);
        }
...
// end item
        ...
        if (HunterEpicBoots == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(HunterEpicBoots);
        }
...
//end item
        ...
        if (HunterEpicHelm == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(HunterEpicHelm);
        }
...
//end item
        ...
        if (HunterEpicGloves == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(HunterEpicGloves);
        }
        ...
        if (HunterEpicVest == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(HunterEpicVest);
        }
        ...
        if (HunterEpicLegs == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(HunterEpicLegs);
        }
        ...
        if (HunterEpicArms == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(HunterEpicArms);
        }
        ...
        if (ShadowbladeEpicBoots == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ShadowbladeEpicBoots);
        }
        ...
        if (ShadowbladeEpicHelm == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ShadowbladeEpicHelm);
        }
        ...
        if (ShadowbladeEpicGloves == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ShadowbladeEpicGloves);
        }
        ...
        if (ShadowbladeEpicVest == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ShadowbladeEpicVest);
        }
        ...
        if (ShadowbladeEpicLegs == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ShadowbladeEpicLegs);
        }
        ...
        if (ShadowbladeEpicArms == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ShadowbladeEpicArms);
        }
...
//Item Descriptions End
    ...
    public static void ScriptUnloaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        GameEventMgr.RemoveHandler(MorlinCaan, GameLivingEvent.WhisperReceive,
            new DOLEventHandler(TalkToMorlinCaan));
    ...
    protected static void TalkToMasrim(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(Rogue_50)) as Rogue_50;
        ...
        if (e == GameObjectEvent.Interact)
        {
            ...
            if (quest != null)
                switch (quest.Step)
                {
                    case 1:
                        Masrim.SayTo(player,
                            "Seek out Oona in Raumarik and kill her! When you get into Raumarik, go west to the river and follow the river south until the river divides.");
                        break;
                    case 2:
                        Masrim.SayTo(player,
                            "Hey, you are back! Please give me the head of Oona and visit " + MorlinCaan.Name +
                            " and bring him the [sealed pouch]!");
                        break;
                    case 3:
                        Masrim.SayTo(player,
                            $"Hello {player.Name}, have you visited " + MorlinCaan.Name + " already?");
                        break;
                }
            else
        ...
        else if (e == GameLivingEvent.WhisperReceive)
        {
            ...
            if (quest == null)
                ...
                {
                    case "services":
                        player.Out.SendQuestSubscribeCommand(Masrim, QuestMgr.GetIDForQuestType(typeof(Rogue_50)),
                            "Will you help Masrim [Rogue Level 50 Epic]?");
                        break;
                }
            else
                switch (wArgs.Text)
                {
                    case "sealed pouch":
                        if (quest.Step == 2)
                        {
                            ...
                            Masrim.SayTo(player,
                                "Take this sealed pouch to Morlin Caan in Jordheim for your reward!");
    ...
    //Set quest name
    public override string Name => "War Concluded (Level 50 Rogue Epic)";
    ...
    public override void Notify(DOLEvent e, object sender, EventArgs args)
    {
        ...
        if (Step == 1 && e == GameLivingEvent.EnemyKilled)
        {
            ...
            {
                m_questPlayer.Out.SendMessage("You collect Oona's Head", eChatType.CT_System,

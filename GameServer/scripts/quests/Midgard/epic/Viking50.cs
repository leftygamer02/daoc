...
public class Viking_50 : BaseQuest
{
    ...
    public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var npcs = WorldMgr.GetNPCsByName("Lynnleigh", eRealm.Midgard);
        ...
        if (Lynnleigh == null)
        {
            ...
            if (SAVE_INTO_DATABASE) Lynnleigh.SaveIntoDatabase();
        }
        ...
        if (Elizabeth == null)
        {
            ...
            if (SAVE_INTO_DATABASE) Elizabeth.SaveIntoDatabase();
        }
        // end npc
        ...
        if (Ydenia == null)
        {
            ...
            Ydenia.AddToWorld();
            if (SAVE_INTO_DATABASE) Ydenia.SaveIntoDatabase();
        }
        // end npc
        ...
        if (tome_enchantments == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(tome_enchantments);
        }
        ...
        if (sealed_pouch == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(sealed_pouch);
        }
        ...
        if (WarriorEpicBoots == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(WarriorEpicBoots);
        }
...
//end item
        ...
        if (WarriorEpicHelm == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(WarriorEpicHelm);
        }
...
//end item
        ...
        if (WarriorEpicGloves == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(WarriorEpicGloves);
        }
        ...
        if (WarriorEpicVest == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(WarriorEpicVest);
        }
        ...
        if (WarriorEpicLegs == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(WarriorEpicLegs);
        }
        ...
        if (WarriorEpicArms == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(WarriorEpicArms);
        }
        ...
        if (BerserkerEpicBoots == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(BerserkerEpicBoots);
        }
...
//end item
        ...
        if (BerserkerEpicHelm == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(BerserkerEpicHelm);
        }
...
//end item
        ...
        if (BerserkerEpicGloves == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(BerserkerEpicGloves);
        }
        ...
        if (BerserkerEpicVest == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(BerserkerEpicVest);
        }
        ...
        if (BerserkerEpicLegs == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(BerserkerEpicLegs);
        }
        ...
        if (BerserkerEpicArms == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(BerserkerEpicArms);
        }
        ...
        if (ThaneEpicBoots == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ThaneEpicBoots);
        }
...
//end item
        ...
        if (ThaneEpicHelm == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ThaneEpicHelm);
        }
...
//end item
        ...
        if (ThaneEpicGloves == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ThaneEpicGloves);
        }
        ...
        if (ThaneEpicVest == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ThaneEpicVest);
        }
        ...
        if (ThaneEpicLegs == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ThaneEpicLegs);
        }
        ...
        if (ThaneEpicArms == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ThaneEpicArms);
        }
        ...
        if (SkaldEpicBoots == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(SkaldEpicBoots);
        }
...
//end item
        ...
        if (SkaldEpicHelm == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(SkaldEpicHelm);
        }
...
//end item
        ...
        if (SkaldEpicGloves == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(SkaldEpicGloves);
        }
        ...
        if (SkaldEpicVest == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(SkaldEpicVest);
        }
        ...
        if (SkaldEpicLegs == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(SkaldEpicLegs);
        }
        ...
        if (SkaldEpicArms == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(SkaldEpicArms);
        }
        ...
        if (SavageEpicBoots == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(SavageEpicBoots);
        }
        ...
        if (SavageEpicHelm == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(SavageEpicHelm);
        }
        ...
        if (SavageEpicGloves == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(SavageEpicGloves);
        }
        ...
        if (SavageEpicVest == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(SavageEpicVest);
        }
        ...
        if (SavageEpicLegs == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(SavageEpicLegs);
        }
        ...
        if (SavageEpicArms == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(SavageEpicArms);
        }
        ...
        if (ValkyrieEpicBoots == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ValkyrieEpicBoots);
        }
        ...
        if (ValkyrieEpicHelm == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ValkyrieEpicHelm);
        }
        ...
        if (ValkyrieEpicGloves == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ValkyrieEpicGloves);
        }
        ...
        if (ValkyrieEpicVest == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ValkyrieEpicVest);
        }
        ...
        if (ValkyrieEpicLegs == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ValkyrieEpicLegs);
        }
        ...
        if (ValkyrieEpicArms == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ValkyrieEpicArms);
        }
...
//Item Descriptions End
        ...
        GameEventMgr.AddHandler(Elizabeth, GameObjectEvent.Interact, new DOLEventHandler(TalkToElizabeth));
    ...
    public static void ScriptUnloaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        GameEventMgr.RemoveHandler(Elizabeth, GameObjectEvent.Interact, new DOLEventHandler(TalkToElizabeth));
    ...
    protected static void TalkToLynnleigh(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(Viking_50)) as Viking_50;
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                ...
                {
                    case 1:
                        Lynnleigh.SayTo(player,
                            "Seek out Ydenia in Vanern Swamp and kill her. You can find her on an island in the swamp.");
                        break;
                    case 2:
                    ...
                    case 3:
                        Lynnleigh.SayTo(player,
                            $"Hey {player.Name}, please visit Elizabeth in Mularn. You can find her in the Healer House. Bring her the [sealed pouch]!");
                        break;
                    case 4:
                ...
                Lynnleigh.SayTo(player,
                    "Ah, this reveals exactly where Jango and his deserters took Ydenia to dispose of him. He also has a note here about how strong Ydenia really was. That [worries me].");
        }
        ...
        else if (e == GameLivingEvent.WhisperReceive)
        {
            ...
            if (quest == null)
                switch (wArgs.Text)
                {
                    case "worries me":
                        Lynnleigh.SayTo(player,
                            "Yes, it worries me, but I think that you are ready to [face Ydenia] and her minions.");
                        break;
                    case "face Ydenia":
                        player.Out.SendQuestSubscribeCommand(Lynnleigh,
                            QuestMgr.GetIDForQuestType(typeof(Viking_50)),
                            "Will you face Ydenia [Viking Level 50 Epic]?");
                        break;
                }
            else
                switch (wArgs.Text)
                {
                    case "get something":
                        if (quest.Step == 2)
                        {
                            ...
                            quest.Step = 3;
                            Lynnleigh.SayTo(player,
                                "Great! Please visit Elizabeth in Mularn and bring her the [sealed pouch].");
                        }
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                switch (quest.Step)
                {
                    ...
                    case 4:
                    {
                        Elizabeth.SayTo(player,
                            "Greetings, there are six parts to your reward, so make sure you have room for them. Just let me know when you are ready, and then you can [take them] with our thanks!");
                        break;
                    }
                }
        }
                ...
                switch (wArgs.Text)
                {
                    case "sealed pouch":
                        if (quest.Step == 3)
                        {
                            ...
                            quest.Step = 4;
                            Elizabeth.SayTo(player,
                                "There are six parts to your reward, so make sure you have room for them. Just let me know when you are ready, and then you can [take them] with our thanks!");
                        }
                    ...
                    case "take them":
                        if (quest.Step == 4)
                        {
                            ...
                            {
                                player.Out.SendMessage("You do not have enough free space in your inventory!",
    ...
    private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
    {
        ...
        if (response == 0x00)
        {
            player.Out.SendMessage("Our God forgives your laziness, just look out for stray lightning bolts.",
    ...
    //Set quest name
    public override string Name => "An End to the Daggers (level 50 Viking epic)";
    ...
    public override void Notify(DOLEvent e, object sender, EventArgs args)
    {
        ...
        if (Step == 1 && e == GameLivingEvent.EnemyKilled)
        {
            ...
            if (gArgs.Target.Name == Ydenia.Name)
            {
                ...
                m_questPlayer.Out.SendMessage("Ydenia drops the Tome of Enchantments and you pick it up!",
        ...
        {
            var gArgs = (GiveItemEventArgs) args;

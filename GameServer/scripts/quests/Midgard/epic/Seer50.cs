...
public class Seer_50 : BaseQuest
{
    ...
    public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var npcs = WorldMgr.GetNPCsByName("Inaksha", eRealm.Midgard);
        ...
        if (Inaksha == null)
        {
            ...
            Inaksha.AddToWorld();
            if (SAVE_INTO_DATABASE) Inaksha.SaveIntoDatabase();
        }
        // end npc
        ...
        if (Loken == null)
        {
            ...
            Loken.Heading = 3777;
            Loken.AddToWorld();
            if (SAVE_INTO_DATABASE) Loken.SaveIntoDatabase();
        }
        // end npc
        ...
        if (ball_of_flame == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ball_of_flame);
        }
...
// end item
        ...
        if (HealerEpicBoots == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(HealerEpicBoots);
        }
...
//end item
        ...
        if (HealerEpicHelm == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(HealerEpicHelm);
        }
...
//end item
        ...
        if (HealerEpicGloves == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(HealerEpicGloves);
        }
        ...
        if (HealerEpicVest == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(HealerEpicVest);
        }
        ...
        if (HealerEpicLegs == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(HealerEpicLegs);
        }
        ...
        if (HealerEpicArms == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(HealerEpicArms);
        }
        ...
        if (ShamanEpicBoots == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ShamanEpicBoots);
        }
        ...
        if (ShamanEpicHelm == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ShamanEpicHelm);
        }
        ...
        if (ShamanEpicGloves == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ShamanEpicGloves);
        }
        ...
        if (ShamanEpicVest == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ShamanEpicVest);
        }
        ...
        if (ShamanEpicLegs == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ShamanEpicLegs);
        }
        ...
        if (ShamanEpicArms == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(ShamanEpicArms);
        }
...
//Item Descriptions End
    ...
    protected static void TalkToInaksha(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(Seer_50)) as Seer_50;
            ...
            if (quest != null)
                switch (quest.Step)
                {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        Inaksha.SayTo(player,
                            $"Hey {player.Name}, please visit Miri in Jordheim and bring her the [sealed pouch]!");
                        break;
                }
            else
        ...
        else if (e == GameLivingEvent.WhisperReceive)
        {
            ...
            if (quest == null)
                ...
                {
                    case "services":
                        player.Out.SendQuestSubscribeCommand(Inaksha, QuestMgr.GetIDForQuestType(typeof(Seer_50)),
                            "Will you help Inaksha [Seer Level 50 Epic]?");
                        break;
                }
            else
                switch (wArgs.Text)
                {
                    case "have something":
                        if (quest.Step == 2)
                        {
                            ...
                            quest.Step = 3;
                            Inaksha.SayTo(player,
                                "Great! Please visit Miri in Jordheim now and bring her the [sealed pouch].");
                        }
    ...
    protected static void TalkToMiri(DOLEvent e, object sender, EventArgs args)
    {
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
            {
                if (quest.Step == 4) Miri.SayTo(player, "Were you able to [fulfill] your given task?");
            }
            else
            {
    ...
    //Set quest name
    public override string Name => "The Desire of a God (Level 50 Seer Epic)";
    ...
    public override void Notify(DOLEvent e, object sender, EventArgs args)
    {
        ...
        if (Step == 1 && e == GameLivingEvent.EnemyKilled)
        {
            ...
            {
                m_questPlayer.Out.SendMessage("You get a ball of flame", eChatType.CT_System,

...
public class Mystic_50 : BaseQuest
{
    ...
    public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var npcs = WorldMgr.GetNPCsByName("Danica", eRealm.Midgard);
        ...
        if (Danica == null)
        {
            ...
            Danica.Heading = 2193;
            Danica.AddToWorld();
            if (SAVE_INTO_DATABASE) Danica.SaveIntoDatabase();
        }
        // end npc
        ...
        if (Kelic == null)
        {
            ...
            Kelic.AddToWorld();
            if (SAVE_INTO_DATABASE) Kelic.SaveIntoDatabase();
        }
        // end npc
        ...
        if (kelics_totem == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(kelics_totem);
        }
        ...
        if (SpiritmasterEpicBoots == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(SpiritmasterEpicBoots);
        }
...
//end item
        ...
        if (SpiritmasterEpicHelm == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(SpiritmasterEpicHelm);
        }
...
//end item
        ...
        if (SpiritmasterEpicGloves == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(SpiritmasterEpicGloves);
        }
        ...
        if (SpiritmasterEpicVest == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(SpiritmasterEpicVest);
        }
        ...
        if (SpiritmasterEpicLegs == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(SpiritmasterEpicLegs);
        }
        ...
        if (SpiritmasterEpicArms == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(SpiritmasterEpicArms);
        }
        ...
        if (RunemasterEpicBoots == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(RunemasterEpicBoots);
        }
...
//end item
        ...
        if (RunemasterEpicHelm == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(RunemasterEpicHelm);
        }
...
//end item
        ...
        if (RunemasterEpicGloves == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(RunemasterEpicGloves);
        }
        ...
        if (RunemasterEpicVest == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(RunemasterEpicVest);
        }
        ...
        if (RunemasterEpicLegs == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(RunemasterEpicLegs);
        }
        ...
        if (RunemasterEpicArms == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(RunemasterEpicArms);
        }
        ...
        if (BonedancerEpicBoots == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(BonedancerEpicBoots);
        }
...
//end item
        ...
        if (BonedancerEpicHelm == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(BonedancerEpicHelm);
        }
...
//end item
        ...
        if (BonedancerEpicGloves == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(BonedancerEpicGloves);
        }
        ...
        if (BonedancerEpicVest == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(BonedancerEpicVest);
        }
        ...
        if (BonedancerEpicLegs == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(BonedancerEpicLegs);
        }
        ...
        if (BonedancerEpicArms == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(BonedancerEpicArms);
        }
        ...
        if (WarlockEpicBoots == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(WarlockEpicBoots);
        }
        ...
        if (WarlockEpicHelm == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(WarlockEpicHelm);
        }
        ...
        if (WarlockEpicGloves == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(WarlockEpicGloves);
        }
        ...
        if (WarlockEpicVest == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(WarlockEpicVest);
        }
        ...
        if (WarlockEpicLegs == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(WarlockEpicLegs);
        }
        ...
        if (WarlockEpicArms == null)
        {
            ...
            if (SAVE_INTO_DATABASE) GameServer.Database.AddObject(WarlockEpicArms);
        }
    ...
    protected static void TalkToDanica(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(Mystic_50)) as Mystic_50;
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                switch (quest.Step)
                {
                    case 1:
                        Danica.SayTo(player,
                            "Yes, you must face and defeat him! There is a note scrawled in the corner of the map that even in death Kelic is strong." +
                    ...
                    case 2:
                        Danica.SayTo(player,
                            "It is good to see you were strong enough to survive Kelic. I can sense you have the controlling totem on you. Give me Kelic's [totem] now! Hurry!");
                        break;
                    case 3:
                        Danica.SayTo(player,
                            "The curse is broken and the clan is safe. They are in your debt, but I think Arnfinn, has come up with a suitable reward for you. There are six parts to it, so make sure you have room for them. Just let me know when you are ready, and then you can [take them] with our thanks!");
                        break;
                }
            else
                Danica.SayTo(player,
                    "Ah, this reveals exactly where Jango and his deserters took Kelic to dispose of him. He also has a note here about how strong Kelic really was. That [worries me].");
        }
        ...
        else if (e == GameLivingEvent.WhisperReceive)
        {
            ...
            if (quest == null)
                switch (wArgs.Text)
                {
                    case "worries me":
                        Danica.SayTo(player,
                            "Yes, it worries me, but I think that you are ready to [face Kelic] and his minions.");
                        break;
                    case "face Kelic":
                        player.Out.SendQuestSubscribeCommand(Danica, QuestMgr.GetIDForQuestType(typeof(Mystic_50)),
                            "Will you face Kelic [Mystic Level 50 Epic]?");
                        break;
                }
            else
                switch (wArgs.Text)
        ...
        else if (e == GameObjectEvent.ReceiveItem)
        {
            ...
            if (quest != null)
                if (rArgs.Item.Id_nb == kelics_totem.Id_nb)
                {
                    RemoveItem(player, kelics_totem);
                    Danica.SayTo(player,
                        "Ah, I can see how he wore the curse around the totem. I can now break the curse that is destroying the clan!");
                    Danica.SayTo(player,
                        "The curse is broken and the clan is safe. They are in your debt, but I think Arnfinn, has come up with a suitable reward for you. There are six parts to it, so make sure you have room for them. Just let me know when you are ready, and then you can [take them] with our thanks!");
                    quest.Step = 3;
                }
    ...
    //Set quest name
    public override string Name => "Saving the Clan (Level 50 Mystic Epic)";
    ...
    public override string Description
    {
        get
        {
            switch (Step)
            {
                case 1:
                    return
                        "Find Kelic in Raumarik. Head to the river and go north. At the end go northwest to the next river, cross and head west. Follow the snowline until you reach a group of trees.";
                case 2:
    ...
    public override void Notify(DOLEvent e, object sender, EventArgs args)
    {
        ...
        if (Step == 1 && e == GameLivingEvent.EnemyKilled)
        {
            ...
            if (gArgs.Target.Name == Kelic.Name)
            {
                ...
                m_questPlayer.Out.SendMessage("Kelic drops his Totem and you pick it up!", eChatType.CT_System,
    ...
    public override void FinishQuest()
    {
        ...
        Danica.SayTo(m_questPlayer,
            "May it serve you well, knowing that you have helped preserve the history of Midgard!");

...
public class Defenders_50 : BaseQuest
{
    ...
    protected static void TalkToLidmann(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(Defenders_50)) as Defenders_50;
                ...
                switch (wArgs.Text)
                {
                    case "services":
                        player.Out.SendQuestSubscribeCommand(Lidmann,
                            QuestMgr.GetIDForQuestType(typeof(Defenders_50)),
    ...
    private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
    {
        ...
        else
        {
            ...
            player.Out.SendMessage("Kill Cailleach Uragaig in Lyonesse!", eChatType.CT_System,
                eChatLoc.CL_PopupWindow);
        }
    }

    //Set quest name
    public override string Name => "Feast of the Decadent (Level 50 Defenders of Albion Epic)";

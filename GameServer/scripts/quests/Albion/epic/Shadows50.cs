...
public class Shadows_50 : BaseQuest
{
    ...
    public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var npcs = WorldMgr.GetNPCsByName("Lidmann Halsey", eRealm.Albion);
        ...
        if (Lidmann == null)
        {
            ...
            Lidmann.AddToWorld();
            if (SAVE_INTO_DATABASE) Lidmann.SaveIntoDatabase();
        }
        // end npc
        ...
        if (Uragaig == null)
        {
            ...
            Uragaig.AddToWorld();
            if (SAVE_INTO_DATABASE) Uragaig.SaveIntoDatabase();
        }
        // end npc
    ...
    protected static void TalkToLidmann(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(Shadows_50)) as Shadows_50;
        ...
        if (e == GameObjectEvent.Interact)
        {
            ...
            if (quest != null)
                ...
                {
                    case 1:
                        Lidmann.SayTo(player,
                            "Seek out Cailleach Uragaig in Lyonesse! Follow the road southwest into Lyonesse past the lesser telamon. " +
        ...
        else if (e == GameLivingEvent.WhisperReceive)
        {
            ...
            if (quest == null)
                ...
                {
                    case "services":
                        player.Out.SendQuestSubscribeCommand(Lidmann,
                            QuestMgr.GetIDForQuestType(typeof(Shadows_50)),
                            "Will you help Lidmann [Defenders of Albion Level 50 Epic]?");
                        break;
                }
            else
                switch (wArgs.Text)
    ...
    private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
    {
        ...
        else
        {
            ...
            player.Out.SendMessage("Kill Cailleach Uragaig in Lyonesse loc 29k, 33k!", eChatType.CT_System,
                eChatLoc.CL_PopupWindow);
        }
    }

    //Set quest name
    public override string Name => "Feast of the Decadent (Level 50 Guild of Shadows Epic)";
    ...
    public override void Notify(DOLEvent e, object sender, EventArgs args)
    {
        ...
        if (Step == 1 && e == GameLivingEvent.EnemyKilled)
        {
            ...
            if (gArgs != null && gArgs.Target != null && Uragaig != null)
                ...
                {
                    m_questPlayer.Out.SendMessage("Take the pouch to Lidmann Halsey", eChatType.CT_System,

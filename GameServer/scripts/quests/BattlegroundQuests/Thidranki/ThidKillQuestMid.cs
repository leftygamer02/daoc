...
public class ThidKillQuestMid : Quests.DailyQuest
{
    ...
    public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var npcs = WorldMgr.GetNPCsByName("Pazz", eRealm.Midgard);
        ...
        if (PazzMid == null)
        {
            ...
            PazzMid.AddToWorld();
            if (SAVE_INTO_DATABASE) PazzMid.SaveIntoDatabase();
        }
    ...
    private static void TalkToRey(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(ThidKillQuestMid)) as ThidKillQuestMid;
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                ...
                PazzMid.SayTo(player, "Hello " + player.Name +
        ...
        else if (e == GameLivingEvent.WhisperReceive)
        {
            ...
            if (quest == null)
                ...
                {
                    case "help me out":
                        player.Out.SendQuestSubscribeCommand(PazzMid,
                            QuestMgr.GetIDForQuestType(typeof(ThidKillQuestMid)),

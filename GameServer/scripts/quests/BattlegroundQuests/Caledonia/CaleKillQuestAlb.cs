...
public class CaleKillQuestAlb : Quests.DailyQuest
{
    ...
    public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var npcs = WorldMgr.GetNPCsByName("Pazz", eRealm.Albion);
        ...
        if (PazzAlb == null)
        {
            ...
            PazzAlb.AddToWorld();
            if (SAVE_INTO_DATABASE) PazzAlb.SaveIntoDatabase();
        }
    ...
    protected static void TalkToRey(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(CaleKillQuestAlb)) as CaleKillQuestAlb;
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                ...
                PazzAlb.SayTo(player, "Hello " + player.Name +
        ...
        else if (e == GameLivingEvent.WhisperReceive)
        {
            ...
            if (quest == null)
                ...
                {
                    case "help me out":
                        player.Out.SendQuestSubscribeCommand(PazzAlb,
                            QuestMgr.GetIDForQuestType(typeof(CaleKillQuestAlb)),

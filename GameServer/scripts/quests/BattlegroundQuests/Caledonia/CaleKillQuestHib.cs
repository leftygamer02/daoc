...
public class CaleKillQuestHib : Quests.DailyQuest
{
    ...
    public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var npcs = WorldMgr.GetNPCsByName("Pazz", eRealm.Hibernia);
        ...
        if (PazzHib == null)
        {
            ...
            PazzHib.AddToWorld();
            if (SAVE_INTO_DATABASE) PazzHib.SaveIntoDatabase();
        }
    ...
    private static void TalkToPazz(DOLEvent e, object sender, EventArgs args)
    {
        ...
        var quest = player.IsDoingQuest(typeof(CaleKillQuestHib)) as CaleKillQuestHib;
        ...
        if (e == GameObjectEvent.Interact)
        {
            if (quest != null)
                ...
                PazzHib.SayTo(player, "Hello " + player.Name +
                                      ", I am Pazz. My master, Fen, has tasked me with collecting bones for a project he's working on. " +
        ...
        else if (e == GameLivingEvent.WhisperReceive)
        {
            ...
            if (quest == null)
                ...
                {
                    case "help me out":
                        player.Out.SendQuestSubscribeCommand(PazzHib,
                            QuestMgr.GetIDForQuestType(typeof(CaleKillQuestHib)),
    ...
    public override void FinishQuest()
    {
        if (m_questPlayer.Inventory.IsSlotsFree(1, eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack))
        {
            m_questPlayer.ForceGainExperience((m_questPlayer.ExperienceForNextLevel -
                                               m_questPlayer.ExperienceForCurrentLevel) / 3);
        ...
        {
            m_questPlayer.Out.SendMessage("Clear one slot of your inventory for your reward", eChatType.CT_System,

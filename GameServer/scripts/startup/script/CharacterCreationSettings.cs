...
public static class CharacterCreationSettings
{
    ...
    /// </summary>
    [ServerProperty("startup", "starting_bps",
        "Starting Bounty Points - Edit this to change the amount of Bounty Points the new characters start the game with",
        0)]
    ...
    /// </summary>
    [ServerProperty("startup", "starting_money",
        "Starting Money - Edit this to change the amount in copper of money new characters start the game with, max 214 plat",
        0)]
    ...
    /// </summary>
    [ServerProperty("startup", "starting_realm_level",
        "Starting Realm level - Edit this to set which realm level a new player starts the game with", 0)]
    public static int STARTING_REALM_LEVEL;

    /// <summary>
    /// The level of experience a player should start with
    /// </summary>
    [ServerProperty("startup", "starting_level",
        "Starting Level - Edit this to set which levels experience a new player start the game with", 1)]
    ...
    public static void OnCharacterCreation(DOLEvent e, object sender, EventArgs args)
    {
        ...
        {
            var realmLevel = STARTING_REALM_LEVEL;
            long rpamount = 0;
            ...
            if (rpamount == 0)
                rpamount = (long) (25.0 / 3.0 * (realmLevel * realmLevel * realmLevel) -

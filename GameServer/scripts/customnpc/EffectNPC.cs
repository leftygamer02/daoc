...
{
    private string
        EFFECTNPC_ITEM_WEAK = "DOL.GS.Scripts.EffectNPC_Item_Manipulation"; //used to store the item in the player
    ...
    private Queue m_timer = new(); //Gametimer for casting some spell at the end of the process
    private Queue castplayer = new(); //Used to hold the player who the spell gets cast on
    ...
    public override bool WhisperReceive(GameLiving source, string str)
    {
        ...
        var item = player.TempProperties.getProperty<InventoryItem>(EFFECTNPC_ITEM_WEAK);

        var cachedEffectID = player.TempProperties.getProperty<int>(TempEffectId);
        var cachedColorID = player.TempProperties.getProperty<int>(TempColorId);
        ...
        switch (str)
        {
            ...
            case "remove all effects":
                ...
                break;
            //Longsword
            case "longsword - propane-style flame":
                PreviewEffect(player, 1);
                break;
            case "longsword - regular flame":
                PreviewEffect(player, 2);
                break;
            case "longsword - orange flame":
                PreviewEffect(player, 3);
                break;
            case "longsword - rising flame":
                PreviewEffect(player, 4);
                break;
            case "longsword - flame with smoke":
                PreviewEffect(player, 5);
                break;
            case "longsword - flame with sparks":
                PreviewEffect(player, 6);
                break;
            case "longsword - hot glow":
                PreviewEffect(player, 7);
                break;
            case "longsword - hot aura":
                PreviewEffect(player, 8);
                break;
            case "longsword - blue aura":
                PreviewEffect(player, 9);
                break;
            case "longsword - hot gold glow":
                PreviewEffect(player, 10);
                break;
            case "longsword - hot blue glow":
                PreviewEffect(player, 11);
                break;
            case "longsword - hot red glow":
                PreviewEffect(player, 12);
                break;
            case "longsword - red aura":
                PreviewEffect(player, 13);
                break;
            case "longsword - cold aura with sparkles":
                PreviewEffect(player, 14);
                break;
            case "longsword - cold aura with vapor":
                PreviewEffect(player, 15);
                break;
            case "longsword - hilt wavering blue beam":
                PreviewEffect(player, 16);
                break;
            case "longsword - hilt wavering green beam":
                PreviewEffect(player, 17);
                break;
            case "longsword - hilt wavering red beam":
                PreviewEffect(player, 18);
                break;
            case "longsword - hilt red/blue beam":
                PreviewEffect(player, 19);
                break;
            case "longsword - hilt purple beam":
                PreviewEffect(player, 20);
                break;
            //2hand sword
            case "gr sword - yellow flames":
                PreviewEffect(player, 21);
                break;
            case "gr sword - orange flames":
                PreviewEffect(player, 22);
                break;
            case "gr sword - fire with smoke":
                PreviewEffect(player, 23);
                break;
            case "gr sword - fire with sparks":
                PreviewEffect(player, 24);
                break;
            //2hand hammer
            case "gr - blue glow with sparkles":
                PreviewEffect(player, 25);
                break;
            case "gr - blue aura with cold vapor":
                PreviewEffect(player, 26);
                break;
            case "gr - icy blue glow":
                PreviewEffect(player, 27);
                break;
            case "gr - red aura":
                PreviewEffect(player, 28);
                break;
            case "gr - strong crimson glow":
                PreviewEffect(player, 29);
                break;
            case "gr - white core red glow":
                PreviewEffect(player, 30);
                break;
            case "gr - silvery/white glow":
                PreviewEffect(player, 31);
                break;
            case "gr - gold/yellow glow":
                PreviewEffect(player, 31);
                break;
            case "gr - hot green glow":
                PreviewEffect(player, 33);
                break;
            //hammer/blunt/crush
            case "hammer - red aura":
                PreviewEffect(player, 34);
                break;
            case "hammer - fiery glow":
                PreviewEffect(player, 35);
                break;
            case "hammer - more intense fiery glow":
                PreviewEffect(player, 36);
                break;
            case "hammer - flaming":
                PreviewEffect(player, 37);
                break;
            case "hammer - torchlike flaming":
                PreviewEffect(player, 38);
                break;
            case "hammer - silvery glow":
                PreviewEffect(player, 39);
                break;
            case "hammer - purple glow":
                PreviewEffect(player, 40);
                break;
            case "hammer - blue aura":
                PreviewEffect(player, 41);
                break;
            case "hammer - blue glow":
                PreviewEffect(player, 42);
                break;
            case "hammer - arcs from head to handle":
                PreviewEffect(player, 43);
                break;
            case "crush - arcing halo":
                PreviewEffect(player, 44);
                break;
            case "crush - center arcing":
                PreviewEffect(player, 45);
                break;
            case "crush - smaller arcing halo":
                PreviewEffect(player, 46);
                break;
            case "crush - hot orange core glow":
                PreviewEffect(player, 47);
                break;
            case "crush - orange aura":
                PreviewEffect(player, 48);
                break;
            case "crush - subtle aura with sparks":
                PreviewEffect(player, 49);
                break;
            case "crush - yellow flame":
                PreviewEffect(player, 50);
                break;
            case "crush - mana flame":
                PreviewEffect(player, 51);
                break;
            case "crush - hot green glow":
                PreviewEffect(player, 52);
                break;
            case "crush - hot red glow":
                PreviewEffect(player, 53);
                break;
            case "crush - hot purple glow":
                PreviewEffect(player, 54);
                break;
            case "crush - cold vapor":
                PreviewEffect(player, 55);
                break;
            //Axe
            case "axe - basic flame":
                PreviewEffect(player, 56);
                break;
            case "axe - orange flame":
                PreviewEffect(player, 57);
                break;
            case "axe - slow orange flame with sparks":
                PreviewEffect(player, 58);
                break;
            case "axe - fiery/trailing flame":
                PreviewEffect(player, 59);
                break;
            case "axe - cold vapor":
                PreviewEffect(player, 60);
                break;
            case "axe - blue aura with twinkles":
                PreviewEffect(player, 61);
                break;
            case "axe - hot green glow":
                PreviewEffect(player, 62);
                break;
            case "axe - hot blue glow":
                PreviewEffect(player, 63);
                break;
            case "axe - hot cyan glow":
                PreviewEffect(player, 64);
                break;
            case "axe - hot purple glow":
                PreviewEffect(player, 65);
                break;
            case "axe - blue->purple->orange glow":
                PreviewEffect(player, 66);
                break;
            //shortsword
            case "shortsword - propane flame":
                PreviewEffect(player, 67);
                break;
            case "shortsword - orange flame with sparks":
                PreviewEffect(player, 68);
                break;
            case "shortsword - blue aura with twinkles":
                PreviewEffect(player, 69);
                break;
            case "shortsword - green cloud with bubbles":
                PreviewEffect(player, 70);
                break;
            case "shortsword - red aura with blood bubbles":
                PreviewEffect(player, 71);
                break;
            case "shortsword - evil green glow":
                PreviewEffect(player, 72);
                break;
            case "shortsword - black glow":
                PreviewEffect(player, 73);
                break;
            //BattleSpear SetEffect
            case "battlespear - cold with twinkles":
                PreviewEffect(player, 74);
                break;
            case "battlespear - evil green aura":
                PreviewEffect(player, 75);
                break;
            case "battlespear - evil red aura":
                PreviewEffect(player, 76);
                break;
            case "battlespear - flaming":
                PreviewEffect(player, 77);
                break;
            case "battlespear - hot gold glow":
                PreviewEffect(player, 78);
                break;
            case "battlespear - hot fire glow":
                PreviewEffect(player, 79);
                break;
            case "battlespear - red aura":
                PreviewEffect(player, 80);
                break;
            //Spear SetEffect
            case "lugged spear - blue glow":
                PreviewEffect(player, 81);
                break;
            case "lugged spear - hot blue glow":
                PreviewEffect(player, 82);
                break;
            case "lugged spear - cold with twinkles":
                PreviewEffect(player, 83);
                break;
            case "lugged spear - flaming":
                PreviewEffect(player, 84);
                break;
            case "lugged spear - electric arcing":
                PreviewEffect(player, 85);
                break;
            case "lugged spear - hot yellow flame":
                PreviewEffect(player, 86);
                break;
            case "lugged spear - orange flame with sparks":
                PreviewEffect(player, 87);
                break;
            case "lugged spear - orange to purple flame":
                PreviewEffect(player, 88);
                break;
            case "lugged spear - hot purple flame":
                PreviewEffect(player, 89);
                break;
            case "lugged spear - silvery glow":
                PreviewEffect(player, 90);
                break;
            //Staff SetEffect
            case "staff - blue glow":
                PreviewEffect(player, 90);
                break;
            case "staff - blue glow with twinkles":
                PreviewEffect(player, 91);
                break;
            case "staff - gold glow":
                PreviewEffect(player, 92);
                break;
            case "staff - gold glow with twinkles":
                PreviewEffect(player, 93);
                break;
            case "staff - faint red glow":
                PreviewEffect(player, 94);
                break;
    ...
    public void SetColor(GamePlayer player, int color, int price)
    {
        ...
        unique.Color = color;
        unique.ObjectId = "Unique" + Guid.NewGuid().ToString();
        unique.Id_nb = "Unique" + Guid.NewGuid().ToString();
        if (GameServer.Database.ExecuteNonQuery(
                "SELECT ItemUnique_ID FROM itemunique WHERE ItemUnique_ID = 'unique.ObjectId'"))
            unique.ObjectId = "Unique" + Guid.NewGuid().ToString();
        ...
        foreach (GamePlayer visplayer in GetPlayersInRadius(WorldMgr.VISIBILITY_DISTANCE))
    ...
    {
        var item = (InventoryItem) player.TempProperties.getProperty<InventoryItem>(TempProperty).Clone();
        var displayItem = player.TempProperties.getProperty<InventoryItem>(DisplayedItem);
        item.Effect = effect;
    ...
    {
        m_timer.Dequeue();
        var player = (GamePlayer) castplayer.Dequeue();
        foreach (GamePlayer visplayer in GetPlayersInRadius(WorldMgr.VISIBILITY_DISTANCE))

    ...
    public override bool Interact(GamePlayer player)
    {
        ...
        if (freeRR > 0)
            player.Out.SendMessage(
                "Greetings, " + player.Name + ", during the alpha test I can give you free [Realmrank " + freeRR +
                "]!", eChatType.CT_System, eChatLoc.CL_PopupWindow);

        if (freeRR == 0)
            player.Out.SendMessage(
                "I'm sorry, " + player.Name + " I've been told not to grant free realmranks anymore!",
        ...
        switch (str)
        {
            ...
            case "Realmrank 2":
            {
                if (player.RealmPoints < RR2 && freeRR == 2)
                    player.GainRealmPoints(
                        (long) (double) (RR2 - player.RealmPoints / ServerProperties.Properties.RP_RATE));
            }
                break;
            case "Realmrank 3":
            {
                if (player.RealmPoints < RR3 && freeRR == 3)
                    player.GainRealmPoints(
                        (long) (double) (RR3 - player.RealmPoints / ServerProperties.Properties.RP_RATE));
            }
                break;
            case "Realmrank 4":
            {
                if (player.RealmPoints < RR4 && freeRR == 4)
                    player.GainRealmPoints(
                        (long) (double) (RR4 - player.RealmPoints / ServerProperties.Properties.RP_RATE));
            }
                break;
            case "Realmrank 5":
            {
                if (player.RealmPoints < RR5 && freeRR == 5)
                    player.GainRealmPoints(
                        (long) (double) (RR5 - player.RealmPoints / ServerProperties.Properties.RP_RATE));
            }
                break;
            case "Realmrank 6":
            {
                if (player.RealmPoints < RR6 && freeRR == 6)
                    player.GainRealmPoints(
                        (long) (double) (RR6 - player.RealmPoints / ServerProperties.Properties.RP_RATE));
            }
                break;
            case "Realmrank 7":
            {
            ...
            case "Realmrank 8":
            {
                if (player.RealmPoints < RR8 && freeRR == 8)
                    player.GainRealmPoints(
                        (long) (double) (RR8 - player.RealmPoints / ServerProperties.Properties.RP_RATE));
            }
                break;
            case "Realmrank 9":
            {
                if (player.RealmPoints < RR9 && freeRR == 9)
                    player.GainRealmPoints(
                        (long) (double) (RR9 - player.RealmPoints / ServerProperties.Properties.RP_RATE));
            }
                break;
            case "Realmrank 10":
            {
                if (player.RealmPoints < RR10 && freeRR == 10)
                    player.GainRealmPoints(
                        (long) (double) (RR10 - player.RealmPoints / ServerProperties.Properties.RP_RATE));
            }
                break;
            case "Realmrank 11":
            {
                if (player.RealmPoints < RR11 && freeRR == 11)
                    player.GainRealmPoints(
                        (long) (double) (RR11 - player.RealmPoints / ServerProperties.Properties.RP_RATE));
            }
                break;
            case "Realmrank 12":
            {
                if (player.RealmPoints < RR12 && freeRR == 12)
                    player.GainRealmPoints(
                        (long) (double) (RR12 - player.RealmPoints / ServerProperties.Properties.RP_RATE));
            }
                break;
            case "Realmrank 13":
            {
                if (player.RealmPoints < RR13 && freeRR == 13)
                    player.GainRealmPoints(
                        (long) (double) (RR13 - player.RealmPoints / ServerProperties.Properties.RP_RATE));
            }
                break;
            ...
            case "2L0":
            {
                ...
                {
                    freeRR = 2;
                    GameServer.Instance.LogGMAction("GM: " + player.Name + "(" + player.Client.Account.Name +
                                                    ") Changed the Free Realmranks to RR2");
                }

                if (player.Client.Account.PrivLevel == 3)
                {
                    freeRR = 2;
                    GameServer.Instance.LogGMAction("ADMIN: " + player.Name + "(" + player.Client.Account.Name +
                                                    ") Changed the Free Realmranks to RR2");
                }
            }
                break;
            case "3L0":
            {
                if (player.Client.Account.PrivLevel == 2 && AllowGMChangeAmount == true)
                {
                    freeRR = 3;
                    GameServer.Instance.LogGMAction("GM: " + player.Name + "(" + player.Client.Account.Name +
                                                    ") Changed the Free Realmranks to RR3");
                }
            ...
            case "4L0":
            {
                if (player.Client.Account.PrivLevel == 2 && AllowGMChangeAmount == true)
                {
                    freeRR = 4;
                    GameServer.Instance.LogGMAction("GM: " + player.Name + "(" + player.Client.Account.Name +
                                                    ") Changed the Free Realmranks to RR4");
                }
            ...
            case "5L0":
            {
                if (player.Client.Account.PrivLevel == 2 && AllowGMChangeAmount == true)
                {
                    freeRR = 5;
                    GameServer.Instance.LogGMAction("GM: " + player.Name + "(" + player.Client.Account.Name +
                                                    ") Changed the Free Realmranks to RR5");
                }
            ...
            case "6L0":
            {
                if (player.Client.Account.PrivLevel == 2 && AllowGMChangeAmount == true)
                {
                    freeRR = 6;
                    GameServer.Instance.LogGMAction("GM: " + player.Name + "(" + player.Client.Account.Name +
                                                    ") Changed the Free Realmranks to RR6");
                }
            ...
            case "7L0":
            {
                if (player.Client.Account.PrivLevel == 2 && AllowGMChangeAmount == true)
                {
                    freeRR = 7;
                    GameServer.Instance.LogGMAction("GM: " + player.Name + "(" + player.Client.Account.Name +
                                                    ") Changed the Free Realmranks to RR7");
                }
            ...
            case "8L0":
            {
                if (player.Client.Account.PrivLevel == 2 && AllowGMChangeAmount == true)
                {
                    freeRR = 8;
                    GameServer.Instance.LogGMAction("GM: " + player.Name + "(" + player.Client.Account.Name +
                                                    ") Changed the Free Realmranks to RR8");
                }
            ...
            case "9L0":
            {
                if (player.Client.Account.PrivLevel == 2 && AllowGMChangeAmount == true)
                {
                    freeRR = 9;
                    GameServer.Instance.LogGMAction("GM: " + player.Name + "(" + player.Client.Account.Name +
                                                    ") Changed the Free Realmranks to RR9");
                }
            ...
            case "10L0":
            {
                if (player.Client.Account.PrivLevel == 2 && AllowGMChangeAmount == true)
                {
                    freeRR = 10;
                    GameServer.Instance.LogGMAction("GM: " + player.Name + "(" + player.Client.Account.Name +
                                                    ") Changed the Free Realmranks to RR10");
                }
            ...
            case "11L0":
            {
                if (player.Client.Account.PrivLevel == 2 && AllowGMChangeAmount == true)
                {
                    ...
                    GameServer.Instance.LogGMAction("GM: " + player.Name + "(" + player.Client.Account.Name +
                                                    ") Changed the Free Realmranks to RR11");
                }
            ...
            case "12L0":
            {
                if (player.Client.Account.PrivLevel == 2 && AllowGMChangeAmount == true)
                {
                    freeRR = 12;
                    GameServer.Instance.LogGMAction("GM: " + player.Name + "(" + player.Client.Account.Name +
                                                    ") Changed the Free Realmranks to RR12");
                }
            ...
            case "13L0":
            {
                if (player.Client.Account.PrivLevel == 2 && AllowGMChangeAmount == true)
                {
                    freeRR = 13;
                    GameServer.Instance.LogGMAction("GM: " + player.Name + "(" + player.Client.Account.Name +
                                                    ") Changed the Free Realmranks to RR13");
                }

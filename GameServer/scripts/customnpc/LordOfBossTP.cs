...
public class LordOfBossTP : GameTrainingDummy
{
    ...
    public override bool Interact(GamePlayer player)
    {
        ...
        {
            player.Out.SendMessage("You must be level 50 and in a group to use this teleporter.", eChatType.CT_Say,
        ...
        player.Out.SendMessage(
            ...
            "I can teleport you to our [boss arena] if you think you stand a chance..", eChatType.CT_Say,
            eChatLoc.CL_PopupWindow);
        return true;
    }

        ...
        public void OnCommand(GameClient client, string[] args)
        {
            ...
            if (args[1].ToLower().Equals("on"))
            {
                ...
                DisplayMessage(client,
                    "Your XFire flag is ON. Your character data will be sent to the XFire service ( if you have XFire installed ). Use '/xfire off' to disable sending character data to the XFire service.");
                flag = 1;
            }

...
public class FactionMgr
{
    ...
    public static Hashtable Factions => m_factions;
    ...
    public static bool Init()
    {
        ...
        {
            var faction = GetFactionByID(dblinkedfaction.LinkedFactionID);
            var linkedFaction = GetFactionByID(dblinkedfaction.FactionID);
            if (faction == null || linkedFaction == null)
            {
                log.Warn("Missing Faction or friend faction with Id :" + dblinkedfaction.LinkedFactionID + "/" +
                         dblinkedfaction.FactionID);
                continue;
            }
        ...
        {
            var faction = GetFactionByID(dbfactionAggroLevel.FactionID);
            if (faction == null)
            {

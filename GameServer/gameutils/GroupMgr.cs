...
public static class GroupMgr
{
    ...
    /// </summary>
    private static readonly ReaderWriterDictionary<Group, bool> m_groups = new();

    /// <summary>
    /// ArrayList of all players looking for a group
    /// </summary>
    private static readonly ReaderWriterDictionary<GamePlayer, bool> m_lfgPlayers = new();
    ...
    {
        if (member.LookingForGroup == false && m_lfgPlayers.AddIfNotExists(member, true)) member.LookingForGroup = true;
    }

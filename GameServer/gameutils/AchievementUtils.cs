...
public class AchievementUtils
{
    ...
    public static IList<string> GetAchievementInfoForPlayer(GamePlayer player)
    {
        ...
        var realmDict = new Dictionary<int, string>();
        realmDict.Add(1, "Albion");
        realmDict.Add(2, "Midgard");
        realmDict.Add(3, "Hibernia");

        var HibAchievements = new List<Achievement>();
        var MidAchievements = new List<Achievement>();
        var AlbAchievements = new List<Achievement>();
    ...
    public static bool CheckAccountCredit(string mob, GamePlayer player)
    {
        ...
        var credit = achievements.Where(achievement =>
            achievement.AchievementName.ToLower() == $"{achievementMob}-credit");

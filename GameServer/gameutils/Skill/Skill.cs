...
public abstract class Skill
{
    ...
    /// The Skill Icon
    /// </summary>
    public virtual ushort Icon => m_icon;
    ...
    /// </summary>
    public virtual eSkillPage SkillType => eSkillPage.Abilities;
...
public class NamedSkill : Skill
{
    ...
    /// </summary>
    public virtual string KeyName => m_keyName;
}
...
public class Song : Spell
{
    ...
    public override eSkillPage SkillType => eSkillPage.Songs;
...
public class SpellLine : NamedSkill
{
    ...
    public string Spec => m_spec;

    public bool IsBaseLine => m_isBaseLine;

    public override eSkillPage SkillType => eSkillPage.Spells;

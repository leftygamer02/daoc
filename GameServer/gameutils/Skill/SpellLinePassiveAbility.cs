...
public class SpellLinePassiveAbility : SpellLineAbstractAbility
{
    public override void Activate(GameLiving living, bool sendUpdates)
    {
        ...
        if (line != null && spell != null && spell.Target.ToLower().Equals("self")) living.CastSpell(this);
    }
    ...
    public override void OnLevelChange(int oldLevel, int newLevel = 0)
    {
        ...
        if (m_activeLiving != null)
        {
            ...
            var spell = Spell;
            var line = SpellLine;
            if (line != null && spell != null && spell.Target.ToLower().Equals("self")) m_activeLiving.CastSpell(this);
        }
    }

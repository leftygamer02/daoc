...
public abstract class Abilities
{
    ...
    {
        var type = eObjectType.GenericItem;
        ...
        switch (abilityKeyName)
        {
            case Shield:
                ...
                break;
            case Weapon_Axes:
                type = eObjectType.Axe;
                break;
            case Weapon_Blades:
                type = eObjectType.Blades;
                break;
            case Weapon_Blunt:
                type = eObjectType.Blunt;
                break;
            case Weapon_CelticSpear:
                type = eObjectType.CelticSpear;
                break;
            case Weapon_CompositeBows:
                type = eObjectType.CompositeBow;
                break;
            case Weapon_Crossbow:
                type = eObjectType.Crossbow;
                break;
            case Weapon_Crushing:
                type = eObjectType.CrushingWeapon;
                break;
            case Weapon_FistWraps:
                type = eObjectType.FistWraps;
                break;
            case Weapon_Flexible:
                type = eObjectType.Flexible;
                break;
            case Weapon_Hammers:
                type = eObjectType.Hammer;
                break;
            case Weapon_HandToHand:
                type = eObjectType.HandToHand;
                break;
            case Weapon_Instruments:
                type = eObjectType.Instrument;
                break;
            case Weapon_LargeWeapons:
                type = eObjectType.LargeWeapons;
                break;
            case Weapon_LeftAxes:
                type = eObjectType.LeftAxe;
                break;
            case Weapon_Longbows:
                type = eObjectType.Longbow;
                break;
            case Weapon_MaulerStaff:
                type = eObjectType.MaulerStaff;
                break;
            case Weapon_Piercing:
                type = eObjectType.Piercing;
                break;
            case Weapon_Polearms:
                type = eObjectType.PolearmWeapon;
                break;
            case Weapon_RecurvedBows:
                type = eObjectType.RecurvedBow;
                break;
            case Weapon_Scythe:
                type = eObjectType.Scythe;
                break;
            case Weapon_Shortbows:
                type = eObjectType.Fired;
                break;
            case Weapon_Slashing:
                type = eObjectType.SlashingWeapon;
                break;
            case Weapon_Spears:
                type = eObjectType.Spear;
                break;
            case Weapon_Staves:
                type = eObjectType.Staff;
                break;
            case Weapon_Swords:
                type = eObjectType.Sword;
                break;
            case Weapon_Thrown:
                type = eObjectType.Thrown;
                break;
            case Weapon_Thrusting:
                type = eObjectType.ThrustWeapon;
                break;
            case Weapon_TwoHanded:
                type = eObjectType.TwoHandedWeapon;
                break;
        }

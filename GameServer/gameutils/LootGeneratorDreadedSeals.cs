...
namespace DOL.GS
{
    ...
    public class LootGeneratorDreadedSeals : LootGeneratorBase
    {
        ...
        private static readonly ItemTemplate m_GlowingDreadedSeal = GameServer.Database.ItemTemplates.FirstOrDefault(x => x.KeyName == "glowing_dreaded_seal");
        private static readonly ItemTemplate m_SanguineDreadedSeal = GameServer.Database.ItemTemplates.FirstOrDefault(x => x.KeyName == "sanguine_dreaded_seal");

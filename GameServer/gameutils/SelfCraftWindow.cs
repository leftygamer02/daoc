...
public class SelfCraftWindow : ITradeWindow
{
    ...
    /// </summary>
    public ArrayList PartnerTradeItems => m_itemToCombine;
    ...
    /// </summary>
    public long PartnerTradeMoney => 0;
    ...
    /// Gets the owner of this window and items in it
    /// </summary>
    public GamePlayer Partner => null;

    /// <summary>
    /// Gets the access sync object for this and TradePartner windows
    /// </summary>
    public object Sync => m_tradeItems;
    ...
    /// </summary>
    public int PartnerItemsCount => m_itemToCombine.Count;
    ...
    public bool Repairing
    {
        get => false;
        set =>
            m_owner.Out.SendMessage("You cannot repair while self-crafting!", eChatType.CT_Important,
    ...
    public bool Combine
    {
        get => true;
        set =>
            m_owner.Out.SendMessage("Combine flag is autoset while self-crafting!", eChatType.CT_Important,
                eChatLoc.CL_SystemWindow);
    }
    ...
    public void TradeUpdate()
    {
        lock (Sync)
        {
            ...
            var itemToCombine = (InventoryItem) PartnerTradeItems[0];
            // --------------------------------------------------------------
    ...
    public bool AcceptTrade()
    {
        ...
        lock (Sync)
        {
            ...
            // --------------------------------------------------------------
            if (skill != null && skill is AdvancedCraftingSkill) ((AdvancedCraftingSkill) skill).CombineItems(m_owner);
        }

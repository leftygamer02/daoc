...
/// Guardian Trainer
/// </summary>
[NPCGuildScript("Guardian Trainer",
    eRealm.Hibernia)] // this attribute instructs DOL to use this script for all "Guardian Trainer" NPC's in Albion (multiple guilds are possible for one script)
        ...
        if (player.CharacterClass.ID == (int) TrainedClass)
        {
            ...
            if (player.Level >= 5)
                player.Out.SendMessage(
                    Name +
                    " says, \"You must now seek your training elsewhere. Which path would you like to follow? [Hero], [Champion] or [Blademaster]?\"",
        ...
        switch (text)
        {
            case "Hero":
                if (player.Race == (int) eRace.Celt || player.Race == (int) eRace.Firbolg ||
                    ...
                    player.Out.SendMessage(
                        Name +
                        " says, \"The path of a Hero is not available to your race. Please choose another.\"",
                        eChatType.CT_System, eChatLoc.CL_PopupWindow);
            ...
            case "Champion":
                if (player.Race == (int) eRace.Celt || player.Race == (int) eRace.Elf ||
                    ...
                    player.Out.SendMessage(
                        Name +
                        " says, \"The path of a Champion is not available to your race. Please choose another.\"",
                        eChatType.CT_System, eChatLoc.CL_PopupWindow);

                return true;
            case "Blademaster":
                if (player.Race == (int) eRace.Celt || player.Race == (int) eRace.Elf ||
                    player.Race == (int) eRace.Firbolg || player.Race == (int) eRace.Shar ||
                    ...
                    player.Out.SendMessage(
                        Name +
                        " says, \"The path of a Blademaster is not available to your race. Please choose another.\"",
                        eChatType.CT_System, eChatLoc.CL_PopupWindow);

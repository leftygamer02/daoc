...
/// Stalker Trainer
/// </summary>
[NPCGuildScript("Stalker Trainer",
    eRealm.Hibernia)] // this attribute instructs DOL to use this script for all "Stalker Trainer" NPC's in Albion (multiple guilds are possible for one script)
        ...
        if (player.CharacterClass.ID == (int) TrainedClass)
        {
            ...
            if (player.Level >= 5)
                player.Out.SendMessage(
                    Name +
                    " says, \"You must now seek your training elsewhere. Which path would you like to follow? [Ranger] or [Nightshade]?\"",
        ...
        switch (text)
        {
            case "Ranger":
                if (player.Race == (int) eRace.Celt || player.Race == (int) eRace.Elf ||
                    ...
                    player.Out.SendMessage(
                        Name +
                        " says, \"The path of an Ranger is not available to your race. Please choose another.\"",
                        eChatType.CT_System, eChatLoc.CL_PopupWindow);
            ...
            case "Nightshade":
                if (player.Race == (int) eRace.Elf || player.Race == (int) eRace.Lurikeen)
                    ...
                    player.Out.SendMessage(
                        Name +
                        " says, \"The path of a Nightshade is not available to your race. Please choose another.\"",
                        eChatType.CT_System, eChatLoc.CL_PopupWindow);

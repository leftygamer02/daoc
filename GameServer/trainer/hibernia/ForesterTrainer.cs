...
/// Forester Trainer
/// </summary>
[NPCGuildScript("Forester Trainer",
    eRealm.Hibernia)] // this attribute instructs DOL to use this script for all "Forester Trainer" NPC's in Albion (multiple guilds are possible for one script)
        ...
        if (player.CharacterClass.ID == (int) TrainedClass)
        {
            ...
            if (player.Level >= 5)
                player.Out.SendMessage(
                    Name +
                    " says, \"You must now seek your training elsewhere. Which path would you like to follow? [Animist] or [Valewalker]?\"",
        ...
        switch (text)
        {
            case "Animist":
                if (player.Race == (int) eRace.Celt || player.Race == (int) eRace.Firbolg ||
                    ...
                    player.Out.SendMessage(
                        Name +
                        " says, \"The path of a Animist is not available to your race. Please choose another.\"",
                        eChatType.CT_System, eChatLoc.CL_PopupWindow);
            ...
            case "Valewalker":
                if (player.Race == (int) eRace.Celt || player.Race == (int) eRace.Firbolg ||
                    ...
                    player.Out.SendMessage(
                        Name +
                        " says, \"The path of a Valewalker is not available to your race. Please choose another.\"",
                        eChatType.CT_System, eChatLoc.CL_PopupWindow);

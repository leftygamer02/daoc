...
/// Naturalist Trainer
/// </summary>
[NPCGuildScript("Naturalist Trainer",
    eRealm.Hibernia)] // this attribute instructs DOL to use this script for all "Naturalist Trainer" NPC's in Albion (multiple guilds are possible for one script)
        ...
        if (player.CharacterClass.ID == (int) TrainedClass)
        {
            ...
            if (player.Level >= 5)
                player.Out.SendMessage(
                    Name +
                    " says, \"You must now seek your training elsewhere. Which path would you like to follow? [Bard], [Druid] or [Warden]?\"",
        ...
        switch (text)
        {
            case "Bard":
                if (player.Race == (int) eRace.Celt || player.Race == (int) eRace.Firbolg)
                    ...
                    player.Out.SendMessage(
                        Name +
                        " says, \"The path of a Bard is not available to your race. Please choose another.\"",
                        eChatType.CT_System, eChatLoc.CL_PopupWindow);
            ...
            case "Druid":
                if (player.Race == (int) eRace.Celt || player.Race == (int) eRace.Firbolg ||
                    ...
                    player.Out.SendMessage(
                        Name +
                        " says, \"The path of a Druid is not available to your race. Please choose another.\"",
                        eChatType.CT_System, eChatLoc.CL_PopupWindow);
            ...
            case "Warden":
                if (player.Race == (int) eRace.Celt || player.Race == (int) eRace.Firbolg ||
                    ...
                    player.Out.SendMessage(
                        Name +
                        " says, \"The path of a Warden is not available to your race. Please choose another.\"",
                        eChatType.CT_System, eChatLoc.CL_PopupWindow);

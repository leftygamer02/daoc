...
/// Reaver Trainer
/// </summary>
[NPCGuildScript("Reaver Trainer",
    eRealm.Albion)] // this attribute instructs DOL to use this script for all "Reaver Trainer" NPC's in Albion (multiple guilds are possible for one script)
        ...
        else
        {
            ...
            if (CanPromotePlayer(player))
            {
                player.Out.SendMessage(
                    Name +
                    " says, \"You have come to seek admittance into the [Temple of Arawn] to worship the old god that your ancestors worshipped?\"",
        ...
        switch (text)
        {
            case "Temple of Arawn":
                ...
                if (CanPromotePlayer(player))
                    ...
                    PromotePlayer(player, (int) eCharacterClass.Reaver,
                        "Welcome to the Temple of Arawn, " + player.Name + ".", null); // TODO: gifts

        ...
        else
        {
            ...
            if (CanPromotePlayer(player))
            {
                player.Out.SendMessage(
                    Name +
                    " says, \"Do you desire to [join the Temple of the Iron Fist] and fight for the glorious realm of Albion?\"",
    ...
    public override bool WhisperReceive(GameLiving source, string text)
    {
        ...
        switch (text)
        {
            case "join the Temple of the Iron Fist":
                ...
                if (CanPromotePlayer(player))
                    // Mauler_Alb = 60
                    PromotePlayer(player, (int) eCharacterClass.MaulerAlb,
                        "Welcome young Mauler. May your time in Albion be rewarding.", null);

...
public class NecromancerTrainer : GameTrainer
{
    ...
    public override bool Interact(GamePlayer player)
    {
        ...
        else
        {
            ...
            {
                var message = "Hail, young Disciple. Have you come seeking to imbue yourself with the power of ";
    ...
    public override bool WhisperReceive(GameLiving source, string text)
    {
        ...
        {
            case "necromancers":
                var message = "The necromancer is a cloth wearing priest of Arawn, lord of the underworld. ";
            ...
            case "join the temple of arawn":
                if (CanPromotePlayer(player))
                {
                    PromotePlayer(player, (int) eCharacterClass.Necromancer,
                        "Lord Arawn has accepted you into his Temple. Here is his gift to you. Use it well, Disciple.",
                        null);

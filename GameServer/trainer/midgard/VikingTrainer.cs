...
public class VikingTrainer : GameTrainer
{
        ...
        if (player.CharacterClass.ID == (int) TrainedClass)
        {
            ...
            if (player.Level >= 5)
                player.Out.SendMessage(
                    Name +
                    " says, \"You must now seek your training elsewhere. Which path would you like to follow? [Warrior], [Berserker], [Skald] or [Thane]?\"",
    ...
    public override bool WhisperReceive(GameLiving source, string text)
    {
        ...
        {
            case "Warrior":
                if (player.Race == (int) eRace.Dwarf || player.Race == (int) eRace.Kobold ||
                    player.Race == (int) eRace.Norseman || player.Race == (int) eRace.Troll ||
                    player.Race == (int) eRace.Valkyn || player.Race == (int) eRace.MidgardMinotaur)
                    player.Out.SendMessage(Name + " says, \"I can't tell you something about this class.\"",
                        eChatType.CT_Say, eChatLoc.CL_PopupWindow);
                else
                    player.Out.SendMessage(
                        Name +
                        " says, \"The path of a Warrior is not available to your race. Please choose another.\"",
                        eChatType.CT_Say, eChatLoc.CL_PopupWindow);

                return true;
            case "Berserker":
                if (player.Race == (int) eRace.Dwarf || player.Race == (int) eRace.Troll ||
                    player.Race == (int) eRace.Norseman || player.Race == (int) eRace.Valkyn ||
                    ...
                    player.Out.SendMessage(
                        Name +
                        " says, \"The path of a Berserker is not available to your race. Please choose another.\"",
                        eChatType.CT_Say, eChatLoc.CL_PopupWindow);
            ...
            case "Skald":
                if (player.Race == (int) eRace.Dwarf || player.Race == (int) eRace.Kobold ||
                    ...
                    player.Out.SendMessage(
                        Name +
                        " says, \"The path of a Skald is not available to your race. Please choose another.\"",
                        eChatType.CT_Say, eChatLoc.CL_PopupWindow);
            ...
            case "Thane":
                if (player.Race == (int) eRace.Dwarf || player.Race == (int) eRace.Frostalf ||
                    ...
                    player.Out.SendMessage(
                        Name +
                        " says, \"The path of a Thane is not available to your race. Please choose another.\"",
                        eChatType.CT_Say, eChatLoc.CL_PopupWindow);

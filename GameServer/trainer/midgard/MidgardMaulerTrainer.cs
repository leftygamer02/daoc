        ...
        else
        {
            ...
            if (CanPromotePlayer(player))
            {
                player.Out.SendMessage(
                    Name +
                    " says, \"Do you desire to [join the Temple of the Iron Fist] and fight for the glorious realm of Midgard?\"",
    ...
    public override bool WhisperReceive(GameLiving source, string text)
    {
        ...
        switch (text)
        {
            case "join the Temple of the Iron Fist":
                ...
                if (CanPromotePlayer(player))
                    // Mauler_mid = 61
                    PromotePlayer(player, (int) eCharacterClass.MaulerMid,
                        "Welcome young Mauler. May your time in Midgard be rewarding.", null);

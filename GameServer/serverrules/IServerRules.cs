...
public interface IServerRules
{
    ...
    void SendHousingMerchantWindow(GamePlayer player, PacketHandler.eMerchantWindowType merchantType);
    ...
    /// <param name="merchantType"></param>
    void BuyHousingItem(GamePlayer player, ushort slot, byte count,
        PacketHandler.eMerchantWindowType merchantType);
    ...
    /// <returns></returns>
    GameNPC PlaceHousingNPC(Housing.House house, ItemTemplate item, IPoint3D location, ushort heading);
    ...
    /// <param name="heading"></param>
    /// <returns></returns>
    GameStaticItem PlaceHousingInteriorItem(Housing.House house, ItemTemplate item, IPoint3D location,
        ushort heading);
    ...
    /// <param name="house"></param>
    /// <returns></returns>
    GameConsignmentMerchant CreateHousingConsignmentMerchant(Housing.House house);

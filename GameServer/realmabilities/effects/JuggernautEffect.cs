...
public class JuggernautEffect : StaticEffect, IGameEffect
{
    private const string m_delveString =
        "Increases the effective level of the pet by the listed number (capped at level 70).";
    ...
    {
        StopTimers();
        m_expireTimer = new ECSGameTimer(m_living, new ECSGameTimer.ECSTimerCallback(ExpireCallback),

...
public class ConcentrationAbility : TimedRealmAbility
{
    ...
    public override void Execute(GameLiving living)
    {
        ...
        if (player != null) player.RemoveDisabledSkill(SkillBase.GetAbility(Abilities.Quickcast));
    ...
    public override void AddEffectsInfo(IList<string> list)
    {
        ...
        list.Add(LanguageMgr.GetTranslation(ServerProperties.Properties.SERV_LANGUAGE,
            "ConcentrationAbility.AddEffectsInfo.Info4"));
        list.Add(LanguageMgr.GetTranslation(ServerProperties.Properties.SERV_LANGUAGE,
            "ConcentrationAbility.AddEffectsInfo.Info5"));
    }
}
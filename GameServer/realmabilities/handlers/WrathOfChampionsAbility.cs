...
public class WrathofChampionsAbility : TimedRealmAbility
{
    ...
    public override void Execute(GameLiving living)
    {
        ...
        foreach (GameNPC mob in caster.GetNPCsInRadius(200))
        {
            ...
            caster.Out.SendMessage("You hit the " + mob.Name + " for " + dmgValue + " damage.", eChatType.CT_YouHit,
                eChatLoc.CL_SystemWindow);
        ...
        foreach (GamePlayer t_player in caster.GetPlayersInRadius(WorldMgr.VISIBILITY_DISTANCE))
        {
            ...
            if (phaseshift != null)
            {
                caster.Out.SendMessage(t_player.Name + " is Phaseshifted and can't be effected by this Spell!",
            ...
            // send a message
            caster.Out.SendMessage("You hit " + t_player.Name + " for " + dmgValue + " damage.",
                eChatType.CT_YouHit, eChatLoc.CL_SystemWindow);
            t_player.Out.SendMessage(caster.Name + " hits you for " + dmgValue + " damage.",

...
namespace DOL.GS.RealmAbilities
{
	...
	public class WildPowerAbility : RAPropertyEnhancer
	{
		...
		public WildPowerAbility(Atlas.DataLayer.Models.Ability dba, int level)
	...
	{
		public MasteryOfMageryAbility(Atlas.DataLayer.Models.Ability dba, int level)
	...
	{
		public WildHealingAbility(Atlas.DataLayer.Models.Ability dba, int level)
	...
	{
		public MasteryOfHealingAbility(Atlas.DataLayer.Models.Ability dba, int level)
	...
	{
		public MasteryOfFocusAbility(Atlas.DataLayer.Models.Ability dba, int level) : base(dba, level, eProperty.SpellLevel) { }

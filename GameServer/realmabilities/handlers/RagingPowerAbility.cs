...
public class RagingPowerAbility : TimedRealmAbility
{
    ...
    public override void Execute(GameLiving living)
    {
        ...
        var heal = GetPowerHealAmount();

        var healed = living.ChangeMana(living, eManaChangeType.Spell, living.MaxMana * heal / 100);
        ...
        {
            if (healed > 0)
                player.Out.SendMessage("You gain " + healed + " power.", eChatType.CT_Spell,

...
public class FerociousWillAbility : RR5RealmAbility
{
    ...
    public override void Execute(GameLiving living)
    {
        ...
        if (player != null)
        {
            ...
            var effect = new FerociousWillEffect();
            effect.Start(player);
        }
    ...
    {
        list.Add(
            "Gives the zerker an ABS buff that ticks up by 5% every 5 seconds for a max of 25% at 25 seconds. Lasts 30 seconds total.");
        list.Add("");

...
public class FuryOfNatureAbility : RR5RealmAbility
{
    ...
    public override void Execute(GameLiving living)
    {
        ...
        if (player != null)
        {
            ...
            var effect = new FuryOfNatureEffect();
            effect.Start(player);
        }
    ...
    {
        list.Add(
            "Doubles Style Damage for 30 seconds and heals the group, excluding the caster, like spreadheal with all the damage dealt");
        list.Add("");

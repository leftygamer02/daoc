...
public class RetributionOfTheFaithfulAbility : RR5RealmAbility
{
    ...
    public override void Execute(GameLiving living)
    {
        ...
        if (player != null)
        {
            ...
            var effect = new RetributionOfTheFaithfulEffect();
            effect.Start(player);
        }
    ...
    {
        list.Add(
            "30 second buff that has a chance to proc a 3 second (duration undiminished by resists) stun on any melee attack on the cleric.");
        list.Add("");

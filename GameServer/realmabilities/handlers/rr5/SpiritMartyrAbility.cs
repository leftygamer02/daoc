...
public class SpiritMartyrAbility : RR5RealmAbility
{
    ...
    private const int m_healRange = 2000;
    private double m_healthpool = 3200;
    ...
    public override void Execute(GameLiving living)
    {
        ...
        {
            foreach (var tplayer in player.Group.GetPlayersInTheGroup())
        ...
        if (targets.Count == 0)
        {
            player.Out.SendMessage((player.Group != null ? "Your group is" : "You are") + " fully healed!",
        ...
        while (pool > 0 && targets.Count > 0)
        {
            ...
            var healValue = Math.Min(600, mostInjuredPlayer.MaxHealth - mostInjuredPlayer.Health);

...
public class ValhallasBlessingAbility : RR5RealmAbility
{
    ...
    public override void Execute(GameLiving living)
    {
        ...
        if (player != null)
        {
            ...
            foreach (GamePlayer target in targets)
            {
                ...
                var ValhallasBlessing = target.EffectList.GetOfType<ValhallasBlessingEffect>();
    ...
    {
        list.Add(
            "Spells/Styles used by group have has a chance of not costing power or endurance. 30s duration, 10min RUT.");
        list.Add("");

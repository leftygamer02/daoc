...
public class BoilingCauldronAbility : RR5RealmAbility
{
    ...
    public override void Execute(GameLiving living)
    {
        ...
        if (player != null)
        {
            var BoilingCauldron = player.EffectList.GetOfType<BoilingCauldronEffect>();
    ...
    {
        list.Add(
            "Summon a cauldron that boil in place for 3.5s before spilling and doing damage to all those nearby. 15min RUT.");
        list.Add("");

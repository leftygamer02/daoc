...
public class DesperateBowmanAbility : RR5RealmAbility
{
    ...
    public override void Execute(GameLiving living)
    {
        ...
        var target = (GameLiving) living.TargetObject;
    ...
    private void DamageTarget(GameLiving target, GameLiving caster)
    {
        ...
        if (player != null)
            player.Out.SendMessage("You hit " + target.Name + " for " + damage + " points of damage!",
    ...
    {
        list.Add(
            "Stuns your target for 5 seconds and damage it for 300 , but disarms you for 15 seconds! You need a bow in your hand to use this ability!");
        list.Add("");
        list.Add("Range: 1000");

...
public class WhirlingStaffAbility : RR5RealmAbility
{
    ...
    {
        var resist = 251 * target.GetResist(eDamageType.Crush) / -100;
        var damage = 251 + resist;
        ...
        {
            var effect = new WhirlingStaffEffect();
            effect.Start(target);
        }
    }
    ...
    {
        list.Add(
            "A 350 radius PBAE attack that deals medium crushing damage and disarms your opponents for 6 seconds");
        list.Add("");
        list.Add("Radius: 350");

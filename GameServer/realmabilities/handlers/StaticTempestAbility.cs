...
public class StaticTempestAbility : TimedRealmAbility
{
    ...
    public override void Execute(GameLiving living)
    {
        ...
        {
            caster.Out.SendMessage("You need a target for this ability!", eChatType.CT_System,
        ...
        {
            caster.Out.SendMessage("You cannot attack " + caster.TargetObject.Name + "!", eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
            return;
        }
        ...
        {
            caster.Out.SendMessage("You cannot see " + caster.TargetObject.Name + "!", eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
            return;
        }
        ...
        {
            caster.Out.SendMessage("You target is too far away to use this ability!", eChatType.CT_System,
                eChatLoc.CL_SystemWindow);
            return;
        }
        ...
        */
        ...
        var st = new Statics.StaticTempestBase(m_stunDuration);
        var targetSpot = new Point3D(caster.TargetObject.X, caster.TargetObject.Y, caster.TargetObject.Z);

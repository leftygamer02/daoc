...
namespace DOL.GS.RealmAbilities
{
	...
	public abstract class RAPropertyEnhancer : L5RealmAbility
	{
		...
		public RAPropertyEnhancer(Atlas.DataLayer.Models.Ability dba, int level, eProperty[] property)
			: base(dba, level)
		{
			m_property = property;
		}
	...
	{
		public L3RAPropertyEnhancer(Atlas.DataLayer.Models.Ability dba, int level, eProperty property)
			: base(dba, level, property)
		{
		}

		public L3RAPropertyEnhancer(Atlas.DataLayer.Models.Ability dba, int level, eProperty[] properties)

...
{
    protected override string GetStaticName()
    {
        return "Negative Maelstrom";
    }

    protected override ushort GetStaticModel()
    {
        return 3738;
    }

    protected override ushort GetStaticEffect()
    {
        return 7027;
    }

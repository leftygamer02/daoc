...
public class MPKFile
{
    ...
    private MPKFileHeader _hdr = new();
    ...
    /// Gets the MPK header
    /// </summary>
    public MPKFileHeader Header => _hdr;
    ...
    public void Load(string fname)
    {
        ...
        if (!fi.Exists) throw new FileNotFoundException("File does not exist", fname);
        ...
        _hdr = new MPKFileHeader
            {Name = fname, UncompressedSize = (uint) fi.Length, TimeStamp = (uint) DateTime.Now.ToFileTime()};

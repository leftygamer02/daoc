...
public class WeakMulticastDelegate
{
    ...
    /// A weak reference to the target for this delegate
    /// </summary>
    public WeakReference WeakRef => _weakRef;
    ...
    /// </summary>
    public WeakMulticastDelegate Previous => _prev;
    ...
    public static WeakMulticastDelegate Combine(WeakMulticastDelegate weakDelegate, Delegate realDelegate)
    {
        ...
        return weakDelegate == null
            ...
            : weakDelegate.Combine(realDelegate);
    }
    ...
    {
        if (Equals(realDelegate)) return _prev;
    ...
    public void Invoke(object[] args)
    {
        ...
        while (current != null)
        {
            ...
            else if (current._weakRef.IsAlive) current._method.Invoke(current._weakRef.Target, args);
    ...
    public void InvokeSafe(object[] args)
    {
        ...
        while (current != null)
        {
            ...
            try
            {
                ...
                if (current._weakRef == null)
                    current._method.Invoke(null, args);
                else if (target != null && current._weakRef.IsAlive) current._method.Invoke(target, args);
            }
            catch (Exception ex)
            {
    ...
    public override string ToString()
    {
        ...
        if (_method != null) declaringType = _method.DeclaringType;

        object target = null;
        if (_weakRef != null && _weakRef.IsAlive) target = _weakRef.Target;

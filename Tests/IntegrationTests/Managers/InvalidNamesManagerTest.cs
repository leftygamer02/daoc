...
public class TestInvalidNamesManager
{
    ...
    public void InvalidNamesManager_LoadContainsAndCheckTwoString_Match()
    {
        ...
        Assert.IsTrue(manager["boba", "fett"], "'boba' 'fett' should match 'Bob' Pattern with case insensitive...");
        Assert.IsTrue(manager["FOOB", "obBAR"],
            "'FOOB' 'obBAR' should match 'Bob' Pattern with case insensitive...");
    }
    ...
    public void InvalidNamesManager_LoadRegexAndCheckOneString_Match()
    {
        ...
        Assert.IsTrue(manager["boba fett"],
            "'boba fett' should match '/B.*o.*b/' Pattern with case insensitive...");
        Assert.IsTrue(manager["FOOBobBAR"],
            "'FOOBobBAR' should match '/B.*o.*b/' Pattern with case insensitive...");
        Assert.IsTrue(manager["F O O B o b B A R"],
            "'F O O B o b B A R' should match '/B.*o.*b/' Pattern with case insensitive...");
    }
    ...
    public void InvalidNamesManager_LoadRegexAndCheckTwoString_Match()
    {
        ...
        Assert.IsTrue(manager["boba", "fett"],
            "'boba' 'fett' should match '/B.*o.*b/' Pattern with case insensitive...");
        Assert.IsTrue(manager["FOOB", "obBAR"],
            "'FOOB' 'obBAR' should match '/B.*o.*b/' Pattern with case insensitive...");
        Assert.IsTrue(manager["F O O", " B o b B A R"],
            "'F O O' ' B o b B A R' should match '/B.*o.*b/' Pattern with case insensitive...");
    }
    ...
    public void InvalidNamesManager_LoadMultiConstraintsCheckOneString_Match()
    {
        ...
        Assert.IsTrue(manager["LukeSkywalker"],
            "'LukeSkywalker' should match 'Luke' Pattern with case insensitive...");
    }
    ...
    public void InvalidNamesManager_LoadMultiConstraintsCheckTwoString_Match()
    {
        ...
        Assert.IsTrue(manager["boba", "fett"],
            "'boba' 'fett' should match '/B.*o.*b/' Pattern with case insensitive...");
        Assert.IsTrue(manager["FOOB", "obBAR"],
            "'FOOB' 'obBAR' should match 'FOO' Pattern with case insensitive...");
        Assert.IsTrue(manager["LukeSky", " walker"],
            "'LukeSky' ' walker' should match 'Luke' Pattern with case insensitive...");
    }

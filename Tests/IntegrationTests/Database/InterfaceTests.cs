...
public class InterfaceTests
{
    ...
    public void TestSingleAdd()
    {
        ...
        Assert.AreEqual(objId, retrieved.ObjectId,
            "Test Object previously added and retrieved object should have same ObjectId...");
        Assert.AreEqual(obj.TestField, retrieved.TestField,
            "Test Object previously added and retrieved object should have equals fields...");
    }
    ...
    public void TestMultipleAddSameTable()
    {
        ...
        var objs = Enumerable.Range(0, 10).Select(i => new TestTable
            {TestField = string.Format("Test Multi Add Same Table #{0}", i)}).ToArray();
        ...
        CollectionAssert.AreEqual(objsId, objs.Select(obj => obj.ObjectId),
            "Test Objects should have kept their ObjectId from Creation...");
        ...
        CollectionAssert.AreEqual(objsId, retrieved.Select(obj => obj.ObjectId),
            "Test Objects previously added and retrieved objects should have same ObjectId...");
        CollectionAssert.AreEqual(objs.Select(obj => obj.TestField), retrieved.Select(obj => obj.TestField),
            "Test Objects previously added and retrieved objects should have equals fields...");
    }
    ...
    public void TestMultipleAddDifferentTable()
    {
        ...
        var objsTestTable = Enumerable.Range(0, 10).Select(i => new TestTable
            {TestField = string.Format("Test Multi Add Different Table #{0}", i)}).ToArray();
        var objsTestTableId = objsTestTable.Select(obj => obj.ObjectId).ToArray();
        var objsTestTableAutoInc = Enumerable.Range(0, 10).Select(i => new TestTableAutoInc
            {TestField = string.Format("Test Auto Inc Multi Add Different Table #{0}", i)}).ToArray();
        var objsTestTableAutoIncId = objsTestTableAutoInc.Select(obj => obj.ObjectId).ToArray();
        var objsTestTableRelations = Enumerable.Range(0, 10).Select(i => new TestTableRelations
            {TestField = string.Format("Test Relation Multi Add Different Table #{0}", i)}).ToArray();
        ...
        foreach (var obj in objsTestTableRelations)
            obj.Entries = Enumerable.Range(0, 5)
                .Select(i => new TestTableRelationsEntries {ForeignTestField = obj.ObjectId}).ToArray();

        var objsTestTableRelationsEntriesId = objsTestTableRelations.ToDictionary(kv => kv.ObjectId,
            kv => kv.Entries.Select(ent => ent.ObjectId).ToArray());
        ...
        foreach (var obj in objs)
        {
            Assert.IsFalse(obj.IsPersisted,
                "Different Test Objects should not have Persisted Flag before adding...");
        ...
        {
            Assert.IsTrue(ent.IsPersisted,
                "TestTableRelationEntries Objects should have Persisted Flag after adding to database...");
            Assert.IsFalse(ent.Dirty,
                "TestTableRelationEntries Objects should not be Dirty after adding to database...");
        }

        CollectionAssert.AreEquivalent(objsTestTableId,
            objs.Where(obj => obj.GetType() == typeof(TestTable)).Select(obj => obj.ObjectId),
            "TestTable Objects should have kept their ObjectId from Creation...");
        CollectionAssert.AreEquivalent(objsTestTableRelationsId,
            objs.Where(obj => obj.GetType() == typeof(TestTableRelations)).Select(obj => obj.ObjectId),
            "TestTableRelations Objects should have kept their ObjectId from Creation...");
        CollectionAssert.AreNotEquivalent(objsTestTableAutoIncId,
            objs.Where(obj => obj.GetType() == typeof(TestTableAutoInc)).Select(obj => obj.ObjectId),
            "TestTableAutoInc Objects should NOT have kept their ObjectId from Creation...");

        foreach (var obj in objs.Where(obj => obj.GetType() == typeof(TestTableRelations))
                     .Cast<TestTableRelations>())
            CollectionAssert.AreEquivalent(objsTestTableRelationsEntriesId[obj.ObjectId],
                obj.Entries.Select(ent => ent.ObjectId),
        ...
        CollectionAssert.AreEqual(objsTestTableId, retrievedTestTable.Select(obj => obj.ObjectId),
            "TestTable Objects previously added and retrieved objects should have same ObjectId...");
        CollectionAssert.AreEqual(objsTestTable.Select(obj => obj.TestField),
            retrievedTestTable.Select(obj => obj.TestField),
            "TestTable Objects previously added and retrieved objects should have equals fields...");

        var retrievedTestTableAutoInc =
            Database.FindObjectsByKey<TestTableAutoInc>(
                objsTestTableAutoInc.Select(key => (object) key.PrimaryKey));
        Assert.IsNotNull(retrievedTestTableAutoInc,
            "TestTableAutoInc Objects retrieved Collection should not be null...");
        CollectionAssert.AreEqual(objsTestTableAutoInc.Select(key => key.PrimaryKey.ToString()),
            retrievedTestTableAutoInc.Select(obj => obj.ObjectId),
            "TestTableAutoInc Objects previously added and retrieved objects should have same ObjectId...");
        CollectionAssert.AreEqual(objsTestTableAutoInc.Select(obj => obj.TestField),
            retrievedTestTableAutoInc.Select(obj => obj.TestField),
            "TestTableAutoInc Objects previously added and retrieved objects should have equals fields...");

        var retrievedTestTableRelations = Database.FindObjectsByKey<TestTableRelations>(objsTestTableRelationsId);
        Assert.IsNotNull(retrievedTestTableRelations,
            "TestTableRelations Objects retrieved Collection should not be null...");
        CollectionAssert.AreEqual(objsTestTableRelationsId, retrievedTestTableRelations.Select(obj => obj.ObjectId),
            "TestTableRelations Objects previously added and retrieved objects should have same ObjectId...");
        CollectionAssert.AreEqual(objsTestTableRelations.Select(obj => obj.TestField),
            retrievedTestTableRelations.Select(obj => obj.TestField),
            "TestTableRelations Objects previously added and retrieved objects should have equals fields...");
    ...
    {
        DataObject dbo = null;
        Assert.Throws(typeof(NullReferenceException), () => Database.AddObject(dbo),
            "Adding a Single Null Object Should throw NullReferenceException...");
    }
    ...
    public void TestMultipleAddWithNull()
    {
        ...
        Assert.Throws(typeof(NullReferenceException), () => Database.AddObject(dbo),
            "Adding a Multiple with Null Objects Should throw NullReferenceException...");
    }
    ...
    {
        Database.RegisterDataObject(typeof(TestTable));
        var dbo = new DataObject[]
        {
            new TestTable {TestField = "Test Multiple Add with some non registered Values"},
            new TableNotRegistered()
        };
        var added = Database.AddObject(dbo);
        Assert.IsFalse(added, "Adding Multiple non registered Object should not return success...");
        Assert.IsFalse(dbo[1].IsPersisted,
            "Adding a Multiple non registered Object should not have Persisted Flag on unregistered Object...");
        Assert.IsTrue(dbo[0].IsPersisted,
            "Adding a Multiple non registered Object should have Persisted Flag on registered Object...");
    }
    ...
    public void BenchSingleAdd()
    {
        ...
        Assert.IsEmpty(Database.SelectAllObjects<TestTableRelations>(),
            "Database shouldn't have any record For TestTable.");
        Assert.IsEmpty(Database.SelectAllObjects<TestTableRelationsEntries>(),
            "Database shouldn't have any record For TestTable.");

        var objs = Enumerable.Range(0, 100)
            .Select(i => new TestTable {TestField = string.Format("Bench Single Add '{0}'", i)}).ToArray();
        ...
        var relationObjs = Enumerable.Range(0, 100).Select(i => new TestTableRelations
            {TestField = string.Format("Bench Single Relations Add '{0}'", i)}).ToArray();
        ...
        Console.WriteLine("Bench Single TestTable Add Total Elapse {3}ms, Average {0}ms, Min {1}ms, Max {2}ms",
            times.Average(), times.Min(), times.Max(), times.Sum());
        Console.WriteLine(
            "Bench Single TestTableRelations Add Total Elapse {3}ms, Average {0}ms, Min {1}ms, Max {2}ms",
            timesRelations.Average(), timesRelations.Min(), timesRelations.Max(), timesRelations.Sum());
    }
    ...
    public void BenchMultipleAdd()
    {
        ...
        var objs = Enumerable.Range(0, 100)
            .Select(i => new TestTable {TestField = string.Format("Bench Multiple Add '{0}'", i)}).ToArray();
        ...
        var relationObjs = Enumerable.Range(0, 100).Select(i => new TestTableRelations
            {TestField = string.Format("Bench Multiple Relations Add '{0}'", i)}).ToArray();
        foreach (var obj in relationObjs)
            obj.Entries = Enumerable.Range(0, 5)
                .Select(i => new TestTableRelationsEntries {ForeignTestField = obj.ObjectId}).ToArray();
    ...
    public void TestSingleSave()
    {
        ...
        Assert.AreEqual(obj.TestField, retrieve.TestField,
            "Previously Changed Object and newly retrieved Object should have the same field value...");
    }
    ...
    public void TestMultipleSaveSameTable()
    {
        Database.RegisterDataObject(typeof(TestTable));
        var objs = Enumerable.Range(0, 10).Select(i => new TestTable
            {TestField = string.Format("Test Multi Save Same Table #{0}", i)}).ToArray();
        var inserted = Database.AddObject(objs);
        ...
        CollectionAssert.AreEquivalent(objs.Select(obj => obj.TestField), retrieved.Select(obj => obj.TestField),
            "Previously Changed Objects and newly retrieved Objects should have the same field value...");
    }
    ...
    public void TestMultipleSaveDifferentTable()
    {
        ...
        var objsTestTable = Enumerable.Range(0, 10).Select(i => new TestTable
            {TestField = string.Format("Test Multi Save Different Table #{0}", i)}).ToArray();
        var objsTestTableAutoInc = Enumerable.Range(0, 10).Select(i => new TestTableAutoInc
            {TestField = string.Format("Test Auto Inc Multi Save Different Table #{0}", i)}).ToArray();
        var objsTestTableRelations = Enumerable.Range(0, 10).Select(i => new TestTableRelations
            {TestField = string.Format("Test Relation Multi Save Different Table #{0}", i)}).ToArray();
        ...
        var retrieved = Database.FindObjectsByKey<TestTable>(objsTestTable.Select(obj => obj.ObjectId))
            ...
            .Concat(Database.FindObjectsByKey<TestTableRelations>(
                objsTestTableRelations.Select(obj => obj.ObjectId)));

        Assert.IsNotNull(retrieved, "Changed Objects Collection Should be retrieved from database...");
        CollectionAssert.AreEquivalent(objs.Select(obj => obj.TestField), retrieved.Select(obj => obj.TestField),
            "Previously Changed Objects and newly retrieved Objects should have the same field value...");

        foreach (var obj in retrieved.Where(o => o.GetType() == typeof(TestTableRelations))
                     .OfType<TestTableRelations>())
            CollectionAssert.AreEquivalent(
                objsTestTableRelations.First(o => o.ObjectId == obj.ObjectId).Entries.Select(o => o.ObjectId),
                obj.Entries.Select(o => o.ObjectId),
                "Previously Changed Objects and newly retrieved Objects should have the same Relations Collections...");
    }
    ...
    {
        DataObject obj = null;
        Assert.Throws(typeof(NullReferenceException), () => Database.SaveObject(obj),
            "Trying to save a null object should throw NullReferenceException...");
    }
    ...
    public void TestMultipleSaveNull()
    {
        ...
        Assert.Throws(typeof(NullReferenceException), () => Database.SaveObject(dbo),
            "Saving a Collection with Null Objects Should throw NullReferenceException...");
    }
    ...
    public void TestMultipleSaveNonRegistered()
    {
        ...
        var dbo = new DataObject[]
        {
            new TestTable {TestField = "Test Multiple Save with some non registered Values"},
            new TableNotRegistered()
        };
        var added = Database.AddObject(dbo);
        ...
        Assert.IsFalse(dbo[0].Dirty,
            "Saving a Collection with non registered Object should not have Dirty Flag on registered Object...");
        Assert.IsTrue(dbo[1].Dirty,
            "Saving a Collection with non registered Object should have Dirty Flag on non-registered Object...");
    }
    ...
    {
        Database.RegisterDataObject(typeof(TestTable));
        var objs = Enumerable.Range(0, 10)
            .Select(i => new TestTable {TestField = string.Format("Test Multiple Delete #{0}", i)}).ToArray();
        var inserted = Database.AddObject(objs);
        ...
        Assert.IsEmpty(retrieve.Where(obj => obj != null),
            "Retrieved Deleted Objects Collection should be empty...");
    }
    ...
    public void TestMultipleDeleteDifferentTable()
    {
        ...
        var objsTestTable = Enumerable.Range(0, 10).Select(i => new TestTable
            {TestField = string.Format("Test Multi Delete Different Table #{0}", i)}).ToArray();
        var objsTestTableAutoInc = Enumerable.Range(0, 10).Select(i => new TestTableAutoInc
            {TestField = string.Format("Test Auto Inc Multi Delete Different Table #{0}", i)}).ToArray();
        var objsTestTableRelations = Enumerable.Range(0, 10).Select(i => new TestTableRelations
            {TestField = string.Format("Test Relation Multi Delete Different Table #{0}", i)}).ToArray();
        ...
        Assert.IsNotNull(retrieved,
            "Deleted Objects Collection Should be retrieved Empty not null from database...");
        Assert.IsEmpty(retrieved.Where(obj => obj != null),
            "Deleted Objects Collection Should be retrieved Empty from database...");

        var relRetrieved = Database.FindObjectsByKey<TestTableRelationsEntries>(objsTestTableRelations
            .SelectMany(obj => obj.Entries).Select(ent => ent.ObjectId));

        Assert.IsNotNull(relRetrieved,
            "Deleted Objects Collection Should be retrieved Empty not null from database...");
        Assert.IsEmpty(relRetrieved.Where(obj => obj != null),
            "Deleted Objects Collection Should be retrieved Empty from database...");
    }
    ...
    {
        DataObject obj = null;
        Assert.Throws(typeof(NullReferenceException), () => Database.DeleteObject(obj),
            "Trying to delete a null object should throw NullReferenceException...");
    }
    ...
    public void TestMultipleDeleteNull()
    {
        ...
        Assert.Throws(typeof(NullReferenceException), () => Database.DeleteObject(dbo),
            "Deleting a Collection with Null Objects Should throw NullReferenceException...");
    }
    ...
    public void TestMutipleDeleteNonRegistered()
    {
        ...
        var dbo = new DataObject[]
        {
            new TestTable {TestField = "Test Multiple Delete with some non registered Values"},
            new TableNotRegistered()
        };
        var added = Database.AddObject(dbo);
        ...
        Assert.IsTrue(dbo[0].IsDeleted,
            "Deleting a Collection with non registered Object should set Deleted Flag on registered Object...");
        Assert.IsFalse(dbo[1].IsDeleted,
            "Deleting a Collection with non registered Object should not set Deleted Flag non-registered Object...");
    }
    ...
    public void TestSingleFindObjectByKey()
    {
        ...
        Assert.AreEqual(obj.ObjectId, retrieve.ObjectId,
            "Find Object By Key Should return similar Object to created one...");
        Assert.AreEqual(obj.TestField, retrieve.TestField,
            "Find Object By Key Should return similar Object to created one...");

        var retrieveCase = Database.FindObjectByKey<TestTable>(obj.ObjectId.ToUpper());

        Assert.IsNotNull(retrieveCase,
            "Find Object By Key Could not retrieve previously added Object using Case Mismatch...");
        Assert.AreEqual(obj.ObjectId, retrieveCase.ObjectId,
            "Find Object By Key Should return similar Object to created one...");
        Assert.AreEqual(obj.TestField, retrieveCase.TestField,
            "Find Object By Key Should return similar Object to created one...");
    }
    ...
    public void TestMultipleFindObjectByKey()
    {
        ...
        Assert.IsNotEmpty(retrieve.Where(obj => obj != null),
            "Find Object By Key Could not retrieve previously added Objects...");
        CollectionAssert.AreEqual(objs.Select(obj => obj.ObjectId), retrieve.Select(obj => obj.ObjectId),
            "Find Object By Key Should return similar Objects to created ones...");
        CollectionAssert.AreEqual(objs.Select(obj => obj.TestField), retrieve.Select(obj => obj.TestField),
            "Find Object By Key Should return similar Objects to created ones...");
        ...
        Assert.IsNotEmpty(retrieveCase.Where(obj => obj != null),
            "Find Object By Key Could not retrieve previously added Objects using Case Mismatch...");
        CollectionAssert.AreEqual(objs.Select(obj => obj.ObjectId), retrieveCase.Select(obj => obj.ObjectId),
            "Find Object By Key Should return similar Objects to created ones...");
        CollectionAssert.AreEqual(objs.Select(obj => obj.TestField), retrieveCase.Select(obj => obj.TestField),
            "Find Object By Key Should return similar Objects to created ones...");
    }
    ...
    public void TestSingleFindObjectByKeyPrimaryKey()
    {
        ...
        var obj = new TestTablePrimaryKey
        {
            PrimaryKey = DOL.Database.UniqueID.IDGenerator.GenerateID(),
            TestField = "Test For Single Find Object By Primary Key"
        };
        ...
        Assert.IsNotNull(retrieve, "Find Object By Key Could not retrieve previously added Object...");
        Assert.AreEqual(obj.PrimaryKey, retrieve.PrimaryKey,
            "Find Object By Key Should return similar Object to created one...");
        Assert.AreEqual(obj.TestField, retrieve.TestField,
            "Find Object By Key Should return similar Object to created one...");
        ...
        Assert.IsNotNull(retrieveCase,
            "Find Object By Key Could not retrieve previously added Object using Case Mismatch...");
        Assert.AreEqual(obj.PrimaryKey, retrieveCase.PrimaryKey,
            "Find Object By Key Should return similar Object to created one...");
        Assert.AreEqual(obj.TestField, retrieveCase.TestField,
            "Find Object By Key Should return similar Object to created one...");
    }
    ...
    public void TestMultipleFindObjectByKeyPrimaryKey()
    {
        ...
        Assert.IsNotEmpty(retrieve.Where(obj => obj != null),
            "Find Object By Key Could not retrieve previously added Objects...");
        CollectionAssert.AreEqual(objs.Select(obj => obj.PrimaryKey), retrieve.Select(obj => obj.PrimaryKey),
            "Find Object By Key Should return similar Objects to created ones...");
        CollectionAssert.AreEqual(objs.Select(obj => obj.TestField), retrieve.Select(obj => obj.TestField),
            "Find Object By Key Should return similar Objects to created ones...");

        var retrieveCase =
            Database.FindObjectsByKey<TestTablePrimaryKey>(objs.Select(obj => obj.PrimaryKey.ToUpper()));

        Assert.IsNotNull(retrieveCase, "Find Object By Key Could should not return a null collection...");
        Assert.IsNotEmpty(retrieveCase.Where(obj => obj != null),
            "Find Object By Key Could not retrieve previously added Objects using Case Mismatch...");
        CollectionAssert.AreEqual(objs.Select(obj => obj.PrimaryKey), retrieveCase.Select(obj => obj.PrimaryKey),
            "Find Object By Key Should return similar Object to created ones...");
        CollectionAssert.AreEqual(objs.Select(obj => obj.TestField), retrieveCase.Select(obj => obj.TestField),
            "Find Object By Key Should return similar Object to created ones...");
    }
    ...
    public void TestSingleFindObjectByKeyPrimaryKeyAutoInc()
    {
        ...
        Assert.IsNotNull(retrieveCast,
            "Find Object By Key Could not retrieve previously added Object using Numeric Cast...");
        Assert.AreEqual(obj.PrimaryKey, retrieveCast.PrimaryKey,
            "Find Object By Key Should return similar Object to created one...");
        Assert.AreEqual(obj.TestField, retrieveCast.TestField,
            "Find Object By Key Should return similar Object to created one...");

        var retrieveString = Database.FindObjectByKey<TestTableAutoInc>(obj.PrimaryKey.ToString());

        Assert.IsNotNull(retrieveString,
            "Find Object By Key Could not retrieve previously added Object using String Cast...");
        Assert.AreEqual(obj.PrimaryKey, retrieveString.PrimaryKey,
            "Find Object By Key Should return similar Object to created one...");
        Assert.AreEqual(obj.TestField, retrieveString.TestField,
            "Find Object By Key Should return similar Object to created one...");
    }
    ...
    public void TestMultipleFindObjectByKeyPrimaryKeyAutoInc()
    {
        ...
        var objs = Enumerable.Range(0, 10).Select(i => new TestTableAutoInc
            {TestField = string.Format("Test For Multiple Find Objects By Key Auto Inc #{0}", i)}).ToArray();
        ...
        var retrieve =
            Database.FindObjectsByKey<TestTableAutoInc>(objs.Select(obj => obj.PrimaryKey).Cast<object>());
        ...
        var retrieveCast =
            Database.FindObjectsByKey<TestTableAutoInc>(objs.Select(obj => (long) obj.PrimaryKey).Cast<object>());

        Assert.IsNotNull(retrieveCast, "Find Object By Key Could should not return a null collection...");
        Assert.IsNotEmpty(retrieveCast.Where(obj => obj != null),
            "Find Object By Key Could not retrieve previously added Objects using Numeric Cast...");
        CollectionAssert.AreEqual(objs.Select(obj => obj.PrimaryKey), retrieveCast.Select(obj => obj.PrimaryKey),
            "Find Object By Key Should return similar Objects to created ones...");
        CollectionAssert.AreEqual(objs.Select(obj => obj.TestField), retrieveCast.Select(obj => obj.TestField),
            "Find Object By Key Should return similar Objects to created ones...");

        var retrieveString =
            Database.FindObjectsByKey<TestTableAutoInc>(objs.Select(obj => obj.PrimaryKey.ToString()));

        Assert.IsNotNull(retrieveString, "Find Object By Key Could should not return a null collection...");
        Assert.IsNotEmpty(retrieveString.Where(obj => obj != null),
            "Find Object By Key Could not retrieve previously added Objects using String Cast...");
        CollectionAssert.AreEqual(objs.Select(obj => obj.PrimaryKey), retrieveString.Select(obj => obj.PrimaryKey),
            "Find Object By Key Should return similar Objects to created ones...");
        CollectionAssert.AreEqual(objs.Select(obj => obj.TestField), retrieveString.Select(obj => obj.TestField),
            "Find Object By Key Should return similar Objects to created ones...");
    }
    ...
    public void TestMultipleFindObjectByKeyWithNull()
    {
        ...
        Assert.IsNotEmpty(result,
            "Searching with multiple keys including null shoud not return an empty collection...");
        Assert.IsNull(result[0],
            "Searching with multiple keys including null should return null data object for null key...");
        Assert.IsNotNull(result[1],
            "Searching with multiple keys including null should return a valid data object for non null key...");
    }
    ...
    {
        Assert.Throws(typeof(DatabaseException),
            () => Database.FindObjectByKey<TableNotRegistered>(new object[] {1, 2}), "");
    }
    ...
    public void TestSelectObjects()
    {
        ...
        CollectionAssert.Contains(simpleWhere.Select(obj => obj.ObjectId), objInitial.ObjectId,
            "Select Objects with Simple Where clause should retrieve Object similar to Created one...");

        var complexWhere = Database.SelectObjects<TestTable>(DB.Column("TestField").IsEqualTo(objInitial.TestField)
            .And(DB.Column("Test_Table_ID").IsEqualTo(objInitial.ObjectId)));

        CollectionAssert.Contains(complexWhere.Select(obj => obj.ObjectId.ToLower()), objInitial.ObjectId.ToLower(),
            "Select Objects with Complex Where clause should retrieve Object similar to Created one...");
        ...
        CollectionAssert.IsEmpty(nullParam,
            "Select Objects with Null Parameter Query should not return any record...");
    ...
    public void SelectObjects_KeywordAsColumnName_SameAsAddedObjects()
    {
        ...
        CollectionAssert.Contains(result.Select(obj => obj.ObjectId), firstEntry.ObjectId,
            "Select Objects with Simple Where clause should retrieve Object similar to Created one...");
    }
    ...
    public void TestSelectObjectsWithMultipleWhereClause()
    {
        ...
        Assert.IsEmpty(Database.SelectAllObjects<TestTable>(),
            "This test needs an Empty Table to Run Successfully...");

        var objs = new[] {"Test Select Group1", "Test Select Group2", "Test Select Group3", "Test Select Group4"}
            .Select(grp => Enumerable.Range(0, 100).Select(i => new TestTable {TestField = grp}))
            .ToDictionary(kv => kv.First().TestField, kv => kv.ToArray());
        ...
        var parameters = new[]
            {"Test Select Group1", "Test Select Group2", "Test Select Group3", "Test Select Group4"};
        var retrieve =
            Database.MultipleSelectObjects<TestTable>(parameters.Select(parameter =>
                DB.Column("TestField").IsEqualTo(parameter)));

        var objectByGroup = new[]
                {"Test Select Group1", "Test Select Group2", "Test Select Group3", "Test Select Group4"}
        ...
        foreach (var sets in objectByGroup)
        {
            ...
            CollectionAssert.AreEquivalent(objs[sets.Grp].Select(obj => obj.ObjectId),
                sets.Objects.Select(obj => obj.ObjectId),
        ...
        var retrieveMany = Database.MultipleSelectObjects<TestTable>(orderedObjs.Select(obj =>
            DB.Column("TestField").IsEqualTo(obj.TestField)
                .And(DB.Column("Test_Table_ID").IsEqualTo(obj.ObjectId))));
        ...
        CollectionAssert.AreEqual(orderedObjs.Select(obj => obj.ObjectId.ToLower()),
            resultsMany.Select(obj => obj.ObjectId.ToLower()),
            "Retrieve Sets from Select Objects should be Equal to Parameter Set ObjectId...");
        CollectionAssert.AreEqual(orderedObjs.Select(obj => obj.TestField.ToLower()),
            resultsMany.Select(obj => obj.TestField.ToLower()),
            "Retrieve Sets from Select Objects should be Equal to Parameter Set Field Value...");

        var parameterManyWithMissing = new[]
                {("No Known Value", "Probably Nothing"), ("Absolutely None", "Nothing for Sure")}
            .Concat(orderedObjs.Select(obj => (obj.TestField, obj.ObjectId)));
        var manyQueriesWithMissing = parameterManyWithMissing.Select(tuple =>
            DB.Column("TestField").IsEqualTo(tuple.Item1).And(DB.Column("Test_Table_ID").IsEqualTo(tuple.Item2)));
        var retrieveManyWithMissing = Database.MultipleSelectObjects<TestTable>(manyQueriesWithMissing);

        Assert.IsNotNull(retrieveManyWithMissing,
            "Retrieve Sets from Select Objects should not return null value...");
        ...
        CollectionAssert.AreEqual(new[] {"", ""}.Concat(orderedObjs.Select(obj => obj.ObjectId.ToLower())),
            resultsManyWithMissing.Select(obj => obj != null ? obj.ObjectId.ToLower() : string.Empty),
            "Retrieve Sets from Select Objects should be Equal to Parameter Set ObjectId...");
        CollectionAssert.AreEqual(new[] {"", ""}.Concat(orderedObjs.Select(obj => obj.TestField.ToLower())),
            resultsManyWithMissing.Select(obj => obj != null ? obj.TestField.ToLower() : string.Empty),
            "Retrieve Sets from Select Objects should be Equal to Parameter Set Field Value...");
    }
    ...
    public void TestSelectObjectsNonRegistered()
    {
        ...
        Assert.Throws(typeof(DatabaseException),
            () => Database.SelectObject<TableNotRegistered>(DB.Column("a").IsEqualTo(null)), assertFailMessage);
        Assert.Throws(typeof(DatabaseException),
            () => Database.SelectObjects<TableNotRegistered>(DB.Column("a").IsEqualTo(null)), assertFailMessage);
        Assert.Throws(typeof(DatabaseException),
            () => Database.MultipleSelectObjects<TableNotRegistered>(new[] {DB.Column("a").IsEqualTo(null)}),
            assertFailMessage);
        Assert.Throws(typeof(DatabaseException), () => Database.SelectAllObjects<TableNotRegistered>(),
            assertFailMessage);
    }
    ...
    public void TestSelectObjectsWithNull()
    {
        ...
        var objInitial = Enumerable.Range(0, 10).Select(i => new TestTable
            {TestField = string.Format("Select Objects Null Values Test #{0}", i)});
        Database.AddObject(objInitial);
    ...
    public void TestSelectAll()
    {
        ...
        objs = Enumerable.Range(0, 10)
            .Select(i => new TestTable {TestField = string.Format("Test Select All Object #{0}", i)}).ToList();
        ...
        CollectionAssert.AreEquivalent(objs.Select(obj => obj.ObjectId), retrieve.Select(obj => obj.ObjectId),
            "TestTable Select All should return Objects with Same ID as Inserted...");
        CollectionAssert.AreEquivalent(objs.Select(obj => obj.TestField), retrieve.Select(obj => obj.TestField),
            "TestTable Select All shoud return Objects with same Value Field as Inserted...");
    }
    ...
    {
        Assert.Throws(typeof(DatabaseException), () => Database.SelectAllObjects<TableNotRegistered>(),
            "Trying to Query a Non Registered Table should throw a DatabaseException...");
    }
    ...
    public void TestCountObject()
    {
        ...
        var objs = Enumerable.Range(0, 10)
            .Select(i => new TestTable {TestField = string.Format("Count Object Test #{0}", i)});
    ...
    {
        Assert.Throws(typeof(DatabaseException), () => Database.GetObjectCount<TableNotRegistered>(),
            "Get Object Count should throw exception for unregistered tables...");
        Assert.Throws(typeof(DatabaseException), () => Database.GetObjectCount<TableNotRegistered>("1"),
            "Get Object Count should throw exception for unregistered tables...");
    }
    ...
    {
        Assert.Throws(typeof(NullReferenceException), () => Database.Escape(null),
            "SQL Escape string with Null value should throw Null Reference Exception...");
    }

...
public class DatabaseTests
{
    ...
    public void TestTable()
    {
        ...
        Assert.AreEqual(testValues.Length, retrieve.Count,
            "Retrieved Test Table Entries Count is not equals to Test Values Count.");

        CollectionAssert.AreEquivalent(testValues, retrieve.Select(o => o.TestField),
            "Retrieved Test Entries and Test Values should be Equivalent.");
        Assert.IsTrue(retrieve.All(o => o.IsPersisted),
            "All Retrieved Test Entries should be Persisted in database.");
        ...
        CollectionAssert.AreEquivalent(testValues, retrieve.Select(o => o.TestField),
            "Retrieved Test Entries after Modification should be Equivalent to Test Values.");
        ...
        CollectionAssert.AreEquivalent(testValues, retrieve.Select(o => o.TestField),
            "Retrieved Test Entries after Deletion should be Equivalent to Test Values.");

        // Find Object By Key
        var keyObject = retrieve.First();
        Assert.That(keyObject.ObjectId, Is.Not.Null.Or.Empty,
            "Test Table Retrieved Object should have an Object Id");
        ...
        Assert.AreEqual(retrieveKeyObj.ObjectId, keyObject.ObjectId,
            "Test Table Key Object and Retrieved Key Object should have same Object Id.");
        Assert.AreEqual(retrieveKeyObj.TestField, keyObject.TestField,
            "Test Table Key Object and Retrieved Key Object should have same Values.");
        ...
        Assert.IsTrue(retrieveKeyObjects.Count == 3,
            "Test Table Retrieved Objects by Key should contains 3 objects");
        Assert.IsTrue(keys.Contains(retrieveKeyObjects[0].ObjectId),
            "Test Table first Key Object and Retrieved first Key Object should have same Object Id.");
        Assert.IsTrue(keys.Contains(retrieveKeyObjects[1].ObjectId),
            "Test Table second Key Object and Retrieved second Key Object should have same Object Id.");
    ...
    public void TestTableAutoIncrement()
    {
        ...
        Assert.AreNotEqual(autoInc, default(int),
            "Test Table Auto Inc Primary should not be Default value after insertion.");
        ...
        Assert.Greater(otherAutoInc, autoInc,
            "Newly Inserted Test Table Auto Inc Other Entry should have a Greater Primary Key Increment.");
        ...
        Assert.Greater(otherObj.PrimaryKey, otherAutoInc,
            "Re-Added Test Table Auto Inc Entry should have a Greater Primary Key Increment.");
        ...
        Assert.AreEqual(otherObj.TestField, retrieve.TestField,
            "Test Table Auto Inc Retrieved Object is different from Other Object.");
    }
    ...
    public void TestTableUnique()
    {
        ...
        Assert.IsFalse(otherInserted,
            "Test Table Unique Field with Other Object violating unique constraint should not be inserted.");
        ...
        Assert.IsTrue(nonUniqueInserted,
            "Test Table Unique Field with Other Non Unique Object could not be inserted");
        ...
        Assert.IsFalse(saved,
            "Test Table Unique Field with Retrieved Object violating unique constraint should not be saved.");
        ...
        Assert.IsTrue(retrievedSaved,
            "Test Table Unique Field Retrieved Object could not be inserted after deleting previous constraint violating object.");
    }
    ...
    public void TestTableMultiUnique()
    {
        ...
        Assert.IsFalse(otherInserted,
            "Test Table Unique Multiple Field with Other Object violating unique constraint should not be inserted.");

        // Try Adding with non unique Value
        var otherNonUniqueObj = new TestTableMultiUnique
            {StrUniquePart = "Test Value Other Non-Unique", IntUniquePart = 2};

        var nonUniqueInserted = Database.AddObject(otherNonUniqueObj);

        Assert.IsTrue(nonUniqueInserted,
            "Test Table Unique Multiple Field with Other Non Unique Object could not be inserted");
        ...
        Assert.IsFalse(saved,
            "Test Table Unique Multiple Field with Retrieved Object violating unique constraint should not be saved.");
    ...
    public void TestTableRelation()
    {
        ...
        CollectionAssert.IsNotEmpty(selectInserted,
            "Test Table Relation could not retrieve objects without relation.");

        // Try Adding Relation
        var relObj = new TestTableRelationEntry()
            {TestField = "RelationEntryTestValue", ObjectId = noRelObj.ObjectId};
        ...
        Assert.AreEqual(relObj.TestField, retrieve.Entry.TestField,
            "Test Table Relation retrieved object Entry Relation is different from created object.");
        ...
        Assert.IsTrue(noRelObj.Entry.IsDeleted,
            "Test Table Relation deleted object Entry should have deleted flag set.");
        ...
        Assert.IsTrue(relObj.IsDeleted,
            "Test Table Relation Entry should have deleted flag set after auto delete.");
        ...
        allowAddRestriction.Entry = new TestTableRelationEntry()
        {
            TestField = "RelationEntryTestValueAllowAddRestriction", ObjectId = allowAddRestriction.ObjectId,
            AllowAdd = false
        };
        ...
        Assert.IsFalse(allowAddRestriction.Entry.IsPersisted,
            "Test Table Relation Entry should not be persisted if AllowAdd Restriction is in place.");
        ...
        Assert.IsTrue(restrictionSaved,
            "Test Table Relation restriction test should have the restricted object seved to database.");
        Assert.IsTrue(allowAddRestriction.Entry.IsPersisted,
            "Test Table Relation Entry restriction test should be persisted.");

        Assert.IsFalse(allowAddRestriction.Dirty,
            "Test Table Relation restriction object should not have Dirty flag after saving.");
        ...
        Assert.IsFalse(allowAddRestriction.Entry.Dirty,
            "Test Table Relation Entry need to have its Dirty flag off for this Test.");
        ...
        Assert.AreNotEqual(modifiedText, allowAddRestriction.Entry.TestField,
            "Test Table Relation Entry should not have been saved with modified text.");
    ...
    public void TestTableRelations()
    {
        ...
        CollectionAssert.IsNotEmpty(selectInserted,
            "Test Table Relations could not retrieve objects without relation.");

        // Try Adding Relation
        var testValues = new[]
            {"RelationsEntriesTestValue 1", "RelationsEntriesTestValue 2", "RelationsEntriesTestValue 3"};

        var relObjs = testValues.Select(val => new TestTableRelationsEntries()
            {TestField = val, ForeignTestField = noRelObj.ObjectId}).ToArray();
        ...
        Assert.IsTrue(noRelObj.Entries.All(ent => ent.IsDeleted),
            "Test Table Relations deleted object should have all Entries with deleted flag set.");

        // Check that Relation was deleted
        var relRetrieve = Database.SelectAllObjects<TestTableRelationsEntries>()
            .Where(o => o.ForeignTestField == noRelObj.ObjectId);

        Assert.IsEmpty(relRetrieve, "Test Table Relations Entries were not auto deleted with relations object.");
        Assert.IsTrue(relObjs.All(o => o.IsDeleted),
            "Test Table Relations Entries should have deleted flags set after auto delete.");
        ...
        allowAddRestriction.Entries = new[]
        {
            new TestTableRelationsEntries()
            {
                TestField = "RelationsEntriesTestValueAllowAddRestriction",
                ForeignTestField = allowAddRestriction.ObjectId, AllowAdd = false
            }
        };
        ...
        Assert.IsFalse(allowAddRestriction.Entries[0].IsPersisted,
            "Test Table Relations Entries should not be persisted if AllowAdd Restriction is in place.");
        ...
        Assert.IsTrue(restrictionSaved,
            "Test Table Relations restriction test should have the restricted object seved to database.");
        Assert.IsTrue(allowAddRestriction.Entries[0].IsPersisted,
            "Test Table Relations Entries restriction test should be persisted.");

        Assert.IsFalse(allowAddRestriction.Dirty,
            "Test Table Relations restriction object should not have Dirty flag after saving.");

        var modifiedText = "RelationEntryTestValueAllowAddRestrictionModified";
        allowAddRestriction.Entries[0].TestField = modifiedText;
        allowAddRestriction.Entries[0].Dirty = false;

        Assert.IsFalse(allowAddRestriction.Entries[0].Dirty,
            "Test Table Relations Entries need to have its Dirty flag off for this Test.");
        ...
        Assert.AreNotEqual(modifiedText, allowAddRestriction.Entries[0].TestField,
            "Test Table Relations Entries should not have been saved with modified text.");
    ...
    public void TestTableRelationsNoAutoload()
    {
        ...
        Assert.IsNull(noRelObj.Entries,
            "Test Table Relations (NoAutoLoad) object with no relation should have null Entry.");
        ...
        Assert.IsNotNull(retrieve,
            "Test Table Relations (NoAutoLoad) could not retrieve relations object by ObjectId.");
        Assert.IsNull(retrieve.Entries,
            "Test Table Relations (NoAutoLoad) retrieved object should not have entries objects.");

        Database.FillObjectRelations(retrieve);
        Assert.IsNotNull(retrieve.Entries,
            "Test Table Relations (NoAutoLoad) retrieved object should have entries objects after filling.");
        ...
        var newTestValues = new[]
            {changedRel.TestField, retrieve.Entries[1].TestField, retrieve.Entries[2].TestField};

        Database.FillObjectRelations(retrieve);

        CollectionAssert.AreEquivalent(newTestValues, retrieve.Entries.Select(obj => obj.TestField),
            "Test Table Relations (NoAutoLoad) refreshed objects Entries Relation are different from changed objects.");

        // Try Deleting Relation
        var deleted = Database.DeleteObject(noRelObj);

        Assert.IsTrue(deleted, "Test Table Relations (NoAutoLoad) could not delete object with relations.");
        Assert.IsTrue(noRelObj.IsDeleted,
            "Test Table Relations (NoAutoLoad) deleted object should have deleted flag set.");

        // Check that Relations were deleted
        var relRetrieve = Database.SelectAllObjects<TestTableRelationsEntries>()
            .Where(o => o.ForeignTestField == noRelObj.ObjectId);

        Assert.IsEmpty(relRetrieve,
            "Test Table Relations (NoAutoLoad) Entries were not auto deleted with relations object.");
        Assert.IsTrue(relObjs.All(o => o.IsDeleted),
            "Test Table Relations (NoAutoLoad) Entries should have deleted flags set after auto delete.");
    }
    ...
    public void TestTableRelationsWithNoAutoDelete()
    {
        ...
        relObj.Entries = testValues.Select(obj => new TestTableRelationsEntries
            {TestField = obj, ForeignTestField = relObj.ObjectId}).ToArray();
        ...
        Assert.IsNotNull(retrieve,
            "Test Table Relations (NoAutoDelete) could not retrieve relations object by ObjectId.");
        Assert.IsNotEmpty(retrieve.Entries,
            "Test Table Relations (NoAutoDelete) retrieved object should have entries objects.");
        CollectionAssert.AreEquivalent(testValues, retrieve.Entries.Select(obj => obj.TestField),
            "Test Table Relations (NoAutoDelete) retrieved object Entries should have same values as created.");
        ...
        Assert.IsTrue(relObj.IsDeleted,
            "Test Table Relations (NoAutoDelete) deleted object should have deleted flag set.");

        // Check that Relation were not deleted
        var relRetrieve = Database.SelectAllObjects<TestTableRelationsEntries>()
            .Where(o => o.ForeignTestField == relObj.ObjectId);

        Assert.IsNotEmpty(relRetrieve,
            "Test Table Relations (NoAutoDelete) Entries should not be auto deleted with relations object.");
        Assert.IsTrue(relObj.Entries.All(o => !o.IsDeleted),
            "Test Table Relations (NoAutoDelete) Entries should not have deleted flags set after delete.");
        CollectionAssert.AreEquivalent(testValues, relRetrieve.Select(obj => obj.TestField),
    ...
    public void TestTablePrimaryKey()
    {
        ...
        Assert.IsFalse(otherInserted,
            "Test Table Primary Key with Other Object violating key constraint should not be inserted.");

        // Try Adding with non unique Value
        var otherNonUniqueObj = new TestTablePrimaryKey
            {TestField = "Test Value Other Non-Primary", PrimaryKey = "Key2"};
        ...
        Assert.IsFalse(saved,
            "Test Table Primary Key with Retrieved Object violating key constraint should not be saved.");
        ...
        Assert.IsTrue(retrievedSaved,
            "Test Table Primary Key Retrieved Object could not be inserted after deleting previous constraint violating object.");
    }
    ...
    public void TestTablePrimaryKeyWithUnique()
    {
        ...
        // Test Add
        var uniqueObj = new TestTablePrimaryKeyUnique
            {TestField = "Test Value", PrimaryKey = "Key1", Unique = "Unique"};
        ...
        // Try Adding with unique Value
        var otherUniqueObj = new TestTablePrimaryKeyUnique
            {TestField = "Test Value Other", PrimaryKey = "Key1", Unique = "Unique"};

        var otherInserted = Database.AddObject(otherUniqueObj);

        Assert.IsFalse(otherInserted,
            "Test Table Primary Key With Unique with Other Object violating key constraint should not be inserted.");

        // Try Adding with non unique Value
        var otherNonUniqueObj = new TestTablePrimaryKeyUnique
            {TestField = "Test Value Other Non-Primary", PrimaryKey = "Key2", Unique = "NonUnique"};

        var nonUniqueInserted = Database.AddObject(otherNonUniqueObj);

        Assert.IsTrue(nonUniqueInserted,
            "Test Table Primary Key With Unique with Other Non Unique Key could not be inserted");
        ...
        Assert.IsFalse(saved,
            "Test Table Primary Key With Unique with Retrieved Object violating key constraint should not be saved.");

        // Delete Previous Unique and Try Reinsert.
        var deleted = Database.DeleteObject(uniqueObj);
        Assert.IsTrue(deleted, "Test Table Primary Key With Unique could not delete unique key object.");
        Assert.IsTrue(uniqueObj.IsDeleted,
            "Test Table Primary Key With Unique unique key object should have delete flag set.");

        var retrievedSaved = Database.SaveObject(retrieved);

        Assert.IsTrue(retrievedSaved,
            "Test Table Primary Key With Unique Retrieved Object could not be inserted after deleting previous constraint violating object.");
    }
    ...
    public void TestTableWithReadOnly()
    {
        ...
        Assert.AreNotEqual(testObj.ReadOnly, retrieved.ReadOnly,
            "Test Table With ReadOnly shouldn't have saved ReadOnly Field Change.");
        Assert.AreEqual(testObj.TestField, retrieved.TestField,
            "Test Table With ReadOnly should have saved Test Field Change.");
        Assert.AreEqual("ReadOnly Value", retrieved.ReadOnly,
            "Test Table With ReadOnly should have the same ReadOnly Field Value as Created.");
    }
    ...
    public void TestTableWithView()
    {
        ...
        var objBase = new TestTableBaseView
            {TestField = "TestField for Base View", ViewValue = "This is a Value to be retrieve in View..."};
        ...
        Assert.AreEqual(objBase.PrimaryKey, retrieve.PrimaryKey,
            "Test Table With View should retrieve same value from Base and View Object.");
        Assert.AreEqual(objBase.TestField, retrieve.TestField,
            "Test Table With View should retrieve same value from Base and View Object.");
        Assert.AreEqual(objBase.ViewValue, retrieve.ViewValue,
            "Test Table With View should retrieve same value from Base and View Object.");
        Assert.AreEqual("Weird Indeed", retrieve.WeirdValue,
            "Test Table With View should retrieve View Object with 'Weird Value' set as expected from ViewAs.");

        // Try Add View Value
        var objView = new TestTableAsView
        {
            TestField = "TestField for As View", ViewValue = "This is a Value to saved in Base...",
            WeirdValue = "Anything..."
        };

        var viewInsert = Database.AddObject(objView);

        Assert.IsTrue(viewInsert,
            "Test Table With View should be able to Insert View Object as Base Object in Database.");
        ...
        Assert.AreEqual(objView.PrimaryKey, baseRetrieve.PrimaryKey,
            "Test Table With View should retrieve same value from View and Base Object.");
        Assert.AreEqual(objView.TestField, baseRetrieve.TestField,
            "Test Table With View should retrieve same value from View and Base Object.");
        Assert.AreEqual(objView.ViewValue, baseRetrieve.ViewValue,
            "Test Table With View should retrieve same value from View and Base Object.");
        ...
        Assert.AreEqual(viewRetrieve.PrimaryKey, saveRetrieve.PrimaryKey,
            "Test Table With View should retrieve same value from View and Base Object.");
        Assert.AreEqual(viewRetrieve.TestField, saveRetrieve.TestField,
            "Test Table With View should retrieve same value from View and Base Object.");
        Assert.AreEqual(viewRetrieve.ViewValue, saveRetrieve.ViewValue,
            "Test Table With View should retrieve same value from View and Base Object.");
        ...
        Assert.IsNull(retrieveHidden,
            "Test Table With View should not be able to retrieve object filtered out of View As Query.");
    }
    ...
    public void TestTableWithViewAndRelation()
    {
        ...
        var objBase = new TestTableBaseView
        {
            TestField = "TestField for Base View With Relation",
            ViewValue = "This is a Value to be retrieve in View Relation..."
        };
        ...
        var entries = Enumerable.Range(0, 5).Select(i => new TestTableRelationsEntries
            {TestField = string.Format("View Relation Test Field #{0}", i), ForeignTestField = objBase.ViewValue});

        var relInserted = Database.AddObject(entries);

        Assert.IsTrue(relInserted,
            "Test Table With View And Relation could not insert relations object in database.");

        // Retrieve
        var viewRetrieve = Database.FindObjectByKey<TestTableAsViewWithRelations>(objBase.PrimaryKey);

        Assert.IsNotNull(viewRetrieve,
            "Test Table With View And Relation could not retrieve object from database.");
        Assert.IsNotEmpty(viewRetrieve.Entries,
            "Test Table With View And Relation should have Relations Populated.");
        CollectionAssert.AreEquivalent(entries.Select(obj => obj.TestField),
            viewRetrieve.Entries.Select(obj => obj.TestField),
            "Test Table With View And Relation should have Relations similar to Created Object");
    }
    ...
    public void TestTablePrimaryKeyWithPrecache()
    {
        ...
        Assert.IsNotNull(retrieve,
            "Test Table Precached With Primary Key could not retrieve object from database or precache using primary key.");
        Assert.AreEqual(obj.PrimaryKey, retrieve.PrimaryKey,
            "Test Table Precached With Primary Key should retrieve Object with similar primary key.");
        ...
        Assert.IsNotNull(retrieveCase,
            "Test Table Precached With Primary Key should be able to retrieve object with primary key using different case.");
    ...
    public void TestTableRelationsWithPrecached()
    {
        ...
        Assert.IsEmpty(Database.SelectAllObjects<TestTableRelationsWithPrecache>(),
            "Relations Test With Precache should begin with Empty Table.");
        Assert.IsEmpty(Database.SelectAllObjects<TestTableRelationsEntriesPrecached>(),
            "Relations Test With Precache should begin with Empty Table.");

        // Objects
        var objs = Enumerable.Range(0, 10).Select(i => new TestTableRelationsWithPrecache
            {TestField = string.Format("Test Table Relation with Precache #{0}", i)}).ToArray();

        foreach (var obj in objs)
            obj.Entries = Enumerable.Range(0, 5).Select(i => new TestTableRelationsEntriesPrecached
            {
                ForeignTestField = obj.ObjectId,
                TestField = string.Format("Test Table Relation Entry with Precache #{0}", i)
            }).ToArray();
        ...
        CollectionAssert.AreEquivalent(objs.Select(obj => obj.ObjectId), retrieve.Select(obj => obj.ObjectId),
            "Relations Test With Precache should retrieve object similar to created ones.");
        ...
        foreach (var ret in retrieve)
        {
            CollectionAssert.AreEquivalent(
                objs.FirstOrDefault(obj => obj.ObjectId.Equals(ret.ObjectId)).Entries.Select(obj => obj.ObjectId),
                ret.Entries.Select(obj => obj.ObjectId),
                "Relations Test With Precache should retrieve object entries similar to created ones.");
            CollectionAssert.AreEquivalent(
                objs.FirstOrDefault(obj => obj.ObjectId.Equals(ret.ObjectId)).Entries.Select(obj => obj.TestField),
                ret.Entries.Select(obj => obj.TestField),
                "Relations Test With Precache should retrieve object entries similar to created ones.");
        }

        Database.DeleteObject(Database.SelectAllObjects<TestTableRelationsEntriesPrecached>());
        Assert.IsEmpty(Database.SelectAllObjects<TestTableRelationsEntriesPrecached>(),
            "Relations Test With Precache should have Empty Entry Table for cache test.");

        Database.FillObjectRelations(objs);

        foreach (var obj in objs)
            Assert.IsNull(obj.Entries,
                "Relation Test With Precache should have objects with null relations after entry deletion.");

        // Try Select with no relation
        var norel = new TestTableRelationsWithPrecache
            {TestField = "Test Table Relation with Precache without relations..."};
        Database.AddObject(norel);
        var selectInserted = Database.SelectAllObjects<TestTableRelationsWithPrecache>()
            .Single(obj => obj.TestField.Equals(norel.TestField));

        Assert.IsNull(selectInserted.Entries,
            "Relations Test With Precache should return null for Entries stored without relation.");

        // Try Fill with null Local Value
        var reAddEntries = Database.AddObject(Enumerable.Range(0, 5).Select(i =>
            new TestTableRelationsEntriesPrecached
            {
                ForeignTestField = IDGenerator.GenerateID(),
                TestField = string.Format("Test Table NOT Related Entry with Precache #{0}", i)
            }));

        Assert.IsTrue(reAddEntries,
            "Relations Test With Precache Relation Entries could not be inserted for testing...");
        ...
        foreach (var obj in objs)
            Assert.IsNull(obj.Entries,
                "Relation Test With Precache should have objects with null relations with null local.");
    }
    ...
    public void TestTableRelationWithPrecacheAndPrimaryRemote()
    {
        ...
        Assert.IsEmpty(Database.SelectAllObjects<TestTableRelationsWithPrecacheAndPrimary>(),
            "Relations Test With Precache and Primary should begin with Empty Table.");
        Assert.IsEmpty(Database.SelectAllObjects<TestTableRelationsEntryPrecached>(),
            "Relations Test With Precache and Primary should begin with Empty Table.");

        // Add one object with no relation
        var norel = new TestTableRelationsWithPrecacheAndPrimary
            {TestField = "Table Relation With Precache and Primary Remote"};
        ...
        Assert.AreEqual(norel.TestField, retrieve.TestField,
            "Relations Test With Precache and Primary should retrieve similar object.");
        Assert.IsNull(retrieve.Entry,
            "Relations Test With Precache and Primary should not have relation set for no relation object.");

        // Add relation

        var relobj = new TestTableRelationsEntryPrecached
            {ForeignTestField = "Some Data", ObjectId = norel.ObjectId};
        ...
        Assert.AreEqual(norel.TestField, relretrieve.TestField,
            "Relations Test With Precache and Primary should retrieve similar object.");
        Assert.IsNotNull(relretrieve.Entry,
            "Relations Test With Precache and Primary should have valid relation entry.");
        Assert.AreEqual(relobj.ForeignTestField, relretrieve.Entry.ForeignTestField,
            "Relations Test With Precache and Primary should retrieve similar relation object.");
        ...
        Assert.IsNull(relretrieve.Entry,
            "Relations Test With Precache and Primary should return null value for null local field relation...");
    }
}
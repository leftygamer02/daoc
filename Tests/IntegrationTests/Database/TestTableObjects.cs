...
{
    [DataElement(IndexColumns = "Index2")] public string Index1 { get; set; }
    [DataElement(IndexColumns = "Index3")] public string Index2 { get; set; }
    [DataElement] public string Index3 { get; set; }
}
...
{
    [DataElement] public string Value { get; set; }
}
...
{
    [PrimaryKey(AutoIncrement = true)] public int PrimaryKey { get; set; }
    [DataElement] public string Value { get; set; }
}
...
{
    [PrimaryKey(AutoIncrement = true)] public int PrimaryKey2 { get; set; }
    [DataElement] public string Value { get; set; }
}
...
{
    [DataElement] public long PrimaryKey { get; set; }
...
{
    [PrimaryKey] public long PrimaryKey { get; set; }
    [DataElement] public string Value { get; set; }
}
...
{
    [DataElement(Varchar = 100)] public string StringValue { get; set; }
    [DataElement] public int IntValue { get; set; }
    [DataElement] public DateTime DateValue { get; set; }
}
...
{
    [DataElement] public string StringValue { get; set; }
    [DataElement] public byte IntValue { get; set; }
    [DataElement] public string DateValue { get; set; }
}
...
{
    [DataElement(AllowDbNull = true)] public string StringValue { get; set; }
}
...
{
    [DataElement(AllowDbNull = false)] public string StringValue { get; set; }

    [DataElement(AllowDbNull = false)] public int IntValue { get; set; }
}
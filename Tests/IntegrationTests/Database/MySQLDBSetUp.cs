...
public class MySQLDBSetUp
{
    ...
    public void SetUp()
    {
        ...
        ConnectionString =
            "Server=localhost;Port=3306;Database=test_dol_database;User ID=root;Password=;Treat Tiny As Boolean=False";

        Database = (SQLObjectDatabase) ObjectDatabase.GetObjectDatabase(ConnectionType.DATABASE_MYSQL,
            ConnectionString);

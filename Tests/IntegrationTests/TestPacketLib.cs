...
public class TestPacketLib : IPacketLib
{
    ...
    {
        get => BowPrepareGetFunc != null ? BowPrepareGetFunc(this) : default;
        set
        {
            if (BowPrepareSetFunc != null) BowPrepareSetFunc(this, value);
        }
    }
    ...
    public int BowShoot
    {
        get => BowShootGetFunc != null ? BowShootGetFunc(this) : default;
        set
        {
            if (BowShootSetFunc != null) BowShootSetFunc(this, value);
        }
    }
    ...
    {
        get => OneDualWeaponHitGetFunc != null ? OneDualWeaponHitGetFunc(this) : default;
        set
        {
            if (OneDualWeaponHitSetFunc != null) OneDualWeaponHitSetFunc(this, value);
        }
    }
    ...
    {
        get => BothDualWeaponHitGetFunc != null ? BothDualWeaponHitGetFunc(this) : default;
        set
        {
            if (BothDualWeaponHitSetFunc != null) BothDualWeaponHitSetFunc(this, value);
        }
    }
    ...
    {
        return GetPacketCodeFunc != null ? GetPacketCodeFunc(this, packetCode) : default;
    }
    ...
    public Action<TestPacketLib, GameObject, GameObject, ushort, ushort, int, byte, byte, byte>
        SendCombatAnimationMethod { get; set; }

    public void SendCombatAnimation(GameObject attacker, GameObject defender, ushort weaponID, ushort shieldID,
        int style,
        byte stance, byte result, byte targetHealthPercent)
    {
        if (SendCombatAnimationMethod != null)
            SendCombatAnimationMethod(this, attacker, defender, weaponID, shieldID, style, stance, result,
                targetHealthPercent);
    }
    ...
    public Action<TestPacketLib, GameObject, GameObject, ushort, ushort, bool, byte> SendSpellEffectAnimationMethod
    {
        get;
        set;
    }

    public void SendSpellEffectAnimation(GameObject spellCaster, GameObject spellTarget, ushort spellid,
        ushort boltTime,
    ...
    public Action<TestPacketLib, eDialogCode, ushort, ushort, ushort, ushort, eDialogType, bool, string>
        SendDialogBoxMethod { get; set; }

    public void SendDialogBox(eDialogCode code, ushort data1, ushort data2, ushort data3, ushort data4,
        eDialogType type,
    ...
    public Action<TestPacketLib, eInventoryWindowType, ICollection<InventoryItem>>
        SendInventoryItemsUpdateWindowMethod { get; set; }
    ...
    public Action<TestPacketLib, IDictionary<int, InventoryItem>, eInventoryWindowType>
        SendInventoryItemsUpdateDictMethod { get; set; }

    public void SendInventoryItemsUpdate(IDictionary<int, InventoryItem> updateItems,
    ...
    public Action<TestPacketLib, int, List<Tuple<Specialization, List<Tuple<Skill, byte>>>>>
        SendCustomTrainerWindowMethod { get; set; }
    ...
    public Action<TestPacketLib, GameLiving, ePetWindowAction, eAggressionState, eWalkState> SendPetWindowMethod
    {
        get;
        set;
    }
    ...
    public void SendHexEffect(GamePlayer player, byte effect1, byte effect2, byte effect3, byte effect4,
        byte effect5)
    {

...
internal class Test_Keeps
{
    ...
    [Category("Unreliable")]
    public void
        ComponentFillPosition_TwoIdenticalComponentsWithAGuardOnEachHeightOnSameKeepWithLevel2_KeepHas4Guards()
    {
        var keep = CreateKeep();
    ...
    private GameKeep CreateKeep()
    {
        return new() {DBKeep = new DBKeep()};
    }

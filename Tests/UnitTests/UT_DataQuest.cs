...
[TestFixture]
internal class UT_DataQuest
{
    private FakeServer fakeServer = new();
    ...
    public void CheckQuestQualification_Default_True()
    {
        ...
        var isQualified = dataQuest.CheckQuestQualification(player);
    ...
    private FakeQuestPlayer NewFakePlayer()
    {
        return new();
    }

    private DataQuestSpy NewDataQuest()
    {
        return NewDataQuest(NewDBDataQuest());
    }

    private DataQuestSpy NewDataQuest(DBDataQuest dbDataQuest)
    {
        return new(null, dbDataQuest, new CharacterXDataQuest());
    }

    private DBDataQuest NewDBDataQuest()
    {
        return new();
    }
    ...
    {
        public List<AbstractQuest> fakeQuestList = new();
        public List<AbstractQuest> fakeQuestListFinished = new();
    ...
    private class DataQuestSpy : DataQuest
    {
        ...
        public DataQuestSpy(GamePlayer player, DBDataQuest dbDataQuest, CharacterXDataQuest charXDataQuest) : base(
            player, dbDataQuest, charXDataQuest)
        {
        }
    }
}
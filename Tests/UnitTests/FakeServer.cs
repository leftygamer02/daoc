...
public class FakeRegion : Region
{
    ...
    {
        get => fakeTimeManager.fakeTime;
        set => fakeTimeManager.fakeTime = value;
    }

    public FakeTimeManager fakeTimeManager = new();
...
public class FakeDatabase : IObjectDatabase
{
    ...
    public string Escape(string rawInput)
    {
        throw new NotImplementedException();
    }
    ...
    public void FillObjectRelations(IEnumerable<DataObject> dataObject)
    {
        throw new NotImplementedException();
    }
    ...
    public int GetObjectCount<TObject>() where TObject : DataObject
    {
        throw new NotImplementedException();
    }

    public int GetObjectCount<TObject>(string whereExpression) where TObject : DataObject
    {
        throw new NotImplementedException();
    }
    ...
    public TObject SelectObject<TObject>(WhereClause whereClause) where TObject : DataObject
    {
        return (TObject) SelectObjectReturns.FirstOrDefault();
    }

    public IList<TObject> SelectObjects<TObject>(WhereClause whereClause) where TObject : DataObject
    {
        return (IList<TObject>) SelectObjectReturns;
    }
    ...
    public bool UpdateInCache<TObject>(object key) where TObject : DataObject
    {
        return false;
    }

    public bool UpdateObjsInCache<TObject>(IEnumerable<object> keys) where TObject : DataObject
    {
        throw new NotImplementedException();
    }
}
...
public class UtilChanceIsHundredPercent : Util
{
    ...
    {
        LoadTestDouble(new UtilChanceIsHundredPercent());
    }
}
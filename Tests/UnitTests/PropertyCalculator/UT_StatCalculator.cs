...
public class UT_StatCalculator
{
    ...
    public void CalcValueFromBuffs_GameNPCWith100ConstBaseBuff_100()
    {
        ...
        var actual = StatCalculator.CalcValueFromBuffs(npc, eProperty.Constitution);
    ...
    public void CalcValueFromBuffs_Level50PlayerWith100ConstBaseBuff_62()
    {
        ...
        var actual = StatCalculator.CalcValueFromBuffs(player, eProperty.Constitution);

        var expected = (int) (50 * 1.25);
    ...
    {
        var actual = StatCalculator.CalcValueFromBuffs(null, eProperty.Constitution);
    ...
    {
        var actual = StatCalculator.CalcValueFromItems(null, eProperty.Constitution);
    ...
    public void CalcValueFromItems_Level50Player100ConstFromItems_75()
    {
        ...
        var actual = StatCalculator.CalcValueFromItems(player, eProperty.Constitution);

        var expected = (int) (1.5 * 50);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void CalcValueFromItems_Level50NPC100ConstFromItems_75()
    {
        ...
        var actual = StatCalculator.CalcValueFromItems(npc, stat);
    ...
    public void CalcValueFromItems_IntelligenceOfLevel50AnimistWith50AcuityFromItems_50()
    {
        ...
        var actual = StatCalculator.CalcValueFromItems(player, eProperty.Intelligence);
    ...
    public void GetItemBonusCapIncrease_Level50Player100ConstCap_26()
    {
        ...
        var actual = StatCalculator.GetItemBonusCapIncrease(player, eProperty.Constitution);

        var expected = (int) (50 / 2.0 + 1);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void GetMythicalItemBonusCapIncrease_PlayerWith100MythicalConCap_52()
    {
        ...
        var actual = StatCalculator.GetMythicalItemBonusCapIncrease(player, eProperty.Constitution);
    ...
    public void CalcValue_NPCWith100Constitution_100()
    {
        ...
        var actual = StatCalculator.CalcValue(npc, eProperty.Constitution);
    ...
    public void CalcValue_NPCWith100Intelligence_100()
    {
        ...
        var actual = StatCalculator.CalcValue(npc, eProperty.Intelligence);
    ...
    public void CalcValue_GetIntelligenceFromLevel50AnimistWith50Acuity_50()
    {
        ...
        var actual = StatCalculator.CalcValue(player, eProperty.Intelligence);
    ...
    public void CalcValue_200ConstitutionAbilityBonus_200()
    {
        ...
        var actual = StatCalculator.CalcValue(player, eProperty.Constitution);
    ...
    public static StatCalculator StatCalculator => new();

    private static FakePlayer NewPlayer()
    {
        return new();
    }

    private static FakeNPC NewNPC()
    {
        return new();
    }
}
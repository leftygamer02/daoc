...
[TestFixture]
internal class UT_HereticFocusSpells
{
    [SetUp]
    public void SetUp()
    {
    ...
    [Test]
    public void
        OnDirectEffect_100InitialDamageAnd50PercentGrowthAnd70PercentGrowthCap_TickTwice_NextTickDoes170Damage()
    {
        double initialDamage = 100;
        var growthPercent = 50;
        var growthCapPercent = 70;

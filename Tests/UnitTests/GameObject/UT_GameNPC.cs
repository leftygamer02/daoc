...
internal class UT_GameNPC
{
    ...
    public void GetModified_Constitution_GameNPCWith75Constitution_75Percent()
    {
        ...
        var actual = npc.GetModified(eProperty.Constitution);
    ...
    private static GameNPC NewNPC()
    {
        return new(new FakeControlledBrain());
    }
}

[TestFixture]
internal class UT_GameKeepGuard
{
    [SetUp]
    public void Init()
    {
